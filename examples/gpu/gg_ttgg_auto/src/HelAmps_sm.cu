    ...
    thrust::complex<double> V1[])
{
  ...
  V1[4] = denom * (-cI * (V3[4] * TMP12) + cI * (V2[4] * TMP10)); 
  V1[5] = denom * (-cI * (V3[5] * TMP12) + cI * (V2[5] * TMP10)); 
}
    ...
    thrust::complex<double> V1[])
{
  ...
  V1[4] = denom * (-cI * (TMP6 * V4[4]) + cI * (V3[4] * TMP12)); 
  V1[5] = denom * (-cI * (TMP6 * V4[5]) + cI * (V3[5] * TMP12)); 
}
