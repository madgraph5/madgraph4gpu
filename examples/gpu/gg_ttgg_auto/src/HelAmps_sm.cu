    ...
    thrust::complex<double> * vertex)
{
  ...
  TMP0 = (V4[2] * V1[2] - V4[3] * V1[3] - V4[4] * V1[4] - V4[5] * V1[5]); 
  TMP6 = (V1[2] * V2[2] - V1[3] * V2[3] - V1[4] * V2[4] - V1[5] * V2[5]); 
  (*vertex) = COUP * (-cI * (TMP0 * TMP1) + cI * (TMP5 * TMP6)); 
}
    ...
    thrust::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V4[2] * TMP1) + cI * (V2[2] * TMP5)); 
  V1[3] = denom * (-cI * (V4[3] * TMP1) + cI * (V2[3] * TMP5)); 
  V1[4] = denom * (-cI * (V4[4] * TMP1) + cI * (V2[4] * TMP5)); 
  V1[5] = denom * (-cI * (V4[5] * TMP1) + cI * (V2[5] * TMP5)); 
}
    ...
    thrust::complex<double> * vertex)
{
  ...
  TMP2 = (V4[2] * V2[2] - V4[3] * V2[3] - V4[4] * V2[4] - V4[5] * V2[5]); 
  TMP6 = (V1[2] * V2[2] - V1[3] * V2[3] - V1[4] * V2[4] - V1[5] * V2[5]); 
  (*vertex) = COUP * (-cI * (TMP2 * TMP3) + cI * (TMP5 * TMP6)); 
}
    ...
    thrust::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V3[2] * TMP2) + cI * (V2[2] * TMP5)); 
  V1[3] = denom * (-cI * (V3[3] * TMP2) + cI * (V2[3] * TMP5)); 
  V1[4] = denom * (-cI * (V3[4] * TMP2) + cI * (V2[4] * TMP5)); 
  V1[5] = denom * (-cI * (V3[5] * TMP2) + cI * (V2[5] * TMP5)); 
}
    ...
    thrust::complex<double> COUP, thrust::complex<double> * vertex)
{
  ...
  (*vertex) = COUP * (TMP1 * (-cI * (TMP11) + cI * (TMP12)) + (TMP3 * (+cI *
      (TMP9) - cI * (TMP10)) + TMP6 * (-cI * (TMP7) + cI * (TMP8))));
}
