...
__device__ void ipzxxx(const double pvec[3], int nhel, int nsf,
    thrust::complex<double> fi[6])
{
  // ASSUMPTION FMASS == 0
  // PX = PY = 0
  ...
  thrust::complex<double> sqp0p3 = thrust::complex<double> (sqrt(2. * pvec[2])
      * nsf, 0.);
...
__device__ void imzxxx(const double pvec[3], int nhel, int nsf,
    thrust::complex<double> fi[6])
{
  // ASSUMPTION FMASS == 0
  // PX = PY = 0
  ...
  int nh = nhel * nsf; 
  thrust::complex<double> chi = thrust::complex<double> (-nhel * sqrt(-2.0 *
      pvec[2]), 0.0);
...
__device__ void ixzxxx(const double pvec[3], int nhel, int nsf,
    thrust::complex<double> fi[6])
{
  // ASSUMPTIONS: FMASS == 0
  ...
  thrust::complex<float> chi1 = thrust::complex<float> (nh * p[1]/sqp0p3,
      p[2]/sqp0p3);
...
__device__ void opzxxx(const double pvec[3], int nhel, int nsf,
    thrust::complex<double> fo[6])
{
  // ASSUMPTIONS FMASS =0
  // PX = PY =0
  ...
  thrust::complex<double> CSQP0P3 = thrust::complex<double> (sqrt(2. * pvec[2])
      * nsf, 0.00);
...
__device__ void omzxxx(const double pvec[3], int nhel, int nsf,
    thrust::complex<double> fo[6])
{
  // ASSUMPTIONS FMASS =0
  // PX = PY =0
  ...
  fo[1] = thrust::complex<double> (0., 0.); 
  int nh = nhel * nsf; 
  thrust::complex<double> chi = thrust::complex<double> (-nhel, 0.00) *
      sqrt(-2.0 * pvec[2]);
...
__device__ void oxzxxx(const double pvec[3], int nhel, int nsf,
    thrust::complex<double> fo[6])
{
  // ASSUMPTIONS FMASS =0
  // PT > 0
...
__device__ void FFV1_1(const thrust::complex<double> F2[], const
...
__device__ void FFV1_2(const thrust::complex<double> F1[], const
    thrust::complex<double> V3[], const thrust::complex<double> COUP, const
    ...
    thrust::complex<double> COUP, thrust::complex<double> * vertex)
{
  ...
  TMP8 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  TMP2 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP5 = (V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3]); 
  TMP6 = (V3[2] * P2[0] - V3[3] * P2[1] - V3[4] * P2[2] - V3[5] * P2[3]); 
  (*vertex) = COUP * (TMP2 * (-cI * (TMP10) + cI * (TMP11)) + (TMP4 * (-cI *
      (TMP5) + cI * (TMP6)) + TMP8 * (+cI * (TMP7) - cI * (TMP9))));
}
    ...
    double M1, const double W1, thrust::complex<double> V1[])
{
  ...
  V1[2] = denom * (TMP2 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP5) + cI * (TMP6)) + V3[2] * (+cI * (TMP7) - cI * (TMP9))));
  V1[3] = denom * (TMP2 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP5) + cI * (TMP6)) + V3[3] * (+cI * (TMP7) - cI * (TMP9))));
  V1[4] = denom * (TMP2 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP5) + cI * (TMP6)) + V3[4] * (+cI * (TMP7) - cI * (TMP9))));
  V1[5] = denom * (TMP2 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP5) + cI * (TMP6)) + V3[5] * (+cI * (TMP7) - cI * (TMP9))));
}
    ...
    thrust::complex<double> * vertex)
{
  ...
  TMP1 = (V4[2] * V1[2] - V4[3] * V1[3] - V4[4] * V1[4] - V4[5] * V1[5]); 
  TMP2 = (V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5]); 
  TMP12 = (V4[2] * V2[2] - V4[3] * V2[3] - V4[4] * V2[4] - V4[5] * V2[5]); 
  TMP8 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  (*vertex) = COUP * (-cI * (TMP1 * TMP2) + cI * (TMP8 * TMP12)); 
}
    ...
    thrust::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V4[2] * TMP2) + cI * (V3[2] * TMP12)); 
  V1[3] = denom * (-cI * (V4[3] * TMP2) + cI * (V3[3] * TMP12)); 
  V1[4] = denom * (-cI * (V4[4] * TMP2) + cI * (V3[4] * TMP12)); 
  V1[5] = denom * (-cI * (V4[5] * TMP2) + cI * (V3[5] * TMP12)); 
}
    ...
    thrust::complex<double> * vertex)
{
  ...
  TMP3 = (V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5]); 
  TMP8 = (V3[2] * V1[2] - V3[3] * V1[3] - V3[4] * V1[4] - V3[5] * V1[5]); 
  (*vertex) = COUP * (-cI * (TMP8 * TMP12) + cI * (TMP3 * TMP4)); 
}
    ...
    thrust::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V3[2] * TMP12) + cI * (V2[2] * TMP3)); 
  V1[3] = denom * (-cI * (V3[3] * TMP12) + cI * (V2[3] * TMP3)); 
  V1[4] = denom * (-cI * (V3[4] * TMP12) + cI * (V2[4] * TMP3)); 
  V1[5] = denom * (-cI * (V3[5] * TMP12) + cI * (V2[5] * TMP3)); 
}
