    ...
    double &matrix)
{
  ...
  vxxxxx((double * )(dps + 0 * dpt), cmME[0], cHel[ihel][0], -1, w[0]); 
  vxxxxx((double * )(dps + 1 * dpt), cmME[1], cHel[ihel][1], -1, w[1]); 
  oxxxxx((double * )(dps + 2 * dpt), cmME[2], cHel[ihel][2], +1, w[2]); 
  ixxxxx((double * )(dps + 3 * dpt), cmME[3], cHel[ihel][3], -1, w[3]); 
  vxxxxx((double * )(dps + 4 * dpt), cmME[4], cHel[ihel][4], +1, w[4]); 
  vxxxxx((double * )(dps + 5 * dpt), cmME[5], cHel[ihel][5], +1, w[5]); 
  VVV1P0_1(w[0], w[1], cIPC[0], 0., 0., w[6]); 
  FFV1P0_3(w[3], w[2], cIPC[1], 0., 0., w[7]); 
  // Amplitude(s) for diagram number 1
  VVVV1_0(w[6], w[7], w[4], w[5], cIPC[2], &amp[0]); 
  VVVV3_0(w[6], w[7], w[4], w[5], cIPC[2], &amp[1]); 
  VVVV4_0(w[6], w[7], w[4], w[5], cIPC[2], &amp[2]); 
  VVV1P0_1(w[6], w[4], cIPC[0], 0., 0., w[8]); 
  // Amplitude(s) for diagram number 2
  VVV1_0(w[7], w[5], w[8], cIPC[0], &amp[3]); 
  VVV1P0_1(w[6], w[5], cIPC[0], 0., 0., w[9]); 
  // Amplitude(s) for diagram number 3
  VVV1_0(w[7], w[4], w[9], cIPC[0], &amp[4]); 
  VVV1P0_1(w[4], w[5], cIPC[0], 0., 0., w[10]); 
  // Amplitude(s) for diagram number 4
  VVV1_0(w[6], w[7], w[10], cIPC[0], &amp[5]); 
  FFV1_1(w[2], w[4], cIPC[1], cIPD[0], cIPD[1], w[11]); 
  FFV1_2(w[3], w[6], cIPC[1], cIPD[0], cIPD[1], w[12]); 
  // Amplitude(s) for diagram number 5
  FFV1_0(w[12], w[11], w[5], cIPC[1], &amp[6]); 
  // Amplitude(s) for diagram number 6
  FFV1_0(w[3], w[11], w[9], cIPC[1], &amp[7]); 
  FFV1_2(w[3], w[5], cIPC[1], cIPD[0], cIPD[1], w[13]); 
  // Amplitude(s) for diagram number 7
  FFV1_0(w[13], w[11], w[6], cIPC[1], &amp[8]); 
  FFV1_1(w[2], w[5], cIPC[1], cIPD[0], cIPD[1], w[14]); 
  // Amplitude(s) for diagram number 8
  FFV1_0(w[12], w[14], w[4], cIPC[1], &amp[9]); 
  // Amplitude(s) for diagram number 9
  FFV1_0(w[3], w[14], w[8], cIPC[1], &amp[10]); 
  FFV1_2(w[3], w[4], cIPC[1], cIPD[0], cIPD[1], w[15]); 
  // Amplitude(s) for diagram number 10
  FFV1_0(w[15], w[14], w[6], cIPC[1], &amp[11]); 
  FFV1_1(w[2], w[6], cIPC[1], cIPD[0], cIPD[1], w[16]); 
  // Amplitude(s) for diagram number 11
  FFV1_0(w[15], w[16], w[5], cIPC[1], &amp[12]); 
  // Amplitude(s) for diagram number 12
  FFV1_0(w[15], w[2], w[9], cIPC[1], &amp[13]); 
  // Amplitude(s) for diagram number 13
  FFV1_0(w[13], w[16], w[4], cIPC[1], &amp[14]); 
  // Amplitude(s) for diagram number 14
  FFV1_0(w[13], w[2], w[8], cIPC[1], &amp[15]); 
  // Amplitude(s) for diagram number 15
  FFV1_0(w[3], w[16], w[10], cIPC[1], &amp[16]); 
  // Amplitude(s) for diagram number 16
  FFV1_0(w[12], w[2], w[10], cIPC[1], &amp[17]); 
  ...
  FFV1_0(w[16], w[8], w[5], cIPC[1], &amp[18]); 
  FFV1_1(w[12], w[5], cIPC[1], cIPD[0], cIPD[1], w[9]); 
  // Amplitude(s) for diagram number 18
  FFV1_0(w[16], w[9], w[4], cIPC[1], &amp[19]); 
  // Amplitude(s) for diagram number 19
  FFV1_0(w[16], w[12], w[10], cIPC[1], &amp[20]); 
  VVV1P0_1(w[1], w[4], cIPC[0], 0., 0., w[6]); 
  FFV1P0_3(w[3], w[12], cIPC[1], 0., 0., w[17]); 
  // Amplitude(s) for diagram number 20
  VVV1_0(w[6], w[5], w[17], cIPC[0], &amp[21]); 
  // Amplitude(s) for diagram number 21
  FFV1_0(w[3], w[9], w[6], cIPC[1], &amp[22]); 
  // Amplitude(s) for diagram number 22
  FFV1_0(w[13], w[12], w[6], cIPC[1], &amp[23]); 
  VVV1P0_1(w[1], w[5], cIPC[0], 0., 0., w[18]); 
  // Amplitude(s) for diagram number 23
  VVV1_0(w[18], w[4], w[17], cIPC[0], &amp[24]); 
  // Amplitude(s) for diagram number 24
  FFV1_0(w[3], w[8], w[18], cIPC[1], &amp[25]); 
  // Amplitude(s) for diagram number 25
  FFV1_0(w[15], w[12], w[18], cIPC[1], &amp[26]); 
  FFV1_1(w[12], w[1], cIPC[1], cIPD[0], cIPD[1], w[19]); 
  // Amplitude(s) for diagram number 26
  FFV1_0(w[15], w[19], w[5], cIPC[1], &amp[27]); 
  // Amplitude(s) for diagram number 27
  FFV1_0(w[15], w[9], w[1], cIPC[1], &amp[28]); 
  // Amplitude(s) for diagram number 28
  FFV1_0(w[13], w[19], w[4], cIPC[1], &amp[29]); 
  // Amplitude(s) for diagram number 29
  FFV1_0(w[13], w[8], w[1], cIPC[1], &amp[30]); 
  // Amplitude(s) for diagram number 30
  FFV1_0(w[3], w[19], w[10], cIPC[1], &amp[31]); 
  // Amplitude(s) for diagram number 31
  VVV1_0(w[1], w[10], w[17], cIPC[0], &amp[32]); 
  ...
  FFV1_0(w[3], w[12], w[17], cIPC[1], &amp[33]); 
  FFV1_0(w[3], w[12], w[19], cIPC[1], &amp[34]); 
  FFV1_0(w[3], w[12], w[8], cIPC[1], &amp[35]); 
  ...
  VVV1_0(w[12], w[7], w[5], cIPC[0], &amp[129]); 
  VVV1_0(w[24], w[7], w[5], cIPC[0], &amp[130]); 
  VVV1_0(w[21], w[7], w[5], cIPC[0], &amp[131]); 
  // Amplitude(s) for diagram number 115
  FFV1_0(w[3], w[14], w[12], cIPC[1], &amp[132]); 
  FFV1_0(w[3], w[14], w[24], cIPC[1], &amp[133]); 
  FFV1_0(w[3], w[14], w[21], cIPC[1], &amp[134]); 
  // Amplitude(s) for diagram number 116
  FFV1_0(w[13], w[2], w[12], cIPC[1], &amp[135]); 
  FFV1_0(w[13], w[2], w[24], cIPC[1], &amp[136]); 
  FFV1_0(w[13], w[2], w[21], cIPC[1], &amp[137]); 
  ...
  VVV1_0(w[21], w[7], w[4], cIPC[0], &amp[138]); 
  VVV1_0(w[13], w[7], w[4], cIPC[0], &amp[139]); 
  VVV1_0(w[24], w[7], w[4], cIPC[0], &amp[140]); 
  // Amplitude(s) for diagram number 118
  FFV1_0(w[3], w[11], w[21], cIPC[1], &amp[141]); 
  FFV1_0(w[3], w[11], w[13], cIPC[1], &amp[142]); 
  FFV1_0(w[3], w[11], w[24], cIPC[1], &amp[143]); 
  // Amplitude(s) for diagram number 119
  FFV1_0(w[15], w[2], w[21], cIPC[1], &amp[144]); 
  FFV1_0(w[15], w[2], w[13], cIPC[1], &amp[145]); 
  FFV1_0(w[15], w[2], w[24], cIPC[1], &amp[146]); 
  ...
  FFV1_0(w[3], w[9], w[24], cIPC[1], &amp[147]); 
  FFV1_0(w[3], w[9], w[15], cIPC[1], &amp[148]); 
  FFV1_0(w[3], w[9], w[13], cIPC[1], &amp[149]); 
  // Amplitude(s) for diagram number 121
  FFV1_0(w[16], w[2], w[24], cIPC[1], &amp[150]); 
  FFV1_0(w[16], w[2], w[15], cIPC[1], &amp[151]); 
  FFV1_0(w[16], w[2], w[13], cIPC[1], &amp[152]); 
  // Amplitude(s) for diagram number 122
  VVV1_0(w[24], w[1], w[7], cIPC[0], &amp[153]); 
  VVV1_0(w[15], w[1], w[7], cIPC[0], &amp[154]); 
  VVV1_0(w[13], w[1], w[7], cIPC[0], &amp[155]); 
  // Amplitude(s) for diagram number 123
  VVV1_0(w[0], w[17], w[7], cIPC[0], &amp[156]); 
  VVV1_0(w[0], w[19], w[7], cIPC[0], &amp[157]); 
  VVV1_0(w[0], w[8], w[7], cIPC[0], &amp[158]); 
...
gpu_nthreads(gputhreads), dim(gpu_nblocks * gpu_nthreads), mME(6, 0.00) 
{
