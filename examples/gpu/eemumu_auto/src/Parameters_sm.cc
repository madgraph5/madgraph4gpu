...
void Parameters_sm::setIndependentParameters(SLHAReader& slha)
{
  ...
  mdl_WH = slha.get_block_entry("decay", 25, DECL_NUM(6.382339e-03));
  mdl_WW = slha.get_block_entry("decay", 24, DECL_NUM(2.047600e+00));
  mdl_WZ = slha.get_block_entry("decay", 23, DECL_NUM(2.441404e+00));
  mdl_WT = slha.get_block_entry("decay", 6, DECL_NUM(1.491500e+00));
  mdl_ymtau = slha.get_block_entry("yukawa", 15, DECL_NUM(1.777000e+00));
  mdl_ymt = slha.get_block_entry("yukawa", 6, DECL_NUM(1.730000e+02));
  mdl_ymb = slha.get_block_entry("yukawa", 5, DECL_NUM(4.700000e+00));
  aS = slha.get_block_entry("sminputs", 3, DECL_NUM(1.180000e-01));
  mdl_Gf = slha.get_block_entry("sminputs", 2, DECL_NUM(1.166390e-05));
  aEWM1 = slha.get_block_entry("sminputs", 1, DECL_NUM(1.325070e+02));
  mdl_MH = slha.get_block_entry("mass", 25, DECL_NUM(1.250000e+02));
  mdl_MZ = slha.get_block_entry("mass", 23, DECL_NUM(9.118800e+01));
  mdl_MTA = slha.get_block_entry("mass", 15, DECL_NUM(1.777000e+00));
  mdl_MT = slha.get_block_entry("mass", 6, DECL_NUM(1.730000e+02));
  mdl_MB = slha.get_block_entry("mass", 5, DECL_NUM(4.700000e+00));
  mdl_conjg__CKM1x1 = DECL_NUM(1.);
  mdl_conjg__CKM3x3 = DECL_NUM(1.);
  mdl_CKM3x3 = DECL_NUM(1.);
  mdl_complexi = std::complex<floa_t> (DECL_NUM(0.), DECL_NUM(1.));
  mdl_MZ__exp__2 = ((mdl_MZ) * (mdl_MZ));
  mdl_MZ__exp__4 = ((mdl_MZ) * (mdl_MZ) * (mdl_MZ) * (mdl_MZ));
  mdl_sqrt__2 = sqrt(DECL_NUM(2.));
  mdl_MH__exp__2 = ((mdl_MH) * (mdl_MH));
  mdl_aEW = DECL_NUM(1.)/aEWM1;
  mdl_MW = sqrt(mdl_MZ__exp__2/DECL_NUM(2.) + sqrt(mdl_MZ__exp__4/DECL_NUM(4.) - (mdl_aEW * M_PI *
      mdl_MZ__exp__2)/(mdl_Gf * mdl_sqrt__2)));
  mdl_sqrt__aEW = sqrt(mdl_aEW);
  mdl_ee = DECL_NUM(2.) * mdl_sqrt__aEW * sqrt(M_PI);
  mdl_MW__exp__2 = ((mdl_MW) * (mdl_MW));
  mdl_sw2 = DECL_NUM(1.) - mdl_MW__exp__2/mdl_MZ__exp__2;
  mdl_cw = sqrt(DECL_NUM(1.) - mdl_sw2);
  mdl_sqrt__sw2 = sqrt(mdl_sw2);
  mdl_sw = mdl_sqrt__sw2;
  mdl_g1 = mdl_ee/mdl_cw;
  mdl_gw = mdl_ee/mdl_sw;
  mdl_vev = (DECL_NUM(2.) * mdl_MW * mdl_sw)/mdl_ee;
  mdl_vev__exp__2 = ((mdl_vev) * (mdl_vev));
  mdl_lam = mdl_MH__exp__2/(DECL_NUM(2.) * mdl_vev__exp__2);
...
void Parameters_sm::setIndependentCouplings()
{
  ...
  GC_50 = -(mdl_cw * mdl_ee * mdl_complexi)/(DECL_NUM(2.) * mdl_sw);
  GC_59 = (mdl_ee * mdl_complexi * mdl_sw)/(DECL_NUM(2.) * mdl_cw);
}
void Parameters_sm::setDependentParameters()
{
  mdl_sqrt__aS = sqrt(aS);
  G = DECL_NUM(2.) * mdl_sqrt__aS * sqrt(M_PI);
  mdl_G__exp__2 = ((G) * (G));
}
