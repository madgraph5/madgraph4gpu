...
class Parameters_sm
{
  public:
    ...
    floa_t mdl_WH, mdl_WW, mdl_WZ, mdl_WT, mdl_ymtau, mdl_ymt, mdl_ymb, aS,
        mdl_Gf, aEWM1, mdl_MH, mdl_MZ, mdl_MTA, mdl_MT, mdl_MB,
        mdl_conjg__CKM1x1, mdl_conjg__CKM3x3, mdl_CKM3x3, mdl_MZ__exp__2,
        ...
        mdl_cw__exp__2;
    std::complex<floa_t> mdl_complexi, mdl_I1x33, mdl_I2x33, mdl_I3x33,
        mdl_I4x33;
    // Model parameters dependent on aS
    floa_t mdl_sqrt__aS, G, mdl_G__exp__2;
    // Model couplings independent of aS
    std::complex<floa_t> GC_3, GC_50, GC_59; 
