...
__device__ void ixxxxx(const double * __restrict__ pvec, double fmass, int nhel, int nsf, thrust::complex<double> fi[6])
{
...
__device__ void txxxxx(const double * __restrict__ pvec, double tmass, int nhel, int nst, thrust::complex<double> tc[18])
{
...
__device__ void vxxxxx(const double * __restrict__ pvec, double vmass, int nhel, int nsv, thrust::complex<double> vc[6])
{
...
__device__ void sxxxxx(const double * __restrict__ pvec, int nss, thrust::complex<double> sc[3])
{
  // double p[4] = {0, pvec[0], pvec[1], pvec[2]};
  // p[0] = sqrt(p[1] * p[1] + p[2] * p[2] + p[3] * p[3]+fmass*fmass);
  double p[4] = {0, 0, 0, 0};
...
__device__ void oxxxxx(const double * __restrict__ pvec, double fmass, int nhel, int nsf,
