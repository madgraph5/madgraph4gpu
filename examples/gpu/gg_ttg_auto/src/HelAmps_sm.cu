    ...
    thrust::complex<double> COUP, thrust::complex<double> * vertex)
{
  ...
  (*vertex) = COUP * (TMP0 * (-cI * (TMP8) + cI * (TMP9)) + (TMP2 * (-cI *
      (TMP3) + cI * (TMP4)) + TMP5 * (+cI * (TMP6) - cI * (TMP7))));
}
    ...
    double M1, const double W1, thrust::complex<double> V1[])
{
  ...
  V1[2] = denom * (TMP0 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[2] * (-cI *
      (TMP3) + cI * (TMP4)) + V3[2] * (+cI * (TMP6) - cI * (TMP7))));
  V1[3] = denom * (TMP0 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[3] * (-cI *
      (TMP3) + cI * (TMP4)) + V3[3] * (+cI * (TMP6) - cI * (TMP7))));
  V1[4] = denom * (TMP0 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[4] * (-cI *
      (TMP3) + cI * (TMP4)) + V3[4] * (+cI * (TMP6) - cI * (TMP7))));
  V1[5] = denom * (TMP0 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[5] * (-cI *
      (TMP3) + cI * (TMP4)) + V3[5] * (+cI * (TMP6) - cI * (TMP7))));
}
    ...
    thrust::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V4[2] * TMP0) + cI * (V3[2] * TMP11)); 
  V1[3] = denom * (-cI * (V4[3] * TMP0) + cI * (V3[3] * TMP11)); 
  V1[4] = denom * (-cI * (V4[4] * TMP0) + cI * (V3[4] * TMP11)); 
  V1[5] = denom * (-cI * (V4[5] * TMP0) + cI * (V3[5] * TMP11)); 
}
    ...
    thrust::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V3[2] * TMP11) + cI * (V2[2] * TMP1)); 
  V1[3] = denom * (-cI * (V3[3] * TMP11) + cI * (V2[3] * TMP1)); 
  V1[4] = denom * (-cI * (V3[4] * TMP11) + cI * (V2[4] * TMP1)); 
  V1[5] = denom * (-cI * (V3[5] * TMP11) + cI * (V2[5] * TMP1)); 
}
