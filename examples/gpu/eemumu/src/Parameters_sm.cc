...
void Parameters_sm::printIndependentParameters() {
  std::cout << "sm model parameters independent of event kinematics:"
            << std::endl;
  ...
  std::cout << std::setw(20) << "aS "
            << "= " << setiosflags(std::ios::scientific) << std::setw(10) << aS
            << std::endl;
  ...
  std::cout << std::setw(20) << "mdl_ee__exp__2 "
            << "= " << setiosflags(std::ios::scientific) << std::setw(10)
            << mdl_ee__exp__2 << std::endl;
  std::cout << std::setw(20) << "mdl_sw__exp__2 "
            << "= " << setiosflags(std::ios::scientific) << std::setw(10)
            << mdl_sw__exp__2 << std::endl;
  std::cout << std::setw(20) << "mdl_cw__exp__2 "
            << "= " << setiosflags(std::ios::scientific) << std::setw(10)
            << mdl_cw__exp__2 << std::endl;
}
void Parameters_sm::printIndependentCouplings() {
  std::cout << "sm model couplings independent of event kinematics:"
            << std::endl;
...
void Parameters_sm::printDependentParameters() {
  std::cout << "sm model parameters dependent on event kinematics:"
            << std::endl;
  std::cout << std::setw(20) << "mdl_sqrt__aS "
            << "= " << setiosflags(std::ios::scientific) << std::setw(10)
            << mdl_sqrt__aS << std::endl;
  std::cout << std::setw(20) << "G "
            << "= " << setiosflags(std::ios::scientific) << std::setw(10) << G
            << std::endl;
  std::cout << std::setw(20) << "mdl_G__exp__2 "
            << "= " << setiosflags(std::ios::scientific) << std::setw(10)
            << mdl_G__exp__2 << std::endl;
}
