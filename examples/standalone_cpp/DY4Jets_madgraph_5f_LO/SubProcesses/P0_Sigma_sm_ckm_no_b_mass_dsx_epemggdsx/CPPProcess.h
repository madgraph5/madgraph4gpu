...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_dsx_epemggdsx_H
#define MG5_Sigma_sm_ckm_no_b_mass_dsx_epemggdsx_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "d s~ > e+ e- g g d s~ (sm_ckm_no_b_mass)";}
  ...
  private:
    ...
    double matrix_dsx_epemggdsx_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_dsx_epemggdsx_H
