...
// Process: g d~ > ta+ ta- g s d~ s~ WEIGHTED<=8 / h
// Process: g d~ > ta+ ta- g b d~ b~ WEIGHTED<=8 / h
// Process: g s~ > ta+ ta- g d s~ d~ WEIGHTED<=8 / h
// Process: g s~ > ta+ ta- g b s~ b~ WEIGHTED<=8 / h
// Process: g b~ > ta+ ta- g d b~ d~ WEIGHTED<=8 / h
// Process: g b~ > ta+ ta- g s b~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gdx_taptamgsdxsx_no_h(); 
        ...
        t[1] = matrix_gdx_taptamgsdxsx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[1], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[15]); 
  FFV1P0_3(w[7], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_2(w[6], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[17]); 
...
double CPPProcess::matrix_gdx_taptamgsdxsx_no_h() 
{
  int i, j; 
  // Local variables
