...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[9], pars->GC_2, pars->ZERO, pars->ZERO, w[13]); 
  ...
  FFV2_4_3(w[2], w[3], -pars->GC_51, pars->GC_59, pars->mdl_MZ, pars->mdl_WZ,
      w[22]);
  FFV2_5_1(w[7], w[22], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[23]);
...
double CPPProcess::matrix_uc_taptamgguc_no_h() 
{
  int i, j; 
  // Local variables
