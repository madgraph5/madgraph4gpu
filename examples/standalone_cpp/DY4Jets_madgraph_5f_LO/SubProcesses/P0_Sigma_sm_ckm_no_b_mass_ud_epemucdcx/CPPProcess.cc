...
// Process: u d > e+ e- u c d c~ WEIGHTED<=8 / h
// Process: u d > mu+ mu- u c d c~ WEIGHTED<=8 / h
// Process: u s > e+ e- u c s c~ WEIGHTED<=8 / h
// Process: u s > mu+ mu- u c s c~ WEIGHTED<=8 / h
// Process: u b > e+ e- u c b c~ WEIGHTED<=8 / h
// Process: u b > mu+ mu- u c b c~ WEIGHTED<=8 / h
// Process: c d > e+ e- c u d u~ WEIGHTED<=8 / h
// Process: c d > mu+ mu- c u d u~ WEIGHTED<=8 / h
// Process: c s > e+ e- c u s u~ WEIGHTED<=8 / h
// Process: c s > mu+ mu- c u s u~ WEIGHTED<=8 / h
// Process: c b > e+ e- c u b u~ WEIGHTED<=8 / h
// Process: c b > mu+ mu- c u b u~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_ud_epemucdcx_no_h() 
{
  int i, j; 
  // Local variables
