...
// Process: s s~ > e+ e- d s d~ s~ WEIGHTED<=8 / h
// Process: s s~ > mu+ mu- d s d~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ssx_epemdsdxsx_no_h(); 
        ...
        t[1] = matrix_ssx_epemdsdxsx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[0], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[9]); 
  ...
  FFV2_3_2(w[7], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[20]);
  FFV1P0_3(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  ...
  FFV1_2(w[6], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1P0_3(w[47], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[6], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[49]); 
  FFV1P0_3(w[49], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_1(w[4], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1P0_3(w[6], w[51], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_1(w[4], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[53]); 
  FFV1P0_3(w[6], w[53], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  ...
  FFV1_0(w[6], w[53], w[60], pars->GC_11, amp[119]); 
  ...
  FFV1_0(w[6], w[57], w[60], pars->GC_11, amp[127]); 
  ...
  FFV1_0(w[6], w[53], w[67], pars->GC_11, amp[151]); 
  ...
  FFV1_0(w[6], w[57], w[67], pars->GC_11, amp[159]); 
...
double CPPProcess::matrix_ssx_epemdsdxsx_no_h() 
{
  int i, j; 
  // Local variables
