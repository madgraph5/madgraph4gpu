...
// Process: u d > ta+ ta- u d s s~ WEIGHTED<=8 / h
// Process: u d > ta+ ta- u d b b~ WEIGHTED<=8 / h
// Process: u s > ta+ ta- u s d d~ WEIGHTED<=8 / h
// Process: u s > ta+ ta- u s b b~ WEIGHTED<=8 / h
// Process: u b > ta+ ta- u d~ b d WEIGHTED<=8 / h
// Process: u b > ta+ ta- u s~ b s WEIGHTED<=8 / h
// Process: c d > ta+ ta- c d s s~ WEIGHTED<=8 / h
// Process: c d > ta+ ta- c d b b~ WEIGHTED<=8 / h
// Process: c s > ta+ ta- c s d d~ WEIGHTED<=8 / h
// Process: c s > ta+ ta- c s b b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_taptamudssx_no_h(); 
        ...
        t[1] = matrix_ud_taptamudssx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ud_taptamudssx_no_h() 
{
  int i, j; 
  // Local variables
