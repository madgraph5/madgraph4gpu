...
// Process: d s > e+ e- u d s u~ WEIGHTED<=8 / h
// Process: d s > e+ e- c d s c~ WEIGHTED<=8 / h
// Process: d s > mu+ mu- u d s u~ WEIGHTED<=8 / h
// Process: d s > mu+ mu- c d s c~ WEIGHTED<=8 / h
// Process: d b > e+ e- u d b u~ WEIGHTED<=8 / h
// Process: d b > e+ e- c d b c~ WEIGHTED<=8 / h
// Process: d b > mu+ mu- u d b u~ WEIGHTED<=8 / h
// Process: d b > mu+ mu- c d b c~ WEIGHTED<=8 / h
// Process: s b > e+ e- u s b u~ WEIGHTED<=8 / h
// Process: s b > e+ e- c s b c~ WEIGHTED<=8 / h
// Process: s b > mu+ mu- u s b u~ WEIGHTED<=8 / h
// Process: s b > mu+ mu- c s b c~ WEIGHTED<=8 / h
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[7], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1P0_3(w[35], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[7], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[37]); 
  FFV1P0_3(w[37], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_1(w[4], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1P0_3(w[7], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[4], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[41]); 
  FFV1P0_3(w[7], w[41], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  ...
  FFV2_5_1(w[4], w[18], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[45]);
  FFV1P0_3(w[7], w[45], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_1(w[4], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  VVV1P0_1(w[9], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[7], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1P0_3(w[49], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1P0_3(w[7], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  ...
  FFV1_0(w[7], w[41], w[48], pars->GC_11, amp[71]); 
  ...
  FFV1_0(w[7], w[45], w[48], pars->GC_11, amp[79]); 
...
double CPPProcess::matrix_ds_epemudsux_no_h() 
{
  int i, j; 
  // Local variables
