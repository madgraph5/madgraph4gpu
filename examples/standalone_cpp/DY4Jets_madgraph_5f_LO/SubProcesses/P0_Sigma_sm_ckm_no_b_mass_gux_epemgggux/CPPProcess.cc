...
// Process: g u~ > e+ e- g g g u~ WEIGHTED<=8 / h
// Process: g u~ > mu+ mu- g g g u~ WEIGHTED<=8 / h
// Process: g c~ > e+ e- g g g c~ WEIGHTED<=8 / h
// Process: g c~ > mu+ mu- g g g c~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_gux_epemgggux_no_h() 
{
  int i, j; 
  // Local variables
