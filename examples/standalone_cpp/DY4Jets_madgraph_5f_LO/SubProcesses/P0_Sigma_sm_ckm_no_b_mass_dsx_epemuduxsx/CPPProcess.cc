...
// Process: d s~ > e+ e- u d u~ s~ WEIGHTED<=8 / h
// Process: d s~ > e+ e- c d c~ s~ WEIGHTED<=8 / h
// Process: d s~ > mu+ mu- u d u~ s~ WEIGHTED<=8 / h
// Process: d s~ > mu+ mu- c d c~ s~ WEIGHTED<=8 / h
// Process: d b~ > e+ e- u d u~ b~ WEIGHTED<=8 / h
// Process: d b~ > e+ e- c d c~ b~ WEIGHTED<=8 / h
// Process: d b~ > mu+ mu- u d u~ b~ WEIGHTED<=8 / h
// Process: d b~ > mu+ mu- c d c~ b~ WEIGHTED<=8 / h
// Process: s d~ > e+ e- u s u~ d~ WEIGHTED<=8 / h
// Process: s d~ > e+ e- c s c~ d~ WEIGHTED<=8 / h
// Process: s d~ > mu+ mu- u s u~ d~ WEIGHTED<=8 / h
// Process: s d~ > mu+ mu- c s c~ d~ WEIGHTED<=8 / h
// Process: s b~ > e+ e- u s u~ b~ WEIGHTED<=8 / h
// Process: s b~ > e+ e- c s c~ b~ WEIGHTED<=8 / h
// Process: s b~ > mu+ mu- u s u~ b~ WEIGHTED<=8 / h
// Process: s b~ > mu+ mu- c s c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dsx_epemuduxsx_no_h(); 
        ...
        t[1] = matrix_dsx_epemuduxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dsx_epemuduxsx_no_h() 
{
  int i, j; 
  // Local variables
