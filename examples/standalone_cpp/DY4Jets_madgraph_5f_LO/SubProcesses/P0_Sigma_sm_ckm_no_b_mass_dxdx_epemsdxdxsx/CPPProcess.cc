...
// Process: d~ d~ > e+ e- s d~ d~ s~ WEIGHTED<=8 / h
// Process: d~ d~ > e+ e- d~ b d~ b~ WEIGHTED<=8 / h
// Process: d~ d~ > mu+ mu- s d~ d~ s~ WEIGHTED<=8 / h
...
// Process: b~ b~ > e+ e- d b~ d~ b~ WEIGHTED<=8 / h
// Process: b~ b~ > e+ e- s b~ s~ b~ WEIGHTED<=8 / h
// Process: b~ b~ > mu+ mu- d b~ d~ b~ WEIGHTED<=8 / h
// Process: b~ b~ > mu+ mu- s b~ s~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxdx_epemsdxdxsx_no_h(); 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[40], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  ...
  FFV1P0_3(w[52], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[53]); 
  FFV1_2(w[5], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[54]); 
  FFV1P0_3(w[54], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_1(w[1], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  ...
  FFV2_3_2(w[5], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[59]);
  FFV1P0_3(w[59], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  ...
  FFV1P0_3(w[63], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[74]); 
  ...
  FFV1_0(w[20], w[4], w[24], pars->GC_11, amp[27]); 
  ...
  FFV1_0(w[13], w[4], w[37], pars->GC_11, amp[49]); 
  ...
  FFV1_0(w[20], w[4], w[37], pars->GC_11, amp[57]); 
  ...
  FFV1_0(w[13], w[4], w[43], pars->GC_11, amp[65]); 
  FFV1_0(w[7], w[12], w[45], pars->GC_11, amp[66]); 
  FFV1_0(w[13], w[4], w[45], pars->GC_11, amp[67]); 
  ...
  FFV1_0(w[20], w[4], w[43], pars->GC_11, amp[73]); 
  FFV1_0(w[7], w[19], w[45], pars->GC_11, amp[74]); 
  FFV1_0(w[20], w[4], w[45], pars->GC_11, amp[75]); 
  ...
  FFV1_0(w[59], w[1], w[62], pars->GC_11, amp[123]); 
  ...
  FFV1_0(w[13], w[4], w[65], pars->GC_11, amp[129]); 
  FFV1_0(w[7], w[17], w[66], pars->GC_11, amp[130]); 
  FFV1_0(w[15], w[4], w[66], pars->GC_11, amp[131]); 
  FFV1_0(w[7], w[12], w[68], pars->GC_11, amp[132]); 
  FFV1_0(w[13], w[4], w[68], pars->GC_11, amp[133]); 
  FFV1_0(w[7], w[17], w[69], pars->GC_11, amp[134]); 
  FFV1_0(w[15], w[4], w[69], pars->GC_11, amp[135]); 
  FFV1_0(w[7], w[19], w[65], pars->GC_11, amp[136]); 
  FFV1_0(w[20], w[4], w[65], pars->GC_11, amp[137]); 
  FFV1_0(w[7], w[17], w[70], pars->GC_11, amp[138]); 
  FFV1_0(w[15], w[4], w[70], pars->GC_11, amp[139]); 
  FFV1_0(w[7], w[19], w[68], pars->GC_11, amp[140]); 
  FFV1_0(w[20], w[4], w[68], pars->GC_11, amp[141]); 
  FFV1_0(w[7], w[17], w[71], pars->GC_11, amp[142]); 
  FFV1_0(w[15], w[4], w[71], pars->GC_11, amp[143]); 
...
double CPPProcess::matrix_dxdx_epemsdxdxsx_no_h() 
{
  int i, j; 
  // Local variables
