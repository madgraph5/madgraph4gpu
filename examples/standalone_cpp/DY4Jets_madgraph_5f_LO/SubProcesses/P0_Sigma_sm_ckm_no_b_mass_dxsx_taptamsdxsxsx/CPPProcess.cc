...
// Process: d~ s~ > ta+ ta- s d~ s~ s~ WEIGHTED<=8 / h
// Process: d~ b~ > ta+ ta- b d~ b~ b~ WEIGHTED<=8 / h
// Process: s~ b~ > ta+ ta- b s~ b~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxsx_taptamsdxsxsx_no_h(); 
        ...
        t[1] = matrix_dxsx_taptamsdxsxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dxsx_taptamsdxsxsx_no_h() 
{
  int i, j; 
  // Local variables
