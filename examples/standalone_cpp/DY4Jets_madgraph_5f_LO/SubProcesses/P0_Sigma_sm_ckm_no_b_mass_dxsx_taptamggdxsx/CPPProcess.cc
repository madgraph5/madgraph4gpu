...
// Process: d~ s~ > ta+ ta- g g d~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxsx_taptamggdxsx_no_h(); 
        ...
        t[1] = matrix_dxsx_taptamggdxsx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[0], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[15]); 
...
double CPPProcess::matrix_dxsx_taptamggdxsx_no_h() 
{
  int i, j; 
  // Local variables
