...
// Process: u u~ > e+ e- u c u~ c~ WEIGHTED<=8 / h
// Process: u u~ > mu+ mu- u c u~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_epemucuxcx_no_h(); 
        ...
        t[1] = matrix_uux_epemucuxcx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uux_epemucuxcx_no_h() 
{
  int i, j; 
  // Local variables
