...
// Process: d~ s~ > e+ e- s d~ s~ s~ WEIGHTED<=8 / h
// Process: d~ s~ > mu+ mu- s d~ s~ s~ WEIGHTED<=8 / h
// Process: d~ b~ > e+ e- b d~ b~ b~ WEIGHTED<=8 / h
// Process: d~ b~ > mu+ mu- b d~ b~ b~ WEIGHTED<=8 / h
// Process: s~ b~ > e+ e- b s~ b~ b~ WEIGHTED<=8 / h
// Process: s~ b~ > mu+ mu- b s~ b~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxsx_epemsdxsxsx_no_h(); 
        ...
        t[1] = matrix_dxsx_epemsdxsxsx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[5], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1P0_3(w[47], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[5], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[49]); 
  FFV1P0_3(w[49], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_1(w[0], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1P0_3(w[5], w[51], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_1(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[53]); 
  ...
  FFV1_2(w[5], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  FFV1P0_3(w[62], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  FFV1_1(w[0], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[64]); 
