...
// Process: u d~ > e+ e- u c c~ d~ WEIGHTED<=8 / h
// Process: u d~ > mu+ mu- u c c~ d~ WEIGHTED<=8 / h
// Process: u s~ > e+ e- u c c~ s~ WEIGHTED<=8 / h
// Process: u s~ > mu+ mu- u c c~ s~ WEIGHTED<=8 / h
// Process: u b~ > e+ e- u c c~ b~ WEIGHTED<=8 / h
// Process: u b~ > mu+ mu- u c c~ b~ WEIGHTED<=8 / h
// Process: c d~ > e+ e- c u u~ d~ WEIGHTED<=8 / h
// Process: c d~ > mu+ mu- c u u~ d~ WEIGHTED<=8 / h
// Process: c s~ > e+ e- c u u~ s~ WEIGHTED<=8 / h
// Process: c s~ > mu+ mu- c u u~ s~ WEIGHTED<=8 / h
// Process: c b~ > e+ e- c u u~ b~ WEIGHTED<=8 / h
// Process: c b~ > mu+ mu- c u u~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_udx_epemuccxdx_no_h(); 
        ...
        t[1] = matrix_udx_epemuccxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_udx_epemuccxdx_no_h() 
{
  int i, j; 
  // Local variables
