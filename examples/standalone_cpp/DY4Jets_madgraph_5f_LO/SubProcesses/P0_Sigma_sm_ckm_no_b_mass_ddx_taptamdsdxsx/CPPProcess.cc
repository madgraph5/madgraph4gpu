...
// Process: d d~ > ta+ ta- d s d~ s~ WEIGHTED<=8 / h
// Process: d d~ > ta+ ta- d b d~ b~ WEIGHTED<=8 / h
// Process: s s~ > ta+ ta- s b s~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ddx_taptamdsdxsx_no_h(); 
        ...
        t[1] = matrix_ddx_taptamdsdxsx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[6], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[25]); 
  FFV1P0_3(w[7], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_1(w[4], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[27]); 
  ...
  FFV1P0_3(w[0], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1P0_3(w[6], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  ...
  FFV1_1(w[1], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[47]); 
...
double CPPProcess::matrix_ddx_taptamdsdxsx_no_h() 
{
  int i, j; 
  // Local variables
