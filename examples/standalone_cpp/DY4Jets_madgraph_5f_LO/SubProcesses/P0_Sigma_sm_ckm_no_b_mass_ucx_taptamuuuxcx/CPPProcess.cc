...
// Process: u c~ > ta+ ta- u u u~ c~ WEIGHTED<=8 / h
// Process: c u~ > ta+ ta- c c c~ u~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ucx_taptamuuuxcx_no_h(); 
        ...
        t[1] = matrix_ucx_taptamuuuxcx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ucx_taptamuuuxcx_no_h() 
{
  int i, j; 
  // Local variables
