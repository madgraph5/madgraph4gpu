...
// Process: u c > e+ e- u c c c~ WEIGHTED<=8 / h
// Process: u c > mu+ mu- u c c c~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_uc_epemucccx_no_h() 
{
  int i, j; 
  // Local variables
