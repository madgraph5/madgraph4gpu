...
// Process: d s~ > ta+ ta- u d u~ s~ WEIGHTED<=8 / h
// Process: d s~ > ta+ ta- c d c~ s~ WEIGHTED<=8 / h
// Process: d b~ > ta+ ta- u d u~ b~ WEIGHTED<=8 / h
// Process: d b~ > ta+ ta- c d c~ b~ WEIGHTED<=8 / h
// Process: s d~ > ta+ ta- u s u~ d~ WEIGHTED<=8 / h
// Process: s d~ > ta+ ta- c s c~ d~ WEIGHTED<=8 / h
// Process: s b~ > ta+ ta- u s u~ b~ WEIGHTED<=8 / h
// Process: s b~ > ta+ ta- c s c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dsx_taptamuduxsx_no_h(); 
        ...
        t[1] = matrix_dsx_taptamuduxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dsx_taptamuduxsx_no_h() 
{
  int i, j; 
  // Local variables
