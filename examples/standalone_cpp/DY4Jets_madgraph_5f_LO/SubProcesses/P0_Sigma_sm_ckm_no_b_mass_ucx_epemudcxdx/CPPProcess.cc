...
// Process: u c~ > e+ e- u d c~ d~ WEIGHTED<=8 / h
// Process: u c~ > e+ e- u s c~ s~ WEIGHTED<=8 / h
// Process: u c~ > e+ e- u b c~ b~ WEIGHTED<=8 / h
// Process: u c~ > mu+ mu- u d c~ d~ WEIGHTED<=8 / h
// Process: u c~ > mu+ mu- u s c~ s~ WEIGHTED<=8 / h
// Process: u c~ > mu+ mu- u b c~ b~ WEIGHTED<=8 / h
// Process: c u~ > e+ e- c d u~ d~ WEIGHTED<=8 / h
// Process: c u~ > e+ e- c s u~ s~ WEIGHTED<=8 / h
// Process: c u~ > e+ e- c b u~ b~ WEIGHTED<=8 / h
// Process: c u~ > mu+ mu- c d u~ d~ WEIGHTED<=8 / h
// Process: c u~ > mu+ mu- c s u~ s~ WEIGHTED<=8 / h
// Process: c u~ > mu+ mu- c b u~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ucx_epemudcxdx_no_h(); 
        ...
        t[1] = matrix_ucx_epemudcxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ucx_epemudcxdx_no_h() 
{
  int i, j; 
  // Local variables
