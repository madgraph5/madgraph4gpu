...
// Process: u~ b > ta+ ta- d u~ d~ b WEIGHTED<=8 / h
// Process: u~ b > ta+ ta- s u~ s~ b WEIGHTED<=8 / h
// Process: c~ b > ta+ ta- d c~ d~ b WEIGHTED<=8 / h
// Process: c~ b > ta+ ta- s c~ s~ b WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxb_taptamduxdxb_no_h(); 
        ...
        t[1] = matrix_uxb_taptamduxdxb_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uxb_taptamduxdxb_no_h() 
{
  int i, j; 
  // Local variables
