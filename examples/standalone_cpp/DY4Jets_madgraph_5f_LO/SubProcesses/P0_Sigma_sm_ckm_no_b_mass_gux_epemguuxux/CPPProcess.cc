...
// Process: g u~ > e+ e- g u u~ u~ WEIGHTED<=8 / h
// Process: g u~ > mu+ mu- g u u~ u~ WEIGHTED<=8 / h
// Process: g c~ > e+ e- g c c~ c~ WEIGHTED<=8 / h
// Process: g c~ > mu+ mu- g c c~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gux_epemguuxux_no_h(); 
        ...
        t[1] = matrix_gux_epemguuxux_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[5], w[9], pars->GC_2, pars->ZERO, pars->ZERO, w[11]); 
  FFV1P0_3(w[6], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1P0_3(w[7], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_2(w[6], w[9], pars->GC_2, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_2(w[7], w[9], pars->GC_2, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_1(w[5], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_1(w[1], w[9], pars->GC_2, pars->ZERO, pars->ZERO, w[17]); 
  ...
  FFV2_4_3(w[2], w[3], -pars->GC_51, pars->GC_59, pars->mdl_MZ, pars->mdl_WZ,
      w[26]);
  FFV2_5_1(w[5], w[26], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[27]);
  FFV2_5_2(w[6], w[26], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[28]);
  FFV2_5_2(w[7], w[26], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[29]);
  FFV2_5_1(w[1], w[26], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[30]);
...
double CPPProcess::matrix_gux_epemguuxux_no_h() 
{
  int i, j; 
  // Local variables
