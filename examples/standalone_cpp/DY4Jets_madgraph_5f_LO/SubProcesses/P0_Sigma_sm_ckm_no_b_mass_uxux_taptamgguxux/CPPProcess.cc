...
// Process: u~ u~ > ta+ ta- g g u~ u~ WEIGHTED<=8 / h
// Process: c~ c~ > ta+ ta- g g c~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxux_taptamgguxux_no_h(); 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[0], w[9], pars->GC_2, pars->ZERO, pars->ZERO, w[17]); 
  ...
  FFV2_5_2(w[7], w[26], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[29]);
  FFV2_5_1(w[0], w[26], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[30]);
...
double CPPProcess::matrix_uxux_taptamgguxux_no_h() 
{
  int i, j; 
  // Local variables
