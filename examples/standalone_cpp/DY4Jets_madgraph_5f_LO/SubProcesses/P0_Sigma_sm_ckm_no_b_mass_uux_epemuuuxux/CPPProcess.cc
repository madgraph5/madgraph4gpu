  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_epemuuuxux_no_h(); 
        ...
        t[1] = matrix_uux_epemuuuxux_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[5], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[12]); 
  ...
  FFV1_1(w[4], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[23]); 
  ...
  FFV1_1(w[1], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[55]); 
...
double CPPProcess::matrix_uux_epemuuuxux_no_h() 
{
  int i, j; 
  // Local variables
