...
// Process: d u~ > ta+ ta- g g d u~ WEIGHTED<=8 / h
// Process: d c~ > ta+ ta- g g d c~ WEIGHTED<=8 / h
// Process: s u~ > ta+ ta- g g s u~ WEIGHTED<=8 / h
// Process: s c~ > ta+ ta- g g s c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_taptamggdux_no_h(); 
        ...
        t[1] = matrix_dux_taptamggdux_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dux_taptamggdux_no_h() 
{
  int i, j; 
  // Local variables
