...
// Process: u d > ta+ ta- u u d u~ WEIGHTED<=8 / h
// Process: u s > ta+ ta- u u s u~ WEIGHTED<=8 / h
// Process: u b > ta+ ta- u u b u~ WEIGHTED<=8 / h
// Process: c d > ta+ ta- c c d c~ WEIGHTED<=8 / h
// Process: c s > ta+ ta- c c s c~ WEIGHTED<=8 / h
// Process: c b > ta+ ta- c c b c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_taptamuudux_no_h(); 
        ...
        t[1] = matrix_ud_taptamuudux_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ud_taptamuudux_no_h() 
{
  int i, j; 
  // Local variables
