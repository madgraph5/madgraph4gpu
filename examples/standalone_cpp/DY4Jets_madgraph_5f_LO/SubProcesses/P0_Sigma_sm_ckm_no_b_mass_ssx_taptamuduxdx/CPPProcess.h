...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_ssx_taptamuduxdx_H
#define MG5_Sigma_sm_ckm_no_b_mass_ssx_taptamuduxdx_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "s s~ > ta+ ta- u d u~ d~ (sm_ckm_no_b_mass)";}
  ...
  private:
    ...
    double matrix_ssx_taptamuduxdx_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_ssx_taptamuduxdx_H
