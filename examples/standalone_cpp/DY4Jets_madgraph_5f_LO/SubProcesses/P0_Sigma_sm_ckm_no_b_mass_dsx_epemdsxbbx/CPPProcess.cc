...
// Process: d b~ > e+ e- d s~ b~ s WEIGHTED<=8 / h
// Process: d b~ > mu+ mu- d s~ b~ s WEIGHTED<=8 / h
// Process: s d~ > e+ e- s d~ b b~ WEIGHTED<=8 / h
// Process: s d~ > mu+ mu- s d~ b b~ WEIGHTED<=8 / h
// Process: s b~ > e+ e- d~ d b~ s WEIGHTED<=8 / h
// Process: s b~ > mu+ mu- d~ d b~ s WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dsx_epemdsxbbx_no_h(); 
        ...
        t[1] = matrix_dsx_epemdsxbbx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[0], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1P0_3(w[35], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[37]); 
  FFV1P0_3(w[37], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_1(w[4], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1P0_3(w[0], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[4], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[41]); 
  FFV1P0_3(w[0], w[41], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  ...
  FFV2_3_1(w[4], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[45]);
  FFV1P0_3(w[0], w[45], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_1(w[4], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  VVV1P0_1(w[9], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[0], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[49]); 
  FFV1P0_3(w[49], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1P0_3(w[0], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  ...
  FFV1_0(w[0], w[41], w[48], pars->GC_11, amp[71]); 
  ...
  FFV1_0(w[0], w[45], w[48], pars->GC_11, amp[79]); 
...
double CPPProcess::matrix_dsx_epemdsxbbx_no_h() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (+1./3. * amp[16] + 1./3. * amp[17] + 1./3. * amp[18] +
      ...
      1./3. * amp[95]);
  jamp[1] = +1./4. * (-std::complex<double> (0, 1) * amp[0] -
  ...
  jamp[2] = +1./4. * (-1./9. * amp[2] - 1./9. * amp[3] - 1./9. * amp[4] - 1./9.
