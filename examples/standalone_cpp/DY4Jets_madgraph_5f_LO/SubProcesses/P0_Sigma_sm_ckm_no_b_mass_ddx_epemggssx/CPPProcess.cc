...
// Process: d d~ > e+ e- g g s s~ WEIGHTED<=8 / h
// Process: d d~ > e+ e- g g b b~ WEIGHTED<=8 / h
// Process: d d~ > mu+ mu- g g s s~ WEIGHTED<=8 / h
// Process: d d~ > mu+ mu- g g b b~ WEIGHTED<=8 / h
// Process: s s~ > e+ e- g g d d~ WEIGHTED<=8 / h
// Process: s s~ > e+ e- g g b b~ WEIGHTED<=8 / h
// Process: s s~ > mu+ mu- g g d d~ WEIGHTED<=8 / h
// Process: s s~ > mu+ mu- g g b b~ WEIGHTED<=8 / h
// Process: b b~ > e+ e- g g d d~ WEIGHTED<=8 / h
// Process: b b~ > e+ e- g g s s~ WEIGHTED<=8 / h
// Process: b b~ > mu+ mu- g g d d~ WEIGHTED<=8 / h
// Process: b b~ > mu+ mu- g g s s~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_ddx_epemggssx_no_h() 
{
  int i, j; 
  // Local variables
