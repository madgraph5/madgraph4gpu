...
// Process: u~ b > e+ e- c u~ c~ b WEIGHTED<=8 / h
// Process: u~ b > mu+ mu- c u~ c~ b WEIGHTED<=8 / h
// Process: c~ b > e+ e- u c~ u~ b WEIGHTED<=8 / h
// Process: c~ b > mu+ mu- u c~ u~ b WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxb_epemcuxcxb_no_h(); 
        ...
        t[1] = matrix_uxb_epemcuxcxb_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uxb_epemcuxcxb_no_h() 
{
  int i, j; 
  // Local variables
