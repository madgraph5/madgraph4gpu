...
// Process: u c > e+ e- u c d d~ WEIGHTED<=8 / h
// Process: u c > e+ e- u c s s~ WEIGHTED<=8 / h
// Process: u c > e+ e- u c b b~ WEIGHTED<=8 / h
// Process: u c > mu+ mu- u c d d~ WEIGHTED<=8 / h
// Process: u c > mu+ mu- u c s s~ WEIGHTED<=8 / h
// Process: u c > mu+ mu- u c b b~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_uc_epemucddx_no_h() 
{
  int i, j; 
  // Local variables
