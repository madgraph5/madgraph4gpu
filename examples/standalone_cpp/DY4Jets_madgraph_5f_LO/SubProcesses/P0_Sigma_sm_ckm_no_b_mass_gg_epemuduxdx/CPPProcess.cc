...
// Process: g g > e+ e- u d u~ d~ WEIGHTED<=8 / h
// Process: g g > e+ e- u s u~ s~ WEIGHTED<=8 / h
// Process: g g > e+ e- u b u~ b~ WEIGHTED<=8 / h
// Process: g g > e+ e- c d c~ d~ WEIGHTED<=8 / h
// Process: g g > e+ e- c s c~ s~ WEIGHTED<=8 / h
// Process: g g > e+ e- c b c~ b~ WEIGHTED<=8 / h
// Process: g g > mu+ mu- u d u~ d~ WEIGHTED<=8 / h
// Process: g g > mu+ mu- u s u~ s~ WEIGHTED<=8 / h
// Process: g g > mu+ mu- u b u~ b~ WEIGHTED<=8 / h
// Process: g g > mu+ mu- c d c~ d~ WEIGHTED<=8 / h
// Process: g g > mu+ mu- c s c~ s~ WEIGHTED<=8 / h
// Process: g g > mu+ mu- c b c~ b~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_gg_epemuduxdx_no_h() 
{
  int i, j; 
  // Local variables
