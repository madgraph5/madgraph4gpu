...
// Process: d u~ > e+ e- u d u~ u~ WEIGHTED<=8 / h
// Process: d u~ > mu+ mu- u d u~ u~ WEIGHTED<=8 / h
// Process: d c~ > e+ e- c d c~ c~ WEIGHTED<=8 / h
// Process: d c~ > mu+ mu- c d c~ c~ WEIGHTED<=8 / h
// Process: s u~ > e+ e- u s u~ u~ WEIGHTED<=8 / h
// Process: s u~ > mu+ mu- u s u~ u~ WEIGHTED<=8 / h
// Process: s c~ > e+ e- c s c~ c~ WEIGHTED<=8 / h
// Process: s c~ > mu+ mu- c s c~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_epemuduxux_no_h(); 
        ...
        t[1] = matrix_dux_epemuduxux_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[6], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1P0_3(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  VVV1P0_1(w[35], w[36], pars->GC_10, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[5], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_2(w[0], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_2(w[0], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[5], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_2(w[7], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1P0_3(w[42], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  ...
  FFV1_1(w[1], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[47]); 
  FFV1P0_3(w[40], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV2_5_1(w[1], w[18], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[49]);
  FFV1_1(w[1], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  VVV1P0_1(w[35], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_2(w[6], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1P0_3(w[52], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[53]); 
  FFV1_2(w[6], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[54]); 
  FFV1P0_3(w[54], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_1(w[4], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  FFV1P0_3(w[6], w[56], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1P0_3(w[6], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV2_5_2(w[6], w[18], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[59]);
  FFV1P0_3(w[59], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  FFV1P0_3(w[6], w[30], pars->GC_11, pars->ZERO, pars->ZERO, w[61]); 
  VVV1P0_1(w[36], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[62]); 
  FFV1_2(w[6], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  FFV1_2(w[6], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[64]); 
  FFV1P0_3(w[64], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  FFV1P0_3(w[54], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[66]); 
  FFV1_1(w[1], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[67]); 
  FFV1P0_3(w[6], w[67], pars->GC_11, pars->ZERO, pars->ZERO, w[68]); 
  FFV1P0_3(w[6], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[69]); 
  FFV1P0_3(w[59], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[70]); 
  FFV1P0_3(w[6], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[71]); 
  VVV1P0_1(w[9], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[72]); 
  FFV1P0_3(w[63], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[73]); 
  FFV1P0_3(w[63], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[74]); 
  FFV1P0_3(w[6], w[50], pars->GC_11, pars->ZERO, pars->ZERO, w[75]); 
  FFV1P0_3(w[6], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[76]); 
  ...
  FFV1_0(w[13], w[5], w[24], pars->GC_11, amp[19]); 
  ...
  FFV1_0(w[20], w[5], w[24], pars->GC_11, amp[27]); 
  ...
  FFV1_0(w[0], w[12], w[37], pars->GC_11, amp[48]); 
  FFV1_0(w[13], w[5], w[37], pars->GC_11, amp[49]); 
  ...
  FFV1_0(w[0], w[19], w[37], pars->GC_11, amp[56]); 
  FFV1_0(w[20], w[5], w[37], pars->GC_11, amp[57]); 
  ...
  FFV1_0(w[0], w[12], w[43], pars->GC_11, amp[64]); 
  FFV1_0(w[13], w[5], w[43], pars->GC_11, amp[65]); 
  FFV1_0(w[0], w[12], w[45], pars->GC_11, amp[66]); 
  FFV1_0(w[13], w[5], w[45], pars->GC_11, amp[67]); 
  FFV1_0(w[25], w[1], w[46], pars->GC_11, amp[68]); 
  FFV1_0(w[7], w[47], w[46], pars->GC_11, amp[69]); 
  FFV1_0(w[25], w[1], w[48], pars->GC_11, amp[70]); 
  FFV1_0(w[7], w[47], w[48], pars->GC_11, amp[71]); 
  FFV1_0(w[0], w[19], w[43], pars->GC_11, amp[72]); 
  FFV1_0(w[20], w[5], w[43], pars->GC_11, amp[73]); 
  FFV1_0(w[0], w[19], w[45], pars->GC_11, amp[74]); 
  FFV1_0(w[20], w[5], w[45], pars->GC_11, amp[75]); 
  FFV1_0(w[29], w[1], w[46], pars->GC_11, amp[76]); 
  FFV1_0(w[7], w[49], w[46], pars->GC_11, amp[77]); 
  FFV1_0(w[29], w[1], w[48], pars->GC_11, amp[78]); 
  ...
  FFV1_0(w[25], w[1], w[51], pars->GC_11, amp[84]); 
  ...
  FFV1_0(w[29], w[1], w[51], pars->GC_11, amp[92]); 
  FFV1_0(w[7], w[49], w[51], pars->GC_11, amp[93]); 
  FFV1_0(w[29], w[50], w[35], pars->GC_11, amp[94]); 
  FFV1_0(w[33], w[49], w[35], pars->GC_11, amp[95]); 
  FFV1_0(w[0], w[12], w[53], pars->GC_11, amp[96]); 
  FFV1_0(w[13], w[5], w[53], pars->GC_11, amp[97]); 
  FFV1_0(w[0], w[41], w[55], pars->GC_11, amp[98]); 
  FFV1_0(w[39], w[5], w[55], pars->GC_11, amp[99]); 
  FFV1_0(w[0], w[12], w[57], pars->GC_11, amp[100]); 
  FFV1_0(w[13], w[5], w[57], pars->GC_11, amp[101]); 
  FFV1_0(w[0], w[41], w[58], pars->GC_11, amp[102]); 
  FFV1_0(w[39], w[5], w[58], pars->GC_11, amp[103]); 
  FFV1_0(w[0], w[19], w[53], pars->GC_11, amp[104]); 
  FFV1_0(w[20], w[5], w[53], pars->GC_11, amp[105]); 
  FFV1_0(w[0], w[41], w[60], pars->GC_11, amp[106]); 
  FFV1_0(w[39], w[5], w[60], pars->GC_11, amp[107]); 
  FFV1_0(w[0], w[19], w[57], pars->GC_11, amp[108]); 
  FFV1_0(w[20], w[5], w[57], pars->GC_11, amp[109]); 
  FFV1_0(w[0], w[41], w[61], pars->GC_11, amp[110]); 
  FFV1_0(w[39], w[5], w[61], pars->GC_11, amp[111]); 
  ...
  FFV1_0(w[6], w[27], w[62], pars->GC_11, amp[119]); 
  ...
  FFV1_0(w[6], w[30], w[62], pars->GC_11, amp[127]); 
  FFV1_0(w[0], w[12], w[65], pars->GC_11, amp[128]); 
  FFV1_0(w[13], w[5], w[65], pars->GC_11, amp[129]); 
  FFV1_0(w[0], w[17], w[66], pars->GC_11, amp[130]); 
  FFV1_0(w[15], w[5], w[66], pars->GC_11, amp[131]); 
  FFV1_0(w[0], w[12], w[68], pars->GC_11, amp[132]); 
  FFV1_0(w[13], w[5], w[68], pars->GC_11, amp[133]); 
  FFV1_0(w[0], w[17], w[69], pars->GC_11, amp[134]); 
  FFV1_0(w[15], w[5], w[69], pars->GC_11, amp[135]); 
  FFV1_0(w[0], w[19], w[65], pars->GC_11, amp[136]); 
  FFV1_0(w[20], w[5], w[65], pars->GC_11, amp[137]); 
  FFV1_0(w[0], w[17], w[70], pars->GC_11, amp[138]); 
  FFV1_0(w[15], w[5], w[70], pars->GC_11, amp[139]); 
  FFV1_0(w[0], w[19], w[68], pars->GC_11, amp[140]); 
  FFV1_0(w[20], w[5], w[68], pars->GC_11, amp[141]); 
  FFV1_0(w[0], w[17], w[71], pars->GC_11, amp[142]); 
  FFV1_0(w[15], w[5], w[71], pars->GC_11, amp[143]); 
  FFV1_0(w[64], w[47], w[31], pars->GC_11, amp[144]); 
  FFV1_0(w[64], w[50], w[10], pars->GC_2, amp[145]); 
  FFV1_0(w[54], w[67], w[31], pars->GC_11, amp[146]); 
  FFV1_0(w[54], w[1], w[72], pars->GC_11, amp[147]); 
  FFV1_0(w[54], w[50], w[9], pars->GC_11, amp[148]); 
  FFV1_0(w[63], w[67], w[10], pars->GC_2, amp[149]); 
  FFV1_0(w[63], w[47], w[9], pars->GC_11, amp[150]); 
  FFV1_0(w[6], w[47], w[72], pars->GC_11, amp[151]); 
  ...
  FFV1_0(w[59], w[1], w[72], pars->GC_11, amp[155]); 
...
double CPPProcess::matrix_dux_epemuduxux_no_h() 
{
  int i, j; 
  // Local variables
  ...
  jamp[2] = +1./4. * (+1./3. * amp[2] + 1./3. * amp[3] + 1./3. * amp[4] + 1./3.
      ...
      * amp[138] + 1./3. * amp[139] + 1./3. * amp[142] + 1./3. * amp[143] +
      ...
      1./3. * amp[188] + amp[189]);
  jamp[3] = +1./4. * (-1./9. * amp[2] - 1./9. * amp[3] - 1./9. * amp[4] - 1./9.
  ...
  jamp[5] = +1./4. * (+1./3. * amp[16] + 1./3. * amp[17] + 1./3. * amp[18] +
