...
// Process: d~ s~ > e+ e- d~ s~ b b~ WEIGHTED<=8 / h
// Process: d~ s~ > mu+ mu- d~ s~ b b~ WEIGHTED<=8 / h
// Process: d~ b~ > e+ e- s~ s b~ d~ WEIGHTED<=8 / h
// Process: d~ b~ > mu+ mu- s~ s b~ d~ WEIGHTED<=8 / h
// Process: s~ b~ > e+ e- s~ b~ d d~ WEIGHTED<=8 / h
// Process: s~ b~ > mu+ mu- s~ b~ d d~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxsx_epemdxsxbbx_no_h(); 
        ...
        t[1] = matrix_dxsx_epemdxsxbbx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[5], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[9]); 
  ...
  FFV2_3_2(w[7], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[20]);
  FFV1_2(w[5], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1P0_3(w[21], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[1], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1P0_3(w[5], w[23], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1_2(w[5], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[25]); 
  FFV1P0_3(w[7], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_1(w[1], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[27]); 
  ...
  FFV1_1(w[1], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_2(w[5], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  VVV1P0_1(w[8], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[34]); 
  FFV1_2(w[4], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  FFV1P0_3(w[35], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[4], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[37]); 
  FFV1P0_3(w[37], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_1(w[0], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1P0_3(w[4], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[41]); 
  FFV1P0_3(w[4], w[41], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV2_3_2(w[4], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[43]);
  FFV1P0_3(w[43], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV2_3_1(w[0], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[45]);
  FFV1P0_3(w[4], w[45], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_1(w[0], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  ...
  FFV1P0_3(w[4], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  ...
  FFV1_0(w[25], w[1], w[26], pars->GC_11, amp[20]); 
  FFV1_0(w[5], w[27], w[26], pars->GC_11, amp[21]); 
  FFV1_0(w[25], w[1], w[28], pars->GC_11, amp[22]); 
  FFV1_0(w[5], w[27], w[28], pars->GC_11, amp[23]); 
  ...
  FFV1_0(w[29], w[1], w[26], pars->GC_11, amp[28]); 
  FFV1_0(w[5], w[30], w[26], pars->GC_11, amp[29]); 
  FFV1_0(w[29], w[1], w[28], pars->GC_11, amp[30]); 
  FFV1_0(w[5], w[30], w[28], pars->GC_11, amp[31]); 
  ...
  FFV1_0(w[25], w[1], w[34], pars->GC_11, amp[36]); 
  FFV1_0(w[5], w[27], w[34], pars->GC_11, amp[37]); 
  ...
  FFV1_0(w[29], w[1], w[34], pars->GC_11, amp[44]); 
  FFV1_0(w[5], w[30], w[34], pars->GC_11, amp[45]); 
  FFV1_0(w[29], w[32], w[8], pars->GC_11, amp[46]); 
  FFV1_0(w[33], w[30], w[8], pars->GC_11, amp[47]); 
  FFV1_0(w[7], w[12], w[36], pars->GC_11, amp[48]); 
  FFV1_0(w[13], w[6], w[36], pars->GC_11, amp[49]); 
  FFV1_0(w[7], w[17], w[38], pars->GC_11, amp[50]); 
  FFV1_0(w[15], w[6], w[38], pars->GC_11, amp[51]); 
  FFV1_0(w[7], w[12], w[40], pars->GC_11, amp[52]); 
  FFV1_0(w[13], w[6], w[40], pars->GC_11, amp[53]); 
  FFV1_0(w[7], w[17], w[42], pars->GC_11, amp[54]); 
  FFV1_0(w[15], w[6], w[42], pars->GC_11, amp[55]); 
  FFV1_0(w[7], w[19], w[36], pars->GC_11, amp[56]); 
  FFV1_0(w[20], w[6], w[36], pars->GC_11, amp[57]); 
  FFV1_0(w[7], w[17], w[44], pars->GC_11, amp[58]); 
  FFV1_0(w[15], w[6], w[44], pars->GC_11, amp[59]); 
  FFV1_0(w[7], w[19], w[40], pars->GC_11, amp[60]); 
  FFV1_0(w[20], w[6], w[40], pars->GC_11, amp[61]); 
  FFV1_0(w[7], w[17], w[46], pars->GC_11, amp[62]); 
  FFV1_0(w[15], w[6], w[46], pars->GC_11, amp[63]); 
  FFV1_0(w[35], w[41], w[31], pars->GC_11, amp[64]); 
  FFV1_0(w[35], w[47], w[10], pars->GC_1, amp[65]); 
  FFV1_0(w[37], w[39], w[31], pars->GC_11, amp[66]); 
  FFV1_0(w[37], w[0], w[48], pars->GC_11, amp[67]); 
  FFV1_0(w[37], w[47], w[9], pars->GC_11, amp[68]); 
  FFV1_0(w[49], w[39], w[10], pars->GC_1, amp[69]); 
  FFV1_0(w[49], w[41], w[9], pars->GC_11, amp[70]); 
  FFV1_0(w[4], w[41], w[48], pars->GC_11, amp[71]); 
  FFV1_0(w[35], w[45], w[31], pars->GC_11, amp[72]); 
  FFV2_3_0(w[35], w[47], w[18], -pars->GC_51, pars->GC_58, amp[73]); 
  FFV1_0(w[43], w[39], w[31], pars->GC_11, amp[74]); 
  FFV1_0(w[43], w[0], w[48], pars->GC_11, amp[75]); 
  FFV1_0(w[43], w[47], w[9], pars->GC_11, amp[76]); 
  FFV2_3_0(w[49], w[39], w[18], -pars->GC_51, pars->GC_58, amp[77]); 
  FFV1_0(w[49], w[45], w[9], pars->GC_11, amp[78]); 
  FFV1_0(w[4], w[45], w[48], pars->GC_11, amp[79]); 
  FFV1_0(w[33], w[1], w[38], pars->GC_11, amp[80]); 
  FFV1_0(w[5], w[32], w[38], pars->GC_11, amp[81]); 
  FFV1_0(w[25], w[1], w[50], pars->GC_11, amp[82]); 
  FFV1_0(w[5], w[27], w[50], pars->GC_11, amp[83]); 
  FFV1_0(w[25], w[1], w[51], pars->GC_11, amp[84]); 
  FFV1_0(w[33], w[1], w[42], pars->GC_11, amp[85]); 
  FFV1_0(w[5], w[32], w[42], pars->GC_11, amp[86]); 
  FFV1_0(w[5], w[27], w[51], pars->GC_11, amp[87]); 
  FFV1_0(w[33], w[1], w[44], pars->GC_11, amp[88]); 
  FFV1_0(w[5], w[32], w[44], pars->GC_11, amp[89]); 
  FFV1_0(w[29], w[1], w[50], pars->GC_11, amp[90]); 
  FFV1_0(w[5], w[30], w[50], pars->GC_11, amp[91]); 
  FFV1_0(w[29], w[1], w[51], pars->GC_11, amp[92]); 
  FFV1_0(w[33], w[1], w[46], pars->GC_11, amp[93]); 
  FFV1_0(w[5], w[32], w[46], pars->GC_11, amp[94]); 
  FFV1_0(w[5], w[30], w[51], pars->GC_11, amp[95]); 

}
double CPPProcess::matrix_dxsx_epemdxsxbbx_no_h() 
{
  int i, j; 
  // Local variables
