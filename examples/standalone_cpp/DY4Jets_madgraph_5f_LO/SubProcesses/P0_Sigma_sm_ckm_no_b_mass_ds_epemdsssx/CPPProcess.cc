...
// Process: d s > e+ e- d s s s~ WEIGHTED<=8 / h
// Process: d s > mu+ mu- d s s s~ WEIGHTED<=8 / h
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[31]); 
  ...
  FFV1_2(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[49]); 
  ...
  FFV1_0(w[1], w[40], w[50], pars->GC_11, amp[161]); 
  FFV1_0(w[31], w[6], w[69], pars->GC_11, amp[162]); 
  FFV1_0(w[1], w[12], w[69], pars->GC_11, amp[163]); 
  FFV1_0(w[31], w[6], w[70], pars->GC_11, amp[164]); 
  FFV1_0(w[42], w[6], w[54], pars->GC_11, amp[165]); 
  FFV1_0(w[1], w[40], w[54], pars->GC_11, amp[166]); 
  FFV1_0(w[1], w[12], w[70], pars->GC_11, amp[167]); 
  FFV1_0(w[42], w[6], w[56], pars->GC_11, amp[168]); 
  FFV1_0(w[1], w[40], w[56], pars->GC_11, amp[169]); 
  FFV1_0(w[38], w[6], w[69], pars->GC_11, amp[170]); 
  FFV1_0(w[1], w[19], w[69], pars->GC_11, amp[171]); 
  FFV1_0(w[38], w[6], w[70], pars->GC_11, amp[172]); 
  FFV1_0(w[42], w[6], w[58], pars->GC_11, amp[173]); 
  FFV1_0(w[1], w[40], w[58], pars->GC_11, amp[174]); 
  FFV1_0(w[1], w[19], w[70], pars->GC_11, amp[175]); 
  FFV1_0(w[45], w[5], w[50], pars->GC_11, amp[176]); 
  FFV1_0(w[1], w[44], w[50], pars->GC_11, amp[177]); 
  FFV1_0(w[31], w[5], w[71], pars->GC_11, amp[178]); 
  FFV1_0(w[1], w[23], w[71], pars->GC_11, amp[179]); 
  FFV1_0(w[31], w[5], w[72], pars->GC_11, amp[180]); 
  FFV1_0(w[45], w[5], w[54], pars->GC_11, amp[181]); 
  FFV1_0(w[1], w[44], w[54], pars->GC_11, amp[182]); 
  FFV1_0(w[1], w[23], w[72], pars->GC_11, amp[183]); 
  FFV1_0(w[45], w[5], w[56], pars->GC_11, amp[184]); 
  FFV1_0(w[1], w[44], w[56], pars->GC_11, amp[185]); 
  FFV1_0(w[38], w[5], w[71], pars->GC_11, amp[186]); 
  FFV1_0(w[1], w[27], w[71], pars->GC_11, amp[187]); 
  FFV1_0(w[38], w[5], w[72], pars->GC_11, amp[188]); 
  FFV1_0(w[45], w[5], w[58], pars->GC_11, amp[189]); 
  FFV1_0(w[1], w[44], w[58], pars->GC_11, amp[190]); 
  FFV1_0(w[1], w[27], w[72], pars->GC_11, amp[191]); 

}
double CPPProcess::matrix_ds_epemdsssx_no_h() 
{
  int i, j; 
  // Local variables
