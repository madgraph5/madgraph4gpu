...
// Process: g u > ta+ ta- g u d d~ WEIGHTED<=8 / h
// Process: g u > ta+ ta- g u s s~ WEIGHTED<=8 / h
// Process: g u > ta+ ta- g u b b~ WEIGHTED<=8 / h
// Process: g c > ta+ ta- g c d d~ WEIGHTED<=8 / h
// Process: g c > ta+ ta- g c s s~ WEIGHTED<=8 / h
// Process: g c > ta+ ta- g c b b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gu_taptamguddx_no_h(); 
        ...
        t[1] = matrix_gu_taptamguddx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_gu_taptamguddx_no_h() 
{
  int i, j; 
  // Local variables
