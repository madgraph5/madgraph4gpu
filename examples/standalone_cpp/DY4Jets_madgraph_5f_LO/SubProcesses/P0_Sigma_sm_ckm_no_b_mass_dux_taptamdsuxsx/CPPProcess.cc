...
// Process: d u~ > ta+ ta- d s u~ s~ WEIGHTED<=8 / h
// Process: d u~ > ta+ ta- d b u~ b~ WEIGHTED<=8 / h
// Process: d c~ > ta+ ta- d s c~ s~ WEIGHTED<=8 / h
// Process: d c~ > ta+ ta- d b c~ b~ WEIGHTED<=8 / h
// Process: s u~ > ta+ ta- s d u~ d~ WEIGHTED<=8 / h
// Process: s u~ > ta+ ta- s b u~ b~ WEIGHTED<=8 / h
// Process: s c~ > ta+ ta- s d c~ d~ WEIGHTED<=8 / h
// Process: s c~ > ta+ ta- s b c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_taptamdsuxsx_no_h(); 
        ...
        t[1] = matrix_dux_taptamdsuxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dux_taptamdsuxsx_no_h() 
{
  int i, j; 
  // Local variables
