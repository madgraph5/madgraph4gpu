...
// Process: u d > e+ e- u d d d~ WEIGHTED<=8 / h
// Process: u d > mu+ mu- u d d d~ WEIGHTED<=8 / h
// Process: u s > e+ e- u s s s~ WEIGHTED<=8 / h
// Process: u s > mu+ mu- u s s s~ WEIGHTED<=8 / h
// Process: u b > e+ e- u b b b~ WEIGHTED<=8 / h
// Process: u b > mu+ mu- u b b b~ WEIGHTED<=8 / h
// Process: c d > e+ e- c d d d~ WEIGHTED<=8 / h
// Process: c d > mu+ mu- c d d d~ WEIGHTED<=8 / h
// Process: c s > e+ e- c s s s~ WEIGHTED<=8 / h
// Process: c s > mu+ mu- c s s s~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_ud_epemudddx_no_h() 
{
  int i, j; 
  // Local variables
