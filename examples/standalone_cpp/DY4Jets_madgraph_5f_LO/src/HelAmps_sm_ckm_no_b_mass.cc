    ...
    std::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (V3[2] * TMP10) + cI * (V2[2] * TMP12)); 
    ...
    std::complex<double> COUP, double M3, double W3, std::complex<double> V3[])
{
  ...
  denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] *
      P3[3]) - M3 * (M3 - cI * W3));
  V3[2] = denom * (-2. * cI) * (OM3 * - 1./2. * P3[0] * (TMP6 + 2. * (TMP11)) +
      (+1./2. * (F1[2] * F2[4] + F1[3] * F2[5]) + F1[4] * F2[2] + F1[5] *
      F2[3]));
  V3[3] = denom * (-2. * cI) * (OM3 * - 1./2. * P3[1] * (TMP6 + 2. * (TMP11)) +
      (-1./2. * (F1[2] * F2[5] + F1[3] * F2[4]) + F1[4] * F2[3] + F1[5] *
      F2[2]));
  V3[4] = denom * 2. * cI * (OM3 * 1./2. * P3[2] * (TMP6 + 2. * (TMP11)) +
      (+1./2. * cI * (F1[2] * F2[5]) - 1./2. * cI * (F1[3] * F2[4]) - cI *
      (F1[4] * F2[3]) + cI * (F1[5] * F2[2])));
  V3[5] = denom * 2. * cI * (OM3 * 1./2. * P3[3] * (TMP6 + 2. * (TMP11)) +
    ...
    std::complex<double> V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[2] = denom * (-cI * (TMP4 * V4[2]) + cI * (V3[2] * TMP10)); 
  V1[3] = denom * (-cI * (TMP4 * V4[3]) + cI * (V3[3] * TMP10)); 
  V1[4] = denom * (-cI * (TMP4 * V4[4]) + cI * (V3[4] * TMP10)); 
  V1[5] = denom * (-cI * (TMP4 * V4[5]) + cI * (V3[5] * TMP10)); 
}
...
}  // end namespace $(namespace)s_sm_ckm_no_b_mass
