...
public:
  ...
  // Initialize process.
  virtual void initProc(char const* param_card_name, bool verb = true);
  ...
  virtual char const* name() const { return "e+ e- > mu+ mu- (sm)"; }
  ...
  double**  getMomenta() { return p; }
  void setMomenta(double** &momenta) { p = momenta; }
...
private:
  ...
  extras::complex w[nwavefuncs][18];
  static const int namplitudes = 2;
  extras::complex amp[namplitudes];
