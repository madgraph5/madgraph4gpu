...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_gu_taptamgggu_H
#define MG5_Sigma_sm_ckm_no_b_mass_gu_taptamgggu_H
...
class CPPProcess
{
  ...
  private:
    ...
    double matrix_gu_taptamgggu_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_gu_taptamgggu_H
