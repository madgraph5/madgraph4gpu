...
// Process: u d > ta+ ta- u c d c~ WEIGHTED<=8 / h
// Process: u s > ta+ ta- u c s c~ WEIGHTED<=8 / h
// Process: u b > ta+ ta- u c b c~ WEIGHTED<=8 / h
// Process: c d > ta+ ta- c u d u~ WEIGHTED<=8 / h
// Process: c s > ta+ ta- c u s u~ WEIGHTED<=8 / h
// Process: c b > ta+ ta- c u b u~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_taptamucdcx_no_h(); 
        ...
        t[1] = matrix_ud_taptamucdcx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ud_taptamucdcx_no_h() 
{
  int i, j; 
  // Local variables
