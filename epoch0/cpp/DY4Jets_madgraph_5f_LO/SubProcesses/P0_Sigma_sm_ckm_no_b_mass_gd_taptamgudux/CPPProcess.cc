...
// Process: g d > ta+ ta- g u d u~ WEIGHTED<=8 / h
// Process: g d > ta+ ta- g c d c~ WEIGHTED<=8 / h
// Process: g s > ta+ ta- g u s u~ WEIGHTED<=8 / h
// Process: g s > ta+ ta- g c s c~ WEIGHTED<=8 / h
// Process: g b > ta+ ta- g u b u~ WEIGHTED<=8 / h
// Process: g b > ta+ ta- g c b c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gd_taptamgudux_no_h(); 
        ...
        t[1] = matrix_gd_taptamgudux_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_gd_taptamgudux_no_h() 
{
  int i, j; 
  // Local variables
