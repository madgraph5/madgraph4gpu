...
// Process: u d~ > ta+ ta- u c c~ d~ WEIGHTED<=8 / h
// Process: u s~ > ta+ ta- u c c~ s~ WEIGHTED<=8 / h
// Process: u b~ > ta+ ta- u c c~ b~ WEIGHTED<=8 / h
// Process: c d~ > ta+ ta- c u u~ d~ WEIGHTED<=8 / h
// Process: c s~ > ta+ ta- c u u~ s~ WEIGHTED<=8 / h
// Process: c b~ > ta+ ta- c u u~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_udx_taptamuccxdx_no_h(); 
        ...
        t[1] = matrix_udx_taptamuccxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_udx_taptamuccxdx_no_h() 
{
  int i, j; 
  // Local variables
