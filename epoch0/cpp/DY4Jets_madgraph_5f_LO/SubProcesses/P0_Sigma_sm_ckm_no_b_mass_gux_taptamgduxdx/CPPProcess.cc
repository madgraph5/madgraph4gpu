...
// Process: g u~ > ta+ ta- g d u~ d~ WEIGHTED<=8 / h
// Process: g u~ > ta+ ta- g s u~ s~ WEIGHTED<=8 / h
// Process: g u~ > ta+ ta- g b u~ b~ WEIGHTED<=8 / h
// Process: g c~ > ta+ ta- g d c~ d~ WEIGHTED<=8 / h
// Process: g c~ > ta+ ta- g s c~ s~ WEIGHTED<=8 / h
// Process: g c~ > ta+ ta- g b c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gux_taptamgduxdx_no_h(); 
        ...
        t[1] = matrix_gux_taptamgduxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_gux_taptamgduxdx_no_h() 
{
  int i, j; 
  // Local variables
