...
// Process: d~ d~ > ta+ ta- s d~ d~ s~ WEIGHTED<=8 / h
// Process: d~ d~ > ta+ ta- d~ b d~ b~ WEIGHTED<=8 / h
// Process: s~ s~ > ta+ ta- d s~ d~ s~ WEIGHTED<=8 / h
// Process: s~ s~ > ta+ ta- s~ b s~ b~ WEIGHTED<=8 / h
// Process: b~ b~ > ta+ ta- d b~ d~ b~ WEIGHTED<=8 / h
// Process: b~ b~ > ta+ ta- s b~ s~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxdx_taptamsdxdxsx_no_h(); 
...
double CPPProcess::matrix_dxdx_taptamsdxdxsx_no_h() 
{
  int i, j; 
  // Local variables
