...
// Process: d u~ > ta+ ta- u d u~ u~ WEIGHTED<=8 / h
// Process: d c~ > ta+ ta- c d c~ c~ WEIGHTED<=8 / h
// Process: s u~ > ta+ ta- u s u~ u~ WEIGHTED<=8 / h
// Process: s c~ > ta+ ta- c s c~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dux_taptamuduxux_no_h(); 
        ...
        t[1] = matrix_dux_taptamuduxux_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dux_taptamuduxux_no_h() 
{
  int i, j; 
  // Local variables
