...
// Process: g d~ > ta+ ta- g g g d~ WEIGHTED<=8 / h
// Process: g s~ > ta+ ta- g g g s~ WEIGHTED<=8 / h
// Process: g b~ > ta+ ta- g g g b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gdx_taptamgggdx_no_h(); 
        ...
        t[1] = matrix_gdx_taptamgggdx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3_1(w[36], w[29], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[40]);
  FFV1_2(w[7], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_2(w[41], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1_2(w[7], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  ...
  FFV1_1(w[1], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  ...
  FFV1_2(w[7], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[70]); 
  ...
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[122]); 
...
double CPPProcess::matrix_gdx_taptamgggdx_no_h() 
{
  int i, j; 
  // Local variables
