...
// Process: u d > ta+ ta- u d d d~ WEIGHTED<=8 / h
// Process: u s > ta+ ta- u s s s~ WEIGHTED<=8 / h
// Process: u b > ta+ ta- u b b b~ WEIGHTED<=8 / h
// Process: c d > ta+ ta- c d d d~ WEIGHTED<=8 / h
// Process: c s > ta+ ta- c s s s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ud_taptamudddx_no_h(); 
        ...
        t[1] = matrix_ud_taptamudddx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ud_taptamudddx_no_h() 
{
  int i, j; 
  // Local variables
