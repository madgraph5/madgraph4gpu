...
// Process: g u > e+ e- g u d d~ WEIGHTED<=8 / h
// Process: g u > e+ e- g u s s~ WEIGHTED<=8 / h
// Process: g u > e+ e- g u b b~ WEIGHTED<=8 / h
// Process: g u > mu+ mu- g u d d~ WEIGHTED<=8 / h
// Process: g u > mu+ mu- g u s s~ WEIGHTED<=8 / h
// Process: g u > mu+ mu- g u b b~ WEIGHTED<=8 / h
// Process: g c > e+ e- g c d d~ WEIGHTED<=8 / h
// Process: g c > e+ e- g c s s~ WEIGHTED<=8 / h
// Process: g c > e+ e- g c b b~ WEIGHTED<=8 / h
// Process: g c > mu+ mu- g c d d~ WEIGHTED<=8 / h
// Process: g c > mu+ mu- g c s s~ WEIGHTED<=8 / h
// Process: g c > mu+ mu- g c b b~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_gu_epemguddx_no_h() 
{
  int i, j; 
  // Local variables
