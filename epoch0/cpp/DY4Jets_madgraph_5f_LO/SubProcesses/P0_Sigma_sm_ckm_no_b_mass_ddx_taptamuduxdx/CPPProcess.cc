...
// Process: d d~ > ta+ ta- u d u~ d~ WEIGHTED<=8 / h
// Process: d d~ > ta+ ta- c d c~ d~ WEIGHTED<=8 / h
// Process: s s~ > ta+ ta- u s u~ s~ WEIGHTED<=8 / h
// Process: s s~ > ta+ ta- c s c~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ddx_taptamuduxdx_no_h(); 
        ...
        t[1] = matrix_ddx_taptamuduxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ddx_taptamuduxdx_no_h() 
{
  int i, j; 
  // Local variables
