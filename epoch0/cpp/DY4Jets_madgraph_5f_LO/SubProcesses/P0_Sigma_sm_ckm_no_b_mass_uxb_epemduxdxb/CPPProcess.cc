...
// Process: u~ b > e+ e- d u~ d~ b WEIGHTED<=8 / h
// Process: u~ b > e+ e- s u~ s~ b WEIGHTED<=8 / h
// Process: u~ b > mu+ mu- d u~ d~ b WEIGHTED<=8 / h
// Process: u~ b > mu+ mu- s u~ s~ b WEIGHTED<=8 / h
// Process: c~ b > e+ e- d c~ d~ b WEIGHTED<=8 / h
// Process: c~ b > e+ e- s c~ s~ b WEIGHTED<=8 / h
// Process: c~ b > mu+ mu- d c~ d~ b WEIGHTED<=8 / h
// Process: c~ b > mu+ mu- s c~ s~ b WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxb_epemduxdxb_no_h(); 
        ...
        t[1] = matrix_uxb_epemduxdxb_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uxb_epemduxdxb_no_h() 
{
  int i, j; 
  // Local variables
