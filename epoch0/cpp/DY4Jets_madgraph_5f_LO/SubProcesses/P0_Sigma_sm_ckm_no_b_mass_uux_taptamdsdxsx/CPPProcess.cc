...
// Process: u u~ > ta+ ta- d s d~ s~ WEIGHTED<=8 / h
// Process: u u~ > ta+ ta- d b d~ b~ WEIGHTED<=8 / h
// Process: u u~ > ta+ ta- s b s~ b~ WEIGHTED<=8 / h
// Process: c c~ > ta+ ta- d s d~ s~ WEIGHTED<=8 / h
// Process: c c~ > ta+ ta- d b d~ b~ WEIGHTED<=8 / h
// Process: c c~ > ta+ ta- s b s~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_taptamdsdxsx_no_h(); 
        ...
        t[1] = matrix_uux_taptamdsdxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uux_taptamdsdxsx_no_h() 
{
  int i, j; 
  // Local variables
