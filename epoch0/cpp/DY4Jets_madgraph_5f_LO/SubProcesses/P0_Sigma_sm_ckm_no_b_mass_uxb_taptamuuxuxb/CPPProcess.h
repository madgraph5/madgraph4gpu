...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_uxb_taptamuuxuxb_H
#define MG5_Sigma_sm_ckm_no_b_mass_uxb_taptamuuxuxb_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "u~ b > ta+ ta- u u~ u~ b (sm_ckm_no_b_mass)";}
  ...
  private:
    ...
    double matrix_uxb_taptamuuxuxb_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_uxb_taptamuuxuxb_H
