...
// Process: u~ u~ > e+ e- u u~ u~ u~ WEIGHTED<=8 / h
// Process: u~ u~ > mu+ mu- u u~ u~ u~ WEIGHTED<=8 / h
// Process: c~ c~ > e+ e- c c~ c~ c~ WEIGHTED<=8 / h
// Process: c~ c~ > mu+ mu- c c~ c~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxux_epemuuxuxux_no_h(); 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[4], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[12]); 
  ...
  FFV1_1(w[1], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[23]); 
  ...
  FFV1_2(w[6], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[31]); 
  ...
  FFV1_1(w[0], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[55]); 
  ...
  FFV1_2(w[5], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[98]); 
...
double CPPProcess::matrix_uxux_epemuuxuxux_no_h() 
{
  int i, j; 
  // Local variables
