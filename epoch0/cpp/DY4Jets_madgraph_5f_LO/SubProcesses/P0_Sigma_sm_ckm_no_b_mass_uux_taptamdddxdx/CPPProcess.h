...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_uux_taptamdddxdx_H
#define MG5_Sigma_sm_ckm_no_b_mass_uux_taptamdddxdx_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "u u~ > ta+ ta- d d d~ d~ (sm_ckm_no_b_mass)";}
  ...
  private:
    ...
    double matrix_uux_taptamdddxdx_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_uux_taptamdddxdx_H
