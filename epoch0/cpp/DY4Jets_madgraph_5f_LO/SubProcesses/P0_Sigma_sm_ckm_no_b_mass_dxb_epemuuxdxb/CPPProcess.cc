...
// Process: d~ b > e+ e- u u~ d~ b WEIGHTED<=8 / h
// Process: d~ b > e+ e- c c~ d~ b WEIGHTED<=8 / h
// Process: d~ b > mu+ mu- u u~ d~ b WEIGHTED<=8 / h
// Process: d~ b > mu+ mu- c c~ d~ b WEIGHTED<=8 / h
// Process: s~ b > e+ e- u u~ s~ b WEIGHTED<=8 / h
// Process: s~ b > e+ e- c c~ s~ b WEIGHTED<=8 / h
// Process: s~ b > mu+ mu- u u~ s~ b WEIGHTED<=8 / h
// Process: s~ b > mu+ mu- c c~ s~ b WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxb_epemuuxdxb_no_h(); 
        ...
        t[1] = matrix_dxb_epemuuxdxb_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[21], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[0], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  ...
  FFV1_1(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[27]); 
  ...
  FFV1_1(w[0], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  ...
  FFV1_0(w[25], w[0], w[26], pars->GC_11, amp[20]); 
  FFV1_0(w[6], w[27], w[26], pars->GC_11, amp[21]); 
  FFV1_0(w[25], w[0], w[28], pars->GC_11, amp[22]); 
  ...
  FFV1_0(w[29], w[0], w[26], pars->GC_11, amp[28]); 
  FFV1_0(w[6], w[30], w[26], pars->GC_11, amp[29]); 
  FFV1_0(w[29], w[0], w[28], pars->GC_11, amp[30]); 
  ...
  FFV1_0(w[25], w[0], w[34], pars->GC_11, amp[36]); 
  ...
  FFV1_0(w[29], w[0], w[34], pars->GC_11, amp[44]); 
...
double CPPProcess::matrix_dxb_epemuuxdxb_no_h() 
{
  ...
  jamp[4] = +1./4. * (+1./3. * amp[2] + 1./3. * amp[3] + 1./3. * amp[4] + 1./3.
      * amp[5] + 1./3. * amp[6] + 1./3. * amp[7] + 1./3. * amp[10] + 1./3. *
      ...
      amp[95]);
  jamp[5] = +1./4. * (-1./9. * amp[2] - 1./9. * amp[3] - 1./9. * amp[4] - 1./9.
