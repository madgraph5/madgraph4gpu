...
// Process: c u~ > ta+ ta- g g c u~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ucx_taptamggucx_no_h(); 
        ...
        t[1] = matrix_ucx_taptamggucx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ucx_taptamggucx_no_h() 
{
  int i, j; 
  // Local variables
  ...
  jamp[3] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[0] - 1./3. *
      ...
      * amp[400]);
  jamp[4] = +1./2. * (+amp[96] + amp[97] + amp[98] + amp[99] + amp[100] +
  ...
  jamp[5] = +1./2. * (-1./3. * amp[96] - 1./3. * amp[97] - 1./3. * amp[98] -
