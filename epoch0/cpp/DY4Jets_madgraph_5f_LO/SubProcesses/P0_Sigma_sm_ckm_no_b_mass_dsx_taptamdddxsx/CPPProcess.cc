...
// Process: d s~ > ta+ ta- d d d~ s~ WEIGHTED<=8 / h
// Process: d b~ > ta+ ta- d d d~ b~ WEIGHTED<=8 / h
// Process: s d~ > ta+ ta- s s s~ d~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dsx_taptamdddxsx_no_h(); 
        ...
        t[1] = matrix_dsx_taptamdddxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dsx_taptamdddxsx_no_h() 
{
  int i, j; 
  // Local variables
