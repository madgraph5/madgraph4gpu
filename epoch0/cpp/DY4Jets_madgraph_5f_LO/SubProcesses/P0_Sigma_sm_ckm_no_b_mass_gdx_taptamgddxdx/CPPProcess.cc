...
// Process: g d~ > ta+ ta- g d d~ d~ WEIGHTED<=8 / h
// Process: g s~ > ta+ ta- g s s~ s~ WEIGHTED<=8 / h
// Process: g b~ > ta+ ta- g b b~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gdx_taptamgddxdx_no_h(); 
        ...
        t[1] = matrix_gdx_taptamgddxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_gdx_taptamgddxdx_no_h() 
{
  int i, j; 
  // Local variables
