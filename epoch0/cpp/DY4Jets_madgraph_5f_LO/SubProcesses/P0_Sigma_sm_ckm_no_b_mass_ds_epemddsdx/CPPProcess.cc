...
// Process: d s > e+ e- d d s d~ WEIGHTED<=8 / h
// Process: d s > mu+ mu- d d s d~ WEIGHTED<=8 / h
// Process: d b > e+ e- d d b d~ WEIGHTED<=8 / h
// Process: d b > mu+ mu- d d b d~ WEIGHTED<=8 / h
// Process: s b > e+ e- s s b s~ WEIGHTED<=8 / h
// Process: s b > mu+ mu- s s b s~ WEIGHTED<=8 / h
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[6], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[12]); 
  FFV1_2(w[1], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[13]); 
  ...
  FFV2_4_3(w[2], w[3], -pars->GC_51, pars->GC_59, pars->mdl_MZ, pars->mdl_WZ,
      w[18]);
  FFV2_3_1(w[6], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[19]);
  FFV2_3_2(w[1], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[20]);
  ...
  FFV1P0_3(w[1], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[26]); 
  FFV1_1(w[5], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[27]); 
  FFV1P0_3(w[16], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  ...
  FFV1P0_3(w[7], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  VVV1P0_1(w[35], w[36], pars->GC_10, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[6], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1_2(w[1], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_2(w[1], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  FFV1_1(w[6], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_2(w[7], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1P0_3(w[42], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_1(w[4], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1P0_3(w[7], w[44], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  FFV1P0_3(w[1], w[38], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_1(w[4], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[47]); 
  FFV1P0_3(w[40], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV2_3_1(w[4], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[49]);
  FFV1_1(w[4], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  VVV1P0_1(w[35], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[51]); 
  FFV1_2(w[0], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1P0_3(w[52], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[53]); 
  FFV1_2(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[54]); 
  FFV1P0_3(w[54], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[55]); 
  FFV1_1(w[5], w[36], pars->GC_11, pars->ZERO, pars->ZERO, w[56]); 
  FFV1P0_3(w[0], w[56], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1P0_3(w[0], w[27], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV2_3_2(w[0], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[59]);
  FFV1P0_3(w[59], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[60]); 
  FFV1P0_3(w[0], w[30], pars->GC_11, pars->ZERO, pars->ZERO, w[61]); 
  VVV1P0_1(w[36], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[62]); 
  FFV1_2(w[0], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  FFV1_2(w[0], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[64]); 
  FFV1P0_3(w[64], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  FFV1P0_3(w[54], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[66]); 
  FFV1_1(w[4], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[67]); 
  FFV1P0_3(w[0], w[67], pars->GC_11, pars->ZERO, pars->ZERO, w[68]); 
  FFV1P0_3(w[0], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[69]); 
  FFV1P0_3(w[59], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[70]); 
  FFV1P0_3(w[0], w[49], pars->GC_11, pars->ZERO, pars->ZERO, w[71]); 
  VVV1P0_1(w[9], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[72]); 
  FFV1P0_3(w[63], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[73]); 
  FFV1P0_3(w[63], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[74]); 
  FFV1P0_3(w[0], w[50], pars->GC_11, pars->ZERO, pars->ZERO, w[75]); 
  FFV1P0_3(w[0], w[32], pars->GC_11, pars->ZERO, pars->ZERO, w[76]); 
  ...
  FFV1_0(w[1], w[19], w[11], pars->GC_11, amp[8]); 
  ...
  FFV1_0(w[1], w[12], w[22], pars->GC_11, amp[16]); 
  FFV1_0(w[13], w[6], w[22], pars->GC_11, amp[17]); 
  FFV1_0(w[1], w[12], w[24], pars->GC_11, amp[18]); 
  FFV1_0(w[13], w[6], w[24], pars->GC_11, amp[19]); 
  ...
  FFV1_0(w[1], w[19], w[22], pars->GC_11, amp[24]); 
  FFV1_0(w[20], w[6], w[22], pars->GC_11, amp[25]); 
  FFV1_0(w[1], w[19], w[24], pars->GC_11, amp[26]); 
  FFV1_0(w[20], w[6], w[24], pars->GC_11, amp[27]); 
  ...
  FFV1_0(w[1], w[12], w[37], pars->GC_11, amp[48]); 
  FFV1_0(w[13], w[6], w[37], pars->GC_11, amp[49]); 
  FFV1_0(w[39], w[38], w[10], pars->GC_1, amp[50]); 
  FFV1_0(w[13], w[38], w[36], pars->GC_11, amp[51]); 
  FFV1_0(w[40], w[41], w[10], pars->GC_1, amp[52]); 
  FFV1_0(w[40], w[12], w[36], pars->GC_11, amp[53]); 
  FFV1_0(w[13], w[41], w[35], pars->GC_11, amp[54]); 
  FFV1_0(w[39], w[12], w[35], pars->GC_11, amp[55]); 
  FFV1_0(w[1], w[19], w[37], pars->GC_11, amp[56]); 
  FFV1_0(w[20], w[6], w[37], pars->GC_11, amp[57]); 
  FFV2_3_0(w[39], w[38], w[18], -pars->GC_51, pars->GC_58, amp[58]); 
  FFV1_0(w[20], w[38], w[36], pars->GC_11, amp[59]); 
  FFV2_3_0(w[40], w[41], w[18], -pars->GC_51, pars->GC_58, amp[60]); 
  FFV1_0(w[40], w[19], w[36], pars->GC_11, amp[61]); 
  FFV1_0(w[20], w[41], w[35], pars->GC_11, amp[62]); 
  FFV1_0(w[39], w[19], w[35], pars->GC_11, amp[63]); 
  FFV1_0(w[1], w[12], w[43], pars->GC_11, amp[64]); 
  FFV1_0(w[13], w[6], w[43], pars->GC_11, amp[65]); 
  FFV1_0(w[1], w[12], w[45], pars->GC_11, amp[66]); 
  FFV1_0(w[13], w[6], w[45], pars->GC_11, amp[67]); 
  FFV1_0(w[25], w[4], w[46], pars->GC_11, amp[68]); 
  FFV1_0(w[7], w[47], w[46], pars->GC_11, amp[69]); 
  FFV1_0(w[25], w[4], w[48], pars->GC_11, amp[70]); 
  FFV1_0(w[7], w[47], w[48], pars->GC_11, amp[71]); 
  FFV1_0(w[1], w[19], w[43], pars->GC_11, amp[72]); 
  FFV1_0(w[20], w[6], w[43], pars->GC_11, amp[73]); 
  FFV1_0(w[1], w[19], w[45], pars->GC_11, amp[74]); 
  FFV1_0(w[20], w[6], w[45], pars->GC_11, amp[75]); 
  FFV1_0(w[29], w[4], w[46], pars->GC_11, amp[76]); 
  FFV1_0(w[7], w[49], w[46], pars->GC_11, amp[77]); 
  FFV1_0(w[29], w[4], w[48], pars->GC_11, amp[78]); 
  FFV1_0(w[7], w[49], w[48], pars->GC_11, amp[79]); 
  FFV1_0(w[42], w[47], w[31], pars->GC_11, amp[80]); 
  FFV1_0(w[42], w[50], w[10], pars->GC_1, amp[81]); 
  FFV1_0(w[25], w[44], w[31], pars->GC_11, amp[82]); 
  FFV1_0(w[33], w[44], w[10], pars->GC_1, amp[83]); 
  FFV1_0(w[25], w[4], w[51], pars->GC_11, amp[84]); 
  FFV1_0(w[7], w[47], w[51], pars->GC_11, amp[85]); 
  FFV1_0(w[25], w[50], w[35], pars->GC_11, amp[86]); 
  FFV1_0(w[33], w[47], w[35], pars->GC_11, amp[87]); 
  FFV1_0(w[42], w[49], w[31], pars->GC_11, amp[88]); 
  FFV2_3_0(w[42], w[50], w[18], -pars->GC_51, pars->GC_58, amp[89]); 
  FFV1_0(w[29], w[44], w[31], pars->GC_11, amp[90]); 
  FFV2_3_0(w[33], w[44], w[18], -pars->GC_51, pars->GC_58, amp[91]); 
  FFV1_0(w[29], w[4], w[51], pars->GC_11, amp[92]); 
  FFV1_0(w[7], w[49], w[51], pars->GC_11, amp[93]); 
  FFV1_0(w[29], w[50], w[35], pars->GC_11, amp[94]); 
  FFV1_0(w[33], w[49], w[35], pars->GC_11, amp[95]); 
  FFV1_0(w[1], w[12], w[53], pars->GC_11, amp[96]); 
  FFV1_0(w[13], w[6], w[53], pars->GC_11, amp[97]); 
  FFV1_0(w[1], w[41], w[55], pars->GC_11, amp[98]); 
  FFV1_0(w[39], w[6], w[55], pars->GC_11, amp[99]); 
  FFV1_0(w[1], w[12], w[57], pars->GC_11, amp[100]); 
  FFV1_0(w[13], w[6], w[57], pars->GC_11, amp[101]); 
  FFV1_0(w[1], w[41], w[58], pars->GC_11, amp[102]); 
  FFV1_0(w[39], w[6], w[58], pars->GC_11, amp[103]); 
  FFV1_0(w[1], w[19], w[53], pars->GC_11, amp[104]); 
  FFV1_0(w[20], w[6], w[53], pars->GC_11, amp[105]); 
  FFV1_0(w[1], w[41], w[60], pars->GC_11, amp[106]); 
  FFV1_0(w[39], w[6], w[60], pars->GC_11, amp[107]); 
  FFV1_0(w[1], w[19], w[57], pars->GC_11, amp[108]); 
  FFV1_0(w[20], w[6], w[57], pars->GC_11, amp[109]); 
  FFV1_0(w[1], w[41], w[61], pars->GC_11, amp[110]); 
  FFV1_0(w[39], w[6], w[61], pars->GC_11, amp[111]); 
  FFV1_0(w[52], w[27], w[31], pars->GC_11, amp[112]); 
  FFV1_0(w[52], w[32], w[10], pars->GC_1, amp[113]); 
  FFV1_0(w[54], w[56], w[31], pars->GC_11, amp[114]); 
  FFV1_0(w[54], w[5], w[62], pars->GC_11, amp[115]); 
  FFV1_0(w[54], w[32], w[36], pars->GC_11, amp[116]); 
  FFV1_0(w[63], w[56], w[10], pars->GC_1, amp[117]); 
  FFV1_0(w[63], w[27], w[36], pars->GC_11, amp[118]); 
  FFV1_0(w[0], w[27], w[62], pars->GC_11, amp[119]); 
  FFV1_0(w[52], w[30], w[31], pars->GC_11, amp[120]); 
  FFV2_3_0(w[52], w[32], w[18], -pars->GC_51, pars->GC_58, amp[121]); 
  FFV1_0(w[59], w[56], w[31], pars->GC_11, amp[122]); 
  FFV1_0(w[59], w[5], w[62], pars->GC_11, amp[123]); 
  FFV1_0(w[59], w[32], w[36], pars->GC_11, amp[124]); 
  FFV2_3_0(w[63], w[56], w[18], -pars->GC_51, pars->GC_58, amp[125]); 
  FFV1_0(w[63], w[30], w[36], pars->GC_11, amp[126]); 
  FFV1_0(w[0], w[30], w[62], pars->GC_11, amp[127]); 
  FFV1_0(w[1], w[12], w[65], pars->GC_11, amp[128]); 
  FFV1_0(w[13], w[6], w[65], pars->GC_11, amp[129]); 
  FFV1_0(w[1], w[17], w[66], pars->GC_11, amp[130]); 
  FFV1_0(w[15], w[6], w[66], pars->GC_11, amp[131]); 
  FFV1_0(w[1], w[12], w[68], pars->GC_11, amp[132]); 
  FFV1_0(w[13], w[6], w[68], pars->GC_11, amp[133]); 
  FFV1_0(w[1], w[17], w[69], pars->GC_11, amp[134]); 
  FFV1_0(w[15], w[6], w[69], pars->GC_11, amp[135]); 
  FFV1_0(w[1], w[19], w[65], pars->GC_11, amp[136]); 
  FFV1_0(w[20], w[6], w[65], pars->GC_11, amp[137]); 
  FFV1_0(w[1], w[17], w[70], pars->GC_11, amp[138]); 
  FFV1_0(w[15], w[6], w[70], pars->GC_11, amp[139]); 
  FFV1_0(w[1], w[19], w[68], pars->GC_11, amp[140]); 
  FFV1_0(w[20], w[6], w[68], pars->GC_11, amp[141]); 
  FFV1_0(w[1], w[17], w[71], pars->GC_11, amp[142]); 
  FFV1_0(w[15], w[6], w[71], pars->GC_11, amp[143]); 
  FFV1_0(w[64], w[47], w[31], pars->GC_11, amp[144]); 
  FFV1_0(w[64], w[50], w[10], pars->GC_1, amp[145]); 
  FFV1_0(w[54], w[67], w[31], pars->GC_11, amp[146]); 
  FFV1_0(w[54], w[4], w[72], pars->GC_11, amp[147]); 
  FFV1_0(w[54], w[50], w[9], pars->GC_11, amp[148]); 
  FFV1_0(w[63], w[67], w[10], pars->GC_1, amp[149]); 
  FFV1_0(w[63], w[47], w[9], pars->GC_11, amp[150]); 
  FFV1_0(w[0], w[47], w[72], pars->GC_11, amp[151]); 
  FFV1_0(w[64], w[49], w[31], pars->GC_11, amp[152]); 
  FFV2_3_0(w[64], w[50], w[18], -pars->GC_51, pars->GC_58, amp[153]); 
  FFV1_0(w[59], w[67], w[31], pars->GC_11, amp[154]); 
  FFV1_0(w[59], w[4], w[72], pars->GC_11, amp[155]); 
  FFV1_0(w[59], w[50], w[9], pars->GC_11, amp[156]); 
  FFV2_3_0(w[63], w[67], w[18], -pars->GC_51, pars->GC_58, amp[157]); 
  FFV1_0(w[63], w[49], w[9], pars->GC_11, amp[158]); 
  FFV1_0(w[0], w[49], w[72], pars->GC_11, amp[159]); 
  FFV1_0(w[33], w[5], w[66], pars->GC_11, amp[160]); 
  FFV1_0(w[33], w[4], w[55], pars->GC_11, amp[161]); 
  FFV1_0(w[7], w[50], w[55], pars->GC_11, amp[162]); 
  FFV1_0(w[7], w[32], w[66], pars->GC_11, amp[163]); 
  FFV1_0(w[25], w[5], w[73], pars->GC_11, amp[164]); 
  FFV1_0(w[25], w[4], w[74], pars->GC_11, amp[165]); 
  FFV1_0(w[7], w[47], w[74], pars->GC_11, amp[166]); 
  FFV1_0(w[7], w[27], w[73], pars->GC_11, amp[167]); 
  FFV1_0(w[25], w[5], w[75], pars->GC_11, amp[168]); 
  FFV1_0(w[25], w[4], w[76], pars->GC_11, amp[169]); 
  FFV1_0(w[33], w[5], w[69], pars->GC_11, amp[170]); 
  FFV1_0(w[33], w[4], w[58], pars->GC_11, amp[171]); 
  FFV1_0(w[7], w[32], w[69], pars->GC_11, amp[172]); 
  FFV1_0(w[7], w[47], w[76], pars->GC_11, amp[173]); 
  FFV1_0(w[7], w[50], w[58], pars->GC_11, amp[174]); 
  FFV1_0(w[7], w[27], w[75], pars->GC_11, amp[175]); 
  FFV1_0(w[33], w[5], w[70], pars->GC_11, amp[176]); 
  FFV1_0(w[33], w[4], w[60], pars->GC_11, amp[177]); 
  FFV1_0(w[7], w[50], w[60], pars->GC_11, amp[178]); 
  FFV1_0(w[7], w[32], w[70], pars->GC_11, amp[179]); 
  FFV1_0(w[29], w[5], w[73], pars->GC_11, amp[180]); 
  FFV1_0(w[29], w[4], w[74], pars->GC_11, amp[181]); 
  FFV1_0(w[7], w[49], w[74], pars->GC_11, amp[182]); 
  FFV1_0(w[7], w[30], w[73], pars->GC_11, amp[183]); 
  FFV1_0(w[29], w[5], w[75], pars->GC_11, amp[184]); 
  FFV1_0(w[29], w[4], w[76], pars->GC_11, amp[185]); 
  FFV1_0(w[33], w[5], w[71], pars->GC_11, amp[186]); 
  FFV1_0(w[33], w[4], w[61], pars->GC_11, amp[187]); 
  FFV1_0(w[7], w[32], w[71], pars->GC_11, amp[188]); 
  FFV1_0(w[7], w[49], w[76], pars->GC_11, amp[189]); 
  FFV1_0(w[7], w[50], w[61], pars->GC_11, amp[190]); 
  FFV1_0(w[7], w[30], w[75], pars->GC_11, amp[191]); 

}
double CPPProcess::matrix_ds_epemddsdx_no_h() 
{
  int i, j; 
  // Local variables
  ...
  jamp[3] = +1./4. * (+1./3. * amp[2] + 1./3. * amp[3] + 1./3. * amp[4] + 1./3.
      * amp[5] + 1./3. * amp[6] + 1./3. * amp[7] + 1./3. * amp[10] + 1./3. *
      amp[11] + 1./3. * amp[12] + 1./3. * amp[13] + 1./3. * amp[14] + 1./3. *
  ...
  jamp[4] = +1./4. * (+1./3. * amp[16] + 1./3. * amp[17] + 1./3. * amp[18] +
