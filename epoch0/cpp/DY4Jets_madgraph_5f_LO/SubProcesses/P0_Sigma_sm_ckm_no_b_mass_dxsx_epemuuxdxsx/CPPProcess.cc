...
// Process: d~ s~ > e+ e- u u~ d~ s~ WEIGHTED<=8 / h
// Process: d~ s~ > e+ e- c c~ d~ s~ WEIGHTED<=8 / h
// Process: d~ s~ > mu+ mu- u u~ d~ s~ WEIGHTED<=8 / h
// Process: d~ s~ > mu+ mu- c c~ d~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxsx_epemuuxdxsx_no_h(); 
        ...
        t[1] = matrix_dxsx_epemuuxdxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_dxsx_epemuuxdxsx_no_h() 
{
  int i, j; 
  // Local variables
