...
// Process: u u > e+ e- u u c c~ WEIGHTED<=8 / h
// Process: u u > mu+ mu- u u c c~ WEIGHTED<=8 / h
// Process: c c > e+ e- c u c u~ WEIGHTED<=8 / h
// Process: c c > mu+ mu- c u c u~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_uu_epemuuccx_no_h() 
{
  int i, j; 
  // Local variables
