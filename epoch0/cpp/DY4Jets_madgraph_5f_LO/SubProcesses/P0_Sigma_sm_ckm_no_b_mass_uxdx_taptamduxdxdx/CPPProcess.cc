...
// Process: u~ d~ > ta+ ta- d u~ d~ d~ WEIGHTED<=8 / h
// Process: u~ s~ > ta+ ta- s u~ s~ s~ WEIGHTED<=8 / h
// Process: u~ b~ > ta+ ta- b u~ b~ b~ WEIGHTED<=8 / h
// Process: c~ d~ > ta+ ta- d c~ d~ d~ WEIGHTED<=8 / h
// Process: c~ s~ > ta+ ta- s c~ s~ s~ WEIGHTED<=8 / h
// Process: c~ b~ > ta+ ta- b c~ b~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxdx_taptamduxdxdx_no_h(); 
        ...
        t[1] = matrix_uxdx_taptamduxdxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uxdx_taptamduxdxdx_no_h() 
{
  int i, j; 
  // Local variables
