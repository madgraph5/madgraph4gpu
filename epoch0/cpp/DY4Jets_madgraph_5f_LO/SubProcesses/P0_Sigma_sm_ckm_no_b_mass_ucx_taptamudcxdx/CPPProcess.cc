...
// Process: u c~ > ta+ ta- u d c~ d~ WEIGHTED<=8 / h
// Process: u c~ > ta+ ta- u s c~ s~ WEIGHTED<=8 / h
// Process: u c~ > ta+ ta- u b c~ b~ WEIGHTED<=8 / h
// Process: c u~ > ta+ ta- c d u~ d~ WEIGHTED<=8 / h
// Process: c u~ > ta+ ta- c s u~ s~ WEIGHTED<=8 / h
// Process: c u~ > ta+ ta- c b u~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ucx_taptamudcxdx_no_h(); 
        ...
        t[1] = matrix_ucx_taptamudcxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ucx_taptamudcxdx_no_h() 
{
  int i, j; 
  // Local variables
