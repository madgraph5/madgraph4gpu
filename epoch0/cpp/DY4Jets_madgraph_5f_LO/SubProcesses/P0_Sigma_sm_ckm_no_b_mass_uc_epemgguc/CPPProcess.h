...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_uc_epemgguc_H
#define MG5_Sigma_sm_ckm_no_b_mass_uc_epemgguc_H
...
class CPPProcess
{
  ...
  private:
    ...
    double matrix_uc_epemgguc_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_uc_epemgguc_H
