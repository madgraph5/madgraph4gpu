...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_ucx_epemggucx_H
#define MG5_Sigma_sm_ckm_no_b_mass_ucx_epemggucx_H
...
class CPPProcess
{
  ...
  private:
    ...
    double matrix_ucx_epemggucx_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_ucx_epemggucx_H
