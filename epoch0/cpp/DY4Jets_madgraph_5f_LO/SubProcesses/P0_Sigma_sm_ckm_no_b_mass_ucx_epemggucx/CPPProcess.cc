...
// Process: c u~ > e+ e- g g c u~ WEIGHTED<=8 / h
// Process: c u~ > mu+ mu- g g c u~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_ucx_epemggucx_no_h() 
{
  int i, j; 
  // Local variables
