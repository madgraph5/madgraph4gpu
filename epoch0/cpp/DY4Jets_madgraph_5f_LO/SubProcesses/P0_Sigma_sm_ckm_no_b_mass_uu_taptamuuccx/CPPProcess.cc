...
// Process: u u > ta+ ta- u u c c~ WEIGHTED<=8 / h
// Process: c c > ta+ ta- c u c u~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uu_taptamuuccx_no_h(); 
...
double CPPProcess::matrix_uu_taptamuuccx_no_h() 
{
  int i, j; 
  // Local variables
