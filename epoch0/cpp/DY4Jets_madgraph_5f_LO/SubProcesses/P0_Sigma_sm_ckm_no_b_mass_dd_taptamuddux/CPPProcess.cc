...
// Process: d d > ta+ ta- u d d u~ WEIGHTED<=8 / h
// Process: d d > ta+ ta- c d d c~ WEIGHTED<=8 / h
// Process: s s > ta+ ta- u s s u~ WEIGHTED<=8 / h
// Process: s s > ta+ ta- c s s c~ WEIGHTED<=8 / h
// Process: b b > ta+ ta- u b u~ b WEIGHTED<=8 / h
// Process: b b > ta+ ta- c b c~ b WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dd_taptamuddux_no_h(); 
...
double CPPProcess::matrix_dd_taptamuddux_no_h() 
{
  int i, j; 
  // Local variables
