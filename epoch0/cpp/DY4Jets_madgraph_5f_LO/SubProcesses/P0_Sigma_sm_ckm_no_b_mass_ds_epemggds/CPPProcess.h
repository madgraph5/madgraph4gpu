...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_ds_epemggds_H
#define MG5_Sigma_sm_ckm_no_b_mass_ds_epemggds_H
...
class CPPProcess
{
  ...
  private:
    ...
    double matrix_ds_epemggds_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_ds_epemggds_H
