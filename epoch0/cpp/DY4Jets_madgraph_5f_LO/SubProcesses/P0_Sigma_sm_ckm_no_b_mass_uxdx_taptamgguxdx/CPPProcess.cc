...
// Process: u~ d~ > ta+ ta- g g u~ d~ WEIGHTED<=8 / h
// Process: u~ s~ > ta+ ta- g g u~ s~ WEIGHTED<=8 / h
// Process: u~ b~ > ta+ ta- g g u~ b~ WEIGHTED<=8 / h
// Process: c~ d~ > ta+ ta- g g c~ d~ WEIGHTED<=8 / h
// Process: c~ s~ > ta+ ta- g g c~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxdx_taptamgguxdx_no_h(); 
        ...
        t[1] = matrix_uxdx_taptamgguxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uxdx_taptamgguxdx_no_h() 
{
  int i, j; 
  // Local variables
