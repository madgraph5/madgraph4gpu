...
// Process: d d > ta+ ta- d d s s~ WEIGHTED<=8 / h
// Process: d d > ta+ ta- d d b b~ WEIGHTED<=8 / h
// Process: s s > ta+ ta- s d s d~ WEIGHTED<=8 / h
// Process: s s > ta+ ta- s s b b~ WEIGHTED<=8 / h
// Process: b b > ta+ ta- b b d d~ WEIGHTED<=8 / h
// Process: b b > ta+ ta- b b s s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dd_taptamddssx_no_h(); 
...
double CPPProcess::matrix_dd_taptamddssx_no_h() 
{
  int i, j; 
  // Local variables
