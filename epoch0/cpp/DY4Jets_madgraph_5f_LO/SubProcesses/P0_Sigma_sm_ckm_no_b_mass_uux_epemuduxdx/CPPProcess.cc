...
// Process: u u~ > e+ e- u d u~ d~ WEIGHTED<=8 / h
// Process: u u~ > e+ e- u s u~ s~ WEIGHTED<=8 / h
// Process: u u~ > e+ e- u b u~ b~ WEIGHTED<=8 / h
// Process: u u~ > mu+ mu- u d u~ d~ WEIGHTED<=8 / h
// Process: u u~ > mu+ mu- u s u~ s~ WEIGHTED<=8 / h
// Process: u u~ > mu+ mu- u b u~ b~ WEIGHTED<=8 / h
// Process: c c~ > e+ e- c d c~ d~ WEIGHTED<=8 / h
// Process: c c~ > e+ e- c s c~ s~ WEIGHTED<=8 / h
// Process: c c~ > e+ e- c b c~ b~ WEIGHTED<=8 / h
// Process: c c~ > mu+ mu- c d c~ d~ WEIGHTED<=8 / h
// Process: c c~ > mu+ mu- c s c~ s~ WEIGHTED<=8 / h
// Process: c c~ > mu+ mu- c b c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uux_epemuduxdx_no_h(); 
        ...
        t[1] = matrix_uux_epemuduxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uux_epemuduxdx_no_h() 
{
  int i, j; 
  // Local variables
