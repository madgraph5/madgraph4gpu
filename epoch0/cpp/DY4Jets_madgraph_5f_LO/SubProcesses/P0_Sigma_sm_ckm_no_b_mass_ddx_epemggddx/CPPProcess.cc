...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3_1(w[6], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[27]);
  FFV2_3_2(w[0], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[28]);
  ...
  FFV1_1(w[1], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  ...
  FFV1_1(w[6], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[80]); 
  FFV1_1(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[81]); 
...
double CPPProcess::matrix_ddx_epemggddx_no_h() 
{
  int i, j; 
  // Local variables
  ...
  jamp[8] = +1./2. * (-amp[192] - 1./3. * amp[193] - 1./3. * amp[194] - 1./3. *
  ...
  jamp[9] = +1./2. * (+1./3. * amp[192] + amp[193] + amp[194] + amp[195] +
