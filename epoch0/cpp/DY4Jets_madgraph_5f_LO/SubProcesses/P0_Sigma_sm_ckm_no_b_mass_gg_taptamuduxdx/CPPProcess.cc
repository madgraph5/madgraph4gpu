...
// Process: g g > ta+ ta- u d u~ d~ WEIGHTED<=8 / h
// Process: g g > ta+ ta- u s u~ s~ WEIGHTED<=8 / h
// Process: g g > ta+ ta- u b u~ b~ WEIGHTED<=8 / h
// Process: g g > ta+ ta- c d c~ d~ WEIGHTED<=8 / h
// Process: g g > ta+ ta- c s c~ s~ WEIGHTED<=8 / h
// Process: g g > ta+ ta- c b c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_taptamuduxdx_no_h(); 
...
double CPPProcess::matrix_gg_taptamuduxdx_no_h() 
{
  int i, j; 
  // Local variables
