...
// Process: g g > ta+ ta- u u u~ u~ WEIGHTED<=8 / h
// Process: g g > ta+ ta- c c c~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gg_taptamuuuxux_no_h(); 
...
double CPPProcess::matrix_gg_taptamuuuxux_no_h() 
{
  int i, j; 
  // Local variables
