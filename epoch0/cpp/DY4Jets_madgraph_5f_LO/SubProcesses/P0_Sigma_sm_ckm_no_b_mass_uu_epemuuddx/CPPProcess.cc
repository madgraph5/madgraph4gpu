...
// Process: u u > e+ e- u u d d~ WEIGHTED<=8 / h
// Process: u u > e+ e- u u s s~ WEIGHTED<=8 / h
// Process: u u > e+ e- u u b b~ WEIGHTED<=8 / h
// Process: u u > mu+ mu- u u d d~ WEIGHTED<=8 / h
// Process: u u > mu+ mu- u u s s~ WEIGHTED<=8 / h
// Process: u u > mu+ mu- u u b b~ WEIGHTED<=8 / h
// Process: c c > e+ e- c c d d~ WEIGHTED<=8 / h
// Process: c c > e+ e- c c s s~ WEIGHTED<=8 / h
// Process: c c > e+ e- c c b b~ WEIGHTED<=8 / h
// Process: c c > mu+ mu- c c d d~ WEIGHTED<=8 / h
// Process: c c > mu+ mu- c c s s~ WEIGHTED<=8 / h
// Process: c c > mu+ mu- c c b b~ WEIGHTED<=8 / h
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_2(w[1], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[25]); 
...
double CPPProcess::matrix_uu_epemuuddx_no_h() 
{
  int i, j; 
  // Local variables
