...
// Process: u d~ > ta+ ta- u s d~ s~ WEIGHTED<=8 / h
// Process: u d~ > ta+ ta- u b d~ b~ WEIGHTED<=8 / h
// Process: u s~ > ta+ ta- u d s~ d~ WEIGHTED<=8 / h
// Process: u s~ > ta+ ta- u b s~ b~ WEIGHTED<=8 / h
// Process: u b~ > ta+ ta- u d b~ d~ WEIGHTED<=8 / h
// Process: u b~ > ta+ ta- u s b~ s~ WEIGHTED<=8 / h
// Process: c d~ > ta+ ta- c s d~ s~ WEIGHTED<=8 / h
// Process: c d~ > ta+ ta- c b d~ b~ WEIGHTED<=8 / h
// Process: c s~ > ta+ ta- c d s~ d~ WEIGHTED<=8 / h
// Process: c s~ > ta+ ta- c b s~ b~ WEIGHTED<=8 / h
// Process: c b~ > ta+ ta- c d b~ d~ WEIGHTED<=8 / h
// Process: c b~ > ta+ ta- c s b~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_udx_taptamusdxsx_no_h(); 
        ...
        t[1] = matrix_udx_taptamusdxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_udx_taptamusdxsx_no_h() 
{
  int i, j; 
  // Local variables
