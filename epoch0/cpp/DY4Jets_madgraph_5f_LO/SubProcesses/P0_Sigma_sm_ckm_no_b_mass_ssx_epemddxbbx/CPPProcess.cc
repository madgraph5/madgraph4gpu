...
// Process: s s~ > e+ e- d d~ b b~ WEIGHTED<=8 / h
// Process: s s~ > mu+ mu- d d~ b b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ssx_epemddxbbx_no_h(); 
        ...
        t[1] = matrix_ssx_epemddxbbx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV2_3_2(w[7], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[20]);
  FFV1_2(w[0], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  ...
  FFV1_2(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[25]); 
  ...
  FFV1_2(w[0], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  ...
  FFV1_0(w[0], w[27], w[26], pars->GC_11, amp[21]); 
  FFV1_0(w[25], w[1], w[28], pars->GC_11, amp[22]); 
  FFV1_0(w[0], w[27], w[28], pars->GC_11, amp[23]); 
  ...
  FFV1_0(w[0], w[30], w[26], pars->GC_11, amp[29]); 
  FFV1_0(w[29], w[1], w[28], pars->GC_11, amp[30]); 
  FFV1_0(w[0], w[30], w[28], pars->GC_11, amp[31]); 
  ...
  FFV1_0(w[0], w[27], w[34], pars->GC_11, amp[37]); 
  ...
  FFV1_0(w[0], w[30], w[34], pars->GC_11, amp[45]); 
  ...
  FFV1_0(w[0], w[32], w[38], pars->GC_11, amp[81]); 
  ...
  FFV1_0(w[0], w[32], w[42], pars->GC_11, amp[86]); 
  FFV1_0(w[0], w[27], w[51], pars->GC_11, amp[87]); 
  FFV1_0(w[33], w[1], w[44], pars->GC_11, amp[88]); 
  FFV1_0(w[0], w[32], w[44], pars->GC_11, amp[89]); 
  FFV1_0(w[29], w[1], w[50], pars->GC_11, amp[90]); 
  FFV1_0(w[0], w[30], w[50], pars->GC_11, amp[91]); 
  FFV1_0(w[29], w[1], w[51], pars->GC_11, amp[92]); 
  FFV1_0(w[33], w[1], w[46], pars->GC_11, amp[93]); 
  FFV1_0(w[0], w[32], w[46], pars->GC_11, amp[94]); 
  FFV1_0(w[0], w[30], w[51], pars->GC_11, amp[95]); 

}
double CPPProcess::matrix_ssx_epemddxbbx_no_h() 
{
  int i, j; 
  // Local variables
