...
// Process: d s > ta+ ta- u d s u~ WEIGHTED<=8 / h
// Process: d s > ta+ ta- c d s c~ WEIGHTED<=8 / h
// Process: d b > ta+ ta- u d b u~ WEIGHTED<=8 / h
// Process: d b > ta+ ta- c d b c~ WEIGHTED<=8 / h
// Process: s b > ta+ ta- u s b u~ WEIGHTED<=8 / h
// Process: s b > ta+ ta- c s b c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ds_taptamudsux_no_h(); 
        ...
        t[1] = matrix_ds_taptamudsux_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ds_taptamudsux_no_h() 
{
  int i, j; 
  // Local variables
