...
// Process: g d~ > ta+ ta- g u u~ d~ WEIGHTED<=8 / h
// Process: g d~ > ta+ ta- g c c~ d~ WEIGHTED<=8 / h
// Process: g s~ > ta+ ta- g u u~ s~ WEIGHTED<=8 / h
// Process: g s~ > ta+ ta- g c c~ s~ WEIGHTED<=8 / h
// Process: g b~ > ta+ ta- g u u~ b~ WEIGHTED<=8 / h
// Process: g b~ > ta+ ta- g c c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gdx_taptamguuxdx_no_h(); 
        ...
        t[1] = matrix_gdx_taptamguuxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_gdx_taptamguuxdx_no_h() 
{
  int i, j; 
  // Local variables
