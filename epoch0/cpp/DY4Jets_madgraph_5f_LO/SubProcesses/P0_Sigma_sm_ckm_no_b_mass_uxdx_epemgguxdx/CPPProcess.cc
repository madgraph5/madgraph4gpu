...
// Process: u~ d~ > e+ e- g g u~ d~ WEIGHTED<=8 / h
// Process: u~ d~ > mu+ mu- g g u~ d~ WEIGHTED<=8 / h
// Process: u~ s~ > e+ e- g g u~ s~ WEIGHTED<=8 / h
// Process: u~ s~ > mu+ mu- g g u~ s~ WEIGHTED<=8 / h
// Process: u~ b~ > e+ e- g g u~ b~ WEIGHTED<=8 / h
// Process: u~ b~ > mu+ mu- g g u~ b~ WEIGHTED<=8 / h
// Process: c~ d~ > e+ e- g g c~ d~ WEIGHTED<=8 / h
// Process: c~ d~ > mu+ mu- g g c~ d~ WEIGHTED<=8 / h
// Process: c~ s~ > e+ e- g g c~ s~ WEIGHTED<=8 / h
// Process: c~ s~ > mu+ mu- g g c~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxdx_epemgguxdx_no_h(); 
        ...
        t[1] = matrix_uxdx_epemgguxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uxdx_epemgguxdx_no_h() 
{
  int i, j; 
  // Local variables
