...
#ifndef MG5_Sigma_sm_ckm_no_b_mass_gux_taptamgggux_H
#define MG5_Sigma_sm_ckm_no_b_mass_gux_taptamgggux_H
...
class CPPProcess
{
  public:
    ...
    virtual string name() const {return "g u~ > ta+ ta- g g g u~ (sm_ckm_no_b_mass)";}
  ...
  private:
    ...
    double matrix_gux_taptamgggux_no_h(); 
...
#endif  // MG5_Sigma_sm_ckm_no_b_mass_gux_taptamgggux_H
