...
// Process: s d~ > e+ e- g g s d~ WEIGHTED<=8 / h
// Process: s d~ > mu+ mu- g g s d~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_dsx_epemggdsx_no_h() 
{
  int i, j; 
  // Local variables
