...
// Process: u~ d~ > e+ e- c u~ c~ d~ WEIGHTED<=8 / h
// Process: u~ d~ > mu+ mu- c u~ c~ d~ WEIGHTED<=8 / h
// Process: u~ s~ > e+ e- c u~ c~ s~ WEIGHTED<=8 / h
// Process: u~ s~ > mu+ mu- c u~ c~ s~ WEIGHTED<=8 / h
// Process: u~ b~ > e+ e- c u~ c~ b~ WEIGHTED<=8 / h
// Process: u~ b~ > mu+ mu- c u~ c~ b~ WEIGHTED<=8 / h
// Process: c~ d~ > e+ e- u c~ u~ d~ WEIGHTED<=8 / h
// Process: c~ d~ > mu+ mu- u c~ u~ d~ WEIGHTED<=8 / h
// Process: c~ s~ > e+ e- u c~ u~ s~ WEIGHTED<=8 / h
// Process: c~ s~ > mu+ mu- u c~ u~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_uxdx_epemcuxcxdx_no_h(); 
        ...
        t[1] = matrix_uxdx_epemcuxcxdx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_uxdx_epemcuxcxdx_no_h() 
{
  int i, j; 
  // Local variables
