...
// Process: d d~ > e+ e- u s u~ s~ WEIGHTED<=8 / h
// Process: d d~ > e+ e- u b u~ b~ WEIGHTED<=8 / h
// Process: d d~ > e+ e- c s c~ s~ WEIGHTED<=8 / h
// Process: d d~ > e+ e- c b c~ b~ WEIGHTED<=8 / h
// Process: d d~ > mu+ mu- u s u~ s~ WEIGHTED<=8 / h
// Process: d d~ > mu+ mu- u b u~ b~ WEIGHTED<=8 / h
// Process: d d~ > mu+ mu- c s c~ s~ WEIGHTED<=8 / h
// Process: d d~ > mu+ mu- c b c~ b~ WEIGHTED<=8 / h
// Process: s s~ > e+ e- u b u~ b~ WEIGHTED<=8 / h
// Process: s s~ > e+ e- c b c~ b~ WEIGHTED<=8 / h
// Process: s s~ > mu+ mu- u b u~ b~ WEIGHTED<=8 / h
// Process: s s~ > mu+ mu- c b c~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ddx_epemusuxsx_no_h(); 
        ...
        t[1] = matrix_ddx_epemusuxsx_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ddx_epemusuxsx_no_h() 
{
  int i, j; 
  // Local variables
