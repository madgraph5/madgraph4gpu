...
// Process: d~ d~ > e+ e- u u~ d~ d~ WEIGHTED<=8 / h
// Process: d~ d~ > e+ e- c c~ d~ d~ WEIGHTED<=8 / h
// Process: d~ d~ > mu+ mu- u u~ d~ d~ WEIGHTED<=8 / h
// Process: d~ d~ > mu+ mu- c c~ d~ d~ WEIGHTED<=8 / h
// Process: s~ s~ > e+ e- u u~ s~ s~ WEIGHTED<=8 / h
// Process: s~ s~ > e+ e- c c~ s~ s~ WEIGHTED<=8 / h
// Process: s~ s~ > mu+ mu- u u~ s~ s~ WEIGHTED<=8 / h
// Process: s~ s~ > mu+ mu- c c~ s~ s~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_dxdx_epemuuxdxdx_no_h(); 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[6], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[9]); 
  ...
  FFV2_3_2(w[7], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[20]);
  FFV1P0_3(w[6], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  VVV1P0_1(w[8], w[21], pars->GC_10, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[23]); 
  FFV1_1(w[0], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  ...
  FFV1P0_3(w[28], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1P0_3(w[28], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  ...
  FFV1P0_3(w[16], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[36]); 
  FFV1P0_3(w[16], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV2_3_2(w[6], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[38]);
  FFV1P0_3(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_1(w[1], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  ...
  FFV1_1(w[0], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  ...
  FFV1_2(w[5], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[49]); 
  ...
  FFV1_0(w[13], w[0], w[22], pars->GC_11, amp[17]); 
  ...
  FFV1_0(w[20], w[0], w[22], pars->GC_11, amp[25]); 
  ...
  FFV1_0(w[13], w[1], w[30], pars->GC_11, amp[34]); 
  FFV1_0(w[13], w[0], w[29], pars->GC_11, amp[35]); 
  FFV1_0(w[31], w[1], w[32], pars->GC_11, amp[36]); 
  FFV1_0(w[7], w[12], w[33], pars->GC_11, amp[37]); 
  FFV1_0(w[6], w[12], w[32], pars->GC_11, amp[38]); 
  FFV1_0(w[13], w[1], w[33], pars->GC_11, amp[39]); 
  FFV1_0(w[31], w[0], w[34], pars->GC_11, amp[40]); 
  FFV1_0(w[7], w[23], w[35], pars->GC_11, amp[41]); 
  FFV1_0(w[6], w[23], w[34], pars->GC_11, amp[42]); 
  FFV1_0(w[13], w[0], w[35], pars->GC_11, amp[43]); 
  FFV1_0(w[31], w[1], w[36], pars->GC_11, amp[44]); 
  FFV1_0(w[31], w[0], w[37], pars->GC_11, amp[45]); 
  ...
  FFV1_0(w[20], w[1], w[30], pars->GC_11, amp[50]); 
  FFV1_0(w[20], w[0], w[29], pars->GC_11, amp[51]); 
  FFV1_0(w[38], w[1], w[32], pars->GC_11, amp[52]); 
  FFV1_0(w[7], w[19], w[33], pars->GC_11, amp[53]); 
  FFV1_0(w[6], w[19], w[32], pars->GC_11, amp[54]); 
  FFV1_0(w[20], w[1], w[33], pars->GC_11, amp[55]); 
  FFV1_0(w[38], w[0], w[34], pars->GC_11, amp[56]); 
  FFV1_0(w[7], w[27], w[35], pars->GC_11, amp[57]); 
  FFV1_0(w[6], w[27], w[34], pars->GC_11, amp[58]); 
  FFV1_0(w[20], w[0], w[35], pars->GC_11, amp[59]); 
  FFV1_0(w[38], w[1], w[36], pars->GC_11, amp[60]); 
  FFV1_0(w[38], w[0], w[37], pars->GC_11, amp[61]); 
  ...
  FFV1_0(w[31], w[1], w[41], pars->GC_11, amp[66]); 
  ...
  FFV1_0(w[38], w[1], w[41], pars->GC_11, amp[74]); 
  ...
  FFV1_0(w[31], w[0], w[46], pars->GC_11, amp[84]); 
  ...
  FFV1_0(w[38], w[0], w[46], pars->GC_11, amp[92]); 
  ...
  FFV1_0(w[13], w[1], w[48], pars->GC_11, amp[97]); 
  FFV1_0(w[7], w[17], w[50], pars->GC_11, amp[98]); 
  FFV1_0(w[15], w[1], w[50], pars->GC_11, amp[99]); 
  FFV1_0(w[7], w[12], w[52], pars->GC_11, amp[100]); 
  FFV1_0(w[13], w[1], w[52], pars->GC_11, amp[101]); 
  FFV1_0(w[7], w[17], w[54], pars->GC_11, amp[102]); 
  FFV1_0(w[15], w[1], w[54], pars->GC_11, amp[103]); 
  FFV1_0(w[7], w[19], w[48], pars->GC_11, amp[104]); 
  FFV1_0(w[20], w[1], w[48], pars->GC_11, amp[105]); 
  FFV1_0(w[7], w[17], w[56], pars->GC_11, amp[106]); 
  FFV1_0(w[15], w[1], w[56], pars->GC_11, amp[107]); 
  FFV1_0(w[7], w[19], w[52], pars->GC_11, amp[108]); 
  FFV1_0(w[20], w[1], w[52], pars->GC_11, amp[109]); 
  FFV1_0(w[7], w[17], w[58], pars->GC_11, amp[110]); 
  FFV1_0(w[15], w[1], w[58], pars->GC_11, amp[111]); 
  ...
  FFV1_0(w[13], w[0], w[63], pars->GC_11, amp[129]); 
  FFV1_0(w[7], w[26], w[50], pars->GC_11, amp[130]); 
  FFV1_0(w[25], w[0], w[50], pars->GC_11, amp[131]); 
  FFV1_0(w[7], w[23], w[65], pars->GC_11, amp[132]); 
  FFV1_0(w[13], w[0], w[65], pars->GC_11, amp[133]); 
  FFV1_0(w[7], w[26], w[54], pars->GC_11, amp[134]); 
  FFV1_0(w[25], w[0], w[54], pars->GC_11, amp[135]); 
  FFV1_0(w[7], w[27], w[63], pars->GC_11, amp[136]); 
  FFV1_0(w[20], w[0], w[63], pars->GC_11, amp[137]); 
  FFV1_0(w[7], w[26], w[56], pars->GC_11, amp[138]); 
  FFV1_0(w[25], w[0], w[56], pars->GC_11, amp[139]); 
  FFV1_0(w[7], w[27], w[65], pars->GC_11, amp[140]); 
  FFV1_0(w[20], w[0], w[65], pars->GC_11, amp[141]); 
  FFV1_0(w[7], w[26], w[58], pars->GC_11, amp[142]); 
  FFV1_0(w[25], w[0], w[58], pars->GC_11, amp[143]); 
  ...
  FFV1_0(w[42], w[1], w[50], pars->GC_11, amp[160]); 
  FFV1_0(w[6], w[40], w[50], pars->GC_11, amp[161]); 
  FFV1_0(w[31], w[1], w[69], pars->GC_11, amp[162]); 
  FFV1_0(w[6], w[12], w[69], pars->GC_11, amp[163]); 
  FFV1_0(w[31], w[1], w[70], pars->GC_11, amp[164]); 
  FFV1_0(w[42], w[1], w[54], pars->GC_11, amp[165]); 
  FFV1_0(w[6], w[40], w[54], pars->GC_11, amp[166]); 
  FFV1_0(w[6], w[12], w[70], pars->GC_11, amp[167]); 
  FFV1_0(w[42], w[1], w[56], pars->GC_11, amp[168]); 
  FFV1_0(w[6], w[40], w[56], pars->GC_11, amp[169]); 
  FFV1_0(w[38], w[1], w[69], pars->GC_11, amp[170]); 
  FFV1_0(w[6], w[19], w[69], pars->GC_11, amp[171]); 
  FFV1_0(w[38], w[1], w[70], pars->GC_11, amp[172]); 
  FFV1_0(w[42], w[1], w[58], pars->GC_11, amp[173]); 
  FFV1_0(w[6], w[40], w[58], pars->GC_11, amp[174]); 
  FFV1_0(w[6], w[19], w[70], pars->GC_11, amp[175]); 
  FFV1_0(w[45], w[0], w[50], pars->GC_11, amp[176]); 
  FFV1_0(w[6], w[44], w[50], pars->GC_11, amp[177]); 
  FFV1_0(w[31], w[0], w[71], pars->GC_11, amp[178]); 
  FFV1_0(w[6], w[23], w[71], pars->GC_11, amp[179]); 
  FFV1_0(w[31], w[0], w[72], pars->GC_11, amp[180]); 
  FFV1_0(w[45], w[0], w[54], pars->GC_11, amp[181]); 
  FFV1_0(w[6], w[44], w[54], pars->GC_11, amp[182]); 
  FFV1_0(w[6], w[23], w[72], pars->GC_11, amp[183]); 
  FFV1_0(w[45], w[0], w[56], pars->GC_11, amp[184]); 
  FFV1_0(w[6], w[44], w[56], pars->GC_11, amp[185]); 
  FFV1_0(w[38], w[0], w[71], pars->GC_11, amp[186]); 
  FFV1_0(w[6], w[27], w[71], pars->GC_11, amp[187]); 
  FFV1_0(w[38], w[0], w[72], pars->GC_11, amp[188]); 
  FFV1_0(w[45], w[0], w[58], pars->GC_11, amp[189]); 
  FFV1_0(w[6], w[44], w[58], pars->GC_11, amp[190]); 
  FFV1_0(w[6], w[27], w[72], pars->GC_11, amp[191]); 

}
double CPPProcess::matrix_dxdx_epemuuxdxdx_no_h() 
{
  int i, j; 
  // Local variables
