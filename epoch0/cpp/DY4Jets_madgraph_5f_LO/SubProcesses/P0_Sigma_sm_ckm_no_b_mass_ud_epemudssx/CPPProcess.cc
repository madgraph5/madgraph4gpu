...
// Process: u d > e+ e- u d s s~ WEIGHTED<=8 / h
// Process: u d > e+ e- u d b b~ WEIGHTED<=8 / h
// Process: u d > mu+ mu- u d s s~ WEIGHTED<=8 / h
// Process: u d > mu+ mu- u d b b~ WEIGHTED<=8 / h
// Process: u s > e+ e- u s d d~ WEIGHTED<=8 / h
// Process: u s > e+ e- u s b b~ WEIGHTED<=8 / h
// Process: u s > mu+ mu- u s d d~ WEIGHTED<=8 / h
// Process: u s > mu+ mu- u s b b~ WEIGHTED<=8 / h
...
// Process: c d > e+ e- c d s s~ WEIGHTED<=8 / h
// Process: c d > e+ e- c d b b~ WEIGHTED<=8 / h
// Process: c d > mu+ mu- c d s s~ WEIGHTED<=8 / h
// Process: c d > mu+ mu- c d b b~ WEIGHTED<=8 / h
// Process: c s > e+ e- c s d d~ WEIGHTED<=8 / h
// Process: c s > e+ e- c s b b~ WEIGHTED<=8 / h
// Process: c s > mu+ mu- c s d d~ WEIGHTED<=8 / h
// Process: c s > mu+ mu- c s b b~ WEIGHTED<=8 / h
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_0(w[1], w[32], w[38], pars->GC_11, amp[81]); 
  FFV1_0(w[25], w[5], w[50], pars->GC_11, amp[82]); 
  FFV1_0(w[1], w[27], w[50], pars->GC_11, amp[83]); 
  FFV1_0(w[25], w[5], w[51], pars->GC_11, amp[84]); 
  FFV1_0(w[33], w[5], w[42], pars->GC_11, amp[85]); 
  FFV1_0(w[1], w[32], w[42], pars->GC_11, amp[86]); 
  FFV1_0(w[1], w[27], w[51], pars->GC_11, amp[87]); 
  FFV1_0(w[33], w[5], w[44], pars->GC_11, amp[88]); 
  FFV1_0(w[1], w[32], w[44], pars->GC_11, amp[89]); 
  FFV1_0(w[29], w[5], w[50], pars->GC_11, amp[90]); 
  FFV1_0(w[1], w[30], w[50], pars->GC_11, amp[91]); 
  FFV1_0(w[29], w[5], w[51], pars->GC_11, amp[92]); 
  FFV1_0(w[33], w[5], w[46], pars->GC_11, amp[93]); 
  FFV1_0(w[1], w[32], w[46], pars->GC_11, amp[94]); 
  FFV1_0(w[1], w[30], w[51], pars->GC_11, amp[95]); 

}
double CPPProcess::matrix_ud_epemudssx_no_h() 
{
  int i, j; 
  // Local variables
