...
// Process: u u~ > e+ e- g g d d~ WEIGHTED<=8 / h
// Process: u u~ > e+ e- g g s s~ WEIGHTED<=8 / h
// Process: u u~ > e+ e- g g b b~ WEIGHTED<=8 / h
// Process: u u~ > mu+ mu- g g d d~ WEIGHTED<=8 / h
// Process: u u~ > mu+ mu- g g s s~ WEIGHTED<=8 / h
// Process: u u~ > mu+ mu- g g b b~ WEIGHTED<=8 / h
// Process: c c~ > e+ e- g g d d~ WEIGHTED<=8 / h
// Process: c c~ > e+ e- g g s s~ WEIGHTED<=8 / h
// Process: c c~ > e+ e- g g b b~ WEIGHTED<=8 / h
// Process: c c~ > mu+ mu- g g d d~ WEIGHTED<=8 / h
// Process: c c~ > mu+ mu- g g s s~ WEIGHTED<=8 / h
// Process: c c~ > mu+ mu- g g b b~ WEIGHTED<=8 / h
...
double CPPProcess::matrix_uux_epemggddx_no_h() 
{
  int i, j; 
  // Local variables
