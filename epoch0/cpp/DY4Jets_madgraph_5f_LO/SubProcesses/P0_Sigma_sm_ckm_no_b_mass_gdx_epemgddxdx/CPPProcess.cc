...
// Process: g d~ > e+ e- g d d~ d~ WEIGHTED<=8 / h
// Process: g d~ > mu+ mu- g d d~ d~ WEIGHTED<=8 / h
// Process: g s~ > e+ e- g s s~ s~ WEIGHTED<=8 / h
// Process: g s~ > mu+ mu- g s s~ s~ WEIGHTED<=8 / h
// Process: g b~ > e+ e- g b b~ b~ WEIGHTED<=8 / h
// Process: g b~ > mu+ mu- g b b~ b~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_gdx_epemgddxdx_no_h(); 
        ...
        t[1] = matrix_gdx_epemgddxdx_no_h(); 
        double tsum = 0; 
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1_1(w[1], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[10]); 
  FFV1_1(w[5], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[11]); 
  FFV1P0_3(w[6], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[12]); 
  FFV1P0_3(w[7], w[10], pars->GC_11, pars->ZERO, pars->ZERO, w[13]); 
  FFV1_2(w[6], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[14]); 
  FFV1_2(w[7], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[15]); 
  FFV1_1(w[5], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[16]); 
  FFV1_1(w[1], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[17]); 
  FFV1P0_3(w[6], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[18]); 
  FFV1P0_3(w[7], w[16], pars->GC_11, pars->ZERO, pars->ZERO, w[19]); 
  FFV1_2(w[6], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[20]); 
  FFV1P0_3(w[20], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  FFV1P0_3(w[20], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_2(w[7], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[23]); 
  FFV1P0_3(w[23], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[24]); 
  FFV1P0_3(w[23], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[25]); 
  FFV2_4_3(w[2], w[3], -pars->GC_51, pars->GC_59, pars->mdl_MZ, pars->mdl_WZ,
      w[26]);
  FFV2_3_1(w[5], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[27]);
  FFV2_3_2(w[6], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[28]);
  FFV2_3_2(w[7], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[29]);
  FFV2_3_1(w[1], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[30]);
  FFV1P0_3(w[6], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[31]); 
  VVV1P0_1(w[8], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[32]); 
  FFV1_2(w[7], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1_1(w[5], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1P0_3(w[7], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  VVV1P0_1(w[8], w[35], pars->GC_10, pars->ZERO, pars->ZERO, w[36]); 
  FFV1_2(w[6], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[37]); 
  FFV1_1(w[5], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[38]); 
  FFV1P0_3(w[6], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_2(w[7], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  VVV1P0_1(w[8], w[39], pars->GC_10, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_1(w[1], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1P0_3(w[7], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_2(w[6], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  VVV1P0_1(w[8], w[43], pars->GC_10, pars->ZERO, pars->ZERO, w[45]); 
  FFV1_1(w[1], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_1(w[1], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1_1(w[5], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_1(w[47], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[49]); 
  FFV1P0_3(w[6], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1P0_3(w[7], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1P0_3(w[6], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_1(w[48], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[53]); 
  FFV1P0_3(w[7], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  FFV2_3_1(w[47], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[55]);
  FFV2_3_1(w[48], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[56]);
  FFV1_2(w[6], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[57]); 
  FFV1P0_3(w[57], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV1P0_3(w[57], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  FFV1_2(w[57], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[60]); 
  FFV2_3_2(w[57], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[61]);
  FFV1_1(w[47], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  FFV1_2(w[7], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  FFV1P0_3(w[63], w[47], pars->GC_11, pars->ZERO, pars->ZERO, w[64]); 
  FFV1P0_3(w[63], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  FFV1_2(w[63], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[66]); 
  FFV2_3_2(w[63], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[67]);
  FFV1_1(w[47], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[68]); 
  FFV1_1(w[47], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[69]); 
  FFV1P0_3(w[6], w[69], pars->GC_11, pars->ZERO, pars->ZERO, w[70]); 
  FFV1P0_3(w[7], w[69], pars->GC_11, pars->ZERO, pars->ZERO, w[71]); 
  VVV1P0_1(w[52], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[72]); 
  FFV1_2(w[7], w[52], pars->GC_11, pars->ZERO, pars->ZERO, w[73]); 
  FFV1_1(w[5], w[52], pars->GC_11, pars->ZERO, pars->ZERO, w[74]); 
  VVV1P0_1(w[54], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[75]); 
  FFV1_2(w[6], w[54], pars->GC_11, pars->ZERO, pars->ZERO, w[76]); 
  FFV1_1(w[5], w[54], pars->GC_11, pars->ZERO, pars->ZERO, w[77]); 
  VVV1P0_1(w[4], w[39], pars->GC_10, pars->ZERO, pars->ZERO, w[78]); 
  VVV1P0_1(w[4], w[43], pars->GC_10, pars->ZERO, pars->ZERO, w[79]); 
  FFV1_1(w[5], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[80]); 
  FFV1_1(w[1], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[81]); 
  FFV1_1(w[80], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[82]); 
  FFV1P0_3(w[6], w[81], pars->GC_11, pars->ZERO, pars->ZERO, w[83]); 
  FFV1P0_3(w[7], w[81], pars->GC_11, pars->ZERO, pars->ZERO, w[84]); 
  FFV1P0_3(w[6], w[80], pars->GC_11, pars->ZERO, pars->ZERO, w[85]); 
  FFV1_1(w[81], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[86]); 
  FFV1P0_3(w[7], w[80], pars->GC_11, pars->ZERO, pars->ZERO, w[87]); 
  FFV2_3_1(w[80], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[88]);
  FFV2_3_1(w[81], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[89]);
  FFV1P0_3(w[57], w[80], pars->GC_11, pars->ZERO, pars->ZERO, w[90]); 
  FFV1P0_3(w[57], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[91]); 
  FFV1_1(w[80], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[92]); 
  FFV1P0_3(w[63], w[80], pars->GC_11, pars->ZERO, pars->ZERO, w[93]); 
  FFV1P0_3(w[63], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[94]); 
  FFV1_1(w[80], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[95]); 
  FFV1_1(w[80], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[96]); 
  FFV1P0_3(w[6], w[96], pars->GC_11, pars->ZERO, pars->ZERO, w[97]); 
  FFV1P0_3(w[7], w[96], pars->GC_11, pars->ZERO, pars->ZERO, w[98]); 
  VVV1P0_1(w[85], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[99]); 
  FFV1_2(w[7], w[85], pars->GC_11, pars->ZERO, pars->ZERO, w[100]); 
  FFV1_1(w[1], w[85], pars->GC_11, pars->ZERO, pars->ZERO, w[101]); 
  VVV1P0_1(w[87], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[102]); 
  FFV1_2(w[6], w[87], pars->GC_11, pars->ZERO, pars->ZERO, w[103]); 
  FFV1_1(w[1], w[87], pars->GC_11, pars->ZERO, pars->ZERO, w[104]); 
  VVV1P0_1(w[4], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[105]); 
  VVV1P0_1(w[4], w[35], pars->GC_10, pars->ZERO, pars->ZERO, w[106]); 
  FFV1_2(w[6], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[107]); 
  FFV1P0_3(w[107], w[81], pars->GC_11, pars->ZERO, pars->ZERO, w[108]); 
  FFV1_2(w[107], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[109]); 
  FFV1P0_3(w[107], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[110]); 
  FFV2_3_2(w[107], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[111]);
  FFV1_2(w[107], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[112]); 
  FFV1P0_3(w[107], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[113]); 
  FFV1P0_3(w[107], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[114]); 
  FFV1_2(w[107], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[115]); 
  FFV1_2(w[107], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[116]); 
  FFV1P0_3(w[116], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[117]); 
  FFV1P0_3(w[116], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[118]); 
  VVV1P0_1(w[114], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[119]); 
  FFV1_2(w[7], w[114], pars->GC_11, pars->ZERO, pars->ZERO, w[120]); 
  FFV1_1(w[5], w[114], pars->GC_11, pars->ZERO, pars->ZERO, w[121]); 
  VVV1P0_1(w[110], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[122]); 
  FFV1_2(w[7], w[110], pars->GC_11, pars->ZERO, pars->ZERO, w[123]); 
  FFV1_1(w[1], w[110], pars->GC_11, pars->ZERO, pars->ZERO, w[124]); 
  FFV1_2(w[7], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[125]); 
  FFV1P0_3(w[125], w[81], pars->GC_11, pars->ZERO, pars->ZERO, w[126]); 
  FFV1_2(w[125], w[9], pars->GC_1, pars->ZERO, pars->ZERO, w[127]); 
  FFV1P0_3(w[125], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[128]); 
  FFV2_3_2(w[125], w[26], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[129]);
  FFV1_2(w[125], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[130]); 
  FFV1P0_3(w[125], w[48], pars->GC_11, pars->ZERO, pars->ZERO, w[131]); 
  FFV1P0_3(w[125], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[132]); 
  FFV1_2(w[125], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[133]); 
  FFV1_2(w[125], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[134]); 
  FFV1P0_3(w[134], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[135]); 
  FFV1P0_3(w[134], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[136]); 
  VVV1P0_1(w[132], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[137]); 
  FFV1_2(w[6], w[132], pars->GC_11, pars->ZERO, pars->ZERO, w[138]); 
  FFV1_1(w[5], w[132], pars->GC_11, pars->ZERO, pars->ZERO, w[139]); 
  VVV1P0_1(w[128], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[140]); 
  FFV1_2(w[6], w[128], pars->GC_11, pars->ZERO, pars->ZERO, w[141]); 
  FFV1_1(w[1], w[128], pars->GC_11, pars->ZERO, pars->ZERO, w[142]); 
  FFV1_1(w[81], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[143]); 
  FFV1P0_3(w[6], w[143], pars->GC_11, pars->ZERO, pars->ZERO, w[144]); 
  FFV1P0_3(w[7], w[143], pars->GC_11, pars->ZERO, pars->ZERO, w[145]); 
  VVV1P0_1(w[0], w[83], pars->GC_10, pars->ZERO, pars->ZERO, w[146]); 
  FFV1_1(w[11], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[147]); 
  FFV1_2(w[15], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[148]); 
  VVV1P0_1(w[0], w[84], pars->GC_10, pars->ZERO, pars->ZERO, w[149]); 
  FFV1_2(w[14], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[150]); 
  FFV1_1(w[27], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[151]); 
  FFV1_2(w[29], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[152]); 
  FFV1_2(w[28], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[153]); 
  VVV1P0_1(w[0], w[39], pars->GC_10, pars->ZERO, pars->ZERO, w[154]); 
  FFV1_1(w[81], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[155]); 
  VVV1P0_1(w[0], w[43], pars->GC_10, pars->ZERO, pars->ZERO, w[156]); 
  FFV1_1(w[81], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[157]); 
  FFV1_1(w[48], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[158]); 
  FFV1P0_3(w[6], w[158], pars->GC_11, pars->ZERO, pars->ZERO, w[159]); 
  FFV1P0_3(w[7], w[158], pars->GC_11, pars->ZERO, pars->ZERO, w[160]); 
  VVV1P0_1(w[0], w[50], pars->GC_10, pars->ZERO, pars->ZERO, w[161]); 
  FFV1_1(w[17], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[162]); 
  VVV1P0_1(w[0], w[51], pars->GC_10, pars->ZERO, pars->ZERO, w[163]); 
  FFV1_1(w[30], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[164]); 
  VVV1P0_1(w[0], w[31], pars->GC_10, pars->ZERO, pars->ZERO, w[165]); 
  FFV1_1(w[48], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[166]); 
  VVV1P0_1(w[0], w[35], pars->GC_10, pars->ZERO, pars->ZERO, w[167]); 
  FFV1_1(w[48], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[168]); 
  FFV1_2(w[57], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[169]); 
  FFV1P0_3(w[169], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[170]); 
  FFV1P0_3(w[169], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[171]); 
  VVV1P0_1(w[0], w[91], pars->GC_10, pars->ZERO, pars->ZERO, w[172]); 
  VVV1P0_1(w[0], w[59], pars->GC_10, pars->ZERO, pars->ZERO, w[173]); 
  FFV1_2(w[57], w[35], pars->GC_11, pars->ZERO, pars->ZERO, w[174]); 
  FFV1_2(w[57], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[175]); 
  FFV1_2(w[63], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[176]); 
  FFV1P0_3(w[176], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[177]); 
  FFV1P0_3(w[176], w[1], pars->GC_11, pars->ZERO, pars->ZERO, w[178]); 
  VVV1P0_1(w[0], w[94], pars->GC_10, pars->ZERO, pars->ZERO, w[179]); 
  VVV1P0_1(w[0], w[65], pars->GC_10, pars->ZERO, pars->ZERO, w[180]); 
  FFV1_2(w[63], w[31], pars->GC_11, pars->ZERO, pars->ZERO, w[181]); 
  FFV1_2(w[63], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[182]); 
  VVV1P0_1(w[165], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[183]); 
  FFV1_2(w[7], w[165], pars->GC_11, pars->ZERO, pars->ZERO, w[184]); 
  FFV1_1(w[5], w[165], pars->GC_11, pars->ZERO, pars->ZERO, w[185]); 
  VVV1P0_1(w[0], w[105], pars->GC_10, pars->ZERO, pars->ZERO, w[186]); 
  FFV1_2(w[33], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[187]); 
  FFV1_1(w[34], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[188]); 
  VVVV1P0_1(w[0], w[4], w[31], pars->GC_12, pars->ZERO, pars->ZERO, w[189]); 
  VVVV3P0_1(w[0], w[4], w[31], pars->GC_12, pars->ZERO, pars->ZERO, w[190]); 
  VVVV4P0_1(w[0], w[4], w[31], pars->GC_12, pars->ZERO, pars->ZERO, w[191]); 
  VVV1P0_1(w[167], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[192]); 
  FFV1_2(w[6], w[167], pars->GC_11, pars->ZERO, pars->ZERO, w[193]); 
  FFV1_1(w[5], w[167], pars->GC_11, pars->ZERO, pars->ZERO, w[194]); 
  VVV1P0_1(w[0], w[106], pars->GC_10, pars->ZERO, pars->ZERO, w[195]); 
  FFV1_2(w[37], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[196]); 
  FFV1_1(w[38], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[197]); 
  VVVV1P0_1(w[0], w[4], w[35], pars->GC_12, pars->ZERO, pars->ZERO, w[198]); 
  VVVV3P0_1(w[0], w[4], w[35], pars->GC_12, pars->ZERO, pars->ZERO, w[199]); 
  VVVV4P0_1(w[0], w[4], w[35], pars->GC_12, pars->ZERO, pars->ZERO, w[200]); 
  VVV1P0_1(w[154], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[201]); 
  FFV1_2(w[7], w[154], pars->GC_11, pars->ZERO, pars->ZERO, w[202]); 
  FFV1_1(w[1], w[154], pars->GC_11, pars->ZERO, pars->ZERO, w[203]); 
  VVV1P0_1(w[0], w[78], pars->GC_10, pars->ZERO, pars->ZERO, w[204]); 
  FFV1_2(w[40], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[205]); 
  FFV1_1(w[42], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[206]); 
  VVVV1P0_1(w[0], w[4], w[39], pars->GC_12, pars->ZERO, pars->ZERO, w[207]); 
  VVVV3P0_1(w[0], w[4], w[39], pars->GC_12, pars->ZERO, pars->ZERO, w[208]); 
  VVVV4P0_1(w[0], w[4], w[39], pars->GC_12, pars->ZERO, pars->ZERO, w[209]); 
  VVV1P0_1(w[156], w[4], pars->GC_10, pars->ZERO, pars->ZERO, w[210]); 
  FFV1_2(w[6], w[156], pars->GC_11, pars->ZERO, pars->ZERO, w[211]); 
  FFV1_1(w[1], w[156], pars->GC_11, pars->ZERO, pars->ZERO, w[212]); 
  VVV1P0_1(w[0], w[79], pars->GC_10, pars->ZERO, pars->ZERO, w[213]); 
  FFV1_2(w[44], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[214]); 
  FFV1_1(w[46], w[0], pars->GC_11, pars->ZERO, pars->ZERO, w[215]); 
  VVVV1P0_1(w[0], w[4], w[43], pars->GC_12, pars->ZERO, pars->ZERO, w[216]); 
  VVVV3P0_1(w[0], w[4], w[43], pars->GC_12, pars->ZERO, pars->ZERO, w[217]); 
  VVVV4P0_1(w[0], w[4], w[43], pars->GC_12, pars->ZERO, pars->ZERO, w[218]); 

  // Calculate all amplitudes
  // Amplitude(s) for diagram number 0
  FFV1_0(w[7], w[11], w[12], pars->GC_11, amp[0]); 
  FFV1_0(w[6], w[11], w[13], pars->GC_11, amp[1]); 
  FFV1_0(w[14], w[5], w[13], pars->GC_11, amp[2]); 
  FFV1_0(w[15], w[5], w[12], pars->GC_11, amp[3]); 
  FFV1_0(w[7], w[17], w[18], pars->GC_11, amp[4]); 
  FFV1_0(w[6], w[17], w[19], pars->GC_11, amp[5]); 
  FFV1_0(w[14], w[1], w[19], pars->GC_11, amp[6]); 
  FFV1_0(w[15], w[1], w[18], pars->GC_11, amp[7]); 
  FFV1_0(w[7], w[17], w[21], pars->GC_11, amp[8]); 
  FFV1_0(w[7], w[11], w[22], pars->GC_11, amp[9]); 
  FFV1_0(w[15], w[5], w[22], pars->GC_11, amp[10]); 
  FFV1_0(w[15], w[1], w[21], pars->GC_11, amp[11]); 
  FFV1_0(w[6], w[17], w[24], pars->GC_11, amp[12]); 
  FFV1_0(w[6], w[11], w[25], pars->GC_11, amp[13]); 
  FFV1_0(w[14], w[5], w[25], pars->GC_11, amp[14]); 
  FFV1_0(w[14], w[1], w[24], pars->GC_11, amp[15]); 
  FFV1_0(w[7], w[27], w[12], pars->GC_11, amp[16]); 
  FFV1_0(w[6], w[27], w[13], pars->GC_11, amp[17]); 
  FFV1_0(w[28], w[5], w[13], pars->GC_11, amp[18]); 
  FFV1_0(w[29], w[5], w[12], pars->GC_11, amp[19]); 
  FFV1_0(w[7], w[30], w[18], pars->GC_11, amp[20]); 
  FFV1_0(w[6], w[30], w[19], pars->GC_11, amp[21]); 
  FFV1_0(w[28], w[1], w[19], pars->GC_11, amp[22]); 
  FFV1_0(w[29], w[1], w[18], pars->GC_11, amp[23]); 
  FFV1_0(w[7], w[30], w[21], pars->GC_11, amp[24]); 
  FFV1_0(w[7], w[27], w[22], pars->GC_11, amp[25]); 
  FFV1_0(w[29], w[5], w[22], pars->GC_11, amp[26]); 
  FFV1_0(w[29], w[1], w[21], pars->GC_11, amp[27]); 
  FFV1_0(w[6], w[30], w[24], pars->GC_11, amp[28]); 
  FFV1_0(w[6], w[27], w[25], pars->GC_11, amp[29]); 
  FFV1_0(w[28], w[5], w[25], pars->GC_11, amp[30]); 
  FFV1_0(w[28], w[1], w[24], pars->GC_11, amp[31]); 
  FFV1_0(w[7], w[11], w[32], pars->GC_11, amp[32]); 
  FFV1_0(w[15], w[5], w[32], pars->GC_11, amp[33]); 
  FFV1_0(w[15], w[16], w[31], pars->GC_11, amp[34]); 
  FFV1_0(w[33], w[16], w[9], pars->GC_1, amp[35]); 
  FFV1_0(w[23], w[11], w[31], pars->GC_11, amp[36]); 
  FFV1_0(w[23], w[34], w[9], pars->GC_1, amp[37]); 
  FFV1_0(w[33], w[11], w[8], pars->GC_11, amp[38]); 
  FFV1_0(w[15], w[34], w[8], pars->GC_11, amp[39]); 
  FFV1_0(w[7], w[27], w[32], pars->GC_11, amp[40]); 
  FFV1_0(w[29], w[5], w[32], pars->GC_11, amp[41]); 
  FFV1_0(w[29], w[16], w[31], pars->GC_11, amp[42]); 
  FFV2_3_0(w[33], w[16], w[26], -pars->GC_51, pars->GC_58, amp[43]); 
  FFV1_0(w[23], w[27], w[31], pars->GC_11, amp[44]); 
  FFV2_3_0(w[23], w[34], w[26], -pars->GC_51, pars->GC_58, amp[45]); 
  FFV1_0(w[33], w[27], w[8], pars->GC_11, amp[46]); 
  FFV1_0(w[29], w[34], w[8], pars->GC_11, amp[47]); 
  FFV1_0(w[6], w[11], w[36], pars->GC_11, amp[48]); 
  FFV1_0(w[14], w[5], w[36], pars->GC_11, amp[49]); 
  FFV1_0(w[14], w[16], w[35], pars->GC_11, amp[50]); 
  FFV1_0(w[37], w[16], w[9], pars->GC_1, amp[51]); 
  FFV1_0(w[20], w[11], w[35], pars->GC_11, amp[52]); 
  FFV1_0(w[20], w[38], w[9], pars->GC_1, amp[53]); 
  FFV1_0(w[37], w[11], w[8], pars->GC_11, amp[54]); 
  FFV1_0(w[14], w[38], w[8], pars->GC_11, amp[55]); 
  FFV1_0(w[6], w[27], w[36], pars->GC_11, amp[56]); 
  FFV1_0(w[28], w[5], w[36], pars->GC_11, amp[57]); 
  FFV1_0(w[28], w[16], w[35], pars->GC_11, amp[58]); 
  FFV2_3_0(w[37], w[16], w[26], -pars->GC_51, pars->GC_58, amp[59]); 
  FFV1_0(w[20], w[27], w[35], pars->GC_11, amp[60]); 
  FFV2_3_0(w[20], w[38], w[26], -pars->GC_51, pars->GC_58, amp[61]); 
  FFV1_0(w[37], w[27], w[8], pars->GC_11, amp[62]); 
  FFV1_0(w[28], w[38], w[8], pars->GC_11, amp[63]); 
  FFV1_0(w[15], w[10], w[39], pars->GC_11, amp[64]); 
  FFV1_0(w[40], w[10], w[9], pars->GC_1, amp[65]); 
  FFV1_0(w[7], w[17], w[41], pars->GC_11, amp[66]); 
  FFV1_0(w[15], w[1], w[41], pars->GC_11, amp[67]); 
  FFV1_0(w[23], w[17], w[39], pars->GC_11, amp[68]); 
  FFV1_0(w[23], w[42], w[9], pars->GC_1, amp[69]); 
  FFV1_0(w[40], w[17], w[8], pars->GC_11, amp[70]); 
  FFV1_0(w[15], w[42], w[8], pars->GC_11, amp[71]); 
  FFV1_0(w[29], w[10], w[39], pars->GC_11, amp[72]); 
  FFV2_3_0(w[40], w[10], w[26], -pars->GC_51, pars->GC_58, amp[73]); 
  FFV1_0(w[7], w[30], w[41], pars->GC_11, amp[74]); 
  FFV1_0(w[29], w[1], w[41], pars->GC_11, amp[75]); 
  FFV1_0(w[23], w[30], w[39], pars->GC_11, amp[76]); 
  FFV2_3_0(w[23], w[42], w[26], -pars->GC_51, pars->GC_58, amp[77]); 
  FFV1_0(w[40], w[30], w[8], pars->GC_11, amp[78]); 
  FFV1_0(w[29], w[42], w[8], pars->GC_11, amp[79]); 
  FFV1_0(w[14], w[10], w[43], pars->GC_11, amp[80]); 
  FFV1_0(w[44], w[10], w[9], pars->GC_1, amp[81]); 
  FFV1_0(w[6], w[17], w[45], pars->GC_11, amp[82]); 
  FFV1_0(w[14], w[1], w[45], pars->GC_11, amp[83]); 
  FFV1_0(w[20], w[17], w[43], pars->GC_11, amp[84]); 
  FFV1_0(w[20], w[46], w[9], pars->GC_1, amp[85]); 
  FFV1_0(w[44], w[17], w[8], pars->GC_11, amp[86]); 
  FFV1_0(w[14], w[46], w[8], pars->GC_11, amp[87]); 
  FFV1_0(w[28], w[10], w[43], pars->GC_11, amp[88]); 
  FFV2_3_0(w[44], w[10], w[26], -pars->GC_51, pars->GC_58, amp[89]); 
  FFV1_0(w[6], w[30], w[45], pars->GC_11, amp[90]); 
  FFV1_0(w[28], w[1], w[45], pars->GC_11, amp[91]); 
  FFV1_0(w[20], w[30], w[43], pars->GC_11, amp[92]); 
  FFV2_3_0(w[20], w[46], w[26], -pars->GC_51, pars->GC_58, amp[93]); 
  FFV1_0(w[44], w[30], w[8], pars->GC_11, amp[94]); 
  FFV1_0(w[28], w[46], w[8], pars->GC_11, amp[95]); 
  FFV1_0(w[7], w[49], w[50], pars->GC_11, amp[96]); 
  FFV1_0(w[6], w[49], w[51], pars->GC_11, amp[97]); 
  FFV1_0(w[7], w[53], w[52], pars->GC_11, amp[98]); 
  FFV1_0(w[15], w[48], w[52], pars->GC_11, amp[99]); 
  FFV1_0(w[6], w[53], w[54], pars->GC_11, amp[100]); 
  FFV1_0(w[14], w[48], w[54], pars->GC_11, amp[101]); 
  FFV1_0(w[15], w[47], w[50], pars->GC_11, amp[102]); 
  FFV1_0(w[14], w[47], w[51], pars->GC_11, amp[103]); 
  FFV1_0(w[7], w[55], w[50], pars->GC_11, amp[104]); 
  FFV1_0(w[6], w[55], w[51], pars->GC_11, amp[105]); 
  FFV1_0(w[7], w[56], w[52], pars->GC_11, amp[106]); 
  FFV1_0(w[29], w[48], w[52], pars->GC_11, amp[107]); 
  FFV1_0(w[6], w[56], w[54], pars->GC_11, amp[108]); 
  FFV1_0(w[28], w[48], w[54], pars->GC_11, amp[109]); 
  FFV1_0(w[29], w[47], w[50], pars->GC_11, amp[110]); 
  FFV1_0(w[28], w[47], w[51], pars->GC_11, amp[111]); 
  FFV1_0(w[7], w[11], w[58], pars->GC_11, amp[112]); 
  FFV1_0(w[15], w[5], w[58], pars->GC_11, amp[113]); 
  FFV1_0(w[7], w[49], w[59], pars->GC_11, amp[114]); 
  FFV1_0(w[60], w[5], w[54], pars->GC_11, amp[115]); 
  FFV1_0(w[57], w[11], w[54], pars->GC_11, amp[116]); 
  FFV1_0(w[15], w[47], w[59], pars->GC_11, amp[117]); 
  FFV1_0(w[7], w[27], w[58], pars->GC_11, amp[118]); 
  FFV1_0(w[29], w[5], w[58], pars->GC_11, amp[119]); 
  FFV1_0(w[7], w[55], w[59], pars->GC_11, amp[120]); 
  FFV1_0(w[61], w[5], w[54], pars->GC_11, amp[121]); 
  FFV1_0(w[57], w[27], w[54], pars->GC_11, amp[122]); 
  FFV1_0(w[29], w[47], w[59], pars->GC_11, amp[123]); 
  FFV1_0(w[57], w[49], w[43], pars->GC_11, amp[124]); 
  FFV1_0(w[57], w[62], w[9], pars->GC_1, amp[125]); 
  FFV1_0(w[57], w[55], w[43], pars->GC_11, amp[126]); 
  FFV2_3_0(w[57], w[62], w[26], -pars->GC_51, pars->GC_58, amp[127]); 
  FFV1_0(w[6], w[11], w[64], pars->GC_11, amp[128]); 
  FFV1_0(w[14], w[5], w[64], pars->GC_11, amp[129]); 
  FFV1_0(w[6], w[49], w[65], pars->GC_11, amp[130]); 
  FFV1_0(w[66], w[5], w[52], pars->GC_11, amp[131]); 
  FFV1_0(w[63], w[11], w[52], pars->GC_11, amp[132]); 
  FFV1_0(w[14], w[47], w[65], pars->GC_11, amp[133]); 
  FFV1_0(w[6], w[27], w[64], pars->GC_11, amp[134]); 
  FFV1_0(w[28], w[5], w[64], pars->GC_11, amp[135]); 
  FFV1_0(w[6], w[55], w[65], pars->GC_11, amp[136]); 
  FFV1_0(w[67], w[5], w[52], pars->GC_11, amp[137]); 
  FFV1_0(w[63], w[27], w[52], pars->GC_11, amp[138]); 
  FFV1_0(w[28], w[47], w[65], pars->GC_11, amp[139]); 
  FFV1_0(w[63], w[49], w[39], pars->GC_11, amp[140]); 
  FFV1_0(w[63], w[68], w[9], pars->GC_1, amp[141]); 
  FFV1_0(w[63], w[55], w[39], pars->GC_11, amp[142]); 
  FFV2_3_0(w[63], w[68], w[26], -pars->GC_51, pars->GC_58, amp[143]); 
  FFV1_0(w[7], w[11], w[70], pars->GC_11, amp[144]); 
  FFV1_0(w[6], w[11], w[71], pars->GC_11, amp[145]); 
  FFV1_0(w[14], w[5], w[71], pars->GC_11, amp[146]); 
  FFV1_0(w[15], w[5], w[70], pars->GC_11, amp[147]); 
  FFV1_0(w[7], w[11], w[72], pars->GC_11, amp[148]); 
  FFV1_0(w[73], w[11], w[4], pars->GC_11, amp[149]); 
  FFV1_0(w[15], w[5], w[72], pars->GC_11, amp[150]); 
  FFV1_0(w[15], w[74], w[4], pars->GC_11, amp[151]); 
  FFV1_0(w[6], w[11], w[75], pars->GC_11, amp[152]); 
  FFV1_0(w[76], w[11], w[4], pars->GC_11, amp[153]); 
  FFV1_0(w[14], w[5], w[75], pars->GC_11, amp[154]); 
  FFV1_0(w[14], w[77], w[4], pars->GC_11, amp[155]); 
  FFV1_0(w[7], w[27], w[70], pars->GC_11, amp[156]); 
  FFV1_0(w[6], w[27], w[71], pars->GC_11, amp[157]); 
  FFV1_0(w[28], w[5], w[71], pars->GC_11, amp[158]); 
  FFV1_0(w[29], w[5], w[70], pars->GC_11, amp[159]); 
  FFV1_0(w[7], w[27], w[72], pars->GC_11, amp[160]); 
  FFV1_0(w[73], w[27], w[4], pars->GC_11, amp[161]); 
  FFV1_0(w[29], w[5], w[72], pars->GC_11, amp[162]); 
  FFV1_0(w[29], w[74], w[4], pars->GC_11, amp[163]); 
  FFV1_0(w[6], w[27], w[75], pars->GC_11, amp[164]); 
  FFV1_0(w[76], w[27], w[4], pars->GC_11, amp[165]); 
  FFV1_0(w[28], w[5], w[75], pars->GC_11, amp[166]); 
  FFV1_0(w[28], w[77], w[4], pars->GC_11, amp[167]); 
  FFV1_0(w[15], w[69], w[39], pars->GC_11, amp[168]); 
  FFV1_0(w[40], w[69], w[9], pars->GC_1, amp[169]); 
  FFV1_0(w[7], w[49], w[78], pars->GC_11, amp[170]); 
  FFV1_0(w[40], w[49], w[4], pars->GC_11, amp[171]); 
  FFV1_0(w[15], w[68], w[4], pars->GC_11, amp[172]); 
  FFV1_0(w[15], w[47], w[78], pars->GC_11, amp[173]); 
  FFV1_0(w[29], w[69], w[39], pars->GC_11, amp[174]); 
  FFV2_3_0(w[40], w[69], w[26], -pars->GC_51, pars->GC_58, amp[175]); 
  FFV1_0(w[7], w[55], w[78], pars->GC_11, amp[176]); 
  FFV1_0(w[40], w[55], w[4], pars->GC_11, amp[177]); 
  FFV1_0(w[29], w[68], w[4], pars->GC_11, amp[178]); 
  FFV1_0(w[29], w[47], w[78], pars->GC_11, amp[179]); 
  FFV1_0(w[14], w[69], w[43], pars->GC_11, amp[180]); 
  FFV1_0(w[44], w[69], w[9], pars->GC_1, amp[181]); 
  FFV1_0(w[6], w[49], w[79], pars->GC_11, amp[182]); 
  FFV1_0(w[44], w[49], w[4], pars->GC_11, amp[183]); 
  FFV1_0(w[14], w[62], w[4], pars->GC_11, amp[184]); 
  FFV1_0(w[14], w[47], w[79], pars->GC_11, amp[185]); 
  FFV1_0(w[28], w[69], w[43], pars->GC_11, amp[186]); 
  FFV2_3_0(w[44], w[69], w[26], -pars->GC_51, pars->GC_58, amp[187]); 
  FFV1_0(w[6], w[55], w[79], pars->GC_11, amp[188]); 
  FFV1_0(w[44], w[55], w[4], pars->GC_11, amp[189]); 
  FFV1_0(w[28], w[62], w[4], pars->GC_11, amp[190]); 
  FFV1_0(w[28], w[47], w[79], pars->GC_11, amp[191]); 
  FFV1_0(w[7], w[82], w[83], pars->GC_11, amp[192]); 
  FFV1_0(w[6], w[82], w[84], pars->GC_11, amp[193]); 
  FFV1_0(w[7], w[86], w[85], pars->GC_11, amp[194]); 
  FFV1_0(w[15], w[81], w[85], pars->GC_11, amp[195]); 
  FFV1_0(w[6], w[86], w[87], pars->GC_11, amp[196]); 
  FFV1_0(w[14], w[81], w[87], pars->GC_11, amp[197]); 
  FFV1_0(w[15], w[80], w[83], pars->GC_11, amp[198]); 
  FFV1_0(w[14], w[80], w[84], pars->GC_11, amp[199]); 
  FFV1_0(w[7], w[88], w[83], pars->GC_11, amp[200]); 
  FFV1_0(w[6], w[88], w[84], pars->GC_11, amp[201]); 
  FFV1_0(w[7], w[89], w[85], pars->GC_11, amp[202]); 
  FFV1_0(w[29], w[81], w[85], pars->GC_11, amp[203]); 
  FFV1_0(w[6], w[89], w[87], pars->GC_11, amp[204]); 
  FFV1_0(w[28], w[81], w[87], pars->GC_11, amp[205]); 
  FFV1_0(w[29], w[80], w[83], pars->GC_11, amp[206]); 
  FFV1_0(w[28], w[80], w[84], pars->GC_11, amp[207]); 
  FFV1_0(w[7], w[17], w[90], pars->GC_11, amp[208]); 
  FFV1_0(w[15], w[1], w[90], pars->GC_11, amp[209]); 
  FFV1_0(w[7], w[82], w[91], pars->GC_11, amp[210]); 
  FFV1_0(w[60], w[1], w[87], pars->GC_11, amp[211]); 
  FFV1_0(w[57], w[17], w[87], pars->GC_11, amp[212]); 
  FFV1_0(w[15], w[80], w[91], pars->GC_11, amp[213]); 
  FFV1_0(w[7], w[30], w[90], pars->GC_11, amp[214]); 
  FFV1_0(w[29], w[1], w[90], pars->GC_11, amp[215]); 
  FFV1_0(w[7], w[88], w[91], pars->GC_11, amp[216]); 
  FFV1_0(w[61], w[1], w[87], pars->GC_11, amp[217]); 
  FFV1_0(w[57], w[30], w[87], pars->GC_11, amp[218]); 
  FFV1_0(w[29], w[80], w[91], pars->GC_11, amp[219]); 
  FFV1_0(w[57], w[82], w[35], pars->GC_11, amp[220]); 
  FFV1_0(w[57], w[92], w[9], pars->GC_1, amp[221]); 
  FFV1_0(w[57], w[88], w[35], pars->GC_11, amp[222]); 
  FFV2_3_0(w[57], w[92], w[26], -pars->GC_51, pars->GC_58, amp[223]); 
  FFV1_0(w[6], w[17], w[93], pars->GC_11, amp[224]); 
  FFV1_0(w[14], w[1], w[93], pars->GC_11, amp[225]); 
  FFV1_0(w[6], w[82], w[94], pars->GC_11, amp[226]); 
  FFV1_0(w[66], w[1], w[85], pars->GC_11, amp[227]); 
  FFV1_0(w[63], w[17], w[85], pars->GC_11, amp[228]); 
  FFV1_0(w[14], w[80], w[94], pars->GC_11, amp[229]); 
  FFV1_0(w[6], w[30], w[93], pars->GC_11, amp[230]); 
  FFV1_0(w[28], w[1], w[93], pars->GC_11, amp[231]); 
  FFV1_0(w[6], w[88], w[94], pars->GC_11, amp[232]); 
  FFV1_0(w[67], w[1], w[85], pars->GC_11, amp[233]); 
  FFV1_0(w[63], w[30], w[85], pars->GC_11, amp[234]); 
  FFV1_0(w[28], w[80], w[94], pars->GC_11, amp[235]); 
  FFV1_0(w[63], w[82], w[31], pars->GC_11, amp[236]); 
  FFV1_0(w[63], w[95], w[9], pars->GC_1, amp[237]); 
  FFV1_0(w[63], w[88], w[31], pars->GC_11, amp[238]); 
  FFV2_3_0(w[63], w[95], w[26], -pars->GC_51, pars->GC_58, amp[239]); 
  FFV1_0(w[7], w[17], w[97], pars->GC_11, amp[240]); 
  FFV1_0(w[6], w[17], w[98], pars->GC_11, amp[241]); 
  FFV1_0(w[14], w[1], w[98], pars->GC_11, amp[242]); 
  FFV1_0(w[15], w[1], w[97], pars->GC_11, amp[243]); 
  FFV1_0(w[7], w[17], w[99], pars->GC_11, amp[244]); 
  FFV1_0(w[100], w[17], w[4], pars->GC_11, amp[245]); 
  FFV1_0(w[15], w[1], w[99], pars->GC_11, amp[246]); 
  FFV1_0(w[15], w[101], w[4], pars->GC_11, amp[247]); 
  FFV1_0(w[6], w[17], w[102], pars->GC_11, amp[248]); 
  FFV1_0(w[103], w[17], w[4], pars->GC_11, amp[249]); 
  FFV1_0(w[14], w[1], w[102], pars->GC_11, amp[250]); 
  FFV1_0(w[14], w[104], w[4], pars->GC_11, amp[251]); 
  FFV1_0(w[7], w[30], w[97], pars->GC_11, amp[252]); 
  FFV1_0(w[6], w[30], w[98], pars->GC_11, amp[253]); 
  FFV1_0(w[28], w[1], w[98], pars->GC_11, amp[254]); 
  FFV1_0(w[29], w[1], w[97], pars->GC_11, amp[255]); 
  FFV1_0(w[7], w[30], w[99], pars->GC_11, amp[256]); 
  FFV1_0(w[100], w[30], w[4], pars->GC_11, amp[257]); 
  FFV1_0(w[29], w[1], w[99], pars->GC_11, amp[258]); 
  FFV1_0(w[29], w[101], w[4], pars->GC_11, amp[259]); 
  FFV1_0(w[6], w[30], w[102], pars->GC_11, amp[260]); 
  FFV1_0(w[103], w[30], w[4], pars->GC_11, amp[261]); 
  FFV1_0(w[28], w[1], w[102], pars->GC_11, amp[262]); 
  FFV1_0(w[28], w[104], w[4], pars->GC_11, amp[263]); 
  FFV1_0(w[15], w[96], w[31], pars->GC_11, amp[264]); 
  FFV1_0(w[33], w[96], w[9], pars->GC_1, amp[265]); 
  FFV1_0(w[7], w[82], w[105], pars->GC_11, amp[266]); 
  FFV1_0(w[33], w[82], w[4], pars->GC_11, amp[267]); 
  FFV1_0(w[15], w[95], w[4], pars->GC_11, amp[268]); 
  FFV1_0(w[15], w[80], w[105], pars->GC_11, amp[269]); 
  FFV1_0(w[29], w[96], w[31], pars->GC_11, amp[270]); 
  FFV2_3_0(w[33], w[96], w[26], -pars->GC_51, pars->GC_58, amp[271]); 
  FFV1_0(w[7], w[88], w[105], pars->GC_11, amp[272]); 
  FFV1_0(w[33], w[88], w[4], pars->GC_11, amp[273]); 
  FFV1_0(w[29], w[95], w[4], pars->GC_11, amp[274]); 
  FFV1_0(w[29], w[80], w[105], pars->GC_11, amp[275]); 
  FFV1_0(w[14], w[96], w[35], pars->GC_11, amp[276]); 
  FFV1_0(w[37], w[96], w[9], pars->GC_1, amp[277]); 
  FFV1_0(w[6], w[82], w[106], pars->GC_11, amp[278]); 
  FFV1_0(w[37], w[82], w[4], pars->GC_11, amp[279]); 
  FFV1_0(w[14], w[92], w[4], pars->GC_11, amp[280]); 
  FFV1_0(w[14], w[80], w[106], pars->GC_11, amp[281]); 
  FFV1_0(w[28], w[96], w[35], pars->GC_11, amp[282]); 
  FFV2_3_0(w[37], w[96], w[26], -pars->GC_51, pars->GC_58, amp[283]); 
  FFV1_0(w[6], w[88], w[106], pars->GC_11, amp[284]); 
  FFV1_0(w[37], w[88], w[4], pars->GC_11, amp[285]); 
  FFV1_0(w[28], w[92], w[4], pars->GC_11, amp[286]); 
  FFV1_0(w[28], w[80], w[106], pars->GC_11, amp[287]); 
  FFV1_0(w[7], w[11], w[108], pars->GC_11, amp[288]); 
  FFV1_0(w[15], w[5], w[108], pars->GC_11, amp[289]); 
  FFV1_0(w[109], w[5], w[84], pars->GC_11, amp[290]); 
  FFV1_0(w[7], w[86], w[110], pars->GC_11, amp[291]); 
  FFV1_0(w[15], w[81], w[110], pars->GC_11, amp[292]); 
  FFV1_0(w[107], w[11], w[84], pars->GC_11, amp[293]); 
  FFV1_0(w[7], w[27], w[108], pars->GC_11, amp[294]); 
  FFV1_0(w[29], w[5], w[108], pars->GC_11, amp[295]); 
  FFV1_0(w[111], w[5], w[84], pars->GC_11, amp[296]); 
  FFV1_0(w[7], w[89], w[110], pars->GC_11, amp[297]); 
  ...
  FFV1_0(w[112], w[81], w[9], pars->GC_1, amp[301]); 
  FFV1_0(w[111], w[81], w[43], pars->GC_11, amp[302]); 
  FFV2_3_0(w[112], w[81], w[26], -pars->GC_51, pars->GC_58, amp[303]); 
  FFV1_0(w[7], w[17], w[113], pars->GC_11, amp[304]); 
  FFV1_0(w[15], w[1], w[113], pars->GC_11, amp[305]); 
  FFV1_0(w[109], w[1], w[51], pars->GC_11, amp[306]); 
  FFV1_0(w[7], w[53], w[114], pars->GC_11, amp[307]); 
  FFV1_0(w[15], w[48], w[114], pars->GC_11, amp[308]); 
  FFV1_0(w[107], w[17], w[51], pars->GC_11, amp[309]); 
  FFV1_0(w[7], w[30], w[113], pars->GC_11, amp[310]); 
  FFV1_0(w[29], w[1], w[113], pars->GC_11, amp[311]); 
  FFV1_0(w[111], w[1], w[51], pars->GC_11, amp[312]); 
  FFV1_0(w[7], w[56], w[114], pars->GC_11, amp[313]); 
  ...
  FFV1_0(w[115], w[48], w[9], pars->GC_1, amp[317]); 
  FFV1_0(w[111], w[48], w[35], pars->GC_11, amp[318]); 
  FFV2_3_0(w[115], w[48], w[26], -pars->GC_51, pars->GC_58, amp[319]); 
  FFV1_0(w[109], w[5], w[94], pars->GC_11, amp[320]); 
  FFV1_0(w[109], w[1], w[65], pars->GC_11, amp[321]); 
  FFV1_0(w[66], w[5], w[114], pars->GC_11, amp[322]); 
  FFV1_0(w[63], w[11], w[114], pars->GC_11, amp[323]); 
  FFV1_0(w[66], w[1], w[110], pars->GC_11, amp[324]); 
  ...
  FFV1_0(w[111], w[5], w[94], pars->GC_11, amp[328]); 
  FFV1_0(w[111], w[1], w[65], pars->GC_11, amp[329]); 
  FFV1_0(w[67], w[5], w[114], pars->GC_11, amp[330]); 
  FFV1_0(w[63], w[27], w[114], pars->GC_11, amp[331]); 
  FFV1_0(w[67], w[1], w[110], pars->GC_11, amp[332]); 
  ...
  FFV1_0(w[7], w[17], w[117], pars->GC_11, amp[336]); 
  FFV1_0(w[7], w[11], w[118], pars->GC_11, amp[337]); 
  FFV1_0(w[15], w[5], w[118], pars->GC_11, amp[338]); 
  FFV1_0(w[15], w[1], w[117], pars->GC_11, amp[339]); 
  FFV1_0(w[7], w[11], w[119], pars->GC_11, amp[340]); 
  FFV1_0(w[120], w[11], w[4], pars->GC_11, amp[341]); 
  FFV1_0(w[15], w[5], w[119], pars->GC_11, amp[342]); 
  FFV1_0(w[15], w[121], w[4], pars->GC_11, amp[343]); 
  FFV1_0(w[7], w[17], w[122], pars->GC_11, amp[344]); 
  FFV1_0(w[123], w[17], w[4], pars->GC_11, amp[345]); 
  FFV1_0(w[15], w[1], w[122], pars->GC_11, amp[346]); 
  FFV1_0(w[15], w[124], w[4], pars->GC_11, amp[347]); 
  FFV1_0(w[7], w[30], w[117], pars->GC_11, amp[348]); 
  FFV1_0(w[7], w[27], w[118], pars->GC_11, amp[349]); 
  FFV1_0(w[29], w[5], w[118], pars->GC_11, amp[350]); 
  FFV1_0(w[29], w[1], w[117], pars->GC_11, amp[351]); 
  FFV1_0(w[7], w[27], w[119], pars->GC_11, amp[352]); 
  FFV1_0(w[120], w[27], w[4], pars->GC_11, amp[353]); 
  FFV1_0(w[29], w[5], w[119], pars->GC_11, amp[354]); 
  FFV1_0(w[29], w[121], w[4], pars->GC_11, amp[355]); 
  FFV1_0(w[7], w[30], w[122], pars->GC_11, amp[356]); 
  FFV1_0(w[123], w[30], w[4], pars->GC_11, amp[357]); 
  FFV1_0(w[29], w[1], w[122], pars->GC_11, amp[358]); 
  FFV1_0(w[29], w[124], w[4], pars->GC_11, amp[359]); 
  FFV1_0(w[116], w[11], w[35], pars->GC_11, amp[360]); 
  FFV1_0(w[116], w[38], w[9], pars->GC_1, amp[361]); 
  FFV1_0(w[109], w[5], w[106], pars->GC_11, amp[362]); 
  FFV1_0(w[109], w[38], w[4], pars->GC_11, amp[363]); 
  FFV1_0(w[115], w[11], w[4], pars->GC_11, amp[364]); 
  FFV1_0(w[107], w[11], w[106], pars->GC_11, amp[365]); 
  FFV1_0(w[116], w[27], w[35], pars->GC_11, amp[366]); 
  FFV2_3_0(w[116], w[38], w[26], -pars->GC_51, pars->GC_58, amp[367]); 
  FFV1_0(w[111], w[5], w[106], pars->GC_11, amp[368]); 
  FFV1_0(w[111], w[38], w[4], pars->GC_11, amp[369]); 
  FFV1_0(w[115], w[27], w[4], pars->GC_11, amp[370]); 
  FFV1_0(w[107], w[27], w[106], pars->GC_11, amp[371]); 
  FFV1_0(w[116], w[17], w[43], pars->GC_11, amp[372]); 
  FFV1_0(w[116], w[46], w[9], pars->GC_1, amp[373]); 
  FFV1_0(w[109], w[1], w[79], pars->GC_11, amp[374]); 
  FFV1_0(w[109], w[46], w[4], pars->GC_11, amp[375]); 
  FFV1_0(w[112], w[17], w[4], pars->GC_11, amp[376]); 
  FFV1_0(w[107], w[17], w[79], pars->GC_11, amp[377]); 
  FFV1_0(w[116], w[30], w[43], pars->GC_11, amp[378]); 
  FFV2_3_0(w[116], w[46], w[26], -pars->GC_51, pars->GC_58, amp[379]); 
  FFV1_0(w[111], w[1], w[79], pars->GC_11, amp[380]); 
  FFV1_0(w[111], w[46], w[4], pars->GC_11, amp[381]); 
  FFV1_0(w[112], w[30], w[4], pars->GC_11, amp[382]); 
  FFV1_0(w[107], w[30], w[79], pars->GC_11, amp[383]); 
  FFV1_0(w[6], w[11], w[126], pars->GC_11, amp[384]); 
  FFV1_0(w[14], w[5], w[126], pars->GC_11, amp[385]); 
  FFV1_0(w[127], w[5], w[83], pars->GC_11, amp[386]); 
  FFV1_0(w[6], w[86], w[128], pars->GC_11, amp[387]); 
  FFV1_0(w[14], w[81], w[128], pars->GC_11, amp[388]); 
  FFV1_0(w[125], w[11], w[83], pars->GC_11, amp[389]); 
  FFV1_0(w[6], w[27], w[126], pars->GC_11, amp[390]); 
  FFV1_0(w[28], w[5], w[126], pars->GC_11, amp[391]); 
  FFV1_0(w[129], w[5], w[83], pars->GC_11, amp[392]); 
  FFV1_0(w[6], w[89], w[128], pars->GC_11, amp[393]); 
  ...
  FFV1_0(w[130], w[81], w[9], pars->GC_1, amp[397]); 
  FFV1_0(w[129], w[81], w[39], pars->GC_11, amp[398]); 
  FFV2_3_0(w[130], w[81], w[26], -pars->GC_51, pars->GC_58, amp[399]); 
  FFV1_0(w[6], w[17], w[131], pars->GC_11, amp[400]); 
  FFV1_0(w[14], w[1], w[131], pars->GC_11, amp[401]); 
  FFV1_0(w[127], w[1], w[50], pars->GC_11, amp[402]); 
  FFV1_0(w[6], w[53], w[132], pars->GC_11, amp[403]); 
  FFV1_0(w[14], w[48], w[132], pars->GC_11, amp[404]); 
  FFV1_0(w[125], w[17], w[50], pars->GC_11, amp[405]); 
  FFV1_0(w[6], w[30], w[131], pars->GC_11, amp[406]); 
  FFV1_0(w[28], w[1], w[131], pars->GC_11, amp[407]); 
  FFV1_0(w[129], w[1], w[50], pars->GC_11, amp[408]); 
  FFV1_0(w[6], w[56], w[132], pars->GC_11, amp[409]); 
  ...
  FFV1_0(w[133], w[48], w[9], pars->GC_1, amp[413]); 
  FFV1_0(w[129], w[48], w[31], pars->GC_11, amp[414]); 
  FFV2_3_0(w[133], w[48], w[26], -pars->GC_51, pars->GC_58, amp[415]); 
  FFV1_0(w[127], w[5], w[91], pars->GC_11, amp[416]); 
  FFV1_0(w[127], w[1], w[59], pars->GC_11, amp[417]); 
  FFV1_0(w[60], w[5], w[132], pars->GC_11, amp[418]); 
  FFV1_0(w[57], w[11], w[132], pars->GC_11, amp[419]); 
  FFV1_0(w[60], w[1], w[128], pars->GC_11, amp[420]); 
  ...
  FFV1_0(w[129], w[5], w[91], pars->GC_11, amp[424]); 
  FFV1_0(w[129], w[1], w[59], pars->GC_11, amp[425]); 
  FFV1_0(w[61], w[5], w[132], pars->GC_11, amp[426]); 
  FFV1_0(w[57], w[27], w[132], pars->GC_11, amp[427]); 
  FFV1_0(w[61], w[1], w[128], pars->GC_11, amp[428]); 
  ...
  FFV1_0(w[6], w[17], w[135], pars->GC_11, amp[432]); 
  FFV1_0(w[6], w[11], w[136], pars->GC_11, amp[433]); 
  FFV1_0(w[14], w[5], w[136], pars->GC_11, amp[434]); 
  FFV1_0(w[14], w[1], w[135], pars->GC_11, amp[435]); 
  FFV1_0(w[6], w[11], w[137], pars->GC_11, amp[436]); 
  FFV1_0(w[138], w[11], w[4], pars->GC_11, amp[437]); 
  FFV1_0(w[14], w[5], w[137], pars->GC_11, amp[438]); 
  FFV1_0(w[14], w[139], w[4], pars->GC_11, amp[439]); 
  FFV1_0(w[6], w[17], w[140], pars->GC_11, amp[440]); 
  FFV1_0(w[141], w[17], w[4], pars->GC_11, amp[441]); 
  FFV1_0(w[14], w[1], w[140], pars->GC_11, amp[442]); 
  FFV1_0(w[14], w[142], w[4], pars->GC_11, amp[443]); 
  FFV1_0(w[6], w[30], w[135], pars->GC_11, amp[444]); 
  FFV1_0(w[6], w[27], w[136], pars->GC_11, amp[445]); 
  FFV1_0(w[28], w[5], w[136], pars->GC_11, amp[446]); 
  FFV1_0(w[28], w[1], w[135], pars->GC_11, amp[447]); 
  FFV1_0(w[6], w[27], w[137], pars->GC_11, amp[448]); 
  FFV1_0(w[138], w[27], w[4], pars->GC_11, amp[449]); 
  FFV1_0(w[28], w[5], w[137], pars->GC_11, amp[450]); 
  FFV1_0(w[28], w[139], w[4], pars->GC_11, amp[451]); 
  FFV1_0(w[6], w[30], w[140], pars->GC_11, amp[452]); 
  FFV1_0(w[141], w[30], w[4], pars->GC_11, amp[453]); 
  FFV1_0(w[28], w[1], w[140], pars->GC_11, amp[454]); 
  FFV1_0(w[28], w[142], w[4], pars->GC_11, amp[455]); 
  FFV1_0(w[134], w[11], w[31], pars->GC_11, amp[456]); 
  FFV1_0(w[134], w[34], w[9], pars->GC_1, amp[457]); 
  FFV1_0(w[127], w[5], w[105], pars->GC_11, amp[458]); 
  FFV1_0(w[127], w[34], w[4], pars->GC_11, amp[459]); 
  FFV1_0(w[133], w[11], w[4], pars->GC_11, amp[460]); 
  FFV1_0(w[125], w[11], w[105], pars->GC_11, amp[461]); 
  FFV1_0(w[134], w[27], w[31], pars->GC_11, amp[462]); 
  FFV2_3_0(w[134], w[34], w[26], -pars->GC_51, pars->GC_58, amp[463]); 
  FFV1_0(w[129], w[5], w[105], pars->GC_11, amp[464]); 
  FFV1_0(w[129], w[34], w[4], pars->GC_11, amp[465]); 
  FFV1_0(w[133], w[27], w[4], pars->GC_11, amp[466]); 
  FFV1_0(w[125], w[27], w[105], pars->GC_11, amp[467]); 
  FFV1_0(w[134], w[17], w[39], pars->GC_11, amp[468]); 
  FFV1_0(w[134], w[42], w[9], pars->GC_1, amp[469]); 
  FFV1_0(w[127], w[1], w[78], pars->GC_11, amp[470]); 
  FFV1_0(w[127], w[42], w[4], pars->GC_11, amp[471]); 
  FFV1_0(w[130], w[17], w[4], pars->GC_11, amp[472]); 
  FFV1_0(w[125], w[17], w[78], pars->GC_11, amp[473]); 
  FFV1_0(w[134], w[30], w[39], pars->GC_11, amp[474]); 
  FFV2_3_0(w[134], w[42], w[26], -pars->GC_51, pars->GC_58, amp[475]); 
  FFV1_0(w[129], w[1], w[78], pars->GC_11, amp[476]); 
  FFV1_0(w[129], w[42], w[4], pars->GC_11, amp[477]); 
  FFV1_0(w[130], w[30], w[4], pars->GC_11, amp[478]); 
  FFV1_0(w[125], w[30], w[78], pars->GC_11, amp[479]); 
  FFV1_0(w[7], w[11], w[144], pars->GC_11, amp[480]); 
  FFV1_0(w[6], w[11], w[145], pars->GC_11, amp[481]); 
  FFV1_0(w[14], w[5], w[145], pars->GC_11, amp[482]); 
  FFV1_0(w[15], w[5], w[144], pars->GC_11, amp[483]); 
  FFV1_0(w[7], w[11], w[146], pars->GC_11, amp[484]); 
  FFV1_0(w[7], w[147], w[83], pars->GC_11, amp[485]); 
  FFV1_0(w[15], w[5], w[146], pars->GC_11, amp[486]); 
  FFV1_0(w[148], w[5], w[83], pars->GC_11, amp[487]); 
  FFV1_0(w[6], w[11], w[149], pars->GC_11, amp[488]); 
  FFV1_0(w[6], w[147], w[84], pars->GC_11, amp[489]); 
  FFV1_0(w[14], w[5], w[149], pars->GC_11, amp[490]); 
  FFV1_0(w[150], w[5], w[84], pars->GC_11, amp[491]); 
  FFV1_0(w[7], w[27], w[144], pars->GC_11, amp[492]); 
  FFV1_0(w[6], w[27], w[145], pars->GC_11, amp[493]); 
  FFV1_0(w[28], w[5], w[145], pars->GC_11, amp[494]); 
  FFV1_0(w[29], w[5], w[144], pars->GC_11, amp[495]); 
  FFV1_0(w[7], w[27], w[146], pars->GC_11, amp[496]); 
  FFV1_0(w[7], w[151], w[83], pars->GC_11, amp[497]); 
  FFV1_0(w[29], w[5], w[146], pars->GC_11, amp[498]); 
  FFV1_0(w[152], w[5], w[83], pars->GC_11, amp[499]); 
  FFV1_0(w[6], w[27], w[149], pars->GC_11, amp[500]); 
  FFV1_0(w[6], w[151], w[84], pars->GC_11, amp[501]); 
  FFV1_0(w[28], w[5], w[149], pars->GC_11, amp[502]); 
  FFV1_0(w[153], w[5], w[84], pars->GC_11, amp[503]); 
  FFV1_0(w[15], w[143], w[39], pars->GC_11, amp[504]); 
  FFV1_0(w[40], w[143], w[9], pars->GC_1, amp[505]); 
  FFV1_0(w[7], w[86], w[154], pars->GC_11, amp[506]); 
  FFV1_0(w[15], w[81], w[154], pars->GC_11, amp[507]); 
  FFV1_0(w[40], w[86], w[0], pars->GC_11, amp[508]); 
  FFV1_0(w[15], w[155], w[0], pars->GC_11, amp[509]); 
  FFV1_0(w[29], w[143], w[39], pars->GC_11, amp[510]); 
  FFV2_3_0(w[40], w[143], w[26], -pars->GC_51, pars->GC_58, amp[511]); 
  FFV1_0(w[7], w[89], w[154], pars->GC_11, amp[512]); 
  FFV1_0(w[29], w[81], w[154], pars->GC_11, amp[513]); 
  FFV1_0(w[40], w[89], w[0], pars->GC_11, amp[514]); 
  FFV1_0(w[29], w[155], w[0], pars->GC_11, amp[515]); 
  FFV1_0(w[14], w[143], w[43], pars->GC_11, amp[516]); 
  FFV1_0(w[44], w[143], w[9], pars->GC_1, amp[517]); 
  FFV1_0(w[6], w[86], w[156], pars->GC_11, amp[518]); 
  FFV1_0(w[14], w[81], w[156], pars->GC_11, amp[519]); 
  FFV1_0(w[44], w[86], w[0], pars->GC_11, amp[520]); 
  FFV1_0(w[14], w[157], w[0], pars->GC_11, amp[521]); 
  FFV1_0(w[28], w[143], w[43], pars->GC_11, amp[522]); 
  FFV2_3_0(w[44], w[143], w[26], -pars->GC_51, pars->GC_58, amp[523]); 
  FFV1_0(w[6], w[89], w[156], pars->GC_11, amp[524]); 
  FFV1_0(w[28], w[81], w[156], pars->GC_11, amp[525]); 
  FFV1_0(w[44], w[89], w[0], pars->GC_11, amp[526]); 
  FFV1_0(w[28], w[157], w[0], pars->GC_11, amp[527]); 
  FFV1_0(w[7], w[17], w[159], pars->GC_11, amp[528]); 
  FFV1_0(w[6], w[17], w[160], pars->GC_11, amp[529]); 
  FFV1_0(w[14], w[1], w[160], pars->GC_11, amp[530]); 
  FFV1_0(w[15], w[1], w[159], pars->GC_11, amp[531]); 
  FFV1_0(w[7], w[17], w[161], pars->GC_11, amp[532]); 
  FFV1_0(w[7], w[162], w[50], pars->GC_11, amp[533]); 
  FFV1_0(w[15], w[1], w[161], pars->GC_11, amp[534]); 
  FFV1_0(w[148], w[1], w[50], pars->GC_11, amp[535]); 
  FFV1_0(w[6], w[17], w[163], pars->GC_11, amp[536]); 
  FFV1_0(w[6], w[162], w[51], pars->GC_11, amp[537]); 
  FFV1_0(w[14], w[1], w[163], pars->GC_11, amp[538]); 
  FFV1_0(w[150], w[1], w[51], pars->GC_11, amp[539]); 
  FFV1_0(w[7], w[30], w[159], pars->GC_11, amp[540]); 
  FFV1_0(w[6], w[30], w[160], pars->GC_11, amp[541]); 
  FFV1_0(w[28], w[1], w[160], pars->GC_11, amp[542]); 
  FFV1_0(w[29], w[1], w[159], pars->GC_11, amp[543]); 
  FFV1_0(w[7], w[30], w[161], pars->GC_11, amp[544]); 
  FFV1_0(w[7], w[164], w[50], pars->GC_11, amp[545]); 
  FFV1_0(w[29], w[1], w[161], pars->GC_11, amp[546]); 
  FFV1_0(w[152], w[1], w[50], pars->GC_11, amp[547]); 
  FFV1_0(w[6], w[30], w[163], pars->GC_11, amp[548]); 
  FFV1_0(w[6], w[164], w[51], pars->GC_11, amp[549]); 
  FFV1_0(w[28], w[1], w[163], pars->GC_11, amp[550]); 
  FFV1_0(w[153], w[1], w[51], pars->GC_11, amp[551]); 
  FFV1_0(w[15], w[158], w[31], pars->GC_11, amp[552]); 
  FFV1_0(w[33], w[158], w[9], pars->GC_1, amp[553]); 
  FFV1_0(w[7], w[53], w[165], pars->GC_11, amp[554]); 
  FFV1_0(w[15], w[48], w[165], pars->GC_11, amp[555]); 
  FFV1_0(w[33], w[53], w[0], pars->GC_11, amp[556]); 
  FFV1_0(w[15], w[166], w[0], pars->GC_11, amp[557]); 
  FFV1_0(w[29], w[158], w[31], pars->GC_11, amp[558]); 
  FFV2_3_0(w[33], w[158], w[26], -pars->GC_51, pars->GC_58, amp[559]); 
  FFV1_0(w[7], w[56], w[165], pars->GC_11, amp[560]); 
  FFV1_0(w[29], w[48], w[165], pars->GC_11, amp[561]); 
  FFV1_0(w[33], w[56], w[0], pars->GC_11, amp[562]); 
  FFV1_0(w[29], w[166], w[0], pars->GC_11, amp[563]); 
  FFV1_0(w[14], w[158], w[35], pars->GC_11, amp[564]); 
  FFV1_0(w[37], w[158], w[9], pars->GC_1, amp[565]); 
  FFV1_0(w[6], w[53], w[167], pars->GC_11, amp[566]); 
  FFV1_0(w[14], w[48], w[167], pars->GC_11, amp[567]); 
  FFV1_0(w[37], w[53], w[0], pars->GC_11, amp[568]); 
  FFV1_0(w[14], w[168], w[0], pars->GC_11, amp[569]); 
  FFV1_0(w[28], w[158], w[35], pars->GC_11, amp[570]); 
  FFV2_3_0(w[37], w[158], w[26], -pars->GC_51, pars->GC_58, amp[571]); 
  FFV1_0(w[6], w[56], w[167], pars->GC_11, amp[572]); 
  FFV1_0(w[28], w[48], w[167], pars->GC_11, amp[573]); 
  FFV1_0(w[37], w[56], w[0], pars->GC_11, amp[574]); 
  FFV1_0(w[28], w[168], w[0], pars->GC_11, amp[575]); 
  FFV1_0(w[7], w[17], w[170], pars->GC_11, amp[576]); 
  FFV1_0(w[7], w[11], w[171], pars->GC_11, amp[577]); 
  FFV1_0(w[15], w[5], w[171], pars->GC_11, amp[578]); 
  FFV1_0(w[15], w[1], w[170], pars->GC_11, amp[579]); 
  FFV1_0(w[7], w[11], w[172], pars->GC_11, amp[580]); 
  FFV1_0(w[7], w[147], w[91], pars->GC_11, amp[581]); 
  FFV1_0(w[15], w[5], w[172], pars->GC_11, amp[582]); 
  FFV1_0(w[148], w[5], w[91], pars->GC_11, amp[583]); 
  FFV1_0(w[7], w[17], w[173], pars->GC_11, amp[584]); 
  FFV1_0(w[7], w[162], w[59], pars->GC_11, amp[585]); 
  FFV1_0(w[15], w[1], w[173], pars->GC_11, amp[586]); 
  FFV1_0(w[148], w[1], w[59], pars->GC_11, amp[587]); 
  FFV1_0(w[7], w[30], w[170], pars->GC_11, amp[588]); 
  FFV1_0(w[7], w[27], w[171], pars->GC_11, amp[589]); 
  FFV1_0(w[29], w[5], w[171], pars->GC_11, amp[590]); 
  FFV1_0(w[29], w[1], w[170], pars->GC_11, amp[591]); 
  FFV1_0(w[7], w[27], w[172], pars->GC_11, amp[592]); 
  FFV1_0(w[7], w[151], w[91], pars->GC_11, amp[593]); 
  FFV1_0(w[29], w[5], w[172], pars->GC_11, amp[594]); 
  FFV1_0(w[152], w[5], w[91], pars->GC_11, amp[595]); 
  FFV1_0(w[7], w[30], w[173], pars->GC_11, amp[596]); 
  FFV1_0(w[7], w[164], w[59], pars->GC_11, amp[597]); 
  FFV1_0(w[29], w[1], w[173], pars->GC_11, amp[598]); 
  FFV1_0(w[152], w[1], w[59], pars->GC_11, amp[599]); 
  FFV1_0(w[169], w[11], w[35], pars->GC_11, amp[600]); 
  FFV1_0(w[169], w[38], w[9], pars->GC_1, amp[601]); 
  FFV1_0(w[60], w[5], w[167], pars->GC_11, amp[602]); 
  FFV1_0(w[57], w[11], w[167], pars->GC_11, amp[603]); 
  FFV1_0(w[60], w[38], w[0], pars->GC_11, amp[604]); 
  FFV1_0(w[174], w[11], w[0], pars->GC_11, amp[605]); 
  FFV1_0(w[169], w[27], w[35], pars->GC_11, amp[606]); 
  FFV2_3_0(w[169], w[38], w[26], -pars->GC_51, pars->GC_58, amp[607]); 
  FFV1_0(w[61], w[5], w[167], pars->GC_11, amp[608]); 
  FFV1_0(w[57], w[27], w[167], pars->GC_11, amp[609]); 
  FFV1_0(w[61], w[38], w[0], pars->GC_11, amp[610]); 
  FFV1_0(w[174], w[27], w[0], pars->GC_11, amp[611]); 
  FFV1_0(w[169], w[17], w[43], pars->GC_11, amp[612]); 
  FFV1_0(w[169], w[46], w[9], pars->GC_1, amp[613]); 
  FFV1_0(w[60], w[1], w[156], pars->GC_11, amp[614]); 
  FFV1_0(w[57], w[17], w[156], pars->GC_11, amp[615]); 
  FFV1_0(w[60], w[46], w[0], pars->GC_11, amp[616]); 
  FFV1_0(w[175], w[17], w[0], pars->GC_11, amp[617]); 
  FFV1_0(w[169], w[30], w[43], pars->GC_11, amp[618]); 
  FFV2_3_0(w[169], w[46], w[26], -pars->GC_51, pars->GC_58, amp[619]); 
  FFV1_0(w[61], w[1], w[156], pars->GC_11, amp[620]); 
  FFV1_0(w[57], w[30], w[156], pars->GC_11, amp[621]); 
  FFV1_0(w[61], w[46], w[0], pars->GC_11, amp[622]); 
  FFV1_0(w[175], w[30], w[0], pars->GC_11, amp[623]); 
  FFV1_0(w[6], w[17], w[177], pars->GC_11, amp[624]); 
  FFV1_0(w[6], w[11], w[178], pars->GC_11, amp[625]); 
  FFV1_0(w[14], w[5], w[178], pars->GC_11, amp[626]); 
  FFV1_0(w[14], w[1], w[177], pars->GC_11, amp[627]); 
  FFV1_0(w[6], w[11], w[179], pars->GC_11, amp[628]); 
  FFV1_0(w[6], w[147], w[94], pars->GC_11, amp[629]); 
  FFV1_0(w[14], w[5], w[179], pars->GC_11, amp[630]); 
  FFV1_0(w[150], w[5], w[94], pars->GC_11, amp[631]); 
  FFV1_0(w[6], w[17], w[180], pars->GC_11, amp[632]); 
  FFV1_0(w[6], w[162], w[65], pars->GC_11, amp[633]); 
  FFV1_0(w[14], w[1], w[180], pars->GC_11, amp[634]); 
  FFV1_0(w[150], w[1], w[65], pars->GC_11, amp[635]); 
  FFV1_0(w[6], w[30], w[177], pars->GC_11, amp[636]); 
  FFV1_0(w[6], w[27], w[178], pars->GC_11, amp[637]); 
  FFV1_0(w[28], w[5], w[178], pars->GC_11, amp[638]); 
  FFV1_0(w[28], w[1], w[177], pars->GC_11, amp[639]); 
  FFV1_0(w[6], w[27], w[179], pars->GC_11, amp[640]); 
  FFV1_0(w[6], w[151], w[94], pars->GC_11, amp[641]); 
  FFV1_0(w[28], w[5], w[179], pars->GC_11, amp[642]); 
  FFV1_0(w[153], w[5], w[94], pars->GC_11, amp[643]); 
  FFV1_0(w[6], w[30], w[180], pars->GC_11, amp[644]); 
  FFV1_0(w[6], w[164], w[65], pars->GC_11, amp[645]); 
  FFV1_0(w[28], w[1], w[180], pars->GC_11, amp[646]); 
  FFV1_0(w[153], w[1], w[65], pars->GC_11, amp[647]); 
  FFV1_0(w[176], w[11], w[31], pars->GC_11, amp[648]); 
  FFV1_0(w[176], w[34], w[9], pars->GC_1, amp[649]); 
  FFV1_0(w[66], w[5], w[165], pars->GC_11, amp[650]); 
  FFV1_0(w[63], w[11], w[165], pars->GC_11, amp[651]); 
  FFV1_0(w[66], w[34], w[0], pars->GC_11, amp[652]); 
  FFV1_0(w[181], w[11], w[0], pars->GC_11, amp[653]); 
  FFV1_0(w[176], w[27], w[31], pars->GC_11, amp[654]); 
  FFV2_3_0(w[176], w[34], w[26], -pars->GC_51, pars->GC_58, amp[655]); 
  FFV1_0(w[67], w[5], w[165], pars->GC_11, amp[656]); 
  FFV1_0(w[63], w[27], w[165], pars->GC_11, amp[657]); 
  FFV1_0(w[67], w[34], w[0], pars->GC_11, amp[658]); 
  FFV1_0(w[181], w[27], w[0], pars->GC_11, amp[659]); 
  FFV1_0(w[176], w[17], w[39], pars->GC_11, amp[660]); 
  FFV1_0(w[176], w[42], w[9], pars->GC_1, amp[661]); 
  FFV1_0(w[66], w[1], w[154], pars->GC_11, amp[662]); 
  FFV1_0(w[63], w[17], w[154], pars->GC_11, amp[663]); 
  FFV1_0(w[66], w[42], w[0], pars->GC_11, amp[664]); 
  FFV1_0(w[182], w[17], w[0], pars->GC_11, amp[665]); 
  FFV1_0(w[176], w[30], w[39], pars->GC_11, amp[666]); 
  FFV2_3_0(w[176], w[42], w[26], -pars->GC_51, pars->GC_58, amp[667]); 
  FFV1_0(w[67], w[1], w[154], pars->GC_11, amp[668]); 
  FFV1_0(w[63], w[30], w[154], pars->GC_11, amp[669]); 
  FFV1_0(w[67], w[42], w[0], pars->GC_11, amp[670]); 
  FFV1_0(w[182], w[30], w[0], pars->GC_11, amp[671]); 
  FFV1_0(w[7], w[11], w[183], pars->GC_11, amp[672]); 
  FFV1_0(w[184], w[11], w[4], pars->GC_11, amp[673]); 
  FFV1_0(w[15], w[5], w[183], pars->GC_11, amp[674]); 
  FFV1_0(w[15], w[185], w[4], pars->GC_11, amp[675]); 
  FFV1_0(w[7], w[11], w[186], pars->GC_11, amp[676]); 
  FFV1_0(w[7], w[147], w[105], pars->GC_11, amp[677]); 
  FFV1_0(w[15], w[5], w[186], pars->GC_11, amp[678]); 
  FFV1_0(w[148], w[5], w[105], pars->GC_11, amp[679]); 
  FFV1_0(w[33], w[147], w[4], pars->GC_11, amp[680]); 
  FFV1_0(w[187], w[11], w[4], pars->GC_11, amp[681]); 
  FFV1_0(w[148], w[34], w[4], pars->GC_11, amp[682]); 
  FFV1_0(w[15], w[188], w[4], pars->GC_11, amp[683]); 
  FFV1_0(w[7], w[11], w[189], pars->GC_11, amp[684]); 
  FFV1_0(w[7], w[11], w[190], pars->GC_11, amp[685]); 
  FFV1_0(w[7], w[11], w[191], pars->GC_11, amp[686]); 
  FFV1_0(w[15], w[5], w[189], pars->GC_11, amp[687]); 
  FFV1_0(w[15], w[5], w[190], pars->GC_11, amp[688]); 
  FFV1_0(w[15], w[5], w[191], pars->GC_11, amp[689]); 
  FFV1_0(w[7], w[27], w[183], pars->GC_11, amp[690]); 
  FFV1_0(w[184], w[27], w[4], pars->GC_11, amp[691]); 
  FFV1_0(w[29], w[5], w[183], pars->GC_11, amp[692]); 
  FFV1_0(w[29], w[185], w[4], pars->GC_11, amp[693]); 
  FFV1_0(w[7], w[27], w[186], pars->GC_11, amp[694]); 
  FFV1_0(w[7], w[151], w[105], pars->GC_11, amp[695]); 
  FFV1_0(w[29], w[5], w[186], pars->GC_11, amp[696]); 
  FFV1_0(w[152], w[5], w[105], pars->GC_11, amp[697]); 
  FFV1_0(w[33], w[151], w[4], pars->GC_11, amp[698]); 
  FFV1_0(w[187], w[27], w[4], pars->GC_11, amp[699]); 
  FFV1_0(w[152], w[34], w[4], pars->GC_11, amp[700]); 
  FFV1_0(w[29], w[188], w[4], pars->GC_11, amp[701]); 
  FFV1_0(w[7], w[27], w[189], pars->GC_11, amp[702]); 
  FFV1_0(w[7], w[27], w[190], pars->GC_11, amp[703]); 
  FFV1_0(w[7], w[27], w[191], pars->GC_11, amp[704]); 
  FFV1_0(w[29], w[5], w[189], pars->GC_11, amp[705]); 
  FFV1_0(w[29], w[5], w[190], pars->GC_11, amp[706]); 
  FFV1_0(w[29], w[5], w[191], pars->GC_11, amp[707]); 
  FFV1_0(w[6], w[11], w[192], pars->GC_11, amp[708]); 
  FFV1_0(w[193], w[11], w[4], pars->GC_11, amp[709]); 
  FFV1_0(w[14], w[5], w[192], pars->GC_11, amp[710]); 
  FFV1_0(w[14], w[194], w[4], pars->GC_11, amp[711]); 
  FFV1_0(w[6], w[11], w[195], pars->GC_11, amp[712]); 
  FFV1_0(w[6], w[147], w[106], pars->GC_11, amp[713]); 
  FFV1_0(w[14], w[5], w[195], pars->GC_11, amp[714]); 
  FFV1_0(w[150], w[5], w[106], pars->GC_11, amp[715]); 
  FFV1_0(w[37], w[147], w[4], pars->GC_11, amp[716]); 
  FFV1_0(w[196], w[11], w[4], pars->GC_11, amp[717]); 
  FFV1_0(w[150], w[38], w[4], pars->GC_11, amp[718]); 
  FFV1_0(w[14], w[197], w[4], pars->GC_11, amp[719]); 
  FFV1_0(w[6], w[11], w[198], pars->GC_11, amp[720]); 
  FFV1_0(w[6], w[11], w[199], pars->GC_11, amp[721]); 
  FFV1_0(w[6], w[11], w[200], pars->GC_11, amp[722]); 
  FFV1_0(w[14], w[5], w[198], pars->GC_11, amp[723]); 
  FFV1_0(w[14], w[5], w[199], pars->GC_11, amp[724]); 
  FFV1_0(w[14], w[5], w[200], pars->GC_11, amp[725]); 
  FFV1_0(w[6], w[27], w[192], pars->GC_11, amp[726]); 
  FFV1_0(w[193], w[27], w[4], pars->GC_11, amp[727]); 
  FFV1_0(w[28], w[5], w[192], pars->GC_11, amp[728]); 
  FFV1_0(w[28], w[194], w[4], pars->GC_11, amp[729]); 
  FFV1_0(w[6], w[27], w[195], pars->GC_11, amp[730]); 
  FFV1_0(w[6], w[151], w[106], pars->GC_11, amp[731]); 
  FFV1_0(w[28], w[5], w[195], pars->GC_11, amp[732]); 
  FFV1_0(w[153], w[5], w[106], pars->GC_11, amp[733]); 
  FFV1_0(w[37], w[151], w[4], pars->GC_11, amp[734]); 
  FFV1_0(w[196], w[27], w[4], pars->GC_11, amp[735]); 
  FFV1_0(w[153], w[38], w[4], pars->GC_11, amp[736]); 
  FFV1_0(w[28], w[197], w[4], pars->GC_11, amp[737]); 
  FFV1_0(w[6], w[27], w[198], pars->GC_11, amp[738]); 
  FFV1_0(w[6], w[27], w[199], pars->GC_11, amp[739]); 
  FFV1_0(w[6], w[27], w[200], pars->GC_11, amp[740]); 
  FFV1_0(w[28], w[5], w[198], pars->GC_11, amp[741]); 
  FFV1_0(w[28], w[5], w[199], pars->GC_11, amp[742]); 
  FFV1_0(w[28], w[5], w[200], pars->GC_11, amp[743]); 
  FFV1_0(w[7], w[17], w[201], pars->GC_11, amp[744]); 
  FFV1_0(w[202], w[17], w[4], pars->GC_11, amp[745]); 
  FFV1_0(w[15], w[1], w[201], pars->GC_11, amp[746]); 
  FFV1_0(w[15], w[203], w[4], pars->GC_11, amp[747]); 
  FFV1_0(w[7], w[17], w[204], pars->GC_11, amp[748]); 
  FFV1_0(w[7], w[162], w[78], pars->GC_11, amp[749]); 
  FFV1_0(w[15], w[1], w[204], pars->GC_11, amp[750]); 
  FFV1_0(w[148], w[1], w[78], pars->GC_11, amp[751]); 
  FFV1_0(w[40], w[162], w[4], pars->GC_11, amp[752]); 
  FFV1_0(w[205], w[17], w[4], pars->GC_11, amp[753]); 
  FFV1_0(w[148], w[42], w[4], pars->GC_11, amp[754]); 
  FFV1_0(w[15], w[206], w[4], pars->GC_11, amp[755]); 
  FFV1_0(w[7], w[17], w[207], pars->GC_11, amp[756]); 
  FFV1_0(w[7], w[17], w[208], pars->GC_11, amp[757]); 
  FFV1_0(w[7], w[17], w[209], pars->GC_11, amp[758]); 
  FFV1_0(w[15], w[1], w[207], pars->GC_11, amp[759]); 
  FFV1_0(w[15], w[1], w[208], pars->GC_11, amp[760]); 
  FFV1_0(w[15], w[1], w[209], pars->GC_11, amp[761]); 
  FFV1_0(w[7], w[30], w[201], pars->GC_11, amp[762]); 
  FFV1_0(w[202], w[30], w[4], pars->GC_11, amp[763]); 
  FFV1_0(w[29], w[1], w[201], pars->GC_11, amp[764]); 
  FFV1_0(w[29], w[203], w[4], pars->GC_11, amp[765]); 
  FFV1_0(w[7], w[30], w[204], pars->GC_11, amp[766]); 
  FFV1_0(w[7], w[164], w[78], pars->GC_11, amp[767]); 
  FFV1_0(w[29], w[1], w[204], pars->GC_11, amp[768]); 
  FFV1_0(w[152], w[1], w[78], pars->GC_11, amp[769]); 
  FFV1_0(w[40], w[164], w[4], pars->GC_11, amp[770]); 
  FFV1_0(w[205], w[30], w[4], pars->GC_11, amp[771]); 
  FFV1_0(w[152], w[42], w[4], pars->GC_11, amp[772]); 
  FFV1_0(w[29], w[206], w[4], pars->GC_11, amp[773]); 
  FFV1_0(w[7], w[30], w[207], pars->GC_11, amp[774]); 
  FFV1_0(w[7], w[30], w[208], pars->GC_11, amp[775]); 
  FFV1_0(w[7], w[30], w[209], pars->GC_11, amp[776]); 
  FFV1_0(w[29], w[1], w[207], pars->GC_11, amp[777]); 
  FFV1_0(w[29], w[1], w[208], pars->GC_11, amp[778]); 
  FFV1_0(w[29], w[1], w[209], pars->GC_11, amp[779]); 
  FFV1_0(w[6], w[17], w[210], pars->GC_11, amp[780]); 
  FFV1_0(w[211], w[17], w[4], pars->GC_11, amp[781]); 
  FFV1_0(w[14], w[1], w[210], pars->GC_11, amp[782]); 
  FFV1_0(w[14], w[212], w[4], pars->GC_11, amp[783]); 
  FFV1_0(w[6], w[17], w[213], pars->GC_11, amp[784]); 
  FFV1_0(w[6], w[162], w[79], pars->GC_11, amp[785]); 
  FFV1_0(w[14], w[1], w[213], pars->GC_11, amp[786]); 
  FFV1_0(w[150], w[1], w[79], pars->GC_11, amp[787]); 
  FFV1_0(w[44], w[162], w[4], pars->GC_11, amp[788]); 
  FFV1_0(w[214], w[17], w[4], pars->GC_11, amp[789]); 
  FFV1_0(w[150], w[46], w[4], pars->GC_11, amp[790]); 
  FFV1_0(w[14], w[215], w[4], pars->GC_11, amp[791]); 
  FFV1_0(w[6], w[17], w[216], pars->GC_11, amp[792]); 
  FFV1_0(w[6], w[17], w[217], pars->GC_11, amp[793]); 
  FFV1_0(w[6], w[17], w[218], pars->GC_11, amp[794]); 
  FFV1_0(w[14], w[1], w[216], pars->GC_11, amp[795]); 
  FFV1_0(w[14], w[1], w[217], pars->GC_11, amp[796]); 
  FFV1_0(w[14], w[1], w[218], pars->GC_11, amp[797]); 
  FFV1_0(w[6], w[30], w[210], pars->GC_11, amp[798]); 
  FFV1_0(w[211], w[30], w[4], pars->GC_11, amp[799]); 
  FFV1_0(w[28], w[1], w[210], pars->GC_11, amp[800]); 
  FFV1_0(w[28], w[212], w[4], pars->GC_11, amp[801]); 
  FFV1_0(w[6], w[30], w[213], pars->GC_11, amp[802]); 
  FFV1_0(w[6], w[164], w[79], pars->GC_11, amp[803]); 
  FFV1_0(w[28], w[1], w[213], pars->GC_11, amp[804]); 
  FFV1_0(w[153], w[1], w[79], pars->GC_11, amp[805]); 
  FFV1_0(w[44], w[164], w[4], pars->GC_11, amp[806]); 
  FFV1_0(w[214], w[30], w[4], pars->GC_11, amp[807]); 
  FFV1_0(w[153], w[46], w[4], pars->GC_11, amp[808]); 
  FFV1_0(w[28], w[215], w[4], pars->GC_11, amp[809]); 
  FFV1_0(w[6], w[30], w[216], pars->GC_11, amp[810]); 
  FFV1_0(w[6], w[30], w[217], pars->GC_11, amp[811]); 
  FFV1_0(w[6], w[30], w[218], pars->GC_11, amp[812]); 
  FFV1_0(w[28], w[1], w[216], pars->GC_11, amp[813]); 
  FFV1_0(w[28], w[1], w[217], pars->GC_11, amp[814]); 
  FFV1_0(w[28], w[1], w[218], pars->GC_11, amp[815]); 

}
double CPPProcess::matrix_gdx_epemgddxdx_no_h() 
{
  int i, j; 
  // Local variables
  ...
  jamp[1] = +1./2. * (-1./3. * amp[96] - amp[97] - amp[98] - amp[99] - 1./3. *
      ...
      - amp[813] - amp[814]);
  jamp[2] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[0] -
  ...
  jamp[4] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[4] +
  ...
  jamp[5] = +1./2. * (-std::complex<double> (0, 1) * amp[4] - 1./3. *
  ...
  jamp[8] = +1./2. * (+std::complex<double> (0, 1) * amp[4] + 1./3. *
      std::complex<double> (0, 1) * amp[5] + 1./3. * std::complex<double> (0,
      1) * amp[6] + std::complex<double> (0, 1) * amp[7] + 1./3. *
      std::complex<double> (0, 1) * amp[12] + std::complex<double> (0, 1) *
      amp[13] + std::complex<double> (0, 1) * amp[14] + 1./3. *
  ...
  jamp[9] = +1./2. * (-1./3. * std::complex<double> (0, 1) * amp[4] -
      std::complex<double> (0, 1) * amp[5] - std::complex<double> (0, 1) *
      amp[6] - 1./3. * std::complex<double> (0, 1) * amp[7] - 1./3. *
      std::complex<double> (0, 1) * amp[8] - std::complex<double> (0, 1) *
      amp[9] - std::complex<double> (0, 1) * amp[10] - 1./3. *
      ...
      * amp[367] - 1./3. * amp[369] - 1./3. * amp[370] - amp[372] - amp[373] -
      ...
      amp[815] + amp[813]);
  jamp[10] = +1./2. * (+1./3. * std::complex<double> (0, 1) * amp[0] +
      std::complex<double> (0, 1) * amp[1] + std::complex<double> (0, 1) *
      amp[2] + 1./3. * std::complex<double> (0, 1) * amp[3] +
      std::complex<double> (0, 1) * amp[8] + 1./3. * std::complex<double> (0,
      1) * amp[9] + 1./3. * std::complex<double> (0, 1) * amp[10] +
  ...
  jamp[11] = +1./2. * (-std::complex<double> (0, 1) * amp[0] - 1./3. *
      std::complex<double> (0, 1) * amp[1] - 1./3. * std::complex<double> (0,
      1) * amp[2] - std::complex<double> (0, 1) * amp[3] - std::complex<double>
      (0, 1) * amp[12] - 1./3. * std::complex<double> (0, 1) * amp[13] - 1./3.
      * std::complex<double> (0, 1) * amp[14] - std::complex<double> (0, 1) *
