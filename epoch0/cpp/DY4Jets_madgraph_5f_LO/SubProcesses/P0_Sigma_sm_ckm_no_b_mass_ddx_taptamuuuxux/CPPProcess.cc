...
// Process: d d~ > ta+ ta- u u u~ u~ WEIGHTED<=8 / h
// Process: d d~ > ta+ ta- c c c~ c~ WEIGHTED<=8 / h
// Process: s s~ > ta+ ta- u u u~ u~ WEIGHTED<=8 / h
// Process: s s~ > ta+ ta- c c c~ c~ WEIGHTED<=8 / h
// Process: b b~ > ta+ ta- u u u~ u~ WEIGHTED<=8 / h
// Process: b b~ > ta+ ta- c c c~ c~ WEIGHTED<=8 / h
  ...
  if (sum_hel == 0 || ntry < 10)
  {
    ...
    for(int ihel = 0; ihel < ncomb; ihel++ )
    {
      if (goodhel[ihel] || ntry < 2)
      {
        ...
        t[0] = matrix_ddx_taptamuuuxux_no_h(); 
        ...
        t[1] = matrix_ddx_taptamuuuxux_no_h(); 
        double tsum = 0; 
...
double CPPProcess::matrix_ddx_taptamuuuxux_no_h() 
{
  int i, j; 
  // Local variables
