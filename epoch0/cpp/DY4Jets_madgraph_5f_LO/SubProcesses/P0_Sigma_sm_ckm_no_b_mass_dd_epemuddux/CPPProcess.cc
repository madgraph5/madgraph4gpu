...
// Process: d d > e+ e- u d d u~ WEIGHTED<=8 / h
// Process: d d > e+ e- c d d c~ WEIGHTED<=8 / h
// Process: d d > mu+ mu- u d d u~ WEIGHTED<=8 / h
// Process: d d > mu+ mu- c d d c~ WEIGHTED<=8 / h
// Process: s s > e+ e- u s s u~ WEIGHTED<=8 / h
// Process: s s > e+ e- c s s c~ WEIGHTED<=8 / h
// Process: s s > mu+ mu- u s s u~ WEIGHTED<=8 / h
// Process: s s > mu+ mu- c s s c~ WEIGHTED<=8 / h
// Process: b b > e+ e- u b u~ b WEIGHTED<=8 / h
// Process: b b > e+ e- c b c~ b WEIGHTED<=8 / h
// Process: b b > mu+ mu- u b u~ b WEIGHTED<=8 / h
// Process: b b > mu+ mu- c b c~ b WEIGHTED<=8 / h
...
void CPPProcess::calculate_wavefunctions(const int perm[], const int hel[])
{
  ...
  FFV1P0_3(w[7], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[8]); 
  FFV1P0_3(w[0], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[9]); 
  ...
  FFV2_3_2(w[1], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[20]);
  FFV1P0_3(w[0], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[21]); 
  VVV1P0_1(w[8], w[21], pars->GC_10, pars->ZERO, pars->ZERO, w[22]); 
  FFV1_1(w[5], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[23]); 
  ...
  FFV2_3_1(w[5], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[27]);
  FFV1_2(w[0], w[8], pars->GC_11, pars->ZERO, pars->ZERO, w[28]); 
  FFV1P0_3(w[28], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[29]); 
  FFV1P0_3(w[28], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[30]); 
  FFV1_2(w[0], w[10], pars->GC_1, pars->ZERO, pars->ZERO, w[31]); 
  FFV1P0_3(w[1], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[32]); 
  FFV1P0_3(w[0], w[24], pars->GC_11, pars->ZERO, pars->ZERO, w[33]); 
  FFV1P0_3(w[1], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[34]); 
  FFV1P0_3(w[0], w[14], pars->GC_11, pars->ZERO, pars->ZERO, w[35]); 
  ...
  FFV2_3_2(w[0], w[18], -pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[38]);
  FFV1P0_3(w[1], w[5], pars->GC_11, pars->ZERO, pars->ZERO, w[39]); 
  FFV1_1(w[6], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[40]); 
  VVV1P0_1(w[8], w[39], pars->GC_10, pars->ZERO, pars->ZERO, w[41]); 
  FFV1_2(w[0], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[42]); 
  FFV1P0_3(w[1], w[6], pars->GC_11, pars->ZERO, pars->ZERO, w[43]); 
  FFV1_1(w[5], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[44]); 
  FFV1_2(w[0], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[45]); 
  VVV1P0_1(w[8], w[43], pars->GC_10, pars->ZERO, pars->ZERO, w[46]); 
  FFV1_2(w[7], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[47]); 
  FFV1P0_3(w[47], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[48]); 
  FFV1_2(w[7], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[49]); 
  FFV1P0_3(w[49], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[50]); 
  FFV1_1(w[4], w[9], pars->GC_11, pars->ZERO, pars->ZERO, w[51]); 
  FFV1P0_3(w[7], w[51], pars->GC_11, pars->ZERO, pars->ZERO, w[52]); 
  FFV1_1(w[4], w[10], pars->GC_2, pars->ZERO, pars->ZERO, w[53]); 
  FFV1P0_3(w[7], w[53], pars->GC_11, pars->ZERO, pars->ZERO, w[54]); 
  ...
  FFV2_5_1(w[4], w[18], pars->GC_51, pars->GC_58, pars->ZERO, pars->ZERO,
      w[57]);
  FFV1P0_3(w[7], w[57], pars->GC_11, pars->ZERO, pars->ZERO, w[58]); 
  FFV1_1(w[4], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[59]); 
  VVV1P0_1(w[9], w[43], pars->GC_10, pars->ZERO, pars->ZERO, w[60]); 
  FFV1_2(w[7], w[43], pars->GC_11, pars->ZERO, pars->ZERO, w[61]); 
  FFV1_2(w[7], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[62]); 
  FFV1P0_3(w[62], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[63]); 
  FFV1_1(w[4], w[21], pars->GC_11, pars->ZERO, pars->ZERO, w[64]); 
  FFV1P0_3(w[7], w[64], pars->GC_11, pars->ZERO, pars->ZERO, w[65]); 
  FFV1_1(w[4], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[66]); 
  VVV1P0_1(w[21], w[39], pars->GC_10, pars->ZERO, pars->ZERO, w[67]); 
  FFV1_2(w[7], w[39], pars->GC_11, pars->ZERO, pars->ZERO, w[68]); 
  FFV1P0_3(w[68], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[69]); 
  FFV1P0_3(w[7], w[66], pars->GC_11, pars->ZERO, pars->ZERO, w[70]); 
  FFV1P0_3(w[61], w[4], pars->GC_11, pars->ZERO, pars->ZERO, w[71]); 
  FFV1P0_3(w[7], w[59], pars->GC_11, pars->ZERO, pars->ZERO, w[72]); 
  ...
  FFV1_0(w[1], w[23], w[22], pars->GC_11, amp[16]); 
  ...
  FFV1_0(w[1], w[27], w[22], pars->GC_11, amp[24]); 
  ...
  FFV1_0(w[0], w[19], w[41], pars->GC_11, amp[75]); 
  ...
  FFV1_0(w[0], w[23], w[46], pars->GC_11, amp[85]); 
  ...
  FFV1_0(w[0], w[27], w[46], pars->GC_11, amp[93]); 
  FFV1_0(w[38], w[44], w[8], pars->GC_11, amp[94]); 
  FFV1_0(w[45], w[27], w[8], pars->GC_11, amp[95]); 
  FFV1_0(w[1], w[12], w[48], pars->GC_11, amp[96]); 
  FFV1_0(w[13], w[6], w[48], pars->GC_11, amp[97]); 
  FFV1_0(w[1], w[17], w[50], pars->GC_11, amp[98]); 
  FFV1_0(w[15], w[6], w[50], pars->GC_11, amp[99]); 
  FFV1_0(w[1], w[12], w[52], pars->GC_11, amp[100]); 
  FFV1_0(w[13], w[6], w[52], pars->GC_11, amp[101]); 
  FFV1_0(w[1], w[17], w[54], pars->GC_11, amp[102]); 
  FFV1_0(w[15], w[6], w[54], pars->GC_11, amp[103]); 
  FFV1_0(w[1], w[19], w[48], pars->GC_11, amp[104]); 
  FFV1_0(w[20], w[6], w[48], pars->GC_11, amp[105]); 
  FFV1_0(w[1], w[17], w[56], pars->GC_11, amp[106]); 
  FFV1_0(w[15], w[6], w[56], pars->GC_11, amp[107]); 
  FFV1_0(w[1], w[19], w[52], pars->GC_11, amp[108]); 
  FFV1_0(w[20], w[6], w[52], pars->GC_11, amp[109]); 
  FFV1_0(w[1], w[17], w[58], pars->GC_11, amp[110]); 
  FFV1_0(w[15], w[6], w[58], pars->GC_11, amp[111]); 
  FFV1_0(w[47], w[53], w[43], pars->GC_11, amp[112]); 
  FFV1_0(w[47], w[59], w[10], pars->GC_2, amp[113]); 
  FFV1_0(w[49], w[51], w[43], pars->GC_11, amp[114]); 
  FFV1_0(w[49], w[4], w[60], pars->GC_11, amp[115]); 
  FFV1_0(w[49], w[59], w[9], pars->GC_11, amp[116]); 
  FFV1_0(w[61], w[51], w[10], pars->GC_2, amp[117]); 
  FFV1_0(w[61], w[53], w[9], pars->GC_11, amp[118]); 
  FFV1_0(w[7], w[53], w[60], pars->GC_11, amp[119]); 
  ...
  FFV1_0(w[55], w[4], w[60], pars->GC_11, amp[123]); 
  ...
  FFV1_0(w[7], w[57], w[60], pars->GC_11, amp[127]); 
  FFV1_0(w[1], w[23], w[63], pars->GC_11, amp[128]); 
  FFV1_0(w[13], w[5], w[63], pars->GC_11, amp[129]); 
  FFV1_0(w[1], w[26], w[50], pars->GC_11, amp[130]); 
  FFV1_0(w[25], w[5], w[50], pars->GC_11, amp[131]); 
  FFV1_0(w[1], w[23], w[65], pars->GC_11, amp[132]); 
  FFV1_0(w[13], w[5], w[65], pars->GC_11, amp[133]); 
  FFV1_0(w[1], w[26], w[54], pars->GC_11, amp[134]); 
  FFV1_0(w[25], w[5], w[54], pars->GC_11, amp[135]); 
  FFV1_0(w[1], w[27], w[63], pars->GC_11, amp[136]); 
  FFV1_0(w[20], w[5], w[63], pars->GC_11, amp[137]); 
  FFV1_0(w[1], w[26], w[56], pars->GC_11, amp[138]); 
  FFV1_0(w[25], w[5], w[56], pars->GC_11, amp[139]); 
  FFV1_0(w[1], w[27], w[65], pars->GC_11, amp[140]); 
  FFV1_0(w[20], w[5], w[65], pars->GC_11, amp[141]); 
  FFV1_0(w[1], w[26], w[58], pars->GC_11, amp[142]); 
  FFV1_0(w[25], w[5], w[58], pars->GC_11, amp[143]); 
  FFV1_0(w[62], w[53], w[39], pars->GC_11, amp[144]); 
  FFV1_0(w[62], w[66], w[10], pars->GC_2, amp[145]); 
  FFV1_0(w[49], w[64], w[39], pars->GC_11, amp[146]); 
  FFV1_0(w[49], w[4], w[67], pars->GC_11, amp[147]); 
  FFV1_0(w[49], w[66], w[21], pars->GC_11, amp[148]); 
  FFV1_0(w[68], w[64], w[10], pars->GC_2, amp[149]); 
  FFV1_0(w[68], w[53], w[21], pars->GC_11, amp[150]); 
  FFV1_0(w[7], w[53], w[67], pars->GC_11, amp[151]); 
  ...
  FFV1_0(w[55], w[4], w[67], pars->GC_11, amp[155]); 
  ...
  FFV1_0(w[7], w[57], w[67], pars->GC_11, amp[159]); 
  FFV1_0(w[42], w[6], w[50], pars->GC_11, amp[160]); 
  FFV1_0(w[0], w[40], w[50], pars->GC_11, amp[161]); 
  FFV1_0(w[31], w[6], w[69], pars->GC_11, amp[162]); 
  FFV1_0(w[0], w[12], w[69], pars->GC_11, amp[163]); 
  FFV1_0(w[31], w[6], w[70], pars->GC_11, amp[164]); 
  FFV1_0(w[42], w[6], w[54], pars->GC_11, amp[165]); 
  FFV1_0(w[0], w[40], w[54], pars->GC_11, amp[166]); 
  FFV1_0(w[0], w[12], w[70], pars->GC_11, amp[167]); 
  FFV1_0(w[42], w[6], w[56], pars->GC_11, amp[168]); 
  FFV1_0(w[0], w[40], w[56], pars->GC_11, amp[169]); 
  FFV1_0(w[38], w[6], w[69], pars->GC_11, amp[170]); 
  FFV1_0(w[0], w[19], w[69], pars->GC_11, amp[171]); 
  FFV1_0(w[38], w[6], w[70], pars->GC_11, amp[172]); 
  FFV1_0(w[42], w[6], w[58], pars->GC_11, amp[173]); 
  FFV1_0(w[0], w[40], w[58], pars->GC_11, amp[174]); 
  FFV1_0(w[0], w[19], w[70], pars->GC_11, amp[175]); 
  FFV1_0(w[45], w[5], w[50], pars->GC_11, amp[176]); 
  FFV1_0(w[0], w[44], w[50], pars->GC_11, amp[177]); 
  FFV1_0(w[31], w[5], w[71], pars->GC_11, amp[178]); 
  FFV1_0(w[0], w[23], w[71], pars->GC_11, amp[179]); 
  FFV1_0(w[31], w[5], w[72], pars->GC_11, amp[180]); 
  FFV1_0(w[45], w[5], w[54], pars->GC_11, amp[181]); 
  FFV1_0(w[0], w[44], w[54], pars->GC_11, amp[182]); 
  FFV1_0(w[0], w[23], w[72], pars->GC_11, amp[183]); 
  FFV1_0(w[45], w[5], w[56], pars->GC_11, amp[184]); 
  FFV1_0(w[0], w[44], w[56], pars->GC_11, amp[185]); 
  FFV1_0(w[38], w[5], w[71], pars->GC_11, amp[186]); 
  FFV1_0(w[0], w[27], w[71], pars->GC_11, amp[187]); 
  FFV1_0(w[38], w[5], w[72], pars->GC_11, amp[188]); 
  FFV1_0(w[45], w[5], w[58], pars->GC_11, amp[189]); 
  FFV1_0(w[0], w[44], w[58], pars->GC_11, amp[190]); 
  FFV1_0(w[0], w[27], w[72], pars->GC_11, amp[191]); 

}
double CPPProcess::matrix_dd_epemuddux_no_h() 
{
  int i, j; 
  // Local variables
  ...
  jamp[0] = +1./4. * (-std::complex<double> (0, 1) * amp[0] -
  ...
  jamp[1] = +1./4. * (+std::complex<double> (0, 1) * amp[16] +
  ...
  jamp[3] = +1./4. * (+std::complex<double> (0, 1) * amp[0] +
      ...
      * amp[150] + 1./3. * amp[152] + 1./3. * amp[153] + 1./3. * amp[154] +
      ...
      amp[189] + amp[191]);
  jamp[4] = +1./4. * (+1./9. * amp[2] + 1./9. * amp[3] + 1./9. * amp[4] + 1./9.
