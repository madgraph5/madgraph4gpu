...
#define MGONGPU_RANDEXTRAS_ONHOST 1
...
//  const int nepp = 32; // choose 32, i.e. the number of threads in a warp
  const int nepp = 1; // testing cupla single threaded cpu
