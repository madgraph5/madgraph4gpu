...
namespace MG5_sm
{
               ...
               )
  {
    ...
    const fptype_sv& pvec0 = kernelAccessConstMomenta( allmomenta, 0, ipar );
    const fptype_sv& pvec1 = kernelAccessConstMomenta( allmomenta, 1, ipar );
    const fptype_sv& pvec2 = kernelAccessConstMomenta( allmomenta, 2, ipar );
    const fptype_sv& pvec3 = kernelAccessConstMomenta( allmomenta, 3, ipar );
#else
    const fptype_sv& pvec0 = kernelAccessConstMomenta( allmomenta, 0 );
    const fptype_sv& pvec1 = kernelAccessConstMomenta( allmomenta, 1 );
    const fptype_sv& pvec2 = kernelAccessConstMomenta( allmomenta, 2 );
