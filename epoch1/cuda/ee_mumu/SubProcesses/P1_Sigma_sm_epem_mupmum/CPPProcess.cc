...
namespace MG5_sm
{
               ...
               cxtype* vertex )      // output: amplitude
  {
    ...
    const cxtype TMP0 = (F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cxI * (V3[4]))) +
                         (F1[3] * (F2[4] * (V3[3] - cxI * (V3[4])) + F2[5] * (V3[2] - V3[5])) +
                          (F1[4] * (F2[2] * (V3[2] - V3[5]) - F2[3] * (V3[3] + cxI * (V3[4]))) +
                           F1[5] * (F2[2] * (-V3[3] + cxI * (V3[4])) + F2[3] * (V3[2] + V3[5])))));
    (*vertex) = COUP * - cxI * TMP0;
    mgDebug( 1, __FUNCTION__ );
    return;
  }
                 ...
                 cxtype V3[] )        // output: wavefunction3[6]
  {
    ...
    V3[2] = denom * (-cxI) * (F1[2] * F2[4] + F1[3] * F2[5] + F1[4] * F2[2] + F1[5] * F2[3]);
    V3[3] = denom * (-cxI) * (-F1[2] * F2[5] - F1[3] * F2[4] + F1[4] * F2[3] + F1[5] * F2[2]);
    V3[4] = denom * (-cxI) * (-cxI * (F1[2] * F2[5] + F1[5] * F2[2]) + cxI * (F1[3] * F2[4] + F1[4] * F2[3]));
    V3[5] = denom * (-cxI) * (-F1[2] * F2[4] - F1[5] * F2[3] + F1[3] * F2[5] + F1[4] * F2[2]);
    mgDebug( 1, __FUNCTION__ );
    return;
  }
               ...
               cxtype* vertex )     // output: amplitude
  {
    mgDebug( 0, __FUNCTION__ );
    const cxtype cxI( 0., 1. );
    const cxtype TMP1 = (F1[2] * (F2[4] * (V3[2] + V3[5]) + F2[5] * (V3[3] + cxI * (V3[4]))) +
                         F1[3] * (F2[4] * (V3[3] - cxI * (V3[4])) + F2[5] * (V3[2] - V3[5])));
    (*vertex) = COUP * - cxI * TMP1;
    mgDebug( 1, __FUNCTION__ );
    return;
  }
               ...
               cxtype V3[] )        // output: wavefunction3[6]
  {
    ...
    const cxtype denom = COUP/((P3[0] * P3[0]) - (P3[1] * P3[1]) - (P3[2] * P3[2]) - (P3[3] * P3[3]) - M3 * (M3 - cxI * W3));
    V3[2] = denom * (-cxI) * (F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP2);
    V3[3] = denom * (-cxI) * (-F1[2] * F2[5] - F1[3] * F2[4] - P3[1] * OM3 * TMP2);
    V3[4] = denom * (-cxI) * (-cxI * (F1[2] * F2[5]) + cxI * (F1[3] * F2[4]) - P3[2] * OM3 * TMP2);
    V3[5] = denom * (-cxI) * (-F1[2] * F2[4] - P3[3] * OM3 * TMP2 + F1[3] * F2[5]);
    mgDebug( 1, __FUNCTION__ );
    return;
  }
