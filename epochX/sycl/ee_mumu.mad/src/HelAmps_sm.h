...
#define ALWAYS_INLINE
  ...
  void FFV2_4_0( const cxtype_sv F1[],
                 const cxtype_sv F2[],
                 const cxtype_sv V3[],
                 const cxtype_sv COUP1,
                 const cxtype_sv COUP2,
                 cxtype_sv* vertex ) ALWAYS_INLINE;
  ...
  void FFV1_0( const cxtype_sv F1[],
               ...
               cxtype_sv* vertex )
  {
    const cxtype_sv TMP0 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + ( F1[3] * ( F2[4] * ( V3[3]- CXIMAGINARYI_SV * ( V3[4] ) ) + F2[5] * ( V3[2] - V3[5] ) ) + ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + F1[5] * ( F2[2] * ( -V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) + F2[3] * ( V3[2] + V3[5] ) ) ) ) );
    (*vertex) = COUP * - CXIMAGINARYI_SV * TMP0;
  }
  ...
  void FFV2_0( const cxtype_sv F1[],
               ...
               cxtype_sv* vertex )
  {
    const cxtype_sv TMP1 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + F1[3] * ( F2[4] * ( V3[3]- CXIMAGINARYI_SV * ( V3[4] ) ) + F2[5] * ( V3[2] - V3[5] ) ) );
    (*vertex) = COUP * - CXIMAGINARYI_SV * TMP1;
  }
               ...
               cxtype_sv V3[] )
  {
    ...
    V3[1] = + F1[1] + F2[1];
    const fptype_sv P3[4] = { -CXREAL( V3[0] ), -CXREAL( V3[1] ), -CXIMAG( V3[1] ), -CXIMAG( V3[0] ) };
    const cxtype_sv TMP2 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + CXIMAGINARYI_SV * ( P3[2] ) ) ) + F1[3] * ( F2[4] * ( P3[1]- CXIMAGINARYI_SV * ( P3[2] ) ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv denom = COUP / ( (P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - CXIMAGINARYI_SV * W3 ) );
    V3[2] = denom * (- CXIMAGINARYI_SV) * ( F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP2 );
    V3[3] = denom * (- CXIMAGINARYI_SV) * ( -F1[2] * F2[5] - F1[3] * F2[4] - P3[1] * OM3 * TMP2 );
    V3[4] = denom * (- CXIMAGINARYI_SV) * ( - CXIMAGINARYI_SV * ( F1[2] * F2[5] ) + CXIMAGINARYI_SV * ( F1[3] * F2[4] ) - P3[2] * OM3 * TMP2 );
    V3[5] = denom * (- CXIMAGINARYI_SV) * ( -F1[2] * F2[4] - P3[3] * OM3 * TMP2 + F1[3] * F2[5] );
  }
               ...
               cxtype_sv* vertex )
  {
    ...
    const cxtype_sv TMP1 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + F1[3] * ( F2[4] * ( V3[3]- CXIMAGINARYI_SV * ( V3[4] ) ) + F2[5] * ( V3[2] - V3[5] ) ) );
    const cxtype_sv TMP3 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + F1[5] * ( F2[2] * ( -V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) + F2[3] * ( V3[2] + V3[5] ) ) );
    (*vertex) = COUP * (- one) * ( +CXIMAGINARYI_SV * ( TMP1 ) + two * CXIMAGINARYI_SV * ( TMP3 ) );
  }
               ...
               cxtype_sv V3[] )
  {
    ...
    const cxtype_sv TMP2 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + CXIMAGINARYI_SV * ( P3[2] ) ) ) + F1[3] * ( F2[4] * ( P3[1]- CXIMAGINARYI_SV * ( P3[2] ) ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv TMP4 = ( F1[4] * ( F2[2] * ( P3[0] - P3[3] ) - F2[3] * ( P3[1] + CXIMAGINARYI_SV * ( P3[2] ) ) ) + F1[5] * ( F2[2] * ( -P3[1] + CXIMAGINARYI_SV * ( P3[2] ) ) + F2[3] * ( P3[0] + P3[3] ) ) );
    const cxtype_sv denom = COUP / ( (P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - CXIMAGINARYI_SV * W3 ) );
    V3[2] = denom * (- two * CXIMAGINARYI_SV) * ( OM3 * - half * P3[0] * ( TMP2 + two * ( TMP4 ) ) + ( +half * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) );
    V3[3] = denom * (- two * CXIMAGINARYI_SV) * ( OM3 * - half * P3[1] * ( TMP2 + two * ( TMP4 ) ) + ( - half * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) );
    V3[4] = denom * two * CXIMAGINARYI_SV * ( OM3 * half * P3[2] * ( TMP2 + two * ( TMP4 ) ) + ( +half * CXIMAGINARYI_SV * ( F1[2] * F2[5] )- half * CXIMAGINARYI_SV * ( F1[3] * F2[4] )- CXIMAGINARYI_SV * ( F1[4] * F2[3] ) + CXIMAGINARYI_SV * ( F1[5] * F2[2] ) ) );
    V3[5] = denom * two * CXIMAGINARYI_SV * ( OM3 * half * P3[3] * ( TMP2 + two * ( TMP4 ) ) + ( +half * ( F1[2] * F2[4] )- half * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) );
  }
                 ...
                 cxtype_sv* vertex )
  {
    ...
    const cxtype_sv TMP1 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + F1[3] * ( F2[4] * ( V3[3]- CXIMAGINARYI_SV * ( V3[4] ) ) + F2[5] * ( V3[2] - V3[5] ) ) );
    const cxtype_sv TMP3 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + F1[5] * ( F2[2] * ( -V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) + F2[3] * ( V3[2] + V3[5] ) ) );
    (*vertex) = (- one) * ( COUP2 * ( +CXIMAGINARYI_SV * ( TMP1 ) + two * CXIMAGINARYI_SV * ( TMP3 ) ) + CXIMAGINARYI_SV * ( TMP1 * COUP1 ) );
  }
                 ...
                 cxtype_sv V3[] )
  {
    ...
    const cxtype_sv TMP2 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + CXIMAGINARYI_SV * ( P3[2] ) ) ) + F1[3] * ( F2[4] * ( P3[1]- CXIMAGINARYI_SV * ( P3[2] ) ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv TMP4 = ( F1[4] * ( F2[2] * ( P3[0] - P3[3] ) - F2[3] * ( P3[1] + CXIMAGINARYI_SV * ( P3[2] ) ) ) + F1[5] * ( F2[2] * ( -P3[1] + CXIMAGINARYI_SV * ( P3[2] ) ) + F2[3] * ( P3[0] + P3[3] ) ) );
    const cxtype_sv denom = one / ( (P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - CXIMAGINARYI_SV * W3 ) );
    V3[2] = denom * (- two * CXIMAGINARYI_SV) * ( COUP2 * ( OM3 * - half * P3[0] * ( TMP2 + two * ( TMP4 ) ) + ( +half * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) ) + half * ( COUP1 * ( F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP2 ) ) );
    V3[3] = denom * (- two * CXIMAGINARYI_SV) * ( COUP2 * ( OM3 * - half * P3[1] * ( TMP2 + two * ( TMP4 ) ) + ( - half * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) )- half * ( COUP1 * ( F1[2] * F2[5] + F1[3] * F2[4] + P3[1] * OM3 * TMP2 ) ) );
    V3[4] = denom * CXIMAGINARYI_SV * ( COUP2 * ( OM3 * P3[2] * ( TMP2 + two * ( TMP4 ) ) + ( +CXIMAGINARYI_SV * ( F1[2] * F2[5] )- CXIMAGINARYI_SV * ( F1[3] * F2[4] )- two * CXIMAGINARYI_SV * ( F1[4] * F2[3] ) + two * CXIMAGINARYI_SV * ( F1[5] * F2[2] ) ) ) + COUP1 * ( +CXIMAGINARYI_SV * ( F1[2] * F2[5] )- CXIMAGINARYI_SV * ( F1[3] * F2[4] ) + P3[2] * OM3 * TMP2 ) );
    V3[5] = denom * two * CXIMAGINARYI_SV * ( COUP2 * ( OM3 * half * P3[3] * ( TMP2 + two * ( TMP4 ) ) + ( +half * ( F1[2] * F2[4] )- half * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) ) + half * ( COUP1 * ( F1[2] * F2[4] + P3[3] * OM3 * TMP2 - F1[3] * F2[5] ) ) );
  }
