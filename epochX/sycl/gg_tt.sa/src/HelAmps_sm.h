...
#define ALWAYS_INLINE
                 ...
                 cxtype_sv V1[] )
  {
    ...
    V1[2] = denom * ( TMP4 * ( - CXIMAGINARYI_SV * ( P2[0] ) + CXIMAGINARYI_SV * ( P3[0] ) ) + ( V2[2] * ( - CXIMAGINARYI_SV * ( TMP0 ) + CXIMAGINARYI_SV * ( TMP1 ) ) + V3[2] * ( +CXIMAGINARYI_SV * ( TMP2 )- CXIMAGINARYI_SV * ( TMP3 ) ) ) );
    V1[3] = denom * ( TMP4 * ( - CXIMAGINARYI_SV * ( P2[1] ) + CXIMAGINARYI_SV * ( P3[1] ) ) + ( V2[3] * ( - CXIMAGINARYI_SV * ( TMP0 ) + CXIMAGINARYI_SV * ( TMP1 ) ) + V3[3] * ( +CXIMAGINARYI_SV * ( TMP2 )- CXIMAGINARYI_SV * ( TMP3 ) ) ) );
    V1[4] = denom * ( TMP4 * ( - CXIMAGINARYI_SV * ( P2[2] ) + CXIMAGINARYI_SV * ( P3[2] ) ) + ( V2[4] * ( - CXIMAGINARYI_SV * ( TMP0 ) + CXIMAGINARYI_SV * ( TMP1 ) ) + V3[4] * ( +CXIMAGINARYI_SV * ( TMP2 )- CXIMAGINARYI_SV * ( TMP3 ) ) ) );
    V1[5] = denom * ( TMP4 * ( - CXIMAGINARYI_SV * ( P2[3] ) + CXIMAGINARYI_SV * ( P3[3] ) ) + ( V2[5] * ( - CXIMAGINARYI_SV * ( TMP0 ) + CXIMAGINARYI_SV * ( TMP1 ) ) + V3[5] * ( +CXIMAGINARYI_SV * ( TMP2 )- CXIMAGINARYI_SV * ( TMP3 ) ) ) );
  }
  ...
  void FFV1_0( const cxtype_sv F1[],
               ...
               cxtype_sv* vertex )
  {
    const cxtype_sv TMP5 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + ( F1[3] * ( F2[4] * ( V3[3]- CXIMAGINARYI_SV * ( V3[4] ) ) + F2[5] * ( V3[2] - V3[5] ) ) + ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) ) + F1[5] * ( F2[2] * ( -V3[3] + CXIMAGINARYI_SV * ( V3[4] ) ) + F2[3] * ( V3[2] + V3[5] ) ) ) ) );
    (*vertex) = COUP * - CXIMAGINARYI_SV * TMP5;
  }
