...
namespace mg5amcGpu
{
  ...
  //ALWAYS_INLINE // attributes are not permitted in a function definition
  {
...

    {
      ...
      VVV1P0_1( w_fp[0], w_fp[1], cxmake( cIPC[0], cIPC[1] ), 0., 0., w_fp[5] );
      FFV1P0_3( w_fp[3], w_fp[2], cxmake( cIPC[2], cIPC[3] ), 0., 0., w_fp[6] );

      // Amplitude(s) for diagram number 1
      VVV1_0( w_fp[5], w_fp[6], w_fp[4], cxmake( cIPC[0], cIPC[1] ), &amp_fp[0] );
      jamp_sv[0] -= amp_sv[0];
      jamp_sv[2] += +amp_sv[0];
      jamp_sv[4] += +amp_sv[0];
      jamp_sv[5] -= amp_sv[0];
      ...
      FFV1_1( w_fp[2], w_fp[4], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_fp[7] );

      // Amplitude(s) for diagram number 2
      FFV1_0( w_fp[3], w_fp[7], w_fp[5], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      ...
      FFV1_2( w_fp[3], w_fp[4], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_fp[8] );

      // Amplitude(s) for diagram number 3
      FFV1_0( w_fp[8], w_fp[2], w_fp[5], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      ...
      FFV1_1( w_fp[2], w_fp[0], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_fp[5] );
      FFV1_2( w_fp[3], w_fp[1], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_fp[9] );

      // Amplitude(s) for diagram number 4
      FFV1_0( w_fp[9], w_fp[5], w_fp[4], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[1] -= amp_sv[0];

      // *** DIAGRAM 5 OF 16 ***

      // Wavefunction(s) for diagram number 5
      VVV1P0_1( w_fp[1], w_fp[4], cxmake( cIPC[0], cIPC[1] ), 0., 0., w_fp[10] );

      // Amplitude(s) for diagram number 5
      FFV1_0( w_fp[3], w_fp[5], w_fp[10], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[0] += +cxtype(0,1)*amp_sv[0];
      ...
      FFV1_0( w_fp[8], w_fp[5], w_fp[1], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[0] -= amp_sv[0];

      // *** DIAGRAM 7 OF 16 ***

      // Wavefunction(s) for diagram number 7
      FFV1_2( w_fp[3], w_fp[0], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_fp[5] );
      FFV1_1( w_fp[2], w_fp[1], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_fp[11] );

      // Amplitude(s) for diagram number 7
      FFV1_0( w_fp[5], w_fp[11], w_fp[4], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[3] -= amp_sv[0];
      ...
      FFV1_0( w_fp[5], w_fp[2], w_fp[10], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      ...
      FFV1_0( w_fp[5], w_fp[7], w_fp[1], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[5] -= amp_sv[0];

      // *** DIAGRAM 10 OF 16 ***

      // Wavefunction(s) for diagram number 10
      VVV1P0_1( w_fp[0], w_fp[4], cxmake( cIPC[0], cIPC[1] ), 0., 0., w_fp[5] );

      // Amplitude(s) for diagram number 10
      FFV1_0( w_fp[3], w_fp[11], w_fp[5], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[2] += +cxtype(0,1)*amp_sv[0];
      jamp_sv[3] -= cxtype(0,1)*amp_sv[0];
      ...
      FFV1_0( w_fp[9], w_fp[2], w_fp[5], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[1] += +cxtype(0,1)*amp_sv[0];
      jamp_sv[4] -= cxtype(0,1)*amp_sv[0];
      ...
      VVV1_0( w_fp[5], w_fp[1], w_fp[6], cxmake( cIPC[0], cIPC[1] ), &amp_fp[0] );
      jamp_sv[1] += +amp_sv[0];
      jamp_sv[2] -= amp_sv[0];
      jamp_sv[3] += +amp_sv[0];
      jamp_sv[4] -= amp_sv[0];
      ...
      FFV1_0( w_fp[8], w_fp[11], w_fp[0], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[2] -= amp_sv[0];
      ...
      FFV1_0( w_fp[9], w_fp[7], w_fp[0], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[4] -= amp_sv[0];
      ...
      VVV1_0( w_fp[0], w_fp[10], w_fp[6], cxmake( cIPC[0], cIPC[1] ), &amp_fp[0] );
      jamp_sv[0] += +amp_sv[0];
      jamp_sv[1] -= amp_sv[0];
      jamp_sv[3] -= amp_sv[0];
      jamp_sv[5] += +amp_sv[0];
      ...
      VVVV1P0_1( w_fp[0], w_fp[1], w_fp[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_fp[10] );
      VVVV3P0_1( w_fp[0], w_fp[1], w_fp[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_fp[6] );
      VVVV4P0_1( w_fp[0], w_fp[1], w_fp[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_fp[9] );

      // Amplitude(s) for diagram number 16
      FFV1_0( w_fp[3], w_fp[2], w_fp[10], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[0] += +amp_sv[0];
      jamp_sv[1] -= amp_sv[0];
      jamp_sv[3] -= amp_sv[0];
      jamp_sv[5] += +amp_sv[0];
      FFV1_0( w_fp[3], w_fp[2], w_fp[6], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[1] -= amp_sv[0];
      jamp_sv[2] += +amp_sv[0];
      jamp_sv[3] -= amp_sv[0];
      jamp_sv[4] += +amp_sv[0];
      FFV1_0( w_fp[3], w_fp[2], w_fp[9], cxmake( cIPC[2], cIPC[3] ), &amp_fp[0] );
      jamp_sv[0] -= amp_sv[0];
      jamp_sv[2] += +amp_sv[0];
      jamp_sv[4] += +amp_sv[0];
      jamp_sv[5] -= amp_sv[0];
