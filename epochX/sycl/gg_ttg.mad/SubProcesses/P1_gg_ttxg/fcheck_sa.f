...
C Further modified by: A. Valassi (2022-2023) for the MG5aMC CUDACPP plugin.
      ...
      PARAMETER(NEVTMAX=2048*256, NEXTERNAL=5, NP4=4)
...
C
      NEVTOK = 0
      MES_SUM = 0
      CALL FBRIDGECREATE(BRIDGE, NEVT, NEXTERNAL, NP4) ! this must be at the beginning as it initialises the SYCL device
...
c         WRITE(6,*)
      ...
      CALL FBRIDGEDELETE(BRIDGE) ! this must be at the end as it shuts down the SYCL device
