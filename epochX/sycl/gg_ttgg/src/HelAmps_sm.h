...
#define ALWAYS_INLINE
  ...
  SYCL_EXTERNAL INLINE
  void VVV1_0( const fptype allV1[],
               const fptype allV2[],
               const fptype allV3[],
               const cxtype COUP,
  ...
  SYCL_EXTERNAL INLINE
  void VVVV1_0( const fptype allV1[],
                const fptype allV2[],
                const fptype allV3[],
                const fptype allV4[],
                const cxtype COUP,
  ...
  SYCL_EXTERNAL INLINE
  void VVVV1P0_1( const fptype allV2[],
                  const fptype allV3[],
                  const fptype allV4[],
                  const cxtype COUP,
                  const fptype M1,
  ...
  SYCL_EXTERNAL INLINE
  void VVVV3_0( const fptype allV1[],
                const fptype allV2[],
                const fptype allV3[],
                const fptype allV4[],
                const cxtype COUP,
  ...
  SYCL_EXTERNAL INLINE
  void VVVV3P0_1( const fptype allV2[],
                  const fptype allV3[],
                  const fptype allV4[],
                  const cxtype COUP,
                  const fptype M1,
  ...
  SYCL_EXTERNAL INLINE
  void VVVV4_0( const fptype allV1[],
                const fptype allV2[],
                const fptype allV3[],
                const fptype allV4[],
                const cxtype COUP,
  ...
  SYCL_EXTERNAL INLINE
  void VVVV4P0_1( const fptype allV2[],
                  const fptype allV3[],
                  const fptype allV4[],
                  const cxtype COUP,
                  const fptype M1,
  ...
  {
    mgDebug( 0, __FUNCTION__ );
    const cxtype_sv* V1 = reinterpret_cast<const cxtype_sv*>( allV1 );
    const cxtype_sv* V2 = reinterpret_cast<const cxtype_sv*>( allV2 );
                 ...
                 fptype allV1[] )
  {
    ...
    const cxtype_sv* V2 = reinterpret_cast<const cxtype_sv*>( allV2 );
    const cxtype_sv* V3 = reinterpret_cast<const cxtype_sv*>( allV3 );
    cxtype_sv* V1 = reinterpret_cast<cxtype_sv*>( allV1 );
    const cxtype cI = cxmake( 0., 1. );
    const fptype_sv P2[4] = { +cxreal( V2[0] ), +cxreal( V2[1] ), +cximag( V2[1] ), +cximag( V2[0] ) };
    const fptype_sv P3[4] = { +cxreal( V3[0] ), +cxreal( V3[1] ), +cximag( V3[1] ), +cximag( V3[0] ) };
    V1[0] = + V2[0] + V3[0];
               ...
               fptype allF1[] )
  {
    ...
    const cxtype_sv* F2 = reinterpret_cast<const cxtype_sv*>( allF2 );
    const cxtype_sv* V3 = reinterpret_cast<const cxtype_sv*>( allV3 );
    cxtype_sv* F1 = reinterpret_cast<cxtype_sv*>( allF1 );
    const cxtype cI = cxmake( 0., 1. );
    F1[0] = + F2[0] + V3[0];
    F1[1] = + F2[1] + V3[1];
               ...
               fptype allF2[] )
  {
    ...
    const cxtype_sv* F1 = reinterpret_cast<const cxtype_sv*>( allF1 );
    const cxtype_sv* V3 = reinterpret_cast<const cxtype_sv*>( allV3 );
    cxtype_sv* F2 = reinterpret_cast<cxtype_sv*>( allF2 );
    const cxtype cI = cxmake( 0., 1. );
    F2[0] = + F1[0] + V3[0];
    F2[1] = + F1[1] + V3[1];
                 ...
                 fptype allV3[] )
  {
    ...
    const cxtype_sv* F1 = reinterpret_cast<const cxtype_sv*>( allF1 );
    const cxtype_sv* F2 = reinterpret_cast<const cxtype_sv*>( allF2 );
    cxtype_sv* V3 = reinterpret_cast<cxtype_sv*>( allV3 );
    const cxtype cI = cxmake( 0., 1. );
    V3[0] = + F1[0] + F2[0];
    V3[1] = + F1[1] + F2[1];
    const fptype_sv P3[4] = { -cxreal( V3[0] ), -cxreal( V3[1] ), -cximag( V3[1] ), -cximag( V3[0] ) };
                ...
                fptype allvertexes[] )
  {
    ...
    const cxtype_sv* V2 = reinterpret_cast<const cxtype_sv*>( allV2 );
    const cxtype_sv* V3 = reinterpret_cast<const cxtype_sv*>( allV3 );
    const cxtype_sv* V4 = reinterpret_cast<const cxtype_sv*>( allV4 );
    cxtype_sv* vertex = reinterpret_cast<cxtype_sv*>( allvertexes );
    const cxtype cI = cxmake( 0., 1. );
