...
#define ALWAYS_INLINE
                  ...
                  cxtype_sv V1[] )
  {
    ...
    const cxtype_sv TMP6 = ( V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5] );
    const cxtype_sv denom = COUP / ( (P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - CXIMAGINARYI_SV * W1 ) );
    V1[2] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[2] ) + CXIMAGINARYI_SV * ( V3[2] * TMP10 ) );
    V1[3] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[3] ) + CXIMAGINARYI_SV * ( V3[3] * TMP10 ) );
    V1[4] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[4] ) + CXIMAGINARYI_SV * ( V3[4] * TMP10 ) );
    V1[5] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[5] ) + CXIMAGINARYI_SV * ( V3[5] * TMP10 ) );
  }
                  ...
                  cxtype_sv V1[] )
  {
    ...
    const cxtype_sv TMP6 = ( V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5] );
    const cxtype_sv denom = COUP / ( (P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - CXIMAGINARYI_SV * W1 ) );
    V1[2] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[2] ) + CXIMAGINARYI_SV * ( V2[2] * TMP11 ) );
    V1[3] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[3] ) + CXIMAGINARYI_SV * ( V2[3] * TMP11 ) );
    V1[4] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[4] ) + CXIMAGINARYI_SV * ( V2[4] * TMP11 ) );
    V1[5] = denom * ( - CXIMAGINARYI_SV * ( TMP6 * V4[5] ) + CXIMAGINARYI_SV * ( V2[5] * TMP11 ) );
  }
                  ...
                  cxtype_sv V1[] )
  {
    ...
    const cxtype_sv TMP11 = ( V3[2] * V4[2] - V3[3] * V4[3] - V3[4] * V4[4] - V3[5] * V4[5] );
    const cxtype_sv denom = COUP / ( (P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - CXIMAGINARYI_SV * W1 ) );
    V1[2] = denom * ( - CXIMAGINARYI_SV * ( V3[2] * TMP10 ) + CXIMAGINARYI_SV * ( V2[2] * TMP11 ) );
    V1[3] = denom * ( - CXIMAGINARYI_SV * ( V3[3] * TMP10 ) + CXIMAGINARYI_SV * ( V2[3] * TMP11 ) );
    V1[4] = denom * ( - CXIMAGINARYI_SV * ( V3[4] * TMP10 ) + CXIMAGINARYI_SV * ( V2[4] * TMP11 ) );
    V1[5] = denom * ( - CXIMAGINARYI_SV * ( V3[5] * TMP10 ) + CXIMAGINARYI_SV * ( V2[5] * TMP11 ) );
  }
