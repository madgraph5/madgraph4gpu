...
#pragma omp parallel for default(none) shared(allmomenta,allMEs,cHel,cIPC,cIPD,ihel,npagV) private (amp_sv,w_sv,jamp_sv)
...
#endif
    {
...
#ifdef ALPAKA
      VVV1P0_1( acc, w_sv[0], w_sv[1], cxmake( cIPC[0], cIPC[1] ), 0., 0., w_sv[5] );
#else
      VVV1P0_1( w_sv[0], w_sv[1], cxmake( cIPC[0], cIPC[1] ), 0., 0., w_sv[5] );
#endif
#ifdef ALPAKA
      FFV1P0_3( acc, w_sv[3], w_sv[2], cxmake( cIPC[2], cIPC[3] ), 0., 0., w_sv[6] );
#else
...
#ifdef ALPAKA
      VVV1_0( acc, w_sv[5], w_sv[6], w_sv[4], cxmake( cIPC[0], cIPC[1] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_1( acc, w_sv[2], w_sv[4], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[7] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[3], w_sv[7], w_sv[5], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_2( acc, w_sv[3], w_sv[4], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[8] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[8], w_sv[2], w_sv[5], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_1( acc, w_sv[2], w_sv[0], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[5] );
#else
      FFV1_1( w_sv[2], w_sv[0], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[5] );
#endif
#ifdef ALPAKA
      FFV1_2( acc, w_sv[3], w_sv[1], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[9] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[9], w_sv[5], w_sv[4], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      VVV1P0_1( acc, w_sv[1], w_sv[4], cxmake( cIPC[0], cIPC[1] ), 0., 0., w_sv[10] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[3], w_sv[5], w_sv[10], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[8], w_sv[5], w_sv[1], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_2( acc, w_sv[3], w_sv[0], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[5] );
#else
      FFV1_2( w_sv[3], w_sv[0], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[5] );
#endif
#ifdef ALPAKA
      FFV1_1( acc, w_sv[2], w_sv[1], cxmake( cIPC[2], cIPC[3] ), cIPD[0], cIPD[1], w_sv[11] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[5], w_sv[11], w_sv[4], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[5], w_sv[2], w_sv[10], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[5], w_sv[7], w_sv[1], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      VVV1P0_1( acc, w_sv[0], w_sv[4], cxmake( cIPC[0], cIPC[1] ), 0., 0., w_sv[5] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[3], w_sv[11], w_sv[5], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[9], w_sv[2], w_sv[5], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      VVV1_0( acc, w_sv[5], w_sv[1], w_sv[6], cxmake( cIPC[0], cIPC[1] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[8], w_sv[11], w_sv[0], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[9], w_sv[7], w_sv[0], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      VVV1_0( acc, w_sv[0], w_sv[10], w_sv[6], cxmake( cIPC[0], cIPC[1] ), &amp_sv[0] );
#else
...
#ifdef ALPAKA
      VVVV1P0_1( acc, w_sv[0], w_sv[1], w_sv[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_sv[10] );
#else
      VVVV1P0_1( w_sv[0], w_sv[1], w_sv[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_sv[10] );
#endif
#ifdef ALPAKA
      VVVV3P0_1( acc, w_sv[0], w_sv[1], w_sv[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_sv[6] );
#else
      VVVV3P0_1( w_sv[0], w_sv[1], w_sv[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_sv[6] );
#endif
#ifdef ALPAKA
      VVVV4P0_1( acc, w_sv[0], w_sv[1], w_sv[4], cxmake( cIPC[4], cIPC[5] ), 0., 0., w_sv[9] );
#else
...
#ifdef ALPAKA
      FFV1_0( acc, w_sv[3], w_sv[2], w_sv[10], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
      ...
      jamp_sv[5] += +amp_sv[0];
#ifdef ALPAKA
      FFV1_0( acc, w_sv[3], w_sv[2], w_sv[6], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
      ...
      jamp_sv[4] += +amp_sv[0];
#ifdef ALPAKA
      FFV1_0( acc, w_sv[3], w_sv[2], w_sv[9], cxmake( cIPC[2], cIPC[3] ), &amp_sv[0] );
#else
