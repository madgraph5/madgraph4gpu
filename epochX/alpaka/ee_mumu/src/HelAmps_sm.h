...
#define ALWAYS_INLINE
  ...
  template< typename T_Acc >
  ALPAKA_FN_ACC  INLINE
  void FFV2_0( __attribute__((unused)) T_Acc const &acc,
#else
  __device__ INLINE
  void FFV2_0( 
#endif
  ...
  template< typename T_Acc >
  ALPAKA_FN_ACC  INLINE
  void FFV2_3( __attribute__((unused)) T_Acc const &acc,
#else
  __device__ INLINE
  void FFV2_3( 
#endif
  ...
  template< typename T_Acc >
  ALPAKA_FN_ACC  INLINE
  void FFV4_0( __attribute__((unused)) T_Acc const &acc,
#else
  __device__ INLINE
  void FFV4_0( 
#endif
  ...
  template< typename T_Acc >
  ALPAKA_FN_ACC  INLINE
  void FFV4_3( __attribute__((unused)) T_Acc const &acc,
#else
  __device__ INLINE
  void FFV4_3( 
#endif
