...
#include "diagrams_boilerplate.h"
    ...
    FFV1_2( w_fp[4], w_fp[0], COUPs[0], 1.0, depCoup, 0., 0., w_fp[5] );
    ...
    FFV1P0_3( w_fp[4], w_fp[1], COUPs[0], 1.0, depCoup, 0., 0., w_fp[7] );
    ...
    FFV1_1( w_fp[1], w_fp[0], COUPs[0], 1.0, depCoup, 0., 0., w_fp[5] );
    // Amplitude(s) for diagram number 4
    FFV1_0( w_fp[4], w_fp[5], w_fp[6], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
