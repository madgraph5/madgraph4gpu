...
#include "diagrams_boilerplate.h"
    ...
    FFV1_2( w_fp[1], w_fp[0], COUPs[0], 1.0, depCoup, 0., 0., w_fp[5] );
    FFV1P0_3( w_fp[3], w_fp[2], COUPs[0], 1.0, depCoup, 0., 0., w_fp[6] );
    // Amplitude(s) for diagram number 1
    FFV1_0( w_fp[5], w_fp[4], w_fp[6], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[2], w_fp[0], COUPs[0], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[5] );
    FFV1P0_3( w_fp[1], w_fp[4], COUPs[0], 1.0, depCoup, 0., 0., w_fp[7] );
    // Amplitude(s) for diagram number 2
    FFV1_0( w_fp[3], w_fp[5], w_fp[7], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[3], w_fp[0], COUPs[0], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[5] );
    // Amplitude(s) for diagram number 3
    FFV1_0( w_fp[5], w_fp[2], w_fp[7], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[4], w_fp[0], COUPs[0], 1.0, depCoup, 0., 0., w_fp[5] );
    // Amplitude(s) for diagram number 4
    FFV1_0( w_fp[1], w_fp[5], w_fp[6], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    VVV1_0( w_fp[0], w_fp[7], w_fp[6], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
