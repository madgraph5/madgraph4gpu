...
#endif
{
  ...
  public:
    ...
    static constexpr auto ieventAccessRecordConst = static_cast<const fptype* (*) (const fptype*, const int)>(&MemoryAccessHelper<MemoryAccessGsBase>::ieventAccessRecordConst);
  ...
  public:
    ...
    static constexpr auto kernelAccessConst_s = static_cast<const fptype& (*) (const fptype*)>(
