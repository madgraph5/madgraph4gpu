...
c Use null-terminated C-string in COUNTERS_REGISTER_COUNTER calls (maybe it is not needed, but it does not harm)
      CALL COUNTERS_REGISTER_COUNTER( 1, 'Fortran X2F'//char(0) )
      ...
      CALL COUNTERS_REGISTER_COUNTER( 12, 'Fortran TEST'//char(0) )
      CALL COUNTERS_REGISTER_COUNTER( 13, 'Fortran TEST2'//char(0) )
      CALL COUNTERS_REGISTER_COUNTER( 14, 'Fortran TEST3'//char(0) )
      CALL COUNTERS_REGISTER_COUNTER( 15, 'Fortran TEST4'//char(0) )
      CALL COUNTERS_REGISTER_COUNTER( 16, 'Fortran TEST5'//char(0) )
      CALL COUNTERS_REGISTER_COUNTER( 17, 'Fortran TEST6'//char(0) )
      CALL COUNTERS_REGISTER_COUNTER( 19, 'PROGRAM initial_I/O'//char(0) )
      CALL COUNTERS_REGISTER_COUNTER( 20, 'PROGRAM sample_full'//char(0) )
#ifdef MG5AMC_MEEXPORTER_CUDACPP
