...
#pragma nv_diagnostic pop
      ...
      if ( ihel == 0 )
      {
        std::cout
          ...
          //<< " W00 = " << w_sv[0][0] << " W01 = " << w_sv[0][1] << " W02 = " << w_sv[0][2] << " W03 = " << w_sv[0][3] << " W04 = " << w_sv[0][4] << " W05 = " << w_sv[0][5] // no issue
          //<< " W10 = " << w_sv[1][0] << " W11 = " << w_sv[1][1] << " W12 = " << w_sv[1][2] << " W13 = " << w_sv[1][3] << " W14 = " << w_sv[1][4] << " W15 = " << w_sv[1][5] // no issue
          //<< " W30 = " << w_sv[3][0] << " W31 = " << w_sv[3][1] << " W32 = " << w_sv[3][2] << " W33 = " << w_sv[3][3] << " W34 = " << w_sv[3][4] << " W35 = " << w_sv[3][5] // no issue
          << " W40 = " << w_sv[4][0] << " W41 = " << w_sv[4][1] << " W42 = " << w_sv[4][2] << " W43 = " << w_sv[4][3] << " W44 = " << w_sv[4][4] << " W45 = " << w_sv[4][5] // DIFF HERE
          << " AMP2 = " << amp_sv[0] // DIFF HERE
          << std::endl;
      }
#endif
