...
#ifndef MG5_Sigma_EWdim6_udx_wpz_H
#define MG5_Sigma_EWdim6_udx_wpz_H 1
...
#endif
{
  ...
  public:
    ...
    static constexpr int ncomb = 36; // #helicity combinations: e.g. 16 for e+ e- -> mu+ mu- (2**4 = fermion spin up/down ** npar)
    ...
    //static const int ncomb = 36; // CPPProcess::ncomb
...
#endif // MG5_Sigma_EWdim6_udx_wpz_H
