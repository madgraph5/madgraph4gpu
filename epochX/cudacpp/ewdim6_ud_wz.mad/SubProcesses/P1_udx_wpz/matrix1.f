...
C     
C     Process: u d~ > w+ z HIG<=1 HIW<=1 NP<=2 WEIGHTED<=6 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WZ)
      ...
      CALL FFV2_3(W(1,1),W(1,2),GC_145,MDL_MW, FK_MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVV2_3_5_6_7_8_9_0(W(1,5),W(1,3),W(1,4),GC_114,GC_109
     $ ,GC_115,GC_113,GC_110,GC_39,GC_38,AMP(1))
