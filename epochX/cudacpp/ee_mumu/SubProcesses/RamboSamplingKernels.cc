...
#endif
{
  ...
  RamboSamplingKernelHost::RamboSamplingKernelHost( const fptype energy,                // input: energy
                                                    ...
                                                    const size_t nevt )
    : SamplingKernelBase( energy, rnarray, momenta, weights ), NumberOfEvents( nevt )
  {
...
#ifdef __CUDACC__
  __global__ void getMomentaFinalDevice( const fptype energy, const fptype* rnarray, fptype* momenta, fptype* wgts )
  {
