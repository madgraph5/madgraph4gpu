...
#pragma omp parallel for default(none) shared(allmomenta,allMEs,cHel,cIPC,cIPD,ihel,npagV) private (amp_sv,w_sv,jamp_sv)
...
#endif
    {
      ...
      //imzxxx<HostAccessMomenta>( allmomenta, cHel[ihel][1], +1, w_sv[1], 1 ); // NB: imzxxx only uses pz (NEW apihel)
#endif
      ...
      oxzxxx<HostAccessMomenta>( allmomenta, cHel[ihel][3], +1, w_sv[1], 3 ); // NEW apihel
#endif
