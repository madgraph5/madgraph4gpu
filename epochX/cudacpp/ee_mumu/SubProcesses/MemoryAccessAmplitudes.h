...
private:
  ...
  static __host__ __device__ inline fptype& decodeRecord( fptype* buffer, const int ix2 )
  {
...
public:
  ...
  static constexpr auto decodeRecordIx2Const = MemoryAccessHelper<MemoryAccessAmplitudesBase>::template decodeRecordConst<int>;

  // Locate a field (output) in a memory buffer (input) from the given event number (input) and the given field indexes (input)
  // [Signature (non-const) ===> fptype& ieventAccessIx2( fptype* buffer, const ievt, const int ix2 ) <===]
  static constexpr auto ieventAccessIx2 = MemoryAccessHelper<MemoryAccessAmplitudesBase>::template ieventAccessField<int>;
...
public:
  ...
  static __host__ __device__ inline cxtype_sv* kernelAccess( fptype* buffer ) { return reinterpret_cast<cxtype_sv*>( buffer ); }

  static __host__ __device__ inline const cxtype_sv* kernelAccessConst( const fptype* buffer )
  {
