...
namespace mgOnGpu
{
  ...
  constexpr unsigned int nchannels = 72;
  ...
  __device__ constexpr int channel2iconfig[72] = { // note: a trailing comma in the initializer list is allowed
     ...
     -1, // CHANNEL_ID=67  i.e. DIAGRAM=67  --> ICONFIG=-1 (diagram with no associated iconfig for single-diagram enhancement)
     67, // CHANNEL_ID=68  i.e. DIAGRAM=68  --> ICONFIG=67
     68, // CHANNEL_ID=69  i.e. DIAGRAM=69  --> ICONFIG=68
     -1, // CHANNEL_ID=70  i.e. DIAGRAM=70  --> ICONFIG=-1 (diagram with no associated iconfig for single-diagram enhancement)
...
#else
  constexpr int hostChannel2iconfig[72] = { // note: a trailing comma in the initializer list is allowed
      1, // CHANNEL_ID=1   i.e. DIAGRAM=1   --> ICONFIG=1
      2, // CHANNEL_ID=2   i.e. DIAGRAM=2   --> ICONFIG=2
      3, // CHANNEL_ID=3   i.e. DIAGRAM=3   --> ICONFIG=3
      4, // CHANNEL_ID=4   i.e. DIAGRAM=4   --> ICONFIG=4
  ...
  constexpr unsigned int nconfigSDE = 70;
