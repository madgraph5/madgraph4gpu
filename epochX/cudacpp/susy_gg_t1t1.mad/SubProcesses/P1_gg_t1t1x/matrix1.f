...
C     Amplitude(s) for diagram number 1
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_90(IVEC),AMP(1))
      CALL VVSS1_0(W(1,1),W(1,2),W(1,4),W(1,3),GC_90(IVEC),AMP(2))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_6(IVEC),ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,5),W(1,4),W(1,3),GC_55(IVEC),AMP(3))
      CALL VSS1_2(W(1,1),W(1,3),GC_55(IVEC),MDL_MSU3, FK_MDL_WSU3,W(1
     $ ,5))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,2),W(1,4),W(1,5),GC_55(IVEC),AMP(4))
      CALL VSS1_3(W(1,1),W(1,3),-GC_57(IVEC),MDL_MSU6, FK_MDL_WSU6,W(1
     $ ,5))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,2),W(1,4),W(1,5),GC_57(IVEC),AMP(5))
      CALL VSS1_3(W(1,1),W(1,4),GC_55(IVEC),MDL_MSU3, FK_MDL_WSU3,W(1
     $ ,5))
C     Amplitude(s) for diagram number 5
      CALL VSS1_0(W(1,2),W(1,5),W(1,3),GC_55(IVEC),AMP(6))
      CALL VSS1_3(W(1,1),W(1,4),GC_57(IVEC),MDL_MSU6, FK_MDL_WSU6,W(1
     $ ,5))
C     Amplitude(s) for diagram number 6
      CALL VSS1_0(W(1,2),W(1,3),W(1,5),-GC_57(IVEC),AMP(7))
