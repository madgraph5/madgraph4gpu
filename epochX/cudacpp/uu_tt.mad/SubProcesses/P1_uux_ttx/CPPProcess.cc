...
#endif
{
  ...
  constexpr int nIPD = 1; // SM independent parameters used in this CPPProcess.cc (FIXME? rename as sm_IndepParam?)
  ...
  __device__ const fptype cIPD[nIPD] = { (fptype)Parameters_sm::mdl_MT };
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_uux_ttx()?)
  ...
  CPPProcess::initProc( const std::string& param_card_name )
  {
    ...
    const fptype tIPD[nIPD] = { (fptype)m_pars->mdl_MT };
