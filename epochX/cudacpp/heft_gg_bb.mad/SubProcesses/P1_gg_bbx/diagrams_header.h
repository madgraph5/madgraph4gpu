...
#endif
{
  ...
  using Parameters_heft_dependentCouplings::ndcoup;   // #couplings that vary event by event (depend on running alphas QC>
  using Parameters_heft_independentCouplings::nicoup; // #couplings that are fixed for all events (do not depend on runni>
