...
C     
C     Process: g g > b b~ HIG<=1 HIW<=1 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $     *SMALL_WIDTH_TREATMENT)), MDL_WH)
      ...
      CALL VVS3_3(W(1,1),W(1,2),GC_13(IVEC),MDL_MH, FK_MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL FFS2_0(W(1,4),W(1,3),W(1,5),GC_74,AMP(1))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_10(IVEC),ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),GC_11(IVEC),AMP(2))
      CALL FFV1_1(W(1,3),W(1,1),GC_11(IVEC),MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),GC_11(IVEC),AMP(3))
      CALL FFV1_2(W(1,4),W(1,1),GC_11(IVEC),MDL_MB, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),GC_11(IVEC),AMP(4))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(2)+(-1.000000000000000D+00)*AMP(4)
      JAMP(3,1) = (-2.000000000000000D+00)*AMP(1)
