...
#ifndef MG5_Sigma_sm_no_b_mass_dux_ttxwmg_H
#define MG5_Sigma_sm_no_b_mass_dux_ttxwmg_H 1
...
#endif
{
  ...
  public:
    ...
    static constexpr int ndiagramgroups = 3; // #groups of Feynman diagrams (with at most 5 diagrams per group)
    ...
    static const int nIPD = 3; // SM independent parameters (FIXME? rename as sm_IndepParam?)
    static const int nIPC = 1; // SM independent couplings (FIXME? rename as sm_IndepCoupl?)
...
#endif // MG5_Sigma_sm_no_b_mass_dux_ttxwmg_H
