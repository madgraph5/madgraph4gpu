...
#endif
{
  ...
  namespace Parameters_sm_no_b_mass // keep the same name rather than HardcodedParameters_sm_no_b_mass for simplicity
  {
    ...
    // Model couplings independent of aS
    constexpr cxsmpl<double> GC_100 = ( mdl_ee * mdl_complexi * mdl_conjg__CKM1x1 ) / ( mdl_sw * mdl_sqrt__2 );
...
#pragma nv_diagnostic pop
  ...
  namespace Parameters_sm_no_b_mass_independentCouplings
  {
    ...
    //constexpr size_t ixcoup_GC_100 = 0 + Parameters_sm_no_b_mass_dependentCouplings::ndcoup; // out of ndcoup+nicoup
  }
