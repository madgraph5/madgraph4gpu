...
C     
C     Process: g u~ > t t~ g u~ WEIGHTED<=4 @1
C     Process: g c~ > t t~ g c~ WEIGHTED<=4 @1
C     Process: g d~ > t t~ g d~ WEIGHTED<=4 @1
C     Process: g s~ > t t~ g s~ WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WT)
      ...
      CALL FFV1_2(W(1,6),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,7))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_11(IVEC),ZERO, FK_ZERO,W(1,8))
      CALL FFV1_2(W(1,7),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_11(IVEC),AMP(1))
      CALL FFV1P0_3(W(1,7),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,8),W(1,5),W(1,9),GC_10(IVEC),AMP(2))
      CALL FFV1_1(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,7),W(1,10),W(1,8),GC_11(IVEC),AMP(3))
      CALL FFV1_1(W(1,3),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,7),W(1,9),GC_11(IVEC),AMP(4))
      CALL FFV1_2(W(1,4),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,11))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,11),W(1,3),W(1,9),GC_11(IVEC),AMP(5))
      CALL FFV1_1(W(1,3),W(1,1),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,9))
      CALL FFV1_2(W(1,6),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
      CALL FFV1P0_3(W(1,4),W(1,9),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,12),W(1,2),W(1,13),GC_11(IVEC),AMP(6))
      CALL FFV1P0_3(W(1,6),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 7
      CALL VVV1_0(W(1,14),W(1,5),W(1,13),GC_10(IVEC),AMP(7))
      CALL FFV1_1(W(1,9),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,15))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,4),W(1,15),W(1,14),GC_11(IVEC),AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,11),W(1,9),W(1,14),GC_11(IVEC),AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,10),W(1,13),GC_11(IVEC),AMP(10))
      CALL FFV1_2(W(1,4),W(1,1),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,13))
      CALL FFV1P0_3(W(1,13),W(1,3),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,12),W(1,2),W(1,9),GC_11(IVEC),AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVV1_0(W(1,14),W(1,5),W(1,9),GC_10(IVEC),AMP(12))
      CALL FFV1_2(W(1,13),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,15))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,15),W(1,3),W(1,14),GC_11(IVEC),AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,13),W(1,7),W(1,14),GC_11(IVEC),AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,6),W(1,10),W(1,9),GC_11(IVEC),AMP(15))
      CALL VVV1P0_1(W(1,1),W(1,5),GC_10(IVEC),ZERO, FK_ZERO,W(1,9))
      CALL FFV1_1(W(1,3),W(1,9),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,13))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,4),W(1,13),W(1,14),GC_11(IVEC),AMP(16))
      CALL FFV1_2(W(1,4),W(1,9),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,13))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,13),W(1,3),W(1,14),GC_11(IVEC),AMP(17))
C     Amplitude(s) for diagram number 18
      CALL VVV1_0(W(1,9),W(1,14),W(1,8),GC_10(IVEC),AMP(18))
      CALL FFV1_2(W(1,6),W(1,9),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,13),W(1,2),W(1,8),GC_11(IVEC),AMP(19))
      CALL FFV1_1(W(1,2),W(1,9),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,6),W(1,13),W(1,8),GC_11(IVEC),AMP(20))
      CALL FFV1_1(W(1,2),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,12),W(1,13),W(1,8),GC_11(IVEC),AMP(21))
      CALL FFV1P0_3(W(1,6),W(1,13),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 22
      CALL VVV1_0(W(1,8),W(1,5),W(1,9),GC_10(IVEC),AMP(22))
      CALL FFV1_1(W(1,13),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,6),W(1,15),W(1,8),GC_11(IVEC),AMP(23))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,7),W(1,9),GC_11(IVEC),AMP(24))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,11),W(1,3),W(1,9),GC_11(IVEC),AMP(25))
      CALL FFV1_2(W(1,12),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_11(IVEC),AMP(26))
      CALL VVV1P0_1(W(1,1),W(1,8),GC_10(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,12),W(1,2),W(1,9),GC_11(IVEC),AMP(27))
C     Amplitude(s) for diagram number 28
      CALL VVVV1_0(W(1,1),W(1,14),W(1,8),W(1,5),GC_12(IVEC),AMP(28))
      CALL VVVV3_0(W(1,1),W(1,14),W(1,8),W(1,5),GC_12(IVEC),AMP(29))
      CALL VVVV4_0(W(1,1),W(1,14),W(1,8),W(1,5),GC_12(IVEC),AMP(30))
      CALL VVV1P0_1(W(1,1),W(1,14),GC_10(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 29
      CALL VVV1_0(W(1,8),W(1,5),W(1,12),GC_10(IVEC),AMP(31))
C     Amplitude(s) for diagram number 30
      CALL VVV1_0(W(1,14),W(1,5),W(1,9),GC_10(IVEC),AMP(32))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,4),W(1,7),W(1,12),GC_11(IVEC),AMP(33))
      CALL FFV1_1(W(1,7),W(1,1),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,4),W(1,5),W(1,14),GC_11(IVEC),AMP(34))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,11),W(1,3),W(1,12),GC_11(IVEC),AMP(35))
      CALL FFV1_2(W(1,11),W(1,1),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,12))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,12),W(1,3),W(1,14),GC_11(IVEC),AMP(36))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,6),W(1,10),W(1,9),GC_11(IVEC),AMP(37))
      CALL FFV1_1(W(1,10),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,6),W(1,9),W(1,8),GC_11(IVEC),AMP(38))

      JAMP(:,:) = (0D0,0D0)
C     JAMPs contributing to orders ALL_ORDERS=1
      TMP_JAMP(3) = AMP(29) +  AMP(32)  ! used 4 times
      TMP_JAMP(2) = AMP(18) +  AMP(30)  ! used 4 times
      TMP_JAMP(1) = AMP(28) +  AMP(31)  ! used 4 times
     ...
     $ -1.000000000000000D+00)) * AMP(7)  ! used 2 times
      TMP_JAMP(15) = TMP_JAMP(1) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(2)  ! used 2 times
      TMP_JAMP(14) = TMP_JAMP(1) + ((-0.000000000000000D+00,
     $ -1.000000000000000D+00)) * AMP(35)  ! used 2 times
      TMP_JAMP(13) = TMP_JAMP(1) + ((-0.000000000000000D+00,
     $ -1.000000000000000D+00)) * AMP(22)  ! used 2 times
      TMP_JAMP(12) = AMP(20) + ((0.000000000000000D+00,
     $ -1.000000000000000D+00)) * AMP(38)  ! used 2 times
      TMP_JAMP(11) = AMP(13) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(17)  ! used 2 times
      TMP_JAMP(10) = AMP(1) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(19)  ! used 2 times
      TMP_JAMP(9) = AMP(16) +  AMP(17)  ! used 2 times
      TMP_JAMP(8) = AMP(16) +  AMP(19)  ! used 2 times
      TMP_JAMP(7) = AMP(19) + ((-0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(26)  ! used 2 times
      TMP_JAMP(6) = AMP(8) + ((0.000000000000000D+00,
     $ -1.000000000000000D+00)) * AMP(16)  ! used 2 times
      TMP_JAMP(5) = AMP(17) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(36)  ! used 2 times
      TMP_JAMP(4) = AMP(20) + ((0.000000000000000D+00
     $ ,1.000000000000000D+00)) * AMP(23)  ! used 2 times
      JAMP(1,1) = (5.000000000000000D-01)*AMP(11)+((0.000000000000000D
     $ +00,5.000000000000000D-01))*AMP(12)+(5.000000000000000D-01)
     $ *AMP(14)+(5.000000000000000D-01)*AMP(21)+(5.000000000000000D-01)
     $ *AMP(24)+((0.000000000000000D+00,5.000000000000000D-01))*AMP(33)
     $ +(5.000000000000000D-01)*TMP_JAMP(13)+(5.000000000000000D-01)
     $ *TMP_JAMP(17)
      JAMP(2,1) = (-1.666666666666667D-01)*AMP(4)+(-1.666666666666667D
     $ -01)*AMP(5)+(-1.666666666666667D-01)*AMP(24)+(
     $ -1.666666666666667D-01)*AMP(25)
      JAMP(3,1) = (-1.666666666666667D-01)*AMP(6)+(-1.666666666666667D
     $ -01)*AMP(10)+(-1.666666666666667D-01)*AMP(11)+(
     $ -1.666666666666667D-01)*AMP(15)
      JAMP(4,1) = ((0.000000000000000D+00,5.000000000000000D-01))
     $ *AMP(2)+(5.000000000000000D-01)*AMP(3)+(5.000000000000000D-01)
     $ *AMP(5)+(5.000000000000000D-01)*AMP(9)+(5.000000000000000D-01)
     $ *AMP(10)+((0.000000000000000D+00,5.000000000000000D-01))*AMP(37)
     $ +(5.000000000000000D-01)*TMP_JAMP(14)+(5.000000000000000D-01)
     $ *TMP_JAMP(16)
      JAMP(5,1) = (5.000000000000000D-01)*AMP(25)+((0.000000000000000D
     $ +00,5.000000000000000D-01))*AMP(35)+(5.000000000000000D-01)
     $ *TMP_JAMP(2)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *TMP_JAMP(4)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *TMP_JAMP(5)+(-5.000000000000000D-01)*TMP_JAMP(13)
      JAMP(6,1) = (-1.666666666666667D-01)*AMP(21)
     $ +((0.000000000000000D+00,1.666666666666667D-01))*TMP_JAMP(4)
     $ +((0.000000000000000D+00,1.666666666666667D-01))*TMP_JAMP(7)
      JAMP(7,1) = (-1.666666666666667D-01)*AMP(9)+((0.000000000000000D
     $ +00,1.666666666666667D-01))*TMP_JAMP(5)+(-1.666666666666667D-01)
     $ *TMP_JAMP(6)
      JAMP(8,1) = (5.000000000000000D-01)*AMP(6)+((0.000000000000000D
     ...
     $ -5.000000000000000D-01)*TMP_JAMP(16)
      JAMP(9,1) = (5.000000000000000D-01)*AMP(1)+(5.000000000000000D
     $ -01)*AMP(4)+((0.000000000000000D+00,-5.000000000000000D-01))
     $ *AMP(33)+(5.000000000000000D-01)*AMP(34)+(5.000000000000000D-01)
     $ *TMP_JAMP(2)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(8)+(-5.000000000000000D-01)*TMP_JAMP(15)
      JAMP(10,1) = (-1.666666666666667D-01)*AMP(13)+(
     $ -1.666666666666667D-01)*AMP(14)+(-1.666666666666667D-01)*AMP(34)
     $ +((0.000000000000000D+00,-1.666666666666667D-01))*TMP_JAMP(9)
      JAMP(11,1) = (-1.666666666666667D-01)*AMP(3)+(
     $ -1.666666666666667D-01)*TMP_JAMP(10)+((0.000000000000000D+00,
     $ -1.666666666666667D-01))*TMP_JAMP(12)
      JAMP(12,1) = ((0.000000000000000D+00,-5.000000000000000D-01))
     $ *AMP(12)+(5.000000000000000D-01)*AMP(15)+((0.000000000000000D
     $ +00,-5.000000000000000D-01))*AMP(37)+(5.000000000000000D-01)
     $ *TMP_JAMP(11)+((0.000000000000000D+00,5.000000000000000D-01))
     $ *TMP_JAMP(12)+(-5.000000000000000D-01)*TMP_JAMP(18)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        ...
        AMP2(32)=AMP2(32)+AMP(34)*DCONJG(AMP(34))
        AMP2(33)=AMP2(33)+AMP(35)*DCONJG(AMP(35))
        AMP2(34)=AMP2(34)+AMP(36)*DCONJG(AMP(36))
