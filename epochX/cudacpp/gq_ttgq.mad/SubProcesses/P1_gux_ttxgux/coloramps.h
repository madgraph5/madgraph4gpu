...
namespace mgOnGpu
{
  ...
  __device__ constexpr int channel2iconfig[36] = { // note: a trailing comma in the initializer list is allowed
     ...
     -1, // CHANNEL_ID=28  i.e. DIAGRAM=28  --> ICONFIG=-1 (diagram with no associated iconfig for single-diagram enhancement)
     ...
     31, // CHANNEL_ID=32  i.e. DIAGRAM=32  --> ICONFIG=31
     32, // CHANNEL_ID=33  i.e. DIAGRAM=33  --> ICONFIG=32
     33, // CHANNEL_ID=34  i.e. DIAGRAM=34  --> ICONFIG=33
  ...
  __device__ constexpr bool icolamp[35][12] = { // note: a trailing comma in the initializer list is allowed
    { false, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=1   <-- CHANNEL_ID=1
    { false, false, false,  true, false, false, false, false,  true, false, false, false }, // ICONFIG=2   <-- CHANNEL_ID=2
    { false, false, false,  true, false, false, false, false, false, false, false, false }, // ICONFIG=3   <-- CHANNEL_ID=3
    { false, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=4   <-- CHANNEL_ID=4
    { false, false, false,  true, false, false, false, false, false, false, false, false }, // ICONFIG=5   <-- CHANNEL_ID=5
    { false, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=6   <-- CHANNEL_ID=6
    { false, false, false,  true, false, false, false,  true, false, false, false, false }, // ICONFIG=7   <-- CHANNEL_ID=7
    { false, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=8   <-- CHANNEL_ID=8
    { false, false, false,  true, false, false, false, false, false, false, false, false }, // ICONFIG=9   <-- CHANNEL_ID=9
    { false, false, false,  true, false, false, false, false, false, false, false, false }, // ICONFIG=10  <-- CHANNEL_ID=10
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=11  <-- CHANNEL_ID=11
    {  true, false, false, false, false, false, false, false, false, false, false,  true }, // ICONFIG=12  <-- CHANNEL_ID=12
    { false, false, false, false, false, false, false, false, false, false, false,  true }, // ICONFIG=13  <-- CHANNEL_ID=13
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=14  <-- CHANNEL_ID=14
    { false, false, false, false, false, false, false, false, false, false, false,  true }, // ICONFIG=15  <-- CHANNEL_ID=15
    { false, false, false, false, false, false, false,  true,  true, false, false, false }, // ICONFIG=16  <-- CHANNEL_ID=16
    { false, false, false, false,  true, false, false, false, false, false, false,  true }, // ICONFIG=17  <-- CHANNEL_ID=17
    { false, false, false, false,  true, false, false,  true,  true, false, false,  true }, // ICONFIG=18  <-- CHANNEL_ID=18
    { false, false, false, false, false, false, false,  true,  true, false, false, false }, // ICONFIG=19  <-- CHANNEL_ID=19
    { false, false, false, false,  true, false, false, false, false, false, false,  true }, // ICONFIG=20  <-- CHANNEL_ID=20
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=21  <-- CHANNEL_ID=21
    {  true, false, false, false,  true, false, false, false, false, false, false, false }, // ICONFIG=22  <-- CHANNEL_ID=22
    { false, false, false, false,  true, false, false, false, false, false, false, false }, // ICONFIG=23  <-- CHANNEL_ID=23
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=24  <-- CHANNEL_ID=24
    { false, false, false, false,  true, false, false, false, false, false, false, false }, // ICONFIG=25  <-- CHANNEL_ID=25
    { false, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=26  <-- CHANNEL_ID=26
    {  true, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=27  <-- CHANNEL_ID=27
    {  true, false, false,  true,  true, false, false, false,  true, false, false, false }, // ICONFIG=28  <-- CHANNEL_ID=29
    {  true, false, false,  true, false, false, false,  true, false, false, false,  true }, // ICONFIG=29  <-- CHANNEL_ID=30
    {  true, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=30  <-- CHANNEL_ID=31
    { false, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=31  <-- CHANNEL_ID=32
    { false, false, false,  true,  true, false, false, false, false, false, false, false }, // ICONFIG=32  <-- CHANNEL_ID=33
    { false, false, false, false,  true, false, false, false, false, false, false, false }, // ICONFIG=33  <-- CHANNEL_ID=34
    { false, false, false,  true, false, false, false, false, false, false, false,  true }, // ICONFIG=34  <-- CHANNEL_ID=35
    { false, false, false, false, false, false, false, false, false, false, false,  true }, // ICONFIG=35  <-- CHANNEL_ID=36
  };
