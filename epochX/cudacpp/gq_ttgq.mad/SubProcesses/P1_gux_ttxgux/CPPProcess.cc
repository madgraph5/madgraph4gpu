...
// Process: g u~ > t t~ g u~ WEIGHTED<=4 @1
// Process: g c~ > t t~ g c~ WEIGHTED<=4 @1
// Process: g d~ > t t~ g d~ WEIGHTED<=4 @1
// Process: g s~ > t t~ g s~ WEIGHTED<=4 @1
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[4], COUPs[0], 1.0, 0., 0., w_fp[8] );
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[1], COUPs[0], 1.0, 0., 0., w_fp[8] );

      // Amplitude(s) for diagram number 2
      VVV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[7], w_fp[4], w_fp[8], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[4], COUPs[0], 1.0, 0., 0., w_fp[9] );

      // Amplitude(s) for diagram number 3
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[9], w_fp[7], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[2], w_fp[4], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[6] );

      // Amplitude(s) for diagram number 4
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[6], w_fp[8], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[4], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[10] );

      // Amplitude(s) for diagram number 5
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[2], w_fp[8], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[2], w_fp[0], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[8] );
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[4], COUPs[0], 1.0, 0., 0., w_fp[11] );
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[8], COUPs[0], 1.0, 0., 0., w_fp[12] );

      // Amplitude(s) for diagram number 6
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[11], w_fp[1], w_fp[12], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[1], COUPs[0], 1.0, 0., 0., w_fp[13] );

      // Amplitude(s) for diagram number 7
      VVV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[13], w_fp[4], w_fp[12], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[8], w_fp[4], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[14] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[8], w_fp[13], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[9], w_fp[12], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[0], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[12] );
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[12], w_fp[2], COUPs[0], 1.0, 0., 0., w_fp[8] );
      ...
      VVV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[13], w_fp[4], w_fp[8], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[12], w_fp[4], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[14] );

      // Amplitude(s) for diagram number 13
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[14], w_fp[2], w_fp[13], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[12], w_fp[6], w_fp[13], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[9], w_fp[8], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      VVV1P0_1<W_ACCESS, CD_ACCESS>( w_fp[0], w_fp[4], COUPs[1], 1.0, 0., 0., w_fp[8] );
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[2], w_fp[8], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[12] );

      // Amplitude(s) for diagram number 16
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[12], w_fp[13], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[8], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[12] );

      // Amplitude(s) for diagram number 17
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[12], w_fp[2], w_fp[13], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      VVV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[8], w_fp[13], w_fp[7], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[8], COUPs[0], 1.0, 0., 0., w_fp[12] );

      // Amplitude(s) for diagram number 19
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[12], w_fp[1], w_fp[7], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[8], COUPs[0], 1.0, 0., 0., w_fp[12] );

      // Amplitude(s) for diagram number 20
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[12], w_fp[7], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[0], COUPs[0], 1.0, 0., 0., w_fp[12] );

      // Amplitude(s) for diagram number 21
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[11], w_fp[12], w_fp[7], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[12], COUPs[0], 1.0, 0., 0., w_fp[8] );
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[12], w_fp[4], COUPs[0], 1.0, 0., 0., w_fp[14] );

      // Amplitude(s) for diagram number 23
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[14], w_fp[7], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[11], w_fp[0], COUPs[0], 1.0, 0., 0., w_fp[8] );
      ...
      VVV1P0_1<W_ACCESS, CD_ACCESS>( w_fp[0], w_fp[7], COUPs[1], 1.0, 0., 0., w_fp[8] );
      ...
      VVVV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[0], w_fp[13], w_fp[7], w_fp[4], COUPs[2], 1.0, &amp_fp[0] );
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      jamp_sv[3] += 1. / 2. * amp_sv[0];
      jamp_sv[4] -= 1. / 2. * amp_sv[0];
      jamp_sv[8] -= 1. / 2. * amp_sv[0];
      VVVV3_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[0], w_fp[13], w_fp[7], w_fp[4], COUPs[2], 1.0, &amp_fp[0] );
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      jamp_sv[3] += 1. / 2. * amp_sv[0];
      jamp_sv[7] -= 1. / 2. * amp_sv[0];
      jamp_sv[11] -= 1. / 2. * amp_sv[0];
      VVVV4_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[0], w_fp[13], w_fp[7], w_fp[4], COUPs[2], 1.0, &amp_fp[0] );
      jamp_sv[4] += 1. / 2. * amp_sv[0];
      jamp_sv[7] -= 1. / 2. * amp_sv[0];
      jamp_sv[8] += 1. / 2. * amp_sv[0];
      jamp_sv[11] -= 1. / 2. * amp_sv[0];
      ...
      VVV1P0_1<W_ACCESS, CD_ACCESS>( w_fp[0], w_fp[13], COUPs[1], 1.0, 0., 0., w_fp[11] );

      // Amplitude(s) for diagram number 29
      VVV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[7], w_fp[4], w_fp[11], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[6], w_fp[11], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[0], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[4] );

      // Amplitude(s) for diagram number 32
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[4], w_fp[13], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[2], w_fp[11], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[10], w_fp[0], COUPs[0], 1.0, cIPD[0], cIPD[1], w_fp[11] );

      // Amplitude(s) for diagram number 34
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[11], w_fp[2], w_fp[13], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[9], w_fp[0], COUPs[0], 1.0, 0., 0., w_fp[8] );

      // Amplitude(s) for diagram number 36
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[8], w_fp[7], COUPs[0], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gux_ttxgux()?)
