...
#ifndef MG5_Sigma_heft_gg_h_H
#define MG5_Sigma_heft_gg_h_H 1
...
#endif
{
  ...
  public:
    ...
    static constexpr int nparf = 1; // #particles in the final state (outgoing): e.g. 2 (mu+ mu-) for e+ e- -> mu+ mu-
