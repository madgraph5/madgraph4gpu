...
// Process: g g > t t~ u u~ WEIGHTED<=4 @1
// Process: g g > t t~ c c~ WEIGHTED<=4 @1
// Process: g g > t t~ d d~ WEIGHTED<=4 @1
// Process: g g > t t~ s s~ WEIGHTED<=4 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gg_ttxuux()?)
