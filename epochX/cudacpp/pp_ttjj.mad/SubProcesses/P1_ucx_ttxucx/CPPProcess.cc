...
// Process: u c~ > t t~ u c~ WEIGHTED<=4 @1
// Process: u d~ > t t~ u d~ WEIGHTED<=4 @1
// Process: u s~ > t t~ u s~ WEIGHTED<=4 @1
// Process: c u~ > t t~ c u~ WEIGHTED<=4 @1
// Process: c d~ > t t~ c d~ WEIGHTED<=4 @1
// Process: c s~ > t t~ c s~ WEIGHTED<=4 @1
// Process: d u~ > t t~ d u~ WEIGHTED<=4 @1
// Process: d c~ > t t~ d c~ WEIGHTED<=4 @1
// Process: d s~ > t t~ d s~ WEIGHTED<=4 @1
// Process: s u~ > t t~ s u~ WEIGHTED<=4 @1
// Process: s c~ > t t~ s c~ WEIGHTED<=4 @1
// Process: s d~ > t t~ s d~ WEIGHTED<=4 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_ucx_ttxucx()?)
