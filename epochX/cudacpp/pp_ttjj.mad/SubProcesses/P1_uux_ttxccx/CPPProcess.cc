...
// Process: u u~ > t t~ c c~ WEIGHTED<=4 @1
// Process: u u~ > t t~ d d~ WEIGHTED<=4 @1
// Process: u u~ > t t~ s s~ WEIGHTED<=4 @1
// Process: c c~ > t t~ u u~ WEIGHTED<=4 @1
// Process: c c~ > t t~ d d~ WEIGHTED<=4 @1
// Process: c c~ > t t~ s s~ WEIGHTED<=4 @1
// Process: d d~ > t t~ u u~ WEIGHTED<=4 @1
// Process: d d~ > t t~ c c~ WEIGHTED<=4 @1
// Process: d d~ > t t~ s s~ WEIGHTED<=4 @1
// Process: s s~ > t t~ u u~ WEIGHTED<=4 @1
// Process: s s~ > t t~ c c~ WEIGHTED<=4 @1
// Process: s s~ > t t~ d d~ WEIGHTED<=4 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_uux_ttxccx()?)
