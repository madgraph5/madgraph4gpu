...
// Process: u u~ > t t~ g g WEIGHTED<=4 @1
// Process: c c~ > t t~ g g WEIGHTED<=4 @1
// Process: d d~ > t t~ g g WEIGHTED<=4 @1
// Process: s s~ > t t~ g g WEIGHTED<=4 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_uux_ttxgg()?)
