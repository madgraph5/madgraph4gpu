...
# check that either _curr_amps or _fks_multi_proc exists
    ...
    def check_generate(self, args):
        ...
        for key in self._curr_model['parameters'].keys():
            print ("HALLOMG-5", key, [o.name for o in self._curr_model['parameters'][key] if o.name])
...
#        line_options = dict(arg[2:].split('=') for arg in args if arg.startswith('--') and '=' not in arg)
        ...
        for key in self._curr_model['parameters'].keys():
            print ("HALLOMG-4", key, [o.name for o in self._curr_model['parameters'][key] if o.name])
        ...
        for key in self._curr_model['parameters'].keys():
            print ("HALLOMG-3", key, [o.name for o in self._curr_model['parameters'][key] if o.name])
...
""")
        ...
        for key in self._curr_model['parameters'].keys():
            print ("HALLOMG-2", key, [o.name for o in self._curr_model['parameters'][key] if o.name])
        ...
        for key in self._curr_model['parameters'].keys():
            print ("HALLOMG-2a", key, [o.name for o in self._curr_model['parameters'][key] if o.name])
        ...
        for key in self._curr_model['parameters'].keys():
            print ("HALLOMG-2b", key, [o.name for o in self._curr_model['parameters'][key] if o.name])
        ...
        for key in self._curr_model['parameters'].keys():
            print ("HALLOMG-1", key, [o.name for o in self._curr_model['parameters'][key] if o.name])
    ...
    def finalize(self, nojpeg, online = False, flaglist=[]):
        ...
        if self._model_v4_path:
            ...
            if 'store_model' in flaglist:
                ...
                tmptmpmodel = self._curr_model
                for key in tmptmpmodel['parameters'].keys():
                    print ("HALLOMG0", key, [o.name for o in tmptmpmodel['parameters'][key] if o.name])
                print("DEBUG: starting self._curr_exporter.convert_model")
                self._curr_exporter.convert_model(self._curr_model, 
                                               wanted_lorentz,
                                               wanted_couplings)
                print("DEBUG: completed self._curr_exporter.convert_model")
                tmptmpmodel = self._curr_model
                for key in tmptmpmodel['parameters'].keys():
                    print ("HALLOMG1", key, [o.name for o in tmptmpmodel['parameters'][key] if o.name])
                if self._me_curr_exporter:
                    print("DEBUG: starting self._me_curr_exporter.convert_model")
                    self._me_curr_exporter.convert_model(self._curr_model, 
                                               wanted_lorentz,
                                               wanted_couplings)
                    print("DEBUG: completed self._me_curr_exporter.convert_model")
                tmptmpmodel = self._curr_model
                for key in tmptmpmodel['parameters'].keys():
                    print ("HALLOMG2", key, [o.name for o in tmptmpmodel['parameters'][key] if o.name])
