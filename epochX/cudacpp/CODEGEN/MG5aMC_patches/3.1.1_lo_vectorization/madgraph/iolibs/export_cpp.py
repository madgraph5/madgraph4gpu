    ...
    def copy_template(self, model):
        ...
        with misc.chdir(self.dir_path):
            ...
            for key in model['parameters'].keys():
                print ("HALLOCC-ccc", key, [o.name for o in model['parameters'][key] if o.name])
            open(os.path.join("Cards","param_card.dat"), 'w').write(\
                                                       model.write_param_card())
            for key in model['parameters'].keys():
                print ("HALLOCC-ddd", key, [o.name for o in model['parameters'][key] if o.name])
        ...
        print("HALLO GOODBYE COPY TEMPLATE")
