...
param_card.inc: ../Cards/param_card.dat\n\t../bin/madevent treatcards param\n'''
    ...
    def convert_model(self, model, wanted_lorentz = [],
        ...
        print("HALLO! ENTERING CONVERT_MODEL")
        ...
        for key in tmptmpmodel['parameters'].keys():
            print ("HALLOTOP", key, [o.name for o in tmptmpmodel['parameters'][key] if o.name])
...
class UFO_model_to_mg4(object):
    ...
    def refactorize(self, wanted_couplings = []):    
        ...
        for key in keys:
            ...
            print ("HALLOKO", key, [o.name for o in self.model['parameters'][key] if o.name])
            if key == ('external',):
        ...
        for param in self.params_ext: print("HALLOK3", param.name)
        # same for couplings
...
c         segments from -DABS(tiny*Ga) to Ga
    ...
    def create_param_write(self):
        ...
        for param in self.params_ext: print("HALLO", param.name)
