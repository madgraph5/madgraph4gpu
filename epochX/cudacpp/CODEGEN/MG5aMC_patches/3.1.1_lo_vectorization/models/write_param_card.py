...
class ParamCardWriter(object):
    ...
    def __init__(self, model, filepath=None, write_special=True):
        ...
        for key in model['parameters'].keys():
            print ("HALLOWPC-ccc", key, [o.name for o in model['parameters'][key] if o.name])
        ...
        for key in model['parameters'].keys():
            print ("HALLOWPC-ccc2", key, [o.name for o in model['parameters'][key] if o.name])
        ...
        for key in model['parameters'].keys():
            print ("HALLOWPC-ccc3", key, [o.name for o in model['parameters'][key] if o.name])
        if filepath:
            self.define_output_file(filepath)
            for key in model['parameters'].keys():
                print ("HALLOWPC-ccc4", key, [o.name for o in model['parameters'][key] if o.name])
            self.write_card(write_special=write_special)
            for key in model['parameters'].keys():
                print ("HALLOWPC-ddd", key, [o.name for o in model['parameters'][key] if o.name])
    ...
    def write_card(self, path=None, write_special=True):
        ...
        for key in self.model['parameters'].keys():
            print ("HALLOWC-ccc", key, [o.name for o in self.model['parameters'][key] if o.name])
        self.external.sort(key=cmp_to_key(self.order_param))
        for key in self.model['parameters'].keys():
            print ("HALLOWC-ddd", key, [o.name for o in self.model['parameters'][key] if o.name])
