...
#===============================================================================
# See https://bugs.launchpad.net/mg5amcnlo/+bug/1944444
# See https://github.com/madgraph5/madgraph4gpu/pull/245
# See https://stackoverflow.com/a/17016257
def remove_duplicates_from_list(items):
    """Remove duplicates from a list, optionally preserving the order"""
    ###return list(set(items)) # faster but does NOT preserve the order
    return list(dict.fromkeys(items)) # slower but preserves the order
