...
class PLUGIN_ProcessExporter(export_cpp.ProcessExporterGPU):
    ...
    from_template = {'src': [s+'gpu/rambo.h', s+'gpu/rambo.cc', s+'read_slha.h', s+'read_slha.cc',
                    ...
                    'SubProcesses': [s+'gpu/nvtx.h', s+'gpu/timer.h', s+'gpu/timermap.h', s+'gpu/Memory.h', 
                                     s+'gpu/Makefile', s+'gpu/MadgraphTest.h', s+'gpu/MadgraphTest.cc',
                                     s+'gpu/runTest.cc', s+'gpu/testxxx.cc', s+'gpu/testxxx_cc_ref.txt',
                                     s+'gpu/perf.py', s+'gpu/profile.sh']}
    to_link_in_P = ['nvtx.h', 'timer.h', 'timermap.h', 'Memory.h', 'Makefile', 'MadgraphTest.h', 'MadgraphTest.cc', 'runTest.cc', 'testxxx.cc', 'testxxx_cc_ref.txt', 'perf.py', 'profile.sh']
