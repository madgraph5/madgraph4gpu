...
#endif
{
  ...
  public:
    ...
    void setIgraph1( const int* igraph1 ) { m_igraph1 = igraph1; }
  ...
  protected:
    ...
    // The per-event MLM graph array (nullptr = no MLM; set via setIgraph1 before computeMatrixElements)
    const int* m_igraph1 = nullptr;
