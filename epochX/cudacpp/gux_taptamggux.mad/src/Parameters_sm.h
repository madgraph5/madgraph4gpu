...
#endif
{
  ...
  public:
    ...
    cxsmpl<double> GC_2, GC_3, GC_50, GC_58, GC_59;

    // Model parameters dependent on aS
    //double mdl_sqrt__aS, G, mdl_G__exp__2; // now computed event-by-event (running alphas #373)

    // Model couplings dependent on aS
    //cxsmpl<double> GC_11, GC_10, GC_12; // now computed event-by-event (running alphas #373)
...
#pragma nv_diagnostic pop
  ...
  namespace Parameters_sm_independentCouplings
  {
    ...
    //constexpr size_t ixcoup_GC_2 = 0 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_3 = 1 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_50 = 2 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_58 = 3 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_59 = 4 + Parameters_sm_dependentCouplings::ndcoup; // out of ndcoup+nicoup
  }
