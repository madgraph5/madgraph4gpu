...
#define ALWAYS_INLINE
          ...
          fptype allvertexes[] )
  {
    ...
    ( *vertex ) = Ccoeff * COUP * ( -one ) * ( +cI * TMP1 + ( 4. * cI ) * TMP4 );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allV1[] )
  {
    ...
    const cxtype_sv TMP5 = ( V3[2] * P1[0] - V3[3] * P1[1] - V3[4] * P1[2] - V3[5] * P1[3] );
    const cxtype_sv TMP6 = ( V3[2] * P2[0] - V3[3] * P2[1] - V3[4] * P2[2] - V3[5] * P2[3] );
    const cxtype_sv TMP7 = ( P1[0] * V2[2] - P1[1] * V2[3] - P1[2] * V2[4] - P1[3] * V2[5] );
    const cxtype_sv TMP8 = ( P3[0] * V2[2] - P3[1] * V2[3] - P3[2] * V2[4] - P3[3] * V2[5] );
    const cxtype_sv TMP9 = ( V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5] );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    V1[2] = denom * ( TMP9 * ( -cI * P2[0] + cI * P3[0] ) + ( V2[2] * ( -cI * TMP5 + cI * TMP6 ) + V3[2] * ( +cI * TMP7 - cI * TMP8 ) ) );
    V1[3] = denom * ( TMP9 * ( -cI * P2[1] + cI * P3[1] ) + ( V2[3] * ( -cI * TMP5 + cI * TMP6 ) + V3[3] * ( +cI * TMP7 - cI * TMP8 ) ) );
    V1[4] = denom * ( TMP9 * ( -cI * P2[2] + cI * P3[2] ) + ( V2[4] * ( -cI * TMP5 + cI * TMP6 ) + V3[4] * ( +cI * TMP7 - cI * TMP8 ) ) );
    V1[5] = denom * ( TMP9 * ( -cI * P2[3] + cI * P3[3] ) + ( V2[5] * ( -cI * TMP5 + cI * TMP6 ) + V3[5] * ( +cI * TMP7 - cI * TMP8 ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
             ...
             fptype allV1[] )
  {
    ...
    const cxtype_sv TMP9 = ( V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5] );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    V1[2] = denom * ( -cI * ( TMP9 * V4[2] ) + cI * ( V3[2] * TMP10 ) );
    V1[3] = denom * ( -cI * ( TMP9 * V4[3] ) + cI * ( V3[3] * TMP10 ) );
    V1[4] = denom * ( -cI * ( TMP9 * V4[4] ) + cI * ( V3[4] * TMP10 ) );
    V1[5] = denom * ( -cI * ( TMP9 * V4[5] ) + cI * ( V3[5] * TMP10 ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
             ...
             fptype allV1[] )
  {
    ...
    const cxtype_sv TMP9 = ( V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5] );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    V1[2] = denom * ( -cI * ( TMP9 * V4[2] ) + cI * ( V2[2] * TMP11 ) );
    V1[3] = denom * ( -cI * ( TMP9 * V4[3] ) + cI * ( V2[3] * TMP11 ) );
    V1[4] = denom * ( -cI * ( TMP9 * V4[4] ) + cI * ( V2[4] * TMP11 ) );
    V1[5] = denom * ( -cI * ( TMP9 * V4[5] ) + cI * ( V2[5] * TMP11 ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
