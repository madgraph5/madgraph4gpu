...
C     
C     Process: g g > t t~ g WEIGHTED<=3 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,6),W(1,7),W(1,5),GC_10(IVEC),AMP(1))
      CALL FFV1_1(W(1,3),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,8),W(1,6),GC_11(IVEC),AMP(2))
...
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,6),W(1,3),W(1,11),GC_11(IVEC),AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,6),W(1,8),W(1,2),GC_11(IVEC),AMP(9))
      CALL VVV1P0_1(W(1,1),W(1,5),GC_10(IVEC),ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,4),W(1,12),W(1,6),GC_11(IVEC),AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,10),W(1,3),W(1,6),GC_11(IVEC),AMP(11))
C     Amplitude(s) for diagram number 12
      CALL VVV1_0(W(1,6),W(1,2),W(1,7),GC_10(IVEC),AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,9),W(1,12),W(1,1),GC_11(IVEC),AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,10),W(1,8),W(1,1),GC_11(IVEC),AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVV1_0(W(1,1),W(1,11),W(1,7),GC_10(IVEC),AMP(15))
...
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,4),W(1,3),W(1,11),GC_11(IVEC),AMP(16))
      CALL FFV1_0(W(1,4),W(1,3),W(1,7),GC_11(IVEC),AMP(17))
      CALL FFV1_0(W(1,4),W(1,3),W(1,10),GC_11(IVEC),AMP(18))
