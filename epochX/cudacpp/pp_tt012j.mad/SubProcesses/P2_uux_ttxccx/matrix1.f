...
C     
C     Process: u u~ > t t~ c c~ WEIGHTED<=4 @2
C     Process: u u~ > t t~ d d~ WEIGHTED<=4 @2
C     Process: u u~ > t t~ s s~ WEIGHTED<=4 @2
C     Process: c c~ > t t~ u u~ WEIGHTED<=4 @2
C     Process: c c~ > t t~ d d~ WEIGHTED<=4 @2
C     Process: c c~ > t t~ s s~ WEIGHTED<=4 @2
C     Process: d d~ > t t~ u u~ WEIGHTED<=4 @2
C     Process: d d~ > t t~ c c~ WEIGHTED<=4 @2
C     Process: d d~ > t t~ s s~ WEIGHTED<=4 @2
C     Process: s s~ > t t~ u u~ WEIGHTED<=4 @2
C     Process: s s~ > t t~ c c~ WEIGHTED<=4 @2
C     Process: s s~ > t t~ d d~ WEIGHTED<=4 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,5),W(1,9),GC_11(IVEC),AMP(4))
      CALL FFV1_1(W(1,5),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,4),W(1,9),GC_11(IVEC),AMP(5))
      CALL FFV1_2(W(1,1),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_11(IVEC),AMP(6))
      CALL FFV1_2(W(1,1),W(1,9),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,2),W(1,8),GC_11(IVEC),AMP(7))
