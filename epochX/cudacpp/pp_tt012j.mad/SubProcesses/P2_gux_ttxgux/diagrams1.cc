...
#include "diagrams_boilerplate.h"
    ...
    VVV1P0_1( w_fp[0], w_fp[4], COUPs[0], 1.0, depCoup, 0., 0., w_fp[6] );
    ...
    FFV1P0_3( w_fp[5], w_fp[1], COUPs[1], 1.0, depCoup, 0., 0., w_fp[8] );
    ...
    FFV1_2( w_fp[3], w_fp[4], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[6] );
    ...
    FFV1_1( w_fp[1], w_fp[4], COUPs[1], 1.0, depCoup, 0., 0., w_fp[10] );
    ...
    FFV1_2( w_fp[5], w_fp[4], COUPs[1], 1.0, depCoup, 0., 0., w_fp[12] );
    ...
    FFV1_1( w_fp[9], w_fp[4], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[13] );
    ...
    VVV1_0( w_fp[4], w_fp[8], w_fp[11], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[2], w_fp[4], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[13] );
    ...
    FFV1_2( w_fp[11], w_fp[4], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[14] );
    ...
    VVV1_0( w_fp[4], w_fp[8], w_fp[9], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[1], w_fp[0], COUPs[1], 1.0, depCoup, 0., 0., w_fp[9] );
    ...
    FFV1_1( w_fp[9], w_fp[4], COUPs[1], 1.0, depCoup, 0., 0., w_fp[11] );
    ...
    VVV1_0( w_fp[4], w_fp[7], w_fp[14], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[14], w_fp[4], COUPs[1], 1.0, depCoup, 0., 0., w_fp[9] );
    ...
    VVV1_0( w_fp[4], w_fp[7], w_fp[11], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    VVVV1_0( w_fp[0], w_fp[4], w_fp[7], w_fp[8], COUPs[2], 1.0, depCoup, &amp_fp[0] );
    jamp_sv[4] -= 1. / 2. * amp_sv[0];
    jamp_sv[7] += 1. / 2. * amp_sv[0];
    jamp_sv[8] -= 1. / 2. * amp_sv[0];
    jamp_sv[11] += 1. / 2. * amp_sv[0];
    VVVV3_0( w_fp[0], w_fp[4], w_fp[7], w_fp[8], COUPs[2], 1.0, depCoup, &amp_fp[0] );
    jamp_sv[0] -= 1. / 2. * amp_sv[0];
    jamp_sv[3] -= 1. / 2. * amp_sv[0];
    jamp_sv[7] += 1. / 2. * amp_sv[0];
    jamp_sv[11] += 1. / 2. * amp_sv[0];
    VVVV4_0( w_fp[0], w_fp[4], w_fp[7], w_fp[8], COUPs[2], 1.0, depCoup, &amp_fp[0] );
    jamp_sv[0] -= 1. / 2. * amp_sv[0];
    jamp_sv[3] -= 1. / 2. * amp_sv[0];
    jamp_sv[4] += 1. / 2. * amp_sv[0];
    jamp_sv[8] += 1. / 2. * amp_sv[0];
    ...
    VVV1_0( w_fp[4], w_fp[8], w_fp[6], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
