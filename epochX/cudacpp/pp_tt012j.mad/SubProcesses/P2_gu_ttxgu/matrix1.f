...
C     
C     Process: g u > t t~ g u WEIGHTED<=4 @2
C     Process: g c > t t~ g c WEIGHTED<=4 @2
C     Process: g d > t t~ g d WEIGHTED<=4 @2
C     Process: g s > t t~ g s WEIGHTED<=4 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,9),W(1,8),GC_11(IVEC),AMP(1))
      CALL FFV1_2(W(1,2),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,9),W(1,6),W(1,8),GC_11(IVEC),AMP(2))
      CALL FFV1P0_3(W(1,2),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,6),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,11))
      CALL FFV1P0_3(W(1,4),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,2),W(1,11),W(1,12),GC_11(IVEC),AMP(7))
      CALL FFV1_2(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,13),W(1,6),W(1,12),GC_11(IVEC),AMP(8))
...
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,2),W(1,11),W(1,10),GC_11(IVEC),AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,13),W(1,6),W(1,10),GC_11(IVEC),AMP(13))
...
C     Amplitude(s) for diagram number 15
      CALL VVV1_0(W(1,5),W(1,9),W(1,10),GC_10(IVEC),AMP(15))
      CALL FFV1_1(W(1,6),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1P0_3(W(1,2),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 18
      ...
      CALL FFV1_1(W(1,10),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,2),W(1,12),W(1,8),GC_11(IVEC),AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVV1_0(W(1,5),W(1,8),W(1,15),GC_10(IVEC),AMP(20))
      CALL FFV1_2(W(1,2),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
      CALL FFV1P0_3(W(1,15),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 23
      ...
      CALL FFV1_2(W(1,15),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,10),W(1,6),W(1,8),GC_11(IVEC),AMP(24))
...
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,2),W(1,7),W(1,8),GC_11(IVEC),AMP(30))
      CALL VVV1P0_1(W(1,1),W(1,8),GC_10(IVEC),ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,2),W(1,11),W(1,7),GC_11(IVEC),AMP(31))
      CALL FFV1_2(W(1,13),W(1,1),GC_11(IVEC),ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,11),W(1,6),W(1,8),GC_11(IVEC),AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,13),W(1,6),W(1,7),GC_11(IVEC),AMP(33))
C     Amplitude(s) for diagram number 34
      CALL VVVV1_0(W(1,1),W(1,5),W(1,8),W(1,9),GC_12(IVEC),AMP(34))
      CALL VVVV3_0(W(1,1),W(1,5),W(1,8),W(1,9),GC_12(IVEC),AMP(35))
      CALL VVVV4_0(W(1,1),W(1,5),W(1,8),W(1,9),GC_12(IVEC),AMP(36))
C     Amplitude(s) for diagram number 35
      CALL VVV1_0(W(1,5),W(1,9),W(1,7),GC_10(IVEC),AMP(37))
C     Amplitude(s) for diagram number 36
      CALL VVV1_0(W(1,5),W(1,8),W(1,12),GC_10(IVEC),AMP(38))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -01)*AMP(13)
      JAMP(3,1) = (-5.000000000000000D-01)*AMP(8)+((
     ...
     $ +00,-1.666666666666667D-01))*TMP_JAMP(7)
      JAMP(5,1) = (1.666666666666667D-01)*AMP(18)+((
     $ -0.000000000000000D+00,-1.666666666666667D-01))*TMP_JAMP(5)+((
