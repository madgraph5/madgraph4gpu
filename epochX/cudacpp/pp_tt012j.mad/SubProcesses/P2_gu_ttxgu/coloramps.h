...
namespace mgOnGpu
{
  ...
  constexpr unsigned int nchannels = 36;
...
#else
  constexpr int hostChannel2iconfig[36] = { // note: a trailing comma in the initializer list is allowed
      1, // CHANNEL_ID=1   i.e. DIAGRAM=1   --> ICONFIG=1
      2, // CHANNEL_ID=2   i.e. DIAGRAM=2   --> ICONFIG=2
      3, // CHANNEL_ID=3   i.e. DIAGRAM=3   --> ICONFIG=3
      4, // CHANNEL_ID=4   i.e. DIAGRAM=4   --> ICONFIG=4
  ...
  constexpr unsigned int nconfigSDE = 35;
  ...
  __device__ constexpr bool icolamp[35][12] = { // note: a trailing comma in the initializer list is allowed
    { false, false, false, false, false,  true, false, false,  true, false, false, false }, // ICONFIG=1   <-- CHANNEL_ID=1
    { false, false,  true, false, false, false, false, false, false, false,  true, false }, // ICONFIG=2   <-- CHANNEL_ID=2
    { false, false,  true, false, false,  true, false, false,  true, false,  true, false }, // ICONFIG=3   <-- CHANNEL_ID=3
    { false, false,  true, false, false, false, false, false, false, false,  true, false }, // ICONFIG=4   <-- CHANNEL_ID=4
    { false, false, false, false, false,  true, false, false,  true, false, false, false }, // ICONFIG=5   <-- CHANNEL_ID=5
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=6   <-- CHANNEL_ID=6
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=7   <-- CHANNEL_ID=7
    { false, false,  true, false, false, false, false, false, false, false, false, false }, // ICONFIG=8   <-- CHANNEL_ID=8
    { false, false,  true, false, false, false, false, false, false, false, false, false }, // ICONFIG=9   <-- CHANNEL_ID=9
    {  true, false,  true, false, false, false, false, false, false, false, false, false }, // ICONFIG=10  <-- CHANNEL_ID=10
    { false, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=11  <-- CHANNEL_ID=11
    { false, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=12  <-- CHANNEL_ID=12
    { false, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=13  <-- CHANNEL_ID=13
    { false, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=14  <-- CHANNEL_ID=14
    { false, false, false, false, false, false, false,  true,  true, false, false, false }, // ICONFIG=15  <-- CHANNEL_ID=15
    { false, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=16  <-- CHANNEL_ID=16
    { false, false, false, false, false,  true, false, false, false, false, false, false }, // ICONFIG=17  <-- CHANNEL_ID=17
    { false, false, false, false, false, false, false,  true, false, false, false, false }, // ICONFIG=18  <-- CHANNEL_ID=18
    { false, false, false, false, false,  true, false, false, false, false, false, false }, // ICONFIG=19  <-- CHANNEL_ID=19
    { false, false, false, false, false,  true, false,  true, false, false, false, false }, // ICONFIG=20  <-- CHANNEL_ID=20
    { false, false, false, false, false, false, false, false, false, false,  true, false }, // ICONFIG=21  <-- CHANNEL_ID=21
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=22  <-- CHANNEL_ID=22
    {  true, false, false, false, false, false, false, false, false, false, false, false }, // ICONFIG=23  <-- CHANNEL_ID=23
    { false, false, false, false, false, false, false, false, false, false,  true, false }, // ICONFIG=24  <-- CHANNEL_ID=24
    {  true, false, false, false, false, false, false, false, false, false,  true, false }, // ICONFIG=25  <-- CHANNEL_ID=25
    { false, false, false, false, false, false, false, false, false, false,  true, false }, // ICONFIG=26  <-- CHANNEL_ID=26
    { false, false, false, false, false, false, false,  true, false, false,  true, false }, // ICONFIG=27  <-- CHANNEL_ID=27
    { false, false, false, false, false,  true, false, false, false, false, false, false }, // ICONFIG=28  <-- CHANNEL_ID=28
    {  true, false, false, false, false,  true, false, false, false, false, false, false }, // ICONFIG=29  <-- CHANNEL_ID=29
    { false, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=30  <-- CHANNEL_ID=30
    {  true, false, false, false, false, false, false, false,  true, false, false, false }, // ICONFIG=31  <-- CHANNEL_ID=31
    { false, false,  true, false, false, false, false, false, false, false, false, false }, // ICONFIG=32  <-- CHANNEL_ID=32
    { false, false,  true, false, false, false, false,  true, false, false, false, false }, // ICONFIG=33  <-- CHANNEL_ID=33
    {  true, false,  true, false, false, false, false,  true,  true, false, false, false }, // ICONFIG=34  <-- CHANNEL_ID=35
    {  true, false, false, false, false,  true, false,  true, false, false,  true, false }, // ICONFIG=35  <-- CHANNEL_ID=36
  };
