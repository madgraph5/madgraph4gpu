...
#include "diagrams_boilerplate.h"
    ...
    FFV1_1( w_fp[5], w_fp[6], COUPs[1], 1.0, depCoup, 0., 0., w_fp[8] );
    // Amplitude(s) for diagram number 1
    FFV1_0( w_fp[1], w_fp[8], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[1], w_fp[6], COUPs[1], 1.0, depCoup, 0., 0., w_fp[8] );
    // Amplitude(s) for diagram number 2
    FFV1_0( w_fp[8], w_fp[5], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1P0_3( w_fp[1], w_fp[5], COUPs[1], 1.0, depCoup, 0., 0., w_fp[8] );
    ...
    FFV1_1( w_fp[5], w_fp[4], COUPs[1], 1.0, depCoup, 0., 0., w_fp[10] );
    FFV1P0_3( w_fp[3], w_fp[9], COUPs[1], 1.0, depCoup, 0., 0., w_fp[11] );
    // Amplitude(s) for diagram number 7
    FFV1_0( w_fp[1], w_fp[10], w_fp[11], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[1], w_fp[4], COUPs[1], 1.0, depCoup, 0., 0., w_fp[12] );
    // Amplitude(s) for diagram number 8
    FFV1_0( w_fp[12], w_fp[5], w_fp[11], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[1], w_fp[10], w_fp[9], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[12], w_fp[5], w_fp[9], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[5], w_fp[0], COUPs[1], 1.0, depCoup, 0., 0., w_fp[9] );
    FFV1P0_3( w_fp[1], w_fp[9], COUPs[1], 1.0, depCoup, 0., 0., w_fp[14] );
    ...
    FFV1_0( w_fp[1], w_fp[11], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[1], w_fp[0], COUPs[1], 1.0, depCoup, 0., 0., w_fp[14] );
    FFV1P0_3( w_fp[14], w_fp[5], COUPs[1], 1.0, depCoup, 0., 0., w_fp[11] );
    ...
    FFV1_0( w_fp[9], w_fp[5], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[1], w_fp[6], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[1], w_fp[10], w_fp[6], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[10], w_fp[5], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[12], w_fp[5], w_fp[6], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
