...
#include "diagrams_boilerplate.h"
    ...
    oxxxxx( momenta, 0., cHel[ihel][0], -1, w_fp[0], 0 );
    ...
    ixxxxx( momenta, 0., cHel[ihel][4], -1, w_fp[4], 4 );
    ixxxxx( momenta, 0., cHel[ihel][5], -1, w_fp[5], 5 );
    FFV1P0_3( w_fp[4], w_fp[0], COUPs[1], 1.0, depCoup, 0., 0., w_fp[6] );
    FFV1P0_3( w_fp[5], w_fp[1], COUPs[1], 1.0, depCoup, 0., 0., w_fp[7] );
    FFV1_1( w_fp[2], w_fp[6], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[8] );
    // Amplitude(s) for diagram number 1
    FFV1_0( w_fp[3], w_fp[8], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[3], w_fp[6], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[8] );
    // Amplitude(s) for diagram number 2
    FFV1_0( w_fp[8], w_fp[2], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1P0_3( w_fp[3], w_fp[2], COUPs[1], 1.0, depCoup, 0., 0., w_fp[8] );
    ...
    FFV1_2( w_fp[5], w_fp[6], COUPs[1], 1.0, depCoup, 0., 0., w_fp[9] );
    // Amplitude(s) for diagram number 4
    FFV1_0( w_fp[9], w_fp[1], w_fp[8], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[1], w_fp[6], COUPs[1], 1.0, depCoup, 0., 0., w_fp[9] );
    ...
    FFV1P0_3( w_fp[4], w_fp[1], COUPs[1], 1.0, depCoup, 0., 0., w_fp[9] );
    FFV1P0_3( w_fp[5], w_fp[0], COUPs[1], 1.0, depCoup, 0., 0., w_fp[6] );
    FFV1_1( w_fp[2], w_fp[9], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[10] );
    // Amplitude(s) for diagram number 6
    FFV1_0( w_fp[3], w_fp[10], w_fp[6], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[3], w_fp[9], COUPs[1], 1.0, depCoup, cIPD[0], cIPD[1], w_fp[10] );
    // Amplitude(s) for diagram number 7
    FFV1_0( w_fp[10], w_fp[2], w_fp[6], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    VVV1_0( w_fp[9], w_fp[6], w_fp[8], COUPs[0], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[5], w_fp[9], COUPs[1], 1.0, depCoup, 0., 0., w_fp[10] );
    // Amplitude(s) for diagram number 9
    FFV1_0( w_fp[10], w_fp[0], w_fp[8], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[0], w_fp[9], COUPs[1], 1.0, depCoup, 0., 0., w_fp[10] );
    // Amplitude(s) for diagram number 10
    FFV1_0( w_fp[5], w_fp[10], w_fp[8], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[4], w_fp[6], COUPs[1], 1.0, depCoup, 0., 0., w_fp[10] );
    // Amplitude(s) for diagram number 11
    FFV1_0( w_fp[10], w_fp[1], w_fp[8], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[4], w_fp[8], COUPs[1], 1.0, depCoup, 0., 0., w_fp[10] );
    // Amplitude(s) for diagram number 12
    FFV1_0( w_fp[10], w_fp[1], w_fp[6], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_2( w_fp[4], w_fp[7], COUPs[1], 1.0, depCoup, 0., 0., w_fp[6] );
    // Amplitude(s) for diagram number 13
    FFV1_0( w_fp[6], w_fp[0], w_fp[8], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[10], w_fp[0], w_fp[7], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
