...
namespace mgOnGpu
{
  ...
  // This array has N_config <= N_diagrams elements    
    ...
    {true, false, false, false, false, false}, // iconfigC=1, diag=2
    {true, false, false, false, true, false}, // iconfigC=2, diag=3
    {false, false, false, false, true, false}, // iconfigC=3, diag=4
    {true, false, false, false, false, false}, // iconfigC=4, diag=5
    ...
    {true, false, false, false, false, false}, // iconfigC=12, diag=13
