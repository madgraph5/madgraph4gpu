...
C     
C     Process: u u~ > t t~ g g WEIGHTED<=4 @2
C     Process: c c~ > t t~ g g WEIGHTED<=4 @2
C     Process: d d~ > t t~ g g WEIGHTED<=4 @2
C     Process: s s~ > t t~ g g WEIGHTED<=4 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,1),W(1,9),W(1,8),GC_11(IVEC),AMP(1))
      CALL FFV1_2(W(1,1),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_11(IVEC),AMP(2))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_1(W(1,3),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,10))
      CALL FFV1_2(W(1,4),W(1,6),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,7),W(1,10),W(1,9),GC_11(IVEC),AMP(6))
      CALL FFV1_1(W(1,2),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,11))
      CALL FFV1P0_3(W(1,4),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,11),W(1,12),GC_11(IVEC),AMP(7))
      CALL FFV1_2(W(1,1),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,13),W(1,2),W(1,12),GC_11(IVEC),AMP(8))
      CALL FFV1_1(W(1,10),W(1,6),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,14))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,14),W(1,9),GC_11(IVEC),AMP(9))
C     Amplitude(s) for diagram number 10
      CALL VVV1_0(W(1,6),W(1,9),W(1,12),GC_10(IVEC),AMP(10))
      CALL FFV1_2(W(1,4),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,12))
      CALL FFV1_1(W(1,3),W(1,6),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,14))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,12),W(1,14),W(1,9),GC_11(IVEC),AMP(11))
      CALL FFV1P0_3(W(1,12),W(1,3),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,1),W(1,11),W(1,10),GC_11(IVEC),AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,13),W(1,2),W(1,10),GC_11(IVEC),AMP(13))
      CALL FFV1_2(W(1,12),W(1,6),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,15))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,15),W(1,3),W(1,9),GC_11(IVEC),AMP(14))
C     Amplitude(s) for diagram number 15
      CALL VVV1_0(W(1,6),W(1,9),W(1,10),GC_10(IVEC),AMP(15))
      CALL FFV1_1(W(1,2),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
      CALL FFV1P0_3(W(1,1),W(1,10),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,4),W(1,14),W(1,15),GC_11(IVEC),AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,7),W(1,3),W(1,15),GC_11(IVEC),AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,13),W(1,10),W(1,8),GC_11(IVEC),AMP(18))
      CALL FFV1_1(W(1,10),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,1),W(1,12),W(1,8),GC_11(IVEC),AMP(19))
C     Amplitude(s) for diagram number 20
      CALL VVV1_0(W(1,6),W(1,8),W(1,15),GC_10(IVEC),AMP(20))
      CALL FFV1_2(W(1,1),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,15))
      CALL FFV1P0_3(W(1,15),W(1,2),GC_11(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,4),W(1,14),W(1,12),GC_11(IVEC),AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,7),W(1,3),W(1,12),GC_11(IVEC),AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV1_0(W(1,15),W(1,11),W(1,8),GC_11(IVEC),AMP(23))
      CALL FFV1_2(W(1,15),W(1,6),GC_11(IVEC),ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,10),W(1,2),W(1,8),GC_11(IVEC),AMP(24))
C     Amplitude(s) for diagram number 25
      CALL VVV1_0(W(1,6),W(1,8),W(1,12),GC_10(IVEC),AMP(25))
      CALL FFV1_1(W(1,14),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,12))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,4),W(1,12),W(1,9),GC_11(IVEC),AMP(26))
      CALL VVV1P0_1(W(1,5),W(1,9),GC_10(IVEC),ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,4),W(1,14),W(1,12),GC_11(IVEC),AMP(27))
      CALL FFV1_2(W(1,7),W(1,5),GC_11(IVEC),MDL_MT, FK_MDL_WT,W(1,14))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,14),W(1,3),W(1,9),GC_11(IVEC),AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,7),W(1,3),W(1,12),GC_11(IVEC),AMP(29))
      CALL FFV1_1(W(1,11),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,1),W(1,7),W(1,8),GC_11(IVEC),AMP(30))
      CALL VVV1P0_1(W(1,5),W(1,8),GC_10(IVEC),ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,1),W(1,11),W(1,7),GC_11(IVEC),AMP(31))
      CALL FFV1_2(W(1,13),W(1,5),GC_11(IVEC),ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,11),W(1,2),W(1,8),GC_11(IVEC),AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,13),W(1,2),W(1,7),GC_11(IVEC),AMP(33))
C     Amplitude(s) for diagram number 34
      CALL VVVV1_0(W(1,5),W(1,6),W(1,8),W(1,9),GC_12(IVEC),AMP(34))
      CALL VVVV3_0(W(1,5),W(1,6),W(1,8),W(1,9),GC_12(IVEC),AMP(35))
      CALL VVVV4_0(W(1,5),W(1,6),W(1,8),W(1,9),GC_12(IVEC),AMP(36))
C     Amplitude(s) for diagram number 35
      CALL VVV1_0(W(1,6),W(1,9),W(1,7),GC_10(IVEC),AMP(37))
C     Amplitude(s) for diagram number 36
      CALL VVV1_0(W(1,6),W(1,8),W(1,12),GC_10(IVEC),AMP(38))
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ -01)*AMP(9)+(1.666666666666667D-01)*AMP(28)+((
     $ -0.000000000000000D+00,-1.666666666666667D-01))*TMP_JAMP(4)
      JAMP(2,1) = (1.666666666666667D-01)*AMP(11)+(1.666666666666667D
     ...
     $ +(-5.000000000000000D-01)*TMP_JAMP(12)
      JAMP(7,1) = (1.666666666666667D-01)*AMP(18)+((
     ...
     $ -5.000000000000000D-01)*AMP(13)+(-5.000000000000000D-01)*AMP(16)
