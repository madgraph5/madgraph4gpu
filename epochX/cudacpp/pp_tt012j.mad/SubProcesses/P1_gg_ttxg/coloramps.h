...
namespace mgOnGpu
{
  ...
  constexpr unsigned int nchannels = 15;
  ...
  __device__ constexpr int channel2iconfig[15] = { // note: a trailing comma in the initializer list is allowed
...
#else
  constexpr int hostChannel2iconfig[15] = { // note: a trailing comma in the initializer list is allowed
      1, // CHANNEL_ID=1   i.e. DIAGRAM=1   --> ICONFIG=1
      2, // CHANNEL_ID=2   i.e. DIAGRAM=2   --> ICONFIG=2
      3, // CHANNEL_ID=3   i.e. DIAGRAM=3   --> ICONFIG=3
      4, // CHANNEL_ID=4   i.e. DIAGRAM=4   --> ICONFIG=4
  ...
  constexpr unsigned int nconfigSDE = 15;
