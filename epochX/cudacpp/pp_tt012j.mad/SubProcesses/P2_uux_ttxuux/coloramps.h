...
namespace mgOnGpu
{
  ...
  // This array has N_config <= N_diagrams elements    
    ...
    {false, false, false, false, true, false}, // iconfigC=0, diag=1
    {false, false, false, true, false, false}, // iconfigC=1, diag=2
    {false, false, false, true, true, false}, // iconfigC=2, diag=3
    {false, false, false, false, true, false}, // iconfigC=3, diag=4
    {false, false, false, true, false, false}, // iconfigC=4, diag=5
    {false, false, true, false, false, false}, // iconfigC=5, diag=6
    {false, true, false, false, false, false}, // iconfigC=6, diag=7
    {false, true, true, false, false, false}, // iconfigC=7, diag=8
    {false, false, true, false, false, false}, // iconfigC=8, diag=9
    {false, true, false, false, false, false}, // iconfigC=9, diag=10
    {false, true, false, false, false, false}, // iconfigC=10, diag=11
    {false, false, true, false, false, false}, // iconfigC=11, diag=12
