...
namespace mgOnGpu
{
  ...
  constexpr unsigned int nchannels = 14;
...
#else
  constexpr int hostChannel2iconfig[14] = { // note: a trailing comma in the initializer list is allowed
      1, // CHANNEL_ID=1   i.e. DIAGRAM=1   --> ICONFIG=1
      2, // CHANNEL_ID=2   i.e. DIAGRAM=2   --> ICONFIG=2
      3, // CHANNEL_ID=3   i.e. DIAGRAM=3   --> ICONFIG=3
      4, // CHANNEL_ID=4   i.e. DIAGRAM=4   --> ICONFIG=4
  ...
  constexpr unsigned int nconfigSDE = 14;
  ...
  __device__ constexpr bool icolamp[14][6] = { // note: a trailing comma in the initializer list is allowed
    ...
    { false, false,  true, false, false, false }, // ICONFIG=6   <-- CHANNEL_ID=6
    { false,  true, false, false, false, false }, // ICONFIG=7   <-- CHANNEL_ID=7
    { false,  true,  true, false, false, false }, // ICONFIG=8   <-- CHANNEL_ID=8
    { false, false,  true, false, false, false }, // ICONFIG=9   <-- CHANNEL_ID=9
    { false,  true, false, false, false, false }, // ICONFIG=10  <-- CHANNEL_ID=10
    { false,  true, false, false, false, false }, // ICONFIG=11  <-- CHANNEL_ID=11
    { false, false,  true, false, false, false }, // ICONFIG=12  <-- CHANNEL_ID=12
    { false, false, false,  true, false, false }, // ICONFIG=13  <-- CHANNEL_ID=13
