...
namespace mgOnGpu
{
  ...
  // This array has N_config <= N_diagrams elements    
    ...
    {false, false, false, true}, // iconfigC=0, diag=1
    {false, false, false, true}, // iconfigC=1, diag=2
    {true, false, false, false}, // iconfigC=2, diag=3
    {true, false, false, false}, // iconfigC=3, diag=4
