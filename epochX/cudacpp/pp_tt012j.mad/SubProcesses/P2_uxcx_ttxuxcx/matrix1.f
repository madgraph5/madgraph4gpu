...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV1_2(W(1,5),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,4),W(1,1),W(1,9),GC_11(IVEC),AMP(6))
      CALL FFV1_2(W(1,5),W(1,9),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,1),W(1,8),GC_11(IVEC),AMP(7))
