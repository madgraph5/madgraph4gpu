...
#include "diagrams_boilerplate.h"
    ...
    FFV1_2( w_fp[1], w_fp[6], COUPs[1], 1.0, depCoup, 0., 0., w_fp[3] );
    // Amplitude(s) for diagram number 4
    FFV1_0( w_fp[3], w_fp[5], w_fp[8], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_1( w_fp[5], w_fp[6], COUPs[1], 1.0, depCoup, 0., 0., w_fp[3] );
    // Amplitude(s) for diagram number 5
    FFV1_0( w_fp[1], w_fp[3], w_fp[8], COUPs[1], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
