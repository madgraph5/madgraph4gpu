...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_2(W(1,2),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,6),W(1,9),GC_11(IVEC),AMP(4))
      CALL FFV1_1(W(1,6),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,4),W(1,9),GC_11(IVEC),AMP(5))
