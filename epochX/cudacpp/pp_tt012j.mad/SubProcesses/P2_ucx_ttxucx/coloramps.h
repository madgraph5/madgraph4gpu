...
namespace mgOnGpu
{
  ...
  constexpr unsigned int nchannels = 7;
  ...
  __device__ constexpr int channel2iconfig[7] = { // note: a trailing comma in the initializer list is allowed
...
#else
  constexpr int hostChannel2iconfig[7] = { // note: a trailing comma in the initializer list is allowed
     1, // CHANNEL_ID=1  i.e. DIAGRAM=1  --> ICONFIG=1
     2, // CHANNEL_ID=2  i.e. DIAGRAM=2  --> ICONFIG=2
     3, // CHANNEL_ID=3  i.e. DIAGRAM=3  --> ICONFIG=3
     4, // CHANNEL_ID=4  i.e. DIAGRAM=4  --> ICONFIG=4
  ...
  constexpr unsigned int nconfigSDE = 7;
  ...
  __device__ constexpr bool icolamp[7][6] = { // note: a trailing comma in the initializer list is allowed
    { false, false,  true, false, false, false }, // ICONFIG=1  <-- CHANNEL_ID=1
    { false,  true, false, false, false, false }, // ICONFIG=2  <-- CHANNEL_ID=2
    { false,  true,  true, false, false, false }, // ICONFIG=3  <-- CHANNEL_ID=3
    { false, false,  true, false, false, false }, // ICONFIG=4  <-- CHANNEL_ID=4
    { false,  true, false, false, false, false }, // ICONFIG=5  <-- CHANNEL_ID=5
