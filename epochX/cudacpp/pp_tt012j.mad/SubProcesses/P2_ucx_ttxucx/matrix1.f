...
C     
C     Process: u c~ > t t~ u c~ WEIGHTED<=4 @2
C     Process: u d~ > t t~ u d~ WEIGHTED<=4 @2
C     Process: u s~ > t t~ u s~ WEIGHTED<=4 @2
C     Process: c u~ > t t~ c u~ WEIGHTED<=4 @2
C     Process: c d~ > t t~ c d~ WEIGHTED<=4 @2
C     Process: c s~ > t t~ c s~ WEIGHTED<=4 @2
C     Process: d u~ > t t~ d u~ WEIGHTED<=4 @2
C     Process: d c~ > t t~ d c~ WEIGHTED<=4 @2
C     Process: d s~ > t t~ d s~ WEIGHTED<=4 @2
C     Process: s u~ > t t~ s u~ WEIGHTED<=4 @2
C     Process: s c~ > t t~ s c~ WEIGHTED<=4 @2
C     Process: s d~ > t t~ s d~ WEIGHTED<=4 @2
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV1_2(W(1,6),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_11(IVEC),AMP(4))
      CALL FFV1_1(W(1,2),W(1,7),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,4),W(1,9),GC_11(IVEC),AMP(5))
      CALL FFV1_2(W(1,1),W(1,8),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL FFV1_0(W(1,4),W(1,5),W(1,9),GC_11(IVEC),AMP(6))
      CALL FFV1_2(W(1,1),W(1,9),GC_11(IVEC),ZERO, FK_ZERO,W(1,4))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,5),W(1,8),GC_11(IVEC),AMP(7))
