...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[35][12] = { // note: a trailing comma in the initializer list is allowed
    ...
    { false,  true,  true, false, false,  true,  true, false, false,  true,  true, false }, // ICONFIG=34  <-- CHANNEL_ID=35
    { false,  true, false, false, false,  true,  true, false, false, false,  true, false }, // ICONFIG=35  <-- CHANNEL_ID=36
  };
