...
namespace mgOnGpu
{
  ...
  // This array has N_config <= N_diagrams elements    
    ...
    {false, true, false, false}, // iconfigC=0, diag=1
    {false, true, false, false}, // iconfigC=1, diag=2
    {false, false, true, false}, // iconfigC=2, diag=3
    {false, false, true, false}, // iconfigC=3, diag=4
    {false, true, true, false}, // iconfigC=4, diag=5
  };
