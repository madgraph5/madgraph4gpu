...
C     
C     Process: u u~ > t t~ g WEIGHTED<=3 @1
C     Process: c c~ > t t~ g WEIGHTED<=3 @1
C     Process: d d~ > t t~ g WEIGHTED<=3 @1
C     Process: s s~ > t t~ g WEIGHTED<=3 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
