...
namespace mgOnGpu
{
  ...
  __device__ constexpr int channel2iconfig[2] = { // note: a trailing comma in the initializer list is allowed
...
#else
  constexpr int hostChannel2iconfig[2] = { // note: a trailing comma in the initializer list is allowed
     1, // CHANNEL_ID=1  i.e. DIAGRAM=1  --> ICONFIG=1
     2, // CHANNEL_ID=2  i.e. DIAGRAM=2  --> ICONFIG=2
  };
#endif
  ...
  constexpr unsigned int nconfigSDE = 2;
  ...
  __device__ constexpr bool icolamp[2][1] = { // note: a trailing comma in the initializer list is allowed
    {  true }, // ICONFIG=1  <-- CHANNEL_ID=1
    {  true }, // ICONFIG=2  <-- CHANNEL_ID=2
  };
