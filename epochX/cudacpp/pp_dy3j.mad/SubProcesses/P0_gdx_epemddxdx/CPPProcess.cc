...
// Process: g d~ > e+ e- d d~ d~ WEIGHTED<=7
// Process: g d~ > mu+ mu- d d~ d~ WEIGHTED<=7
// Process: g s~ > e+ e- s s~ s~ WEIGHTED<=7
// Process: g s~ > mu+ mu- s s~ s~ WEIGHTED<=7
// Process: g b~ > e+ e- b b~ b~ WEIGHTED<=7
// Process: g b~ > mu+ mu- b b~ b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gdx_epemddxdx()?)
