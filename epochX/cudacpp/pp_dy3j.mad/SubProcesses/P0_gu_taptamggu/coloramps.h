...
namespace mgOnGpu
{
  ...
  constexpr unsigned int nchannels = 96;
...
#else
  constexpr int hostChannel2iconfig[96] = { // note: a trailing comma in the initializer list is allowed
      1, // CHANNEL_ID=1   i.e. DIAGRAM=1   --> ICONFIG=1
      2, // CHANNEL_ID=2   i.e. DIAGRAM=2   --> ICONFIG=2
      3, // CHANNEL_ID=3   i.e. DIAGRAM=3   --> ICONFIG=3
      4, // CHANNEL_ID=4   i.e. DIAGRAM=4   --> ICONFIG=4
  ...
  constexpr unsigned int nconfigSDE = 96;
  ...
  __device__ constexpr bool icolamp[96][6] = { // note: a trailing comma in the initializer list is allowed
    ...
    {  true, false,  true, false,  true,  true }, // ICONFIG=2   <-- CHANNEL_ID=2
    {  true, false,  true, false, false, false }, // ICONFIG=3   <-- CHANNEL_ID=3
    { false, false, false, false,  true,  true }, // ICONFIG=4   <-- CHANNEL_ID=4
    {  true, false,  true, false,  true,  true }, // ICONFIG=5   <-- CHANNEL_ID=5
    {  true, false,  true, false,  true,  true }, // ICONFIG=6   <-- CHANNEL_ID=6
    {  true, false,  true, false, false, false }, // ICONFIG=7   <-- CHANNEL_ID=7
    { false, false, false, false,  true,  true }, // ICONFIG=8   <-- CHANNEL_ID=8
    { false, false, false, false,  true,  true }, // ICONFIG=9   <-- CHANNEL_ID=9
    { false, false, false, false,  true,  true }, // ICONFIG=10  <-- CHANNEL_ID=10
    { false, false, false, false,  true,  true }, // ICONFIG=11  <-- CHANNEL_ID=11
    { false, false, false, false,  true,  true }, // ICONFIG=12  <-- CHANNEL_ID=12
    {  true, false,  true, false, false, false }, // ICONFIG=13  <-- CHANNEL_ID=13
    {  true, false,  true, false, false, false }, // ICONFIG=14  <-- CHANNEL_ID=14
    {  true, false,  true, false, false, false }, // ICONFIG=15  <-- CHANNEL_ID=15
    {  true, false,  true, false, false, false }, // ICONFIG=16  <-- CHANNEL_ID=16
    { false, false,  true,  true, false, false }, // ICONFIG=17  <-- CHANNEL_ID=17
    { false, false,  true,  true, false, false }, // ICONFIG=18  <-- CHANNEL_ID=18
    { false, false,  true,  true, false, false }, // ICONFIG=19  <-- CHANNEL_ID=19
    { false, false,  true,  true, false, false }, // ICONFIG=20  <-- CHANNEL_ID=20
    { false,  true, false, false,  true, false }, // ICONFIG=21  <-- CHANNEL_ID=21
    { false,  true, false, false,  true, false }, // ICONFIG=22  <-- CHANNEL_ID=22
    { false,  true, false, false,  true, false }, // ICONFIG=23  <-- CHANNEL_ID=23
    { false,  true, false, false,  true, false }, // ICONFIG=24  <-- CHANNEL_ID=24
    { false,  true,  true,  true,  true, false }, // ICONFIG=25  <-- CHANNEL_ID=25
    { false,  true,  true,  true,  true, false }, // ICONFIG=26  <-- CHANNEL_ID=26
    { false,  true, false, false,  true, false }, // ICONFIG=27  <-- CHANNEL_ID=27
    { false, false,  true,  true, false, false }, // ICONFIG=28  <-- CHANNEL_ID=28
    { false,  true,  true,  true,  true, false }, // ICONFIG=29  <-- CHANNEL_ID=29
    { false,  true,  true,  true,  true, false }, // ICONFIG=30  <-- CHANNEL_ID=30
    { false,  true, false, false,  true, false }, // ICONFIG=31  <-- CHANNEL_ID=31
    { false, false,  true,  true, false, false }, // ICONFIG=32  <-- CHANNEL_ID=32
    {  true,  true, false, false, false, false }, // ICONFIG=33  <-- CHANNEL_ID=33
    {  true,  true, false, false, false, false }, // ICONFIG=34  <-- CHANNEL_ID=34
    {  true,  true, false, false, false, false }, // ICONFIG=35  <-- CHANNEL_ID=35
    {  true,  true, false, false, false, false }, // ICONFIG=36  <-- CHANNEL_ID=36
    { false,  true, false, false, false, false }, // ICONFIG=37  <-- CHANNEL_ID=37
    { false,  true, false, false, false, false }, // ICONFIG=38  <-- CHANNEL_ID=38
    { false,  true, false, false, false, false }, // ICONFIG=39  <-- CHANNEL_ID=39
    { false,  true, false, false, false, false }, // ICONFIG=40  <-- CHANNEL_ID=40
    {  true, false, false, false, false, false }, // ICONFIG=41  <-- CHANNEL_ID=41
    { false,  true, false, false, false, false }, // ICONFIG=42  <-- CHANNEL_ID=42
    {  true, false, false, false, false, false }, // ICONFIG=43  <-- CHANNEL_ID=43
    { false,  true, false, false, false, false }, // ICONFIG=44  <-- CHANNEL_ID=44
    {  true, false, false, false, false, false }, // ICONFIG=45  <-- CHANNEL_ID=45
    {  true, false, false, false, false, false }, // ICONFIG=46  <-- CHANNEL_ID=46
    {  true, false, false, false, false, false }, // ICONFIG=47  <-- CHANNEL_ID=47
    {  true, false, false, false, false, false }, // ICONFIG=48  <-- CHANNEL_ID=48
    { false, false, false,  true, false,  true }, // ICONFIG=49  <-- CHANNEL_ID=49
    { false, false, false,  true, false,  true }, // ICONFIG=50  <-- CHANNEL_ID=50
    { false, false, false,  true, false,  true }, // ICONFIG=51  <-- CHANNEL_ID=51
    { false, false, false,  true, false,  true }, // ICONFIG=52  <-- CHANNEL_ID=52
    { false, false, false,  true, false, false }, // ICONFIG=53  <-- CHANNEL_ID=53
    { false, false, false,  true, false, false }, // ICONFIG=54  <-- CHANNEL_ID=54
    { false, false, false,  true, false, false }, // ICONFIG=55  <-- CHANNEL_ID=55
    { false, false, false,  true, false, false }, // ICONFIG=56  <-- CHANNEL_ID=56
    ...
    { false, false, false, false, false,  true }, // ICONFIG=61  <-- CHANNEL_ID=61
    { false, false, false, false, false,  true }, // ICONFIG=62  <-- CHANNEL_ID=62
    { false, false, false, false, false,  true }, // ICONFIG=63  <-- CHANNEL_ID=63
    { false, false, false, false, false,  true }, // ICONFIG=64  <-- CHANNEL_ID=64
    {  true,  true, false,  true, false,  true }, // ICONFIG=65  <-- CHANNEL_ID=65
    {  true,  true, false,  true, false,  true }, // ICONFIG=66  <-- CHANNEL_ID=66
    { false, false, false,  true, false,  true }, // ICONFIG=67  <-- CHANNEL_ID=67
    {  true,  true, false, false, false, false }, // ICONFIG=68  <-- CHANNEL_ID=68
    {  true,  true, false,  true, false,  true }, // ICONFIG=69  <-- CHANNEL_ID=69
    {  true,  true, false,  true, false,  true }, // ICONFIG=70  <-- CHANNEL_ID=70
    { false, false, false,  true, false,  true }, // ICONFIG=71  <-- CHANNEL_ID=71
    {  true,  true, false, false, false, false }, // ICONFIG=72  <-- CHANNEL_ID=72
    { false, false,  true, false, false, false }, // ICONFIG=73  <-- CHANNEL_ID=73
    { false, false, false,  true, false, false }, // ICONFIG=74  <-- CHANNEL_ID=74
    { false, false,  true, false, false, false }, // ICONFIG=75  <-- CHANNEL_ID=75
    { false, false, false,  true, false, false }, // ICONFIG=76  <-- CHANNEL_ID=76
    { false, false,  true, false, false, false }, // ICONFIG=77  <-- CHANNEL_ID=77
    { false, false,  true, false, false, false }, // ICONFIG=78  <-- CHANNEL_ID=78
    { false, false,  true, false, false, false }, // ICONFIG=79  <-- CHANNEL_ID=79
    { false, false,  true, false, false, false }, // ICONFIG=80  <-- CHANNEL_ID=80
    { false, false, false, false,  true, false }, // ICONFIG=81  <-- CHANNEL_ID=81
    { false,  true, false, false, false, false }, // ICONFIG=82  <-- CHANNEL_ID=82
    { false, false, false, false,  true, false }, // ICONFIG=83  <-- CHANNEL_ID=83
    { false,  true, false, false, false, false }, // ICONFIG=84  <-- CHANNEL_ID=84
    { false, false, false, false,  true, false }, // ICONFIG=85  <-- CHANNEL_ID=85
    { false, false, false, false,  true, false }, // ICONFIG=86  <-- CHANNEL_ID=86
    { false, false, false, false,  true, false }, // ICONFIG=87  <-- CHANNEL_ID=87
    { false, false, false, false,  true, false }, // ICONFIG=88  <-- CHANNEL_ID=88
    { false, false, false, false,  true, false }, // ICONFIG=89  <-- CHANNEL_ID=89
    { false, false, false, false, false,  true }, // ICONFIG=90  <-- CHANNEL_ID=90
    { false, false, false, false,  true, false }, // ICONFIG=91  <-- CHANNEL_ID=91
    { false, false, false, false, false,  true }, // ICONFIG=92  <-- CHANNEL_ID=92
