...
// Process: g g > e+ e- g u u~ WEIGHTED<=7
// Process: g g > e+ e- g c c~ WEIGHTED<=7
// Process: g g > mu+ mu- g u u~ WEIGHTED<=7
// Process: g g > mu+ mu- g c c~ WEIGHTED<=7
...
#endif
{
  ...
  __device__ const fptype cIPC[nIPC * 2] = { (fptype)Parameters_sm_no_b_mass::GC_3.real(), (fptype)Parameters_sm_no_b_mass::GC_3.imag(), (fptype)Parameters_sm_no_b_mass::GC_2.real(), (fptype)Parameters_sm_no_b_mass::GC_2.imag(), (fptype)Parameters_sm_no_b_mass::GC_50.real(), (fptype)Parameters_sm_no_b_mass::GC_50.imag(), (fptype)Parameters_sm_no_b_mass::GC_59.real(), (fptype)Parameters_sm_no_b_mass::GC_59.imag(), (fptype)Parameters_sm_no_b_mass::GC_58.real(), (fptype)Parameters_sm_no_b_mass::GC_58.imag() };
#else
#ifdef MGONGPUCPP_GPUIMPL
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gg_epemguux()?)
