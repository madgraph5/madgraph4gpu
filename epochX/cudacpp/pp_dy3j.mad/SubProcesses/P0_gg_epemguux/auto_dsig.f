...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: g g > e+ e- g u u~ WEIGHTED<=7
C     Process: g g > e+ e- g c c~ WEIGHTED<=7
C     Process: g g > mu+ mu- g u u~ WEIGHTED<=7
C     Process: g g > mu+ mu- g c c~ WEIGHTED<=7
C     
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! g g > e+ e- g u u~
C     ENDIF
