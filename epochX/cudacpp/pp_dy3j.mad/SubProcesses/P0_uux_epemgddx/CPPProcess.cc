...
// Process: u u~ > e+ e- g d d~ WEIGHTED<=7
// Process: u u~ > e+ e- g s s~ WEIGHTED<=7
// Process: u u~ > e+ e- g b b~ WEIGHTED<=7
// Process: u u~ > mu+ mu- g d d~ WEIGHTED<=7
// Process: u u~ > mu+ mu- g s s~ WEIGHTED<=7
// Process: u u~ > mu+ mu- g b b~ WEIGHTED<=7
// Process: c c~ > e+ e- g d d~ WEIGHTED<=7
// Process: c c~ > e+ e- g s s~ WEIGHTED<=7
// Process: c c~ > e+ e- g b b~ WEIGHTED<=7
// Process: c c~ > mu+ mu- g d d~ WEIGHTED<=7
// Process: c c~ > mu+ mu- g s s~ WEIGHTED<=7
// Process: c c~ > mu+ mu- g b b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_uux_epemgddx()?)
