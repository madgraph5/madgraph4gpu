...
// Process: u d~ > e+ e- g u d~ WEIGHTED<=7
// Process: u d~ > mu+ mu- g u d~ WEIGHTED<=7
// Process: u s~ > e+ e- g u s~ WEIGHTED<=7
// Process: u s~ > mu+ mu- g u s~ WEIGHTED<=7
// Process: u b~ > e+ e- g u b~ WEIGHTED<=7
// Process: u b~ > mu+ mu- g u b~ WEIGHTED<=7
// Process: c d~ > e+ e- g c d~ WEIGHTED<=7
// Process: c d~ > mu+ mu- g c d~ WEIGHTED<=7
// Process: c s~ > e+ e- g c s~ WEIGHTED<=7
// Process: c s~ > mu+ mu- g c s~ WEIGHTED<=7
// Process: c b~ > e+ e- g c b~ WEIGHTED<=7
// Process: c b~ > mu+ mu- g c b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_udx_epemgudx()?)
