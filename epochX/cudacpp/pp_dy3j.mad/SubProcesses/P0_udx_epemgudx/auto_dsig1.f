...
C     
C     Process: u d~ > e+ e- g u d~ WEIGHTED<=7
C     Process: u d~ > mu+ mu- g u d~ WEIGHTED<=7
C     Process: u s~ > e+ e- g u s~ WEIGHTED<=7
C     Process: u s~ > mu+ mu- g u s~ WEIGHTED<=7
C     Process: u b~ > e+ e- g u b~ WEIGHTED<=7
C     Process: u b~ > mu+ mu- g u b~ WEIGHTED<=7
C     Process: c d~ > e+ e- g c d~ WEIGHTED<=7
C     Process: c d~ > mu+ mu- g c d~ WEIGHTED<=7
C     Process: c s~ > e+ e- g c s~ WEIGHTED<=7
C     Process: c s~ > mu+ mu- g c s~ WEIGHTED<=7
C     Process: c b~ > e+ e- g c b~ WEIGHTED<=7
C     Process: c b~ > mu+ mu- g c b~ WEIGHTED<=7
C     
...
C     Continue only if IMODE is 0, 4 or 5
     ...
     $       -PP(3,I))))
      ...
      PD(IPROC)=U1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u b~ > e+ e- g u b~
      PD(IPROC)=U1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! u b~ > mu+ mu- g u b~
      PD(IPROC)=U1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      ...
      PD(IPROC)=C1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c b~ > e+ e- g c b~
      PD(IPROC)=C1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! c b~ > mu+ mu- g c b~
      PD(IPROC)=C1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IF (IMODE.EQ.4)THEN
        DSIG1 = PD(0)
...
C     Continue only if IMODE is 0, 4 or 5
     ...
     $     ,DSQRT(ALL_Q2FACT(IB(2), IVEC)))
      ...
      IPROC=IPROC+1  ! u b~ > e+ e- g u b~
      DO IVEC=1, VECSIZE_USED
        ALL_PD(IPROC,IVEC)=U1(IVEC)*BX2(IVEC)
        ALL_PD(0,IVEC)=ALL_PD(0,IVEC)+DABS(ALL_PD(IPROC,IVEC))
      ...
      IPROC=IPROC+1  ! c b~ > e+ e- g c b~
      DO IVEC=1, VECSIZE_USED
        ALL_PD(IPROC,IVEC)=C1(IVEC)*BX2(IVEC)
        ALL_PD(0,IVEC)=ALL_PD(0,IVEC)+DABS(ALL_PD(IPROC,IVEC))
