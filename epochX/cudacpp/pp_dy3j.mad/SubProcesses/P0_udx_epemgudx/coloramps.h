...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[48][4] = { // note: a trailing comma in the initializer list is allowed
    ...
    {  true, false,  true, false }, // ICONFIG=33  <-- CHANNEL_ID=33
    {  true, false,  true, false }, // ICONFIG=34  <-- CHANNEL_ID=34
    {  true, false, false, false }, // ICONFIG=35  <-- CHANNEL_ID=35
    { false, false,  true, false }, // ICONFIG=36  <-- CHANNEL_ID=36
    {  true, false,  true, false }, // ICONFIG=37  <-- CHANNEL_ID=37
    {  true, false,  true, false }, // ICONFIG=38  <-- CHANNEL_ID=38
    {  true, false, false, false }, // ICONFIG=39  <-- CHANNEL_ID=39
    { false, false,  true, false }, // ICONFIG=40  <-- CHANNEL_ID=40
    {  true, false,  true, false }, // ICONFIG=41  <-- CHANNEL_ID=41
    {  true, false,  true, false }, // ICONFIG=42  <-- CHANNEL_ID=42
    { false, false,  true, false }, // ICONFIG=43  <-- CHANNEL_ID=43
    {  true, false, false, false }, // ICONFIG=44  <-- CHANNEL_ID=44
    {  true, false,  true, false }, // ICONFIG=45  <-- CHANNEL_ID=45
    {  true, false,  true, false }, // ICONFIG=46  <-- CHANNEL_ID=46
