...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[48][4] = { // note: a trailing comma in the initializer list is allowed
    { false, false, false,  true }, // ICONFIG=1   <-- CHANNEL_ID=1
    { false, false, false,  true }, // ICONFIG=2   <-- CHANNEL_ID=2
    { false, false, false,  true }, // ICONFIG=3   <-- CHANNEL_ID=3
    { false, false, false,  true }, // ICONFIG=4   <-- CHANNEL_ID=4
    { false, false, false,  true }, // ICONFIG=5   <-- CHANNEL_ID=5
    { false, false, false,  true }, // ICONFIG=6   <-- CHANNEL_ID=6
    ...
    {  true, false, false, false }, // ICONFIG=13  <-- CHANNEL_ID=13
    {  true, false, false, false }, // ICONFIG=14  <-- CHANNEL_ID=14
    {  true, false, false, false }, // ICONFIG=15  <-- CHANNEL_ID=15
    {  true, false, false, false }, // ICONFIG=16  <-- CHANNEL_ID=16
    ...
    {  true, false, false, false }, // ICONFIG=25  <-- CHANNEL_ID=25
    {  true, false, false, false }, // ICONFIG=26  <-- CHANNEL_ID=26
    {  true, false, false, false }, // ICONFIG=27  <-- CHANNEL_ID=27
    {  true, false, false, false }, // ICONFIG=28  <-- CHANNEL_ID=28
    {  true, false, false, false }, // ICONFIG=29  <-- CHANNEL_ID=29
    {  true, false, false, false }, // ICONFIG=30  <-- CHANNEL_ID=30
    {  true, false, false, false }, // ICONFIG=31  <-- CHANNEL_ID=31
    {  true, false, false, false }, // ICONFIG=32  <-- CHANNEL_ID=32
    {  true, false, false,  true }, // ICONFIG=33  <-- CHANNEL_ID=33
    {  true, false, false,  true }, // ICONFIG=34  <-- CHANNEL_ID=34
    {  true, false, false, false }, // ICONFIG=35  <-- CHANNEL_ID=35
    { false, false, false,  true }, // ICONFIG=36  <-- CHANNEL_ID=36
    {  true, false, false,  true }, // ICONFIG=37  <-- CHANNEL_ID=37
    {  true, false, false,  true }, // ICONFIG=38  <-- CHANNEL_ID=38
    {  true, false, false, false }, // ICONFIG=39  <-- CHANNEL_ID=39
    { false, false, false,  true }, // ICONFIG=40  <-- CHANNEL_ID=40
    {  true, false, false,  true }, // ICONFIG=41  <-- CHANNEL_ID=41
    {  true, false, false,  true }, // ICONFIG=42  <-- CHANNEL_ID=42
    { false, false, false,  true }, // ICONFIG=43  <-- CHANNEL_ID=43
    {  true, false, false, false }, // ICONFIG=44  <-- CHANNEL_ID=44
