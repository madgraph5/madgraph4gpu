...
// Process: g d > e+ e- u d u~ WEIGHTED<=7
// Process: g d > e+ e- c d c~ WEIGHTED<=7
// Process: g d > mu+ mu- u d u~ WEIGHTED<=7
// Process: g d > mu+ mu- c d c~ WEIGHTED<=7
// Process: g s > e+ e- u s u~ WEIGHTED<=7
// Process: g s > e+ e- c s c~ WEIGHTED<=7
// Process: g s > mu+ mu- u s u~ WEIGHTED<=7
// Process: g s > mu+ mu- c s c~ WEIGHTED<=7
// Process: g b > e+ e- u b u~ WEIGHTED<=7
// Process: g b > e+ e- c b c~ WEIGHTED<=7
// Process: g b > mu+ mu- u b u~ WEIGHTED<=7
// Process: g b > mu+ mu- c b c~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gd_epemudux()?)
