...
// Process: u c~ > ta+ ta- g u c~ WEIGHTED<=7
// Process: c u~ > ta+ ta- g c u~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[3] );
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[2] );
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[14], w_fp[8], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[15] );
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[14], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[13] );
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[13], w_fp[8], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[19] );
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[13], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[18] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_ucx_taptamgucx()?)
