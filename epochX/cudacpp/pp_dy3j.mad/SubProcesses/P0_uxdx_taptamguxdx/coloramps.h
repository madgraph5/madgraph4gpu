...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[48][4] = { // note: a trailing comma in the initializer list is allowed
    ...
    { false,  true, false, false }, // ICONFIG=7   <-- CHANNEL_ID=7
    { false,  true, false, false }, // ICONFIG=8   <-- CHANNEL_ID=8
    ...
    { false,  true, false, false }, // ICONFIG=17  <-- CHANNEL_ID=17
    { false,  true, false, false }, // ICONFIG=18  <-- CHANNEL_ID=18
    { false,  true, false, false }, // ICONFIG=19  <-- CHANNEL_ID=19
    { false,  true, false, false }, // ICONFIG=20  <-- CHANNEL_ID=20
    { false,  true, false, false }, // ICONFIG=21  <-- CHANNEL_ID=21
    { false,  true, false, false }, // ICONFIG=22  <-- CHANNEL_ID=22
    { false,  true, false, false }, // ICONFIG=23  <-- CHANNEL_ID=23
    { false,  true, false, false }, // ICONFIG=24  <-- CHANNEL_ID=24
    ...
    { false,  true, false, false }, // ICONFIG=47  <-- CHANNEL_ID=47
    { false, false,  true, false }, // ICONFIG=48  <-- CHANNEL_ID=48
  };
