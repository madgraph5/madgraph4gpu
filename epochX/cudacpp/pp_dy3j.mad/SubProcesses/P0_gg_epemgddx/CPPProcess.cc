...
// Process: g g > e+ e- g d d~ WEIGHTED<=7
// Process: g g > e+ e- g s s~ WEIGHTED<=7
// Process: g g > e+ e- g b b~ WEIGHTED<=7
// Process: g g > mu+ mu- g d d~ WEIGHTED<=7
// Process: g g > mu+ mu- g s s~ WEIGHTED<=7
// Process: g g > mu+ mu- g b b~ WEIGHTED<=7
...
#endif
{
  ...
  __device__ const fptype cIPD[nIPD] = { (fptype)Parameters_sm_no_b_mass::mdl_MZ, (fptype)Parameters_sm_no_b_mass::mdl_WZ };
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gg_epemgddx()?)
