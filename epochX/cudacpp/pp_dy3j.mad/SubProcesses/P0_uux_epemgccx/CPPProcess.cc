...
// Process: u u~ > e+ e- g c c~ WEIGHTED<=7
// Process: u u~ > mu+ mu- g c c~ WEIGHTED<=7
// Process: c c~ > e+ e- g u u~ WEIGHTED<=7
// Process: c c~ > mu+ mu- g u u~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_uux_epemgccx()?)
