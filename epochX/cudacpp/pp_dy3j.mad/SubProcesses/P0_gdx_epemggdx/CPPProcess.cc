...
// Process: g d~ > e+ e- g g d~ WEIGHTED<=7
// Process: g d~ > mu+ mu- g g d~ WEIGHTED<=7
// Process: g s~ > e+ e- g g s~ WEIGHTED<=7
// Process: g s~ > mu+ mu- g g s~ WEIGHTED<=7
// Process: g b~ > e+ e- g g b~ WEIGHTED<=7
// Process: g b~ > mu+ mu- g g b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gdx_epemggdx()?)
