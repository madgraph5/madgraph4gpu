...
#ifndef MG5_Sigma_sm_no_b_mass_gdx_epemggdx_H
#define MG5_Sigma_sm_no_b_mass_gdx_epemggdx_H 1
...
#endif
{
  ...
  public:
    ...
    static constexpr int ndiagrams = 100; // #Feynman diagrams: e.g. 3 for e+ e- -> mu+ mu-
...
#endif // MG5_Sigma_sm_no_b_mass_gdx_epemggdx_H
