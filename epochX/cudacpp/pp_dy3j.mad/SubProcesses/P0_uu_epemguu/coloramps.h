...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[96][4] = { // note: a trailing comma in the initializer list is allowed
    ...
    {  true, false, false, false }, // ICONFIG=9   <-- CHANNEL_ID=9
    {  true, false, false, false }, // ICONFIG=10  <-- CHANNEL_ID=10
    {  true, false, false, false }, // ICONFIG=11  <-- CHANNEL_ID=11
    {  true, false, false, false }, // ICONFIG=12  <-- CHANNEL_ID=12
    { false, false,  true, false }, // ICONFIG=13  <-- CHANNEL_ID=13
    { false, false,  true, false }, // ICONFIG=14  <-- CHANNEL_ID=14
    { false, false,  true, false }, // ICONFIG=15  <-- CHANNEL_ID=15
    { false, false,  true, false }, // ICONFIG=16  <-- CHANNEL_ID=16
    ...
    { false,  true, false, false }, // ICONFIG=21  <-- CHANNEL_ID=21
    { false,  true, false, false }, // ICONFIG=22  <-- CHANNEL_ID=22
    ...
    {  true, false, false, false }, // ICONFIG=27  <-- CHANNEL_ID=27
    {  true, false, false, false }, // ICONFIG=28  <-- CHANNEL_ID=28
    ...
    { false, false,  true, false }, // ICONFIG=33  <-- CHANNEL_ID=33
    { false, false,  true, false }, // ICONFIG=34  <-- CHANNEL_ID=34
    { false, false,  true, false }, // ICONFIG=35  <-- CHANNEL_ID=35
    { false, false,  true, false }, // ICONFIG=36  <-- CHANNEL_ID=36
    { false, false, false,  true }, // ICONFIG=37  <-- CHANNEL_ID=37
    { false, false, false,  true }, // ICONFIG=38  <-- CHANNEL_ID=38
    { false, false,  true, false }, // ICONFIG=39  <-- CHANNEL_ID=39
    { false, false,  true, false }, // ICONFIG=40  <-- CHANNEL_ID=40
    { false, false, false,  true }, // ICONFIG=41  <-- CHANNEL_ID=41
    { false, false, false,  true }, // ICONFIG=42  <-- CHANNEL_ID=42
    { false, false,  true, false }, // ICONFIG=43  <-- CHANNEL_ID=43
    { false, false,  true, false }, // ICONFIG=44  <-- CHANNEL_ID=44
    { false, false, false,  true }, // ICONFIG=45  <-- CHANNEL_ID=45
    { false, false, false,  true }, // ICONFIG=46  <-- CHANNEL_ID=46
    { false, false, false,  true }, // ICONFIG=47  <-- CHANNEL_ID=47
    { false, false, false,  true }, // ICONFIG=48  <-- CHANNEL_ID=48
    { false,  true, false, false }, // ICONFIG=49  <-- CHANNEL_ID=49
    { false,  true, false, false }, // ICONFIG=50  <-- CHANNEL_ID=50
    { false,  true, false, false }, // ICONFIG=51  <-- CHANNEL_ID=51
    { false,  true, false, false }, // ICONFIG=52  <-- CHANNEL_ID=52
    { false, false, false,  true }, // ICONFIG=53  <-- CHANNEL_ID=53
    { false, false, false,  true }, // ICONFIG=54  <-- CHANNEL_ID=54
    { false, false, false,  true }, // ICONFIG=55  <-- CHANNEL_ID=55
    { false, false, false,  true }, // ICONFIG=56  <-- CHANNEL_ID=56
    { false, false, false,  true }, // ICONFIG=57  <-- CHANNEL_ID=57
    { false, false, false,  true }, // ICONFIG=58  <-- CHANNEL_ID=58
    { false,  true, false, false }, // ICONFIG=59  <-- CHANNEL_ID=59
    { false,  true, false, false }, // ICONFIG=60  <-- CHANNEL_ID=60
    { false, false, false,  true }, // ICONFIG=61  <-- CHANNEL_ID=61
    { false, false, false,  true }, // ICONFIG=62  <-- CHANNEL_ID=62
    { false,  true, false, false }, // ICONFIG=63  <-- CHANNEL_ID=63
    { false,  true, false, false }, // ICONFIG=64  <-- CHANNEL_ID=64
    { false,  true,  true, false }, // ICONFIG=65  <-- CHANNEL_ID=65
    { false,  true,  true, false }, // ICONFIG=66  <-- CHANNEL_ID=66
    { false,  true, false, false }, // ICONFIG=67  <-- CHANNEL_ID=67
    { false, false,  true, false }, // ICONFIG=68  <-- CHANNEL_ID=68
    { false,  true,  true, false }, // ICONFIG=69  <-- CHANNEL_ID=69
    { false,  true,  true, false }, // ICONFIG=70  <-- CHANNEL_ID=70
    { false,  true, false, false }, // ICONFIG=71  <-- CHANNEL_ID=71
    { false, false,  true, false }, // ICONFIG=72  <-- CHANNEL_ID=72
    {  true, false, false,  true }, // ICONFIG=73  <-- CHANNEL_ID=73
    {  true, false, false,  true }, // ICONFIG=74  <-- CHANNEL_ID=74
    { false, false, false,  true }, // ICONFIG=75  <-- CHANNEL_ID=75
    {  true, false, false, false }, // ICONFIG=76  <-- CHANNEL_ID=76
    {  true, false, false,  true }, // ICONFIG=77  <-- CHANNEL_ID=77
    {  true, false, false,  true }, // ICONFIG=78  <-- CHANNEL_ID=78
    { false, false, false,  true }, // ICONFIG=79  <-- CHANNEL_ID=79
    {  true, false, false, false }, // ICONFIG=80  <-- CHANNEL_ID=80
    {  true, false, false,  true }, // ICONFIG=81  <-- CHANNEL_ID=81
    {  true, false, false,  true }, // ICONFIG=82  <-- CHANNEL_ID=82
    {  true, false, false, false }, // ICONFIG=83  <-- CHANNEL_ID=83
    { false, false, false,  true }, // ICONFIG=84  <-- CHANNEL_ID=84
    {  true, false, false,  true }, // ICONFIG=85  <-- CHANNEL_ID=85
    {  true, false, false,  true }, // ICONFIG=86  <-- CHANNEL_ID=86
    {  true, false, false, false }, // ICONFIG=87  <-- CHANNEL_ID=87
    { false, false, false,  true }, // ICONFIG=88  <-- CHANNEL_ID=88
    { false,  true,  true, false }, // ICONFIG=89  <-- CHANNEL_ID=89
    { false,  true,  true, false }, // ICONFIG=90  <-- CHANNEL_ID=90
    { false, false,  true, false }, // ICONFIG=91  <-- CHANNEL_ID=91
    { false,  true, false, false }, // ICONFIG=92  <-- CHANNEL_ID=92
    { false,  true,  true, false }, // ICONFIG=93  <-- CHANNEL_ID=93
    { false,  true,  true, false }, // ICONFIG=94  <-- CHANNEL_ID=94
    { false, false,  true, false }, // ICONFIG=95  <-- CHANNEL_ID=95
    { false,  true, false, false }, // ICONFIG=96  <-- CHANNEL_ID=96
  };
