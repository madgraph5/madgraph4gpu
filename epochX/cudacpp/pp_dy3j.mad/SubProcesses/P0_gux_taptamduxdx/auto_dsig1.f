...
C     
C     Process: g u~ > ta+ ta- d u~ d~ WEIGHTED<=7
C     Process: g u~ > ta+ ta- s u~ s~ WEIGHTED<=7
C     Process: g u~ > ta+ ta- b u~ b~ WEIGHTED<=7
C     Process: g c~ > ta+ ta- d c~ d~ WEIGHTED<=7
C     Process: g c~ > ta+ ta- s c~ s~ WEIGHTED<=7
C     Process: g c~ > ta+ ta- b c~ b~ WEIGHTED<=7
C     
...
C     Continue only if IMODE is 0, 4 or 5
     ...
     $       -PP(3,I))))
      ...
      IPROC=IPROC+1  ! g u~ > ta+ ta- s u~ s~
      PD(IPROC)=G1*UX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g u~ > ta+ ta- b u~ b~
      PD(IPROC)=G1*UX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g c~ > ta+ ta- d c~ d~
      PD(IPROC)=G1*CX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g c~ > ta+ ta- s c~ s~
      PD(IPROC)=G1*CX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g c~ > ta+ ta- b c~ b~
      PD(IPROC)=G1*CX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IF (IMODE.EQ.4)THEN
        DSIG1 = PD(0)
