...
// Process: g u~ > ta+ ta- d u~ d~ WEIGHTED<=7
// Process: g u~ > ta+ ta- s u~ s~ WEIGHTED<=7
// Process: g u~ > ta+ ta- b u~ b~ WEIGHTED<=7
// Process: g c~ > ta+ ta- d c~ d~ WEIGHTED<=7
// Process: g c~ > ta+ ta- s c~ s~ WEIGHTED<=7
// Process: g c~ > ta+ ta- b c~ b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gux_taptamduxdx()?)
