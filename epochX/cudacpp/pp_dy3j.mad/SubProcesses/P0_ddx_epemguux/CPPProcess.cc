...
// Process: d d~ > e+ e- g u u~ WEIGHTED<=7
// Process: d d~ > e+ e- g c c~ WEIGHTED<=7
// Process: d d~ > mu+ mu- g u u~ WEIGHTED<=7
// Process: d d~ > mu+ mu- g c c~ WEIGHTED<=7
// Process: s s~ > e+ e- g u u~ WEIGHTED<=7
// Process: s s~ > e+ e- g c c~ WEIGHTED<=7
// Process: s s~ > mu+ mu- g u u~ WEIGHTED<=7
// Process: s s~ > mu+ mu- g c c~ WEIGHTED<=7
// Process: b b~ > e+ e- g u u~ WEIGHTED<=7
// Process: b b~ > e+ e- g c c~ WEIGHTED<=7
// Process: b b~ > mu+ mu- g u u~ WEIGHTED<=7
// Process: b b~ > mu+ mu- g c c~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_ddx_epemguux()?)
