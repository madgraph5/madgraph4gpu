...
// Process: d d~ > e+ e- g g g WEIGHTED<=7
// Process: d d~ > mu+ mu- g g g WEIGHTED<=7
// Process: s s~ > e+ e- g g g WEIGHTED<=7
// Process: s s~ > mu+ mu- g g g WEIGHTED<=7
// Process: b b~ > e+ e- g g g WEIGHTED<=7
// Process: b b~ > mu+ mu- g g g WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_ddx_epemggg()?)
