...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[96][4] = { // note: a trailing comma in the initializer list is allowed
    ...
    { false, false,  true, false }, // ICONFIG=9   <-- CHANNEL_ID=9
    { false, false,  true, false }, // ICONFIG=10  <-- CHANNEL_ID=10
    { false, false,  true, false }, // ICONFIG=11  <-- CHANNEL_ID=11
    ...
    { false, false, false,  true }, // ICONFIG=21  <-- CHANNEL_ID=21
    { false, false, false,  true }, // ICONFIG=22  <-- CHANNEL_ID=22
    ...
    { false, false,  true, false }, // ICONFIG=27  <-- CHANNEL_ID=27
    { false, false,  true, false }, // ICONFIG=28  <-- CHANNEL_ID=28
    ...
    { false, false, false,  true }, // ICONFIG=49  <-- CHANNEL_ID=49
    { false, false, false,  true }, // ICONFIG=50  <-- CHANNEL_ID=50
    { false, false, false,  true }, // ICONFIG=51  <-- CHANNEL_ID=51
    { false, false, false,  true }, // ICONFIG=52  <-- CHANNEL_ID=52
    ...
    { false, false, false,  true }, // ICONFIG=59  <-- CHANNEL_ID=59
    { false, false, false,  true }, // ICONFIG=60  <-- CHANNEL_ID=60
    {  true, false, false, false }, // ICONFIG=61  <-- CHANNEL_ID=61
    {  true, false, false, false }, // ICONFIG=62  <-- CHANNEL_ID=62
    { false, false, false,  true }, // ICONFIG=63  <-- CHANNEL_ID=63
    { false, false, false,  true }, // ICONFIG=64  <-- CHANNEL_ID=64
    { false,  true, false,  true }, // ICONFIG=65  <-- CHANNEL_ID=65
    { false,  true, false,  true }, // ICONFIG=66  <-- CHANNEL_ID=66
    { false, false, false,  true }, // ICONFIG=67  <-- CHANNEL_ID=67
    { false,  true, false, false }, // ICONFIG=68  <-- CHANNEL_ID=68
    { false,  true, false,  true }, // ICONFIG=69  <-- CHANNEL_ID=69
    { false,  true, false,  true }, // ICONFIG=70  <-- CHANNEL_ID=70
    { false, false, false,  true }, // ICONFIG=71  <-- CHANNEL_ID=71
    { false,  true, false, false }, // ICONFIG=72  <-- CHANNEL_ID=72
    {  true, false,  true, false }, // ICONFIG=73  <-- CHANNEL_ID=73
    {  true, false,  true, false }, // ICONFIG=74  <-- CHANNEL_ID=74
    {  true, false, false, false }, // ICONFIG=75  <-- CHANNEL_ID=75
    { false, false,  true, false }, // ICONFIG=76  <-- CHANNEL_ID=76
    {  true, false,  true, false }, // ICONFIG=77  <-- CHANNEL_ID=77
    {  true, false,  true, false }, // ICONFIG=78  <-- CHANNEL_ID=78
    {  true, false, false, false }, // ICONFIG=79  <-- CHANNEL_ID=79
    { false, false,  true, false }, // ICONFIG=80  <-- CHANNEL_ID=80
    {  true, false,  true, false }, // ICONFIG=81  <-- CHANNEL_ID=81
    {  true, false,  true, false }, // ICONFIG=82  <-- CHANNEL_ID=82
    { false, false,  true, false }, // ICONFIG=83  <-- CHANNEL_ID=83
    {  true, false, false, false }, // ICONFIG=84  <-- CHANNEL_ID=84
    {  true, false,  true, false }, // ICONFIG=85  <-- CHANNEL_ID=85
    {  true, false,  true, false }, // ICONFIG=86  <-- CHANNEL_ID=86
    { false, false,  true, false }, // ICONFIG=87  <-- CHANNEL_ID=87
    {  true, false, false, false }, // ICONFIG=88  <-- CHANNEL_ID=88
    { false,  true, false,  true }, // ICONFIG=89  <-- CHANNEL_ID=89
    { false,  true, false,  true }, // ICONFIG=90  <-- CHANNEL_ID=90
    { false,  true, false, false }, // ICONFIG=91  <-- CHANNEL_ID=91
    { false, false, false,  true }, // ICONFIG=92  <-- CHANNEL_ID=92
    { false,  true, false,  true }, // ICONFIG=93  <-- CHANNEL_ID=93
    { false,  true, false,  true }, // ICONFIG=94  <-- CHANNEL_ID=94
    { false,  true, false, false }, // ICONFIG=95  <-- CHANNEL_ID=95
    { false, false, false,  true }, // ICONFIG=96  <-- CHANNEL_ID=96
  };
