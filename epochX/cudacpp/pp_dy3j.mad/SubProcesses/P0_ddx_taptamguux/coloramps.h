...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[48][4] = { // note: a trailing comma in the initializer list is allowed
    ...
    { false,  true, false,  true }, // ICONFIG=33  <-- CHANNEL_ID=33
    { false,  true, false,  true }, // ICONFIG=34  <-- CHANNEL_ID=34
    { false,  true, false, false }, // ICONFIG=35  <-- CHANNEL_ID=35
    { false, false, false,  true }, // ICONFIG=36  <-- CHANNEL_ID=36
    { false,  true, false,  true }, // ICONFIG=37  <-- CHANNEL_ID=37
    { false,  true, false,  true }, // ICONFIG=38  <-- CHANNEL_ID=38
    { false,  true, false, false }, // ICONFIG=39  <-- CHANNEL_ID=39
    { false, false, false,  true }, // ICONFIG=40  <-- CHANNEL_ID=40
    { false,  true, false,  true }, // ICONFIG=41  <-- CHANNEL_ID=41
    { false,  true, false,  true }, // ICONFIG=42  <-- CHANNEL_ID=42
    { false, false, false,  true }, // ICONFIG=43  <-- CHANNEL_ID=43
    { false,  true, false, false }, // ICONFIG=44  <-- CHANNEL_ID=44
    { false,  true, false,  true }, // ICONFIG=45  <-- CHANNEL_ID=45
    { false,  true, false,  true }, // ICONFIG=46  <-- CHANNEL_ID=46
