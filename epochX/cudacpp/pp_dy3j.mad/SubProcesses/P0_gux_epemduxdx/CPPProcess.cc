...
// Process: g u~ > e+ e- d u~ d~ WEIGHTED<=7
// Process: g u~ > e+ e- s u~ s~ WEIGHTED<=7
// Process: g u~ > e+ e- b u~ b~ WEIGHTED<=7
// Process: g u~ > mu+ mu- d u~ d~ WEIGHTED<=7
// Process: g u~ > mu+ mu- s u~ s~ WEIGHTED<=7
// Process: g u~ > mu+ mu- b u~ b~ WEIGHTED<=7
// Process: g c~ > e+ e- d c~ d~ WEIGHTED<=7
// Process: g c~ > e+ e- s c~ s~ WEIGHTED<=7
// Process: g c~ > e+ e- b c~ b~ WEIGHTED<=7
// Process: g c~ > mu+ mu- d c~ d~ WEIGHTED<=7
// Process: g c~ > mu+ mu- s c~ s~ WEIGHTED<=7
// Process: g c~ > mu+ mu- b c~ b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gux_epemduxdx()?)
