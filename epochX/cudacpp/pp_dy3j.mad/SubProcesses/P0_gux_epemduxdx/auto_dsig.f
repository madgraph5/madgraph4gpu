...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: g u~ > e+ e- d u~ d~ WEIGHTED<=7
C     Process: g u~ > e+ e- s u~ s~ WEIGHTED<=7
C     Process: g u~ > e+ e- b u~ b~ WEIGHTED<=7
C     Process: g u~ > mu+ mu- d u~ d~ WEIGHTED<=7
C     Process: g u~ > mu+ mu- s u~ s~ WEIGHTED<=7
C     Process: g u~ > mu+ mu- b u~ b~ WEIGHTED<=7
C     Process: g c~ > e+ e- d c~ d~ WEIGHTED<=7
C     Process: g c~ > e+ e- s c~ s~ WEIGHTED<=7
C     Process: g c~ > e+ e- b c~ b~ WEIGHTED<=7
C     Process: g c~ > mu+ mu- d c~ d~ WEIGHTED<=7
C     Process: g c~ > mu+ mu- s c~ s~ WEIGHTED<=7
C     Process: g c~ > mu+ mu- b c~ b~ WEIGHTED<=7
C     
...
C     and update the couplings accordingly
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g u~ > e+ e- d u~ d~
C     ENDIF
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! g u~ > e+ e- d u~ d~
C     ENDIF
