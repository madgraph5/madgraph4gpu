...
// Process: g u~ > e+ e- u u~ u~ WEIGHTED<=7
// Process: g u~ > mu+ mu- u u~ u~ WEIGHTED<=7
// Process: g c~ > e+ e- c c~ c~ WEIGHTED<=7
// Process: g c~ > mu+ mu- c c~ c~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gux_epemuuxux()?)
