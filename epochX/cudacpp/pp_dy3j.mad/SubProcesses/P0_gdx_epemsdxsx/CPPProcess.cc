...
// Process: g d~ > e+ e- s d~ s~ WEIGHTED<=7
// Process: g d~ > e+ e- b d~ b~ WEIGHTED<=7
// Process: g d~ > mu+ mu- s d~ s~ WEIGHTED<=7
// Process: g d~ > mu+ mu- b d~ b~ WEIGHTED<=7
// Process: g s~ > e+ e- d s~ d~ WEIGHTED<=7
// Process: g s~ > e+ e- b s~ b~ WEIGHTED<=7
// Process: g s~ > mu+ mu- d s~ d~ WEIGHTED<=7
// Process: g s~ > mu+ mu- b s~ b~ WEIGHTED<=7
// Process: g b~ > e+ e- d b~ d~ WEIGHTED<=7
// Process: g b~ > e+ e- s b~ s~ WEIGHTED<=7
// Process: g b~ > mu+ mu- d b~ d~ WEIGHTED<=7
// Process: g b~ > mu+ mu- s b~ s~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gdx_epemsdxsx()?)
