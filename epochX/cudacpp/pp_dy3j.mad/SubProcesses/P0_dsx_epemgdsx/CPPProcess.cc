...
// Process: d s~ > e+ e- g d s~ WEIGHTED<=7
// Process: d s~ > mu+ mu- g d s~ WEIGHTED<=7
// Process: d b~ > e+ e- g d b~ WEIGHTED<=7
// Process: d b~ > mu+ mu- g d b~ WEIGHTED<=7
// Process: s d~ > e+ e- g s d~ WEIGHTED<=7
// Process: s d~ > mu+ mu- g s d~ WEIGHTED<=7
// Process: s b~ > e+ e- g s b~ WEIGHTED<=7
// Process: s b~ > mu+ mu- g s b~ WEIGHTED<=7
// Process: b d~ > e+ e- g b d~ WEIGHTED<=7
// Process: b d~ > mu+ mu- g b d~ WEIGHTED<=7
// Process: b s~ > e+ e- g b s~ WEIGHTED<=7
// Process: b s~ > mu+ mu- g b s~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_dsx_epemgdsx()?)
