...
// Process: g u~ > e+ e- g g u~ WEIGHTED<=7
// Process: g u~ > mu+ mu- g g u~ WEIGHTED<=7
// Process: g c~ > e+ e- g g c~ WEIGHTED<=7
// Process: g c~ > mu+ mu- g g c~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gux_epemggux()?)
