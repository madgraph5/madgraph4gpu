...
// Process: u c~ > e+ e- g u c~ WEIGHTED<=7
// Process: u c~ > mu+ mu- g u c~ WEIGHTED<=7
// Process: c u~ > e+ e- g c u~ WEIGHTED<=7
// Process: c u~ > mu+ mu- g c u~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_ucx_epemgucx()?)
