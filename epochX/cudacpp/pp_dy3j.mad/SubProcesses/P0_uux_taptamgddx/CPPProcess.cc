...
// Process: u u~ > ta+ ta- g d d~ WEIGHTED<=7
// Process: u u~ > ta+ ta- g s s~ WEIGHTED<=7
// Process: u u~ > ta+ ta- g b b~ WEIGHTED<=7
// Process: c c~ > ta+ ta- g d d~ WEIGHTED<=7
// Process: c c~ > ta+ ta- g s s~ WEIGHTED<=7
// Process: c c~ > ta+ ta- g b b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV2_3_1<W_ACCESS, CI_ACCESS>( w_fp[5], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[3] );
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[5], COUPs[1], 1.0, 0., 0., w_fp[9] );
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[7], w_fp[8], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[13] );

      // Amplitude(s) for diagram number 5
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[13], w_fp[1], w_fp[9], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[13], w_fp[1], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[14], w_fp[1], w_fp[9], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[13], w_fp[1], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[4], COUPs[1], 1.0, 0., 0., w_fp[13] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[11], w_fp[5], w_fp[14], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[2], w_fp[5], w_fp[14], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[4], COUPs[1], 1.0, 0., 0., w_fp[14] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[14], w_fp[1], w_fp[13], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[8], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[15] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[1], w_fp[13], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[17] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[18], w_fp[5], w_fp[8], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[19], w_fp[5], w_fp[7], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[18], w_fp[5], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[13], w_fp[5], COUPs[1], 1.0, 0., 0., w_fp[18] );

      // Amplitude(s) for diagram number 29
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[14], w_fp[1], w_fp[18], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[1], w_fp[18], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[11], w_fp[5], w_fp[18], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[7], COUPs[1], 1.0, 0., 0., w_fp[13] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[2], w_fp[5], w_fp[18], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[14], w_fp[1], w_fp[11], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[9], COUPs[1], 1.0, 0., 0., w_fp[3] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[1], w_fp[11], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_uux_taptamgddx()?)
