...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[96][4] = { // note: a trailing comma in the initializer list is allowed
    ...
    { false,  true, false, false }, // ICONFIG=5   <-- CHANNEL_ID=5
    { false,  true, false, false }, // ICONFIG=6   <-- CHANNEL_ID=6
    { false, false, false,  true }, // ICONFIG=7   <-- CHANNEL_ID=7
    { false, false, false,  true }, // ICONFIG=8   <-- CHANNEL_ID=8
    ...
    { false, false, false,  true }, // ICONFIG=17  <-- CHANNEL_ID=17
    { false, false, false,  true }, // ICONFIG=18  <-- CHANNEL_ID=18
    { false, false, false,  true }, // ICONFIG=19  <-- CHANNEL_ID=19
    { false, false, false,  true }, // ICONFIG=20  <-- CHANNEL_ID=20
    { false, false,  true, false }, // ICONFIG=21  <-- CHANNEL_ID=21
    { false, false,  true, false }, // ICONFIG=22  <-- CHANNEL_ID=22
    { false, false, false,  true }, // ICONFIG=23  <-- CHANNEL_ID=23
    { false, false, false,  true }, // ICONFIG=24  <-- CHANNEL_ID=24
    { false, false,  true, false }, // ICONFIG=25  <-- CHANNEL_ID=25
    { false, false,  true, false }, // ICONFIG=26  <-- CHANNEL_ID=26
    { false, false, false,  true }, // ICONFIG=27  <-- CHANNEL_ID=27
    { false, false, false,  true }, // ICONFIG=28  <-- CHANNEL_ID=28
    { false, false,  true, false }, // ICONFIG=29  <-- CHANNEL_ID=29
    { false, false,  true, false }, // ICONFIG=30  <-- CHANNEL_ID=30
    { false, false,  true, false }, // ICONFIG=31  <-- CHANNEL_ID=31
    { false, false,  true, false }, // ICONFIG=32  <-- CHANNEL_ID=32
    { false,  true, false, false }, // ICONFIG=33  <-- CHANNEL_ID=33
    { false,  true, false, false }, // ICONFIG=34  <-- CHANNEL_ID=34
    { false,  true, false, false }, // ICONFIG=35  <-- CHANNEL_ID=35
    { false,  true, false, false }, // ICONFIG=36  <-- CHANNEL_ID=36
    {  true, false, false, false }, // ICONFIG=37  <-- CHANNEL_ID=37
    {  true, false, false, false }, // ICONFIG=38  <-- CHANNEL_ID=38
    { false,  true, false, false }, // ICONFIG=39  <-- CHANNEL_ID=39
    { false,  true, false, false }, // ICONFIG=40  <-- CHANNEL_ID=40
    {  true, false, false, false }, // ICONFIG=41  <-- CHANNEL_ID=41
    {  true, false, false, false }, // ICONFIG=42  <-- CHANNEL_ID=42
    { false,  true, false, false }, // ICONFIG=43  <-- CHANNEL_ID=43
    { false,  true, false, false }, // ICONFIG=44  <-- CHANNEL_ID=44
    {  true, false, false, false }, // ICONFIG=45  <-- CHANNEL_ID=45
    {  true, false, false, false }, // ICONFIG=46  <-- CHANNEL_ID=46
    {  true, false, false, false }, // ICONFIG=47  <-- CHANNEL_ID=47
    {  true, false, false, false }, // ICONFIG=48  <-- CHANNEL_ID=48
    { false, false,  true, false }, // ICONFIG=49  <-- CHANNEL_ID=49
    { false, false,  true, false }, // ICONFIG=50  <-- CHANNEL_ID=50
    { false, false,  true, false }, // ICONFIG=51  <-- CHANNEL_ID=51
    { false, false,  true, false }, // ICONFIG=52  <-- CHANNEL_ID=52
    {  true, false, false, false }, // ICONFIG=53  <-- CHANNEL_ID=53
    {  true, false, false, false }, // ICONFIG=54  <-- CHANNEL_ID=54
    {  true, false, false, false }, // ICONFIG=55  <-- CHANNEL_ID=55
    {  true, false, false, false }, // ICONFIG=56  <-- CHANNEL_ID=56
    {  true, false, false, false }, // ICONFIG=57  <-- CHANNEL_ID=57
    {  true, false, false, false }, // ICONFIG=58  <-- CHANNEL_ID=58
    { false, false,  true, false }, // ICONFIG=59  <-- CHANNEL_ID=59
    { false, false,  true, false }, // ICONFIG=60  <-- CHANNEL_ID=60
    {  true, false, false, false }, // ICONFIG=61  <-- CHANNEL_ID=61
    {  true, false, false, false }, // ICONFIG=62  <-- CHANNEL_ID=62
    { false, false,  true, false }, // ICONFIG=63  <-- CHANNEL_ID=63
    { false, false,  true, false }, // ICONFIG=64  <-- CHANNEL_ID=64
    { false,  true,  true, false }, // ICONFIG=65  <-- CHANNEL_ID=65
    { false,  true,  true, false }, // ICONFIG=66  <-- CHANNEL_ID=66
    { false, false,  true, false }, // ICONFIG=67  <-- CHANNEL_ID=67
    { false,  true, false, false }, // ICONFIG=68  <-- CHANNEL_ID=68
    { false,  true,  true, false }, // ICONFIG=69  <-- CHANNEL_ID=69
    { false,  true,  true, false }, // ICONFIG=70  <-- CHANNEL_ID=70
    { false, false,  true, false }, // ICONFIG=71  <-- CHANNEL_ID=71
    { false,  true, false, false }, // ICONFIG=72  <-- CHANNEL_ID=72
    {  true, false, false,  true }, // ICONFIG=73  <-- CHANNEL_ID=73
    {  true, false, false,  true }, // ICONFIG=74  <-- CHANNEL_ID=74
    {  true, false, false, false }, // ICONFIG=75  <-- CHANNEL_ID=75
    { false, false, false,  true }, // ICONFIG=76  <-- CHANNEL_ID=76
    {  true, false, false,  true }, // ICONFIG=77  <-- CHANNEL_ID=77
    {  true, false, false,  true }, // ICONFIG=78  <-- CHANNEL_ID=78
    {  true, false, false, false }, // ICONFIG=79  <-- CHANNEL_ID=79
    { false, false, false,  true }, // ICONFIG=80  <-- CHANNEL_ID=80
    {  true, false, false,  true }, // ICONFIG=81  <-- CHANNEL_ID=81
    {  true, false, false,  true }, // ICONFIG=82  <-- CHANNEL_ID=82
    { false, false, false,  true }, // ICONFIG=83  <-- CHANNEL_ID=83
    {  true, false, false, false }, // ICONFIG=84  <-- CHANNEL_ID=84
    {  true, false, false,  true }, // ICONFIG=85  <-- CHANNEL_ID=85
    {  true, false, false,  true }, // ICONFIG=86  <-- CHANNEL_ID=86
    { false, false, false,  true }, // ICONFIG=87  <-- CHANNEL_ID=87
    {  true, false, false, false }, // ICONFIG=88  <-- CHANNEL_ID=88
    { false,  true,  true, false }, // ICONFIG=89  <-- CHANNEL_ID=89
    { false,  true,  true, false }, // ICONFIG=90  <-- CHANNEL_ID=90
    { false,  true, false, false }, // ICONFIG=91  <-- CHANNEL_ID=91
    { false, false,  true, false }, // ICONFIG=92  <-- CHANNEL_ID=92
    { false,  true,  true, false }, // ICONFIG=93  <-- CHANNEL_ID=93
    { false,  true,  true, false }, // ICONFIG=94  <-- CHANNEL_ID=94
    { false,  true, false, false }, // ICONFIG=95  <-- CHANNEL_ID=95
    { false, false,  true, false }, // ICONFIG=96  <-- CHANNEL_ID=96
  };
