...
// Process: u u~ > e+ e- g g g WEIGHTED<=7
// Process: u u~ > mu+ mu- g g g WEIGHTED<=7
// Process: c c~ > e+ e- g g g WEIGHTED<=7
// Process: c c~ > mu+ mu- g g g WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_uux_epemggg()?)
