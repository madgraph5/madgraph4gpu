...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: u u~ > e+ e- g g g WEIGHTED<=7
C     Process: u u~ > mu+ mu- g g g WEIGHTED<=7
C     Process: c c~ > e+ e- g g g WEIGHTED<=7
C     Process: c c~ > mu+ mu- g g g WEIGHTED<=7
C     
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! u u~ > e+ e- g g g
C     ENDIF
