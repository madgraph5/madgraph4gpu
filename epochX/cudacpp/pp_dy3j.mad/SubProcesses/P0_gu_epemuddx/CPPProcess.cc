...
// Process: g u > e+ e- u d d~ WEIGHTED<=7
// Process: g u > e+ e- u s s~ WEIGHTED<=7
// Process: g u > e+ e- u b b~ WEIGHTED<=7
// Process: g u > mu+ mu- u d d~ WEIGHTED<=7
// Process: g u > mu+ mu- u s s~ WEIGHTED<=7
// Process: g u > mu+ mu- u b b~ WEIGHTED<=7
// Process: g c > e+ e- c d d~ WEIGHTED<=7
// Process: g c > e+ e- c s s~ WEIGHTED<=7
// Process: g c > e+ e- c b b~ WEIGHTED<=7
// Process: g c > mu+ mu- c d d~ WEIGHTED<=7
// Process: g c > mu+ mu- c s s~ WEIGHTED<=7
// Process: g c > mu+ mu- c b b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gu_epemuddx()?)
