...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: g u > e+ e- u d d~ WEIGHTED<=7
C     Process: g u > e+ e- u s s~ WEIGHTED<=7
C     Process: g u > e+ e- u b b~ WEIGHTED<=7
C     Process: g u > mu+ mu- u d d~ WEIGHTED<=7
C     Process: g u > mu+ mu- u s s~ WEIGHTED<=7
C     Process: g u > mu+ mu- u b b~ WEIGHTED<=7
C     Process: g c > e+ e- c d d~ WEIGHTED<=7
C     Process: g c > e+ e- c s s~ WEIGHTED<=7
C     Process: g c > e+ e- c b b~ WEIGHTED<=7
C     Process: g c > mu+ mu- c d d~ WEIGHTED<=7
C     Process: g c > mu+ mu- c s s~ WEIGHTED<=7
C     Process: g c > mu+ mu- c b b~ WEIGHTED<=7
C     
...
C     and update the couplings accordingly
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! g u > e+ e- u d d~
C     ENDIF
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! g u > e+ e- u d d~
C     ENDIF
