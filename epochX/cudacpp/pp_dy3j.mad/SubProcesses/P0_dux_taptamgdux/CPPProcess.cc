...
// Process: d u~ > ta+ ta- g d u~ WEIGHTED<=7
// Process: d c~ > ta+ ta- g d c~ WEIGHTED<=7
// Process: s u~ > ta+ ta- g s u~ WEIGHTED<=7
// Process: s c~ > ta+ ta- g s c~ WEIGHTED<=7
// Process: b u~ > ta+ ta- g b u~ WEIGHTED<=7
// Process: b c~ > ta+ ta- g b c~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[1], COUPs[1], 1.0, 0., 0., w_fp[7] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_dux_taptamgdux()?)
