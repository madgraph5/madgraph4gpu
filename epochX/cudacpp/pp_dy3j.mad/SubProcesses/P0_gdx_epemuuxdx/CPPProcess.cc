...
// Process: g d~ > e+ e- u u~ d~ WEIGHTED<=7
// Process: g d~ > e+ e- c c~ d~ WEIGHTED<=7
// Process: g d~ > mu+ mu- u u~ d~ WEIGHTED<=7
// Process: g d~ > mu+ mu- c c~ d~ WEIGHTED<=7
// Process: g s~ > e+ e- u u~ s~ WEIGHTED<=7
// Process: g s~ > e+ e- c c~ s~ WEIGHTED<=7
// Process: g s~ > mu+ mu- u u~ s~ WEIGHTED<=7
// Process: g s~ > mu+ mu- c c~ s~ WEIGHTED<=7
// Process: g b~ > e+ e- u u~ b~ WEIGHTED<=7
// Process: g b~ > e+ e- c c~ b~ WEIGHTED<=7
// Process: g b~ > mu+ mu- u u~ b~ WEIGHTED<=7
// Process: g b~ > mu+ mu- c c~ b~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gdx_epemuuxdx()?)
