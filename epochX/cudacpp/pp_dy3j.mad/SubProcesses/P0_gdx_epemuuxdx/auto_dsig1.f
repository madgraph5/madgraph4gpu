...
C     
C     Process: g d~ > e+ e- u u~ d~ WEIGHTED<=7
C     Process: g d~ > e+ e- c c~ d~ WEIGHTED<=7
C     Process: g d~ > mu+ mu- u u~ d~ WEIGHTED<=7
C     Process: g d~ > mu+ mu- c c~ d~ WEIGHTED<=7
C     Process: g s~ > e+ e- u u~ s~ WEIGHTED<=7
C     Process: g s~ > e+ e- c c~ s~ WEIGHTED<=7
C     Process: g s~ > mu+ mu- u u~ s~ WEIGHTED<=7
C     Process: g s~ > mu+ mu- c c~ s~ WEIGHTED<=7
C     Process: g b~ > e+ e- u u~ b~ WEIGHTED<=7
C     Process: g b~ > e+ e- c c~ b~ WEIGHTED<=7
C     Process: g b~ > mu+ mu- u u~ b~ WEIGHTED<=7
C     Process: g b~ > mu+ mu- c c~ b~ WEIGHTED<=7
C     
...
C     Continue only if IMODE is 0, 4 or 5
     ...
     $       -PP(3,I))))
      ...
      PD(IPROC)=G1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g b~ > e+ e- u u~ b~
      PD(IPROC)=G1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g b~ > e+ e- c c~ b~
      PD(IPROC)=G1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g b~ > mu+ mu- u u~ b~
      PD(IPROC)=G1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! g b~ > mu+ mu- c c~ b~
      PD(IPROC)=G1*BX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IF (IMODE.EQ.4)THEN
        DSIG1 = PD(0)
