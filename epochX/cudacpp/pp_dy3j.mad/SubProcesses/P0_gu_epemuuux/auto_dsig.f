...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: g u > e+ e- u u u~ WEIGHTED<=7
C     Process: g u > mu+ mu- u u u~ WEIGHTED<=7
C     Process: g c > e+ e- c c c~ WEIGHTED<=7
C     Process: g c > mu+ mu- c c c~ WEIGHTED<=7
C     
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! g u > e+ e- u u u~
C     ENDIF
