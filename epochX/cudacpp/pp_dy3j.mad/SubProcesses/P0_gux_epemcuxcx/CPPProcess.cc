...
// Process: g u~ > e+ e- c u~ c~ WEIGHTED<=7
// Process: g u~ > mu+ mu- c u~ c~ WEIGHTED<=7
// Process: g c~ > e+ e- u c~ u~ WEIGHTED<=7
// Process: g c~ > mu+ mu- u c~ u~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gux_epemcuxcx()?)
