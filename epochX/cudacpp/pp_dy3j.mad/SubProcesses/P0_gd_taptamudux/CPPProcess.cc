...
// Process: g d > ta+ ta- u d u~ WEIGHTED<=7
// Process: g d > ta+ ta- c d c~ WEIGHTED<=7
// Process: g s > ta+ ta- u s u~ WEIGHTED<=7
// Process: g s > ta+ ta- c s c~ WEIGHTED<=7
// Process: g b > ta+ ta- u b u~ WEIGHTED<=7
// Process: g b > ta+ ta- c b c~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[0], COUPs[1], 1.0, 0., 0., w_fp[7] );
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[5], COUPs[1], 1.0, 0., 0., w_fp[9] );
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[4], COUPs[1], 1.0, 0., 0., w_fp[7] );
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[0], COUPs[1], 1.0, 0., 0., w_fp[13] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gd_taptamudux()?)
