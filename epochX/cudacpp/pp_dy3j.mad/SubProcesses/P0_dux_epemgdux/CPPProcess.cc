...
// Process: d u~ > e+ e- g d u~ WEIGHTED<=7
// Process: d u~ > mu+ mu- g d u~ WEIGHTED<=7
// Process: d c~ > e+ e- g d c~ WEIGHTED<=7
// Process: d c~ > mu+ mu- g d c~ WEIGHTED<=7
// Process: s u~ > e+ e- g s u~ WEIGHTED<=7
// Process: s u~ > mu+ mu- g s u~ WEIGHTED<=7
// Process: s c~ > e+ e- g s c~ WEIGHTED<=7
// Process: s c~ > mu+ mu- g s c~ WEIGHTED<=7
// Process: b u~ > e+ e- g b u~ WEIGHTED<=7
// Process: b u~ > mu+ mu- g b u~ WEIGHTED<=7
// Process: b c~ > e+ e- g b c~ WEIGHTED<=7
// Process: b c~ > mu+ mu- g b c~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_dux_epemgdux()?)
