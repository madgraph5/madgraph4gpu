...
// Process: g d > ta+ ta- d s s~ WEIGHTED<=7
// Process: g d > ta+ ta- d b b~ WEIGHTED<=7
// Process: g s > ta+ ta- s d d~ WEIGHTED<=7
// Process: g s > ta+ ta- s b b~ WEIGHTED<=7
// Process: g b > ta+ ta- b d d~ WEIGHTED<=7
// Process: g b > ta+ ta- b s s~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[13], w_fp[4], w_fp[8], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[13], w_fp[4], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[14], w_fp[8], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[14], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[8], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[14] );
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[4], w_fp[8], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[15] );
      ...
      FFV2_3_2<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[16] );
      ...
      FFV2_3_1<W_ACCESS, CI_ACCESS>( w_fp[4], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[17] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gd_taptamdssx()?)
