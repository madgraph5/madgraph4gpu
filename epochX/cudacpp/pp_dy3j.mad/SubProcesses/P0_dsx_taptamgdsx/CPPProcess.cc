...
// Process: d s~ > ta+ ta- g d s~ WEIGHTED<=7
// Process: d b~ > ta+ ta- g d b~ WEIGHTED<=7
// Process: s d~ > ta+ ta- g s d~ WEIGHTED<=7
// Process: s b~ > ta+ ta- g s b~ WEIGHTED<=7
// Process: b d~ > ta+ ta- g b d~ WEIGHTED<=7
// Process: b s~ > ta+ ta- g b s~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[7], w_fp[8], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[13] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[13], w_fp[5], w_fp[8], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_2<W_ACCESS, CI_ACCESS>( w_fp[7], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[14] );
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[13], w_fp[5], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[13], w_fp[8], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[14] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[14], w_fp[8], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_1<W_ACCESS, CI_ACCESS>( w_fp[13], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[7] );
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[14], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[8], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[14] );
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[5], w_fp[8], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[15] );
      ...
      FFV2_3_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[16] );
      ...
      FFV2_3_1<W_ACCESS, CI_ACCESS>( w_fp[5], w_fp[12], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[17] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_dsx_taptamgdsx()?)
