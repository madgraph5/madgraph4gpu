...
// Process: d d~ > e+ e- g s s~ WEIGHTED<=7
// Process: d d~ > e+ e- g b b~ WEIGHTED<=7
// Process: d d~ > mu+ mu- g s s~ WEIGHTED<=7
// Process: d d~ > mu+ mu- g b b~ WEIGHTED<=7
// Process: s s~ > e+ e- g d d~ WEIGHTED<=7
// Process: s s~ > e+ e- g b b~ WEIGHTED<=7
// Process: s s~ > mu+ mu- g d d~ WEIGHTED<=7
// Process: s s~ > mu+ mu- g b b~ WEIGHTED<=7
// Process: b b~ > e+ e- g d d~ WEIGHTED<=7
// Process: b b~ > e+ e- g s s~ WEIGHTED<=7
// Process: b b~ > mu+ mu- g d d~ WEIGHTED<=7
// Process: b b~ > mu+ mu- g s s~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_ddx_epemgssx()?)
