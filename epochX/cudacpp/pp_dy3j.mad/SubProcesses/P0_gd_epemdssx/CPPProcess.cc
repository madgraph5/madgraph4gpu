...
// Process: g d > e+ e- d s s~ WEIGHTED<=7
// Process: g d > e+ e- d b b~ WEIGHTED<=7
// Process: g d > mu+ mu- d s s~ WEIGHTED<=7
// Process: g d > mu+ mu- d b b~ WEIGHTED<=7
// Process: g s > e+ e- s d d~ WEIGHTED<=7
// Process: g s > e+ e- s b b~ WEIGHTED<=7
// Process: g s > mu+ mu- s d d~ WEIGHTED<=7
// Process: g s > mu+ mu- s b b~ WEIGHTED<=7
// Process: g b > e+ e- b d d~ WEIGHTED<=7
// Process: g b > e+ e- b s s~ WEIGHTED<=7
// Process: g b > mu+ mu- b d d~ WEIGHTED<=7
// Process: g b > mu+ mu- b s s~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gd_epemdssx()?)
