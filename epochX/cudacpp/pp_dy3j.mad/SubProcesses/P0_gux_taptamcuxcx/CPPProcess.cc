...
// Process: g u~ > ta+ ta- c u~ c~ WEIGHTED<=7
// Process: g c~ > ta+ ta- u c~ u~ WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[4], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[3] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[18], w_fp[4], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[18], w_fp[4], w_fp[12], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_gux_taptamcuxcx()?)
