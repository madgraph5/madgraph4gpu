...
// Process: u u~ > ta+ ta- g g g WEIGHTED<=7
// Process: c c~ > ta+ ta- g g g WEIGHTED<=7
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[8], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[11] );
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[14], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[2] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[15], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[15], w_fp[14], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[7], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[7], w_fp[14], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[17], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[17], w_fp[14], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[6], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
      jamp_sv[0] -= amp_sv[0];
      jamp_sv[1] += amp_sv[0];
      jamp_sv[3] += amp_sv[0];
      jamp_sv[5] -= amp_sv[0];
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[5], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
      jamp_sv[1] += amp_sv[0];
      jamp_sv[2] -= amp_sv[0];
      jamp_sv[3] += amp_sv[0];
      jamp_sv[4] -= amp_sv[0];
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[4], w_fp[8], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
      jamp_sv[0] += amp_sv[0];
      jamp_sv[2] -= amp_sv[0];
      jamp_sv[4] -= amp_sv[0];
      jamp_sv[5] += amp_sv[0];
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[6], w_fp[14], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
      jamp_sv[0] -= amp_sv[0];
      jamp_sv[1] += amp_sv[0];
      jamp_sv[3] += amp_sv[0];
      jamp_sv[5] -= amp_sv[0];
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[5], w_fp[14], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
      jamp_sv[1] += amp_sv[0];
      jamp_sv[2] -= amp_sv[0];
      jamp_sv[3] += amp_sv[0];
      jamp_sv[4] -= amp_sv[0];
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[0], w_fp[4], w_fp[14], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
      jamp_sv[0] += amp_sv[0];
      jamp_sv[2] -= amp_sv[0];
      jamp_sv[4] -= amp_sv[0];
      jamp_sv[5] += amp_sv[0];
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_uux_taptamggg()?)
