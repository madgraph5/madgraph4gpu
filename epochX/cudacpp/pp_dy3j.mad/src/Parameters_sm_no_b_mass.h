...
#endif
{
  ...
  public:
    ...
    double mdl_WH, mdl_WW, mdl_WZ, mdl_WT, mdl_ymtau, mdl_ymt, mdl_Gf, aEWM1, mdl_MH, mdl_MZ, mdl_MTA, mdl_MT, mdl_conjg__CKM3x3, mdl_conjg__CKM1x1, mdl_CKM3x3, mdl_MZ__exp__2, mdl_MZ__exp__4, mdl_sqrt__2, mdl_MH__exp__2, mdl_aEW, mdl_MW, mdl_sqrt__aEW, mdl_ee, mdl_MW__exp__2, mdl_sw2, mdl_cw, mdl_sqrt__sw2, mdl_sw, mdl_g1, mdl_gw, mdl_vev, mdl_vev__exp__2, mdl_lam, mdl_yt, mdl_ytau, mdl_muH, mdl_ee__exp__2, mdl_sw__exp__2, mdl_cw__exp__2;
    cxsmpl<double> mdl_complexi, mdl_I2x33, mdl_I3x33;
...
#endif
{
  ...
  namespace Parameters_sm_no_b_mass // keep the same name rather than HardcodedParameters_sm_no_b_mass for simplicity
  {
    // Model parameters independent of aS
...
#pragma nv_diag_suppress 177 // e.g. <<warning #177-D: variable "mdl_G__exp__2" was declared but never referenced>>
    ...
    __host__ __device__ inline const DependentCouplings_sv computeDependentCouplings_fromG( const fptype_sv& G_sv, const double* bsmIndepParamPtr )
    {
      ...
      using namespace Parameters_sm_no_b_mass;
#else
      // No special handling of non-hardcoded parameters (no additional BSM parameters needed in constant memory)
#endif
      // NB: hardcode cxtype cI(0,1) instead of cxtype (or hardcoded cxsmpl) mdl_complexi (which exists in Parameters_sm_no_b_mass) because:
...
#pragma nv_diagnostic pop
  ...
  namespace Parameters_sm_no_b_mass_independentCouplings
  {
    constexpr size_t nicoup = 6; // #couplings that are fixed for all events because they do not depend on the running alphas QCD
    //constexpr size_t ixcoup_GC_1 = 0 + Parameters_sm_no_b_mass_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_2 = 1 + Parameters_sm_no_b_mass_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_3 = 2 + Parameters_sm_no_b_mass_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_50 = 3 + Parameters_sm_no_b_mass_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_58 = 4 + Parameters_sm_no_b_mass_dependentCouplings::ndcoup; // out of ndcoup+nicoup
    //constexpr size_t ixcoup_GC_59 = 5 + Parameters_sm_no_b_mass_dependentCouplings::ndcoup; // out of ndcoup+nicoup
  }
