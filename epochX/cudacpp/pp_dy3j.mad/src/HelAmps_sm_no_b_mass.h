...
#define ALWAYS_INLINE
          ...
          fptype allvertexes[] )
  {
    ...
    cxtype_sv* vertex = A_ACCESS::kernelAccess( allvertexes );
    const cxtype cI = cxmake( 0., 1. );
    const cxtype_sv TMP6 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    ( *vertex ) = Ccoeff * COUP * -cI * TMP6;
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allF1[] )
  {
    ...
    F1[3] = denom * -cI * M1 * ( F2[4] * ( -V3[3] + cI * V3[4] ) + F2[5] * ( -V3[2] + V3[5] ) );
    F1[4] = denom * ( -cI ) * ( F2[4] * ( P1[0] * ( V3[2] + V3[5] ) + ( P1[1] * ( -V3[3] + cI * V3[4] ) + ( P1[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P1[3] * ( V3[2] + V3[5] ) ) ) ) + F2[5] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( -cI * V3[2] + cI * V3[5] ) - P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) );
    F1[5] = denom * ( -cI ) * ( F2[4] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] - cI * V3[4] ) ) ) ) + F2[5] * ( P1[0] * ( V3[2] - V3[5] ) + ( P1[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] - V3[4] ) + P1[3] * ( V3[2] - V3[5] ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allF2[] )
  {
    ...
    constexpr fptype one( 1. );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P2[0] * P2[0] ) - ( P2[1] * P2[1] ) - ( P2[2] * P2[2] ) - ( P2[3] * P2[3] ) - M2 * ( M2 - cI * W2 ) );
    F2[2] = denom * cI * ( F1[2] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] - V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + F1[3] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( -V3[3] + cI * V3[4] ) ) ) ) );
    F2[3] = denom * cI * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) );
    F2[4] = denom * -cI * M2 * ( F1[2] * ( -one ) * ( V3[2] + V3[5] ) + F1[3] * ( -V3[3] + cI * V3[4] ) );
          ...
          fptype allV3[] )
  {
    ...
    V3[1] = +F1[1] + F2[1];
    const fptype_sv P3[4] = { -cxreal( V3[0] ), -cxreal( V3[1] ), -cximag( V3[1] ), -cximag( V3[0] ) };
    const cxtype_sv TMP7 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + cI * P3[2] ) ) + F1[3] * ( F2[4] * ( P3[1] - cI * P3[2] ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - cI * W3 ) );
    V3[2] = denom * ( -cI ) * ( F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP7 );
    V3[3] = denom * ( -cI ) * ( -F1[2] * F2[5] - F1[3] * F2[4] - P3[1] * OM3 * TMP7 );
    V3[4] = denom * ( -cI ) * ( -cI * ( F1[2] * F2[5] ) + cI * ( F1[3] * F2[4] ) - P3[2] * OM3 * TMP7 );
    V3[5] = denom * ( -cI ) * ( -F1[2] * F2[4] - P3[3] * OM3 * TMP7 + F1[3] * F2[5] );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allV3[] )
  {
    ...
    const cxtype_sv TMP7 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + cI * P3[2] ) ) + F1[3] * ( F2[4] * ( P3[1] - cI * P3[2] ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv TMP8 = ( F1[4] * ( F2[2] * ( P3[0] - P3[3] ) - F2[3] * ( P3[1] + cI * P3[2] ) ) + F1[5] * ( F2[2] * ( -P3[1] + cI * P3[2] ) + F2[3] * ( P3[0] + P3[3] ) ) );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - cI * W3 ) );
    V3[2] = denom * ( -two * cI ) * ( OM3 * -half * P3[0] * ( TMP7 + two * TMP8 ) + ( +half * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) );
    V3[3] = denom * ( -two * cI ) * ( OM3 * -half * P3[1] * ( TMP7 + two * TMP8 ) + ( -half * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) );
    V3[4] = denom * ( two * cI ) * ( OM3 * half * P3[2] * ( TMP7 + two * TMP8 ) + ( half * cI * ( F1[2] * F2[5] ) - half * cI * ( F1[3] * F2[4] ) - cI * ( F1[4] * F2[3] ) + cI * ( F1[5] * F2[2] ) ) );
    V3[5] = denom * ( two * cI ) * ( OM3 * half * P3[3] * ( TMP7 + two * TMP8 ) + ( +half * ( F1[2] * F2[4] ) - half * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allvertexes[] )
  {
    ...
    const cxtype cI = cxmake( 0., 1. );
    constexpr fptype one( 1. );
    const cxtype_sv TMP10 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    ( *vertex ) = Ccoeff * COUP * ( -one ) * ( +cI * TMP9 + ( 4. * cI ) * TMP10 );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allF1[] )
  {
    ...
    const cxtype_sv denom = Ccoeff * COUP / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    F1[2] = denom * ( 4. * cI ) * ( F2[2] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] - cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F2[3] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[4] * quarter * ( V3[2] + V3[5] ) + quarter * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) ) );
    F1[3] = denom * ( 4. * cI ) * ( F2[2] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[3] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + M1 * ( F2[4] * quarter * ( V3[3] - cI * V3[4] ) + quarter * ( F2[5] * ( V3[2] - V3[5] ) ) ) ) );
    F1[4] = denom * ( -cI ) * ( F2[4] * ( P1[0] * ( V3[2] + V3[5] ) + ( P1[1] * ( -V3[3] + cI * V3[4] ) + ( P1[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P1[3] * ( V3[2] + V3[5] ) ) ) ) + ( F2[5] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( -cI * V3[2] + cI * V3[5] ) - P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[2] * 4. * ( -V3[2] + V3[5] ) + 4. * ( F2[3] * ( V3[3] + cI * V3[4] ) ) ) ) );
    F1[5] = denom * cI * ( F2[4] * ( P1[0] * ( -V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[5] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) + M1 * ( F2[2] * 4. * ( -V3[3] + cI * V3[4] ) + 4. * ( F2[3] * ( V3[2] + V3[5] ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allF2[] )
  {
    ...
    constexpr fptype quarter( 1. / 4. );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P2[0] * P2[0] ) - ( P2[1] * P2[1] ) - ( P2[2] * P2[2] ) - ( P2[3] * P2[3] ) - M2 * ( M2 - cI * W2 ) );
    F2[2] = denom * cI * ( F1[2] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] - V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + M2 * ( F1[4] * 4. * ( V3[2] - V3[5] ) + 4. * ( F1[5] * ( -V3[3] + cI * V3[4] ) ) ) ) );
    F2[3] = denom * cI * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) + M2 * ( F1[4] * ( -4. ) * ( V3[3] + cI * V3[4] ) + 4. * ( F1[5] * ( V3[2] + V3[5] ) ) ) ) );
    F2[4] = denom * ( -4. * cI ) * ( F1[4] * ( P2[0] * ( -V3[2] + V3[5] ) + ( P2[1] * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( -cI * V3[3] + V3[4] ) + P2[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F1[5] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] - cI * V3[4] ) ) ) ) + M2 * ( F1[2] * ( -quarter ) * ( V3[2] + V3[5] ) + quarter * ( F1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) );
    F2[5] = denom * ( -4. * cI ) * ( F1[4] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( -cI * V3[2] + cI * V3[5] ) - P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[5] * ( P2[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[1] * ( V3[3] - cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] + V3[5] ) ) ) ) + M2 * ( F1[2] * ( -quarter ) * ( V3[3] + cI * V3[4] ) + quarter * ( F1[3] * ( -V3[2] + V3[5] ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
             ...
             fptype allV1[] )
  {
    ...
    const cxtype_sv TMP4 = ( V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5] );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    V1[2] = denom * ( -cI * ( TMP4 * V4[2] ) + cI * ( V3[2] * TMP11 ) );
             ...
             fptype allV1[] )
  {
    ...
    const cxtype_sv TMP4 = ( V3[2] * V2[2] - V3[3] * V2[3] - V3[4] * V2[4] - V3[5] * V2[5] );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    V1[2] = denom * ( -cI * ( TMP4 * V4[2] ) + cI * ( V2[2] * TMP12 ) );
          ...
          fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP10 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    ( *vertex ) = Ccoeff * COUP * ( -cI * TMP9 + ( two * cI ) * TMP10 );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allF1[] )
  {
    ...
    constexpr fptype half( 1. / 2. );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    F1[2] = denom * ( -two * cI ) * ( F2[2] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] - cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F2[3] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[4] * ( -half ) * ( V3[2] + V3[5] ) - half * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) ) );
    F1[3] = denom * ( -two * cI ) * ( F2[2] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[3] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + M1 * ( F2[4] * half * ( -V3[3] + cI * V3[4] ) + half * ( F2[5] * ( -V3[2] + V3[5] ) ) ) ) );
    F1[4] = denom * cI * ( F2[4] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] - cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + ( F2[5] * ( P1[0] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] - V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[2] * two * ( -V3[2] + V3[5] ) + two * ( F2[3] * ( V3[3] + cI * V3[4] ) ) ) ) );
    F1[5] = denom * ( -cI ) * ( F2[4] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] - cI * V3[4] ) ) ) ) + ( F2[5] * ( P1[0] * ( V3[2] - V3[5] ) + ( P1[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] - V3[4] ) + P1[3] * ( V3[2] - V3[5] ) ) ) ) + M1 * ( F2[2] * two * ( -V3[3] + cI * V3[4] ) + two * ( F2[3] * ( V3[2] + V3[5] ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allF2[] )
  {
    ...
    constexpr fptype half( 1. / 2. );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P2[0] * P2[0] ) - ( P2[1] * P2[1] ) - ( P2[2] * P2[2] ) - ( P2[3] * P2[3] ) - M2 * ( M2 - cI * W2 ) );
    F2[2] = denom * cI * ( F1[2] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] - V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + M2 * ( F1[4] * two * ( -V3[2] + V3[5] ) + two * ( F1[5] * ( V3[3] - cI * V3[4] ) ) ) ) );
    F2[3] = denom * cI * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) + M2 * ( F1[4] * two * ( V3[3] + cI * V3[4] ) - two * ( F1[5] * ( V3[2] + V3[5] ) ) ) ) );
    F2[4] = denom * ( two * cI ) * ( F1[4] * ( P2[0] * ( -V3[2] + V3[5] ) + ( P2[1] * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( -cI * V3[3] + V3[4] ) + P2[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F1[5] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] - cI * V3[4] ) ) ) ) + M2 * ( F1[2] * half * ( V3[2] + V3[5] ) + half * ( F1[3] * ( V3[3] - cI * V3[4] ) ) ) ) );
    F2[5] = denom * ( two * cI ) * ( F1[4] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( -cI * V3[2] + cI * V3[5] ) - P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[5] * ( P2[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[1] * ( V3[3] - cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] + V3[5] ) ) ) ) + M2 * ( F1[2] * half * ( V3[3] + cI * V3[4] ) + half * ( F1[3] * ( V3[2] - V3[5] ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP10 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    ( *vertex ) = ( -one ) * ( Ccoeff2 * COUP2 * ( +cI * TMP9 + ( two * cI ) * TMP10 ) + cI * ( TMP9 * Ccoeff1 * COUP1 ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allF1[] )
  {
    ...
    constexpr fptype two( 2. );
    constexpr fptype half( 1. / 2. );
    const cxtype_sv denom = one / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    F1[2] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( F2[2] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] - cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F2[3] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[4] * half * ( V3[2] + V3[5] ) + half * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * M1 * ( F2[4] * half * ( V3[2] + V3[5] ) + half * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) );
    F1[3] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( F2[2] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[3] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + M1 * ( F2[4] * half * ( V3[3] - cI * V3[4] ) + half * ( F2[5] * ( V3[2] - V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * M1 * ( F2[4] * half * ( V3[3] - cI * V3[4] ) + half * ( F2[5] * ( V3[2] - V3[5] ) ) ) );
    F1[4] = denom * ( -cI ) * ( Ccoeff2 * COUP2 * ( F2[4] * ( P1[0] * ( V3[2] + V3[5] ) + ( P1[1] * ( -V3[3] + cI * V3[4] ) + ( P1[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P1[3] * ( V3[2] + V3[5] ) ) ) ) + ( F2[5] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( -cI * V3[2] + cI * V3[5] ) - P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[2] * two * ( -V3[2] + V3[5] ) + two * ( F2[3] * ( V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F2[4] * ( P1[0] * ( V3[2] + V3[5] ) + ( P1[1] * ( -V3[3] + cI * V3[4] ) + ( P1[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P1[3] * ( V3[2] + V3[5] ) ) ) ) + F2[5] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( -cI * V3[2] + cI * V3[5] ) - P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) ) );
    F1[5] = denom * cI * ( Ccoeff2 * COUP2 * ( F2[4] * ( P1[0] * ( -V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[5] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) + M1 * ( F2[2] * two * ( -V3[3] + cI * V3[4] ) + two * ( F2[3] * ( V3[2] + V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F2[4] * ( P1[0] * ( -V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + F2[5] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allF2[] )
  {
    ...
    constexpr fptype two( 2. );
    constexpr fptype half( 1. / 2. );
    const cxtype_sv denom = one / ( ( P2[0] * P2[0] ) - ( P2[1] * P2[1] ) - ( P2[2] * P2[2] ) - ( P2[3] * P2[3] ) - M2 * ( M2 - cI * W2 ) );
    F2[2] = denom * cI * ( Ccoeff2 * COUP2 * ( F1[2] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] - V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + M2 * ( F1[4] * two * ( V3[2] - V3[5] ) + two * ( F1[5] * ( -V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F1[2] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] - V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + F1[3] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( -V3[3] + cI * V3[4] ) ) ) ) ) );
    F2[3] = denom * cI * ( Ccoeff2 * COUP2 * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) + M2 * ( F1[4] * ( -two ) * ( V3[3] + cI * V3[4] ) + two * ( F1[5] * ( V3[2] + V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) ) );
    F2[4] = denom * ( -two * cI ) * ( Ccoeff2 * COUP2 * ( F1[4] * ( P2[0] * ( -V3[2] + V3[5] ) + ( P2[1] * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( -cI * V3[3] + V3[4] ) + P2[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F1[5] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] - cI * V3[4] ) ) ) ) + M2 * ( F1[2] * ( -half ) * ( V3[2] + V3[5] ) + half * ( F1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * M2 * ( F1[2] * ( -half ) * ( V3[2] + V3[5] ) + half * ( F1[3] * ( -V3[3] + cI * V3[4] ) ) ) );
    F2[5] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( F1[4] * ( P2[0] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( V3[2] - V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[5] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + M2 * ( F1[2] * half * ( V3[3] + cI * V3[4] ) + half * ( F1[3] * ( V3[2] - V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * M2 * ( F1[2] * half * ( V3[3] + cI * V3[4] ) + half * ( F1[3] * ( V3[2] - V3[5] ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allV3[] )
  {
    ...
    V3[2] = denom * ( -two * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -half * P3[0] * ( TMP7 + two * TMP8 ) + ( +half * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) ) + half * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP7 ) ) );
    V3[3] = denom * ( -two * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -half * P3[1] * ( TMP7 + two * TMP8 ) + ( -half * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) ) - half * ( Ccoeff1 * COUP1 * ( F1[2] * F2[5] + F1[3] * F2[4] + P3[1] * OM3 * TMP7 ) ) );
    V3[4] = denom * cI * ( Ccoeff2 * COUP2 * ( OM3 * P3[2] * ( TMP7 + two * TMP8 ) + ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + ( -two * cI ) * ( F1[4] * F2[3] ) + ( two * cI ) * ( F1[5] * F2[2] ) ) ) + Ccoeff1 * COUP1 * ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + P3[2] * OM3 * TMP7 ) );
    V3[5] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * half * P3[3] * ( TMP7 + two * TMP8 ) + ( +half * ( F1[2] * F2[4] ) - half * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) ) + half * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + P3[3] * OM3 * TMP7 - F1[3] * F2[5] ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP10 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    ( *vertex ) = ( -one ) * ( Ccoeff2 * COUP2 * ( +cI * TMP9 + ( 4. * cI ) * TMP10 ) + cI * ( TMP9 * Ccoeff1 * COUP1 ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allF1[] )
  {
    ...
    constexpr fptype quarter( 1. / 4. );
    const cxtype_sv denom = one / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    F1[2] = denom * ( 4. * cI ) * ( Ccoeff2 * COUP2 * ( F2[2] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] - cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F2[3] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[4] * quarter * ( V3[2] + V3[5] ) + quarter * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * M1 * ( F2[4] * quarter * ( V3[2] + V3[5] ) + quarter * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) );
    F1[3] = denom * ( 4. * cI ) * ( Ccoeff2 * COUP2 * ( F2[2] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[3] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + M1 * ( F2[4] * quarter * ( V3[3] - cI * V3[4] ) + quarter * ( F2[5] * ( V3[2] - V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * M1 * ( F2[4] * quarter * ( V3[3] - cI * V3[4] ) + quarter * ( F2[5] * ( V3[2] - V3[5] ) ) ) );
    F1[4] = denom * ( -cI ) * ( Ccoeff2 * COUP2 * ( F2[4] * ( P1[0] * ( V3[2] + V3[5] ) + ( P1[1] * ( -V3[3] + cI * V3[4] ) + ( P1[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P1[3] * ( V3[2] + V3[5] ) ) ) ) + ( F2[5] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( -cI * V3[2] + cI * V3[5] ) - P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[2] * 4. * ( -V3[2] + V3[5] ) + 4. * ( F2[3] * ( V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F2[4] * ( P1[0] * ( V3[2] + V3[5] ) + ( P1[1] * ( -V3[3] + cI * V3[4] ) + ( P1[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P1[3] * ( V3[2] + V3[5] ) ) ) ) + F2[5] * ( P1[0] * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( -cI * V3[2] + cI * V3[5] ) - P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) ) );
    F1[5] = denom * cI * ( Ccoeff2 * COUP2 * ( F2[4] * ( P1[0] * ( -V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[5] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) + M1 * ( F2[2] * 4. * ( -V3[3] + cI * V3[4] ) + 4. * ( F2[3] * ( V3[2] + V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F2[4] * ( P1[0] * ( -V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] + V3[5] ) + ( P1[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + F2[5] * ( P1[0] * ( -V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( -V3[2] + V3[5] ) ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allF2[] )
  {
    ...
    constexpr fptype quarter( 1. / 4. );
    const cxtype_sv denom = one / ( ( P2[0] * P2[0] ) - ( P2[1] * P2[1] ) - ( P2[2] * P2[2] ) - ( P2[3] * P2[3] ) - M2 * ( M2 - cI * W2 ) );
    F2[2] = denom * cI * ( Ccoeff2 * COUP2 * ( F1[2] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] - V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + M2 * ( F1[4] * 4. * ( V3[2] - V3[5] ) + 4. * ( F1[5] * ( -V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F1[2] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] - V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + F1[3] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( -V3[3] + cI * V3[4] ) ) ) ) ) );
    F2[3] = denom * cI * ( Ccoeff2 * COUP2 * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) + M2 * ( F1[4] * ( -4. ) * ( V3[3] + cI * V3[4] ) + 4. * ( F1[5] * ( V3[2] + V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) ) );
    F2[4] = denom * ( -4. * cI ) * ( Ccoeff2 * COUP2 * ( F1[4] * ( P2[0] * ( -V3[2] + V3[5] ) + ( P2[1] * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( -cI * V3[3] + V3[4] ) + P2[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F1[5] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] - cI * V3[4] ) ) ) ) + M2 * ( F1[2] * ( -quarter ) * ( V3[2] + V3[5] ) + quarter * ( F1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * M2 * ( F1[2] * ( -quarter ) * ( V3[2] + V3[5] ) + quarter * ( F1[3] * ( -V3[3] + cI * V3[4] ) ) ) );
    F2[5] = denom * ( 4. * cI ) * ( Ccoeff2 * COUP2 * ( F1[4] * ( P2[0] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( V3[2] - V3[5] ) + ( P2[2] * ( +cI * V3[2] - cI * V3[5] ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[5] * ( P2[0] * ( V3[2] + V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) - P2[3] * ( V3[2] + V3[5] ) ) ) ) + M2 * ( F1[2] * quarter * ( V3[3] + cI * V3[4] ) + quarter * ( F1[3] * ( V3[2] - V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * M2 * ( F1[2] * quarter * ( V3[3] + cI * V3[4] ) + quarter * ( F1[3] * ( V3[2] - V3[5] ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allV3[] )
  {
    ...
    const cxtype_sv TMP8 = ( F1[4] * ( F2[2] * ( P3[0] - P3[3] ) - F2[3] * ( P3[1] + cI * P3[2] ) ) + F1[5] * ( F2[2] * ( -P3[1] + cI * P3[2] ) + F2[3] * ( P3[0] + P3[3] ) ) );
    const cxtype_sv denom = one / ( ( P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - cI * W3 ) );
    V3[2] = denom * ( -4. * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -quarter * P3[0] * ( TMP7 + 4. * TMP8 ) + ( +quarter * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) ) + quarter * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP7 ) ) );
    V3[3] = denom * ( -4. * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -quarter * P3[1] * ( TMP7 + 4. * TMP8 ) + ( -quarter * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) ) - quarter * ( Ccoeff1 * COUP1 * ( F1[2] * F2[5] + F1[3] * F2[4] + P3[1] * OM3 * TMP7 ) ) );
    V3[4] = denom * cI * ( Ccoeff2 * COUP2 * ( OM3 * P3[2] * ( TMP7 + 4. * TMP8 ) + ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + ( -4. * cI ) * ( F1[4] * F2[3] ) + ( 4. * cI ) * ( F1[5] * F2[2] ) ) ) + Ccoeff1 * COUP1 * ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + P3[2] * OM3 * TMP7 ) );
    V3[5] = denom * ( 4. * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * quarter * P3[3] * ( TMP7 + 4. * TMP8 ) + ( +quarter * ( F1[2] * F2[4] ) - quarter * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) ) + quarter * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + P3[3] * OM3 * TMP7 - F1[3] * F2[5] ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allF1[] )
  {
    ...
    constexpr fptype half( 1. / 2. );
    const cxtype_sv denom = one / ( ( P1[0] * P1[0] ) - ( P1[1] * P1[1] ) - ( P1[2] * P1[2] ) - ( P1[3] * P1[3] ) - M1 * ( M1 - cI * W1 ) );
    F1[2] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( F2[2] * ( P1[0] * ( V3[2] - V3[5] ) + ( P1[1] * ( -V3[3] + cI * V3[4] ) + ( P1[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] - V3[5] ) ) ) ) + ( F2[3] * ( P1[0] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] + V3[5] ) + ( P1[2] * ( +cI * ( V3[2] + V3[5] ) ) - P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[4] * half * ( V3[2] + V3[5] ) + half * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * M1 * ( F2[4] * half * ( V3[2] + V3[5] ) + half * ( F2[5] * ( V3[3] + cI * V3[4] ) ) ) );
    F1[3] = denom * ( -two * cI ) * ( Ccoeff2 * COUP2 * ( F2[2] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -V3[2] + V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( -V3[3] + cI * V3[4] ) ) ) ) + ( F2[3] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( -cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + M1 * ( F2[4] * half * ( -V3[3] + cI * V3[4] ) + half * ( F2[5] * ( -V3[2] + V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * M1 * ( F2[4] * half * ( -V3[3] + cI * V3[4] ) + half * ( F2[5] * ( -V3[2] + V3[5] ) ) ) );
    F1[4] = denom * cI * ( Ccoeff2 * COUP2 * ( F2[4] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] - cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + ( F2[5] * ( P1[0] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] - V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) + M1 * ( F2[2] * two * ( -V3[2] + V3[5] ) + two * ( F2[3] * ( V3[3] + cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F2[4] * ( P1[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[1] * ( V3[3] - cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] + V3[4] ) + P1[3] * ( V3[2] + V3[5] ) ) ) ) + F2[5] * ( P1[0] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[1] * ( V3[2] - V3[5] ) + ( P1[2] * ( +cI * V3[2] - cI * V3[5] ) + P1[3] * ( V3[3] + cI * V3[4] ) ) ) ) ) );
    F1[5] = denom * ( -cI ) * ( Ccoeff2 * COUP2 * ( F2[4] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] - cI * V3[4] ) ) ) ) + ( F2[5] * ( P1[0] * ( V3[2] - V3[5] ) + ( P1[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] - V3[4] ) + P1[3] * ( V3[2] - V3[5] ) ) ) ) + M1 * ( F2[2] * two * ( -V3[3] + cI * V3[4] ) + two * ( F2[3] * ( V3[2] + V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F2[4] * ( P1[0] * ( V3[3] - cI * V3[4] ) + ( P1[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P1[2] * ( +cI * ( V3[2] + V3[5] ) ) + P1[3] * ( V3[3] - cI * V3[4] ) ) ) ) + F2[5] * ( P1[0] * ( V3[2] - V3[5] ) + ( P1[1] * ( -one ) * ( V3[3] + cI * V3[4] ) + ( P1[2] * ( +cI * V3[3] - V3[4] ) + P1[3] * ( V3[2] - V3[5] ) ) ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allF2[] )
  {
    ...
    F2[3] = denom * cI * ( Ccoeff2 * COUP2 * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) + M2 * ( F1[4] * two * ( V3[3] + cI * V3[4] ) - two * ( F1[5] * ( V3[2] + V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * ( F1[2] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( -one ) * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + F1[3] * ( P2[0] * ( V3[2] - V3[5] ) + ( P2[1] * ( -V3[3] + cI * V3[4] ) + ( P2[2] * ( -one ) * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] - V3[5] ) ) ) ) ) );
    F2[4] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( F1[4] * ( P2[0] * ( -V3[2] + V3[5] ) + ( P2[1] * ( V3[3] + cI * V3[4] ) + ( P2[2] * ( -cI * V3[3] + V3[4] ) + P2[3] * ( -V3[2] + V3[5] ) ) ) ) + ( F1[5] * ( P2[0] * ( V3[3] - cI * V3[4] ) + ( P2[1] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[2] * ( +cI * ( V3[2] + V3[5] ) ) + P2[3] * ( V3[3] - cI * V3[4] ) ) ) ) + M2 * ( F1[2] * half * ( V3[2] + V3[5] ) + half * ( F1[3] * ( V3[3] - cI * V3[4] ) ) ) ) ) + Ccoeff1 * COUP1 * M2 * ( F1[2] * half * ( V3[2] + V3[5] ) + half * ( F1[3] * ( V3[3] - cI * V3[4] ) ) ) );
    F2[5] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( F1[4] * ( P2[0] * ( V3[3] + cI * V3[4] ) + ( P2[1] * ( -V3[2] + V3[5] ) + ( P2[2] * ( -cI * V3[2] + cI * V3[5] ) - P2[3] * ( V3[3] + cI * V3[4] ) ) ) ) + ( F1[5] * ( P2[0] * ( -one ) * ( V3[2] + V3[5] ) + ( P2[1] * ( V3[3] - cI * V3[4] ) + ( P2[2] * ( +cI * V3[3] + V3[4] ) + P2[3] * ( V3[2] + V3[5] ) ) ) ) + M2 * ( F1[2] * half * ( V3[3] + cI * V3[4] ) + half * ( F1[3] * ( V3[2] - V3[5] ) ) ) ) ) + Ccoeff1 * COUP1 * M2 * ( F1[2] * half * ( V3[3] + cI * V3[4] ) + half * ( F1[3] * ( V3[2] - V3[5] ) ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
