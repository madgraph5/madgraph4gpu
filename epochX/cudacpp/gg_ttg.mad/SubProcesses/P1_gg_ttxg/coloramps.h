...
namespace mgOnGpu
{
  ...
  // The 0 entry is a fall back to still write events even if no multi-channel is setup (wrong color selected in that mode) 
    __device__ constexpr int channelId_to_iconfigC[16] = {
  ...
  // This array has N_config <= N_diagrams elements    
    ...
    {true, false, true, false, true, true}, // iconfigC=0, diag=1
    {false, false, false, false, true, true}, // iconfigC=1, diag=2
    {true, false, true, false, false, false}, // iconfigC=2, diag=3
    {false, true, false, false, false, false}, // iconfigC=3, diag=4
    {true, true, false, false, false, false}, // iconfigC=4, diag=5
    {true, false, false, false, false, false}, // iconfigC=5, diag=6
    {false, false, false, true, false, false}, // iconfigC=6, diag=7
    {false, false, false, true, false, true}, // iconfigC=7, diag=8
    {false, false, false, false, false, true}, // iconfigC=8, diag=9
    {false, false, true, true, false, false}, // iconfigC=9, diag=10
    {false, true, false, false, true, false}, // iconfigC=10, diag=11
    {false, true, true, true, true, false}, // iconfigC=11, diag=12
    {false, false, true, false, false, false}, // iconfigC=12, diag=13
    {false, false, false, false, true, false}, // iconfigC=13, diag=14
    {true, true, false, true, false, true}, // iconfigC=14, diag=15
  };
