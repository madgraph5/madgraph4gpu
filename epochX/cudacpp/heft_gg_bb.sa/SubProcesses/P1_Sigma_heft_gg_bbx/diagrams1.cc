...
#include "diagrams_boilerplate.h"
    ...
    VVS3_3( w_fp[0], w_fp[1], COUPs[0], 1.0, depCoup, cIPD[1], cIPD[2], w_fp[4] );
    // Amplitude(s) for diagram number 1
    FFS2_0( w_fp[3], w_fp[2], w_fp[4], COUPs[ndcoup + 0], 1.0, indepCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    ...
    FFV1_0( w_fp[3], w_fp[2], w_fp[4], COUPs[2], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
    ...
    FFV1_1( w_fp[2], w_fp[0], COUPs[2], 1.0, depCoup, cIPD[0], 0., w_fp[4] );
    // Amplitude(s) for diagram number 3
    FFV1_0( w_fp[3], w_fp[4], w_fp[1], COUPs[2], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
    jamp_sv[0] -= amp_sv[0];
    ...
    FFV1_2( w_fp[3], w_fp[0], COUPs[2], 1.0, depCoup, cIPD[0], 0., w_fp[4] );
    // Amplitude(s) for diagram number 4
    FFV1_0( w_fp[4], w_fp[2], w_fp[1], COUPs[2], 1.0, depCoup, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
    // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
    jamp_sv[1] -= amp_sv[0];
