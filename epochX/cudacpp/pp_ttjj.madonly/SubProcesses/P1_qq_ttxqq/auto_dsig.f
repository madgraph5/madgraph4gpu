...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: u u > t t~ u u WEIGHTED<=4 @1
C     Process: c c > t t~ c c WEIGHTED<=4 @1
C     Process: d d > t t~ d d WEIGHTED<=4 @1
C     Process: s s > t t~ s s WEIGHTED<=4 @1
C     Process: u u~ > t t~ u u~ WEIGHTED<=4 @1
C     Process: c c~ > t t~ c c~ WEIGHTED<=4 @1
C     Process: d d~ > t t~ d d~ WEIGHTED<=4 @1
C     Process: s s~ > t t~ s s~ WEIGHTED<=4 @1
...
C     Process: d~ d~ > t t~ d~ d~ WEIGHTED<=4 @1
C     Process: s~ s~ > t t~ s~ s~ WEIGHTED<=4 @1
C     Process: u c > t t~ u c WEIGHTED<=4 @1
C     Process: u d > t t~ u d WEIGHTED<=4 @1
C     Process: u s > t t~ u s WEIGHTED<=4 @1
C     Process: c d > t t~ c d WEIGHTED<=4 @1
C     Process: c s > t t~ c s WEIGHTED<=4 @1
C     Process: d s > t t~ d s WEIGHTED<=4 @1
C     Process: u u~ > t t~ c c~ WEIGHTED<=4 @1
C     Process: u u~ > t t~ d d~ WEIGHTED<=4 @1
C     Process: u u~ > t t~ s s~ WEIGHTED<=4 @1
C     Process: c c~ > t t~ u u~ WEIGHTED<=4 @1
C     Process: c c~ > t t~ d d~ WEIGHTED<=4 @1
C     Process: c c~ > t t~ s s~ WEIGHTED<=4 @1
C     Process: d d~ > t t~ u u~ WEIGHTED<=4 @1
C     Process: d d~ > t t~ c c~ WEIGHTED<=4 @1
C     Process: d d~ > t t~ s s~ WEIGHTED<=4 @1
C     Process: s s~ > t t~ u u~ WEIGHTED<=4 @1
C     Process: s s~ > t t~ c c~ WEIGHTED<=4 @1
C     Process: s s~ > t t~ d d~ WEIGHTED<=4 @1
C     Process: u c~ > t t~ u c~ WEIGHTED<=4 @1
C     Process: u d~ > t t~ u d~ WEIGHTED<=4 @1
C     Process: u s~ > t t~ u s~ WEIGHTED<=4 @1
C     Process: c u~ > t t~ c u~ WEIGHTED<=4 @1
C     Process: c d~ > t t~ c d~ WEIGHTED<=4 @1
C     Process: c s~ > t t~ c s~ WEIGHTED<=4 @1
C     Process: d u~ > t t~ d u~ WEIGHTED<=4 @1
C     Process: d c~ > t t~ d c~ WEIGHTED<=4 @1
C     Process: d s~ > t t~ d s~ WEIGHTED<=4 @1
C     Process: s u~ > t t~ s u~ WEIGHTED<=4 @1
C     Process: s c~ > t t~ s c~ WEIGHTED<=4 @1
C     Process: s d~ > t t~ s d~ WEIGHTED<=4 @1
C     Process: u~ c~ > t t~ u~ c~ WEIGHTED<=4 @1
C     Process: u~ d~ > t t~ u~ d~ WEIGHTED<=4 @1
C     Process: u~ s~ > t t~ u~ s~ WEIGHTED<=4 @1
C     Process: c~ d~ > t t~ c~ d~ WEIGHTED<=4 @1
...
C     and update the couplings accordingly
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u > t t~ u u
      IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! u u~ > t t~ u u~
      IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! u~ u~ > t t~ u~ u~
      IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u c > t t~ u c
      IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u u~ > t t~ c c~
      IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u c~ > t t~ u c~
      IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! u~ c~ > t t~ u~ c~
C     ENDIF
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! u u > t t~ u u
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! u c > t t~ u c
      IF(IPROC.EQ.5) CALL DSIG5_VEC(ALL_P1,ALL_XBK,ALL_Q2FACT
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! u u~ > t t~ c c~
