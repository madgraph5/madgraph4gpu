...
C     DATA
C     
      DATA D1,U1,C1/VECSIZE_MEMMAX*1D0,VECSIZE_MEMMAX*1D0
     $ ,VECSIZE_MEMMAX*1D0/
      DATA D2,S2,C2/VECSIZE_MEMMAX*1D0,VECSIZE_MEMMAX*1D0
     $ ,VECSIZE_MEMMAX*1D0/
C     ----------
C     BEGIN CODE
C     ----------
...
C       Select a flavor combination (need to do here for right sign)
     ...
     $     ,IVEC))
      ...
      ENDDO
      CALL SMATRIX4_MULTI(P_MULTI, HEL_RAND, COL_RAND, CHANNEL,
...
C     
      ...
      SUBROUTINE SMATRIX4_MULTI(P_MULTI, HEL_RAND, COL_RAND, CHANNEL,
