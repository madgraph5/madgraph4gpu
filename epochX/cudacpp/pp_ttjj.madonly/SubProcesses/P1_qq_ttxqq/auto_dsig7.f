...
C     DATA
C     
      DATA CX1,UX1,DX1/VECSIZE_MEMMAX*1D0,VECSIZE_MEMMAX*1D0
     $ ,VECSIZE_MEMMAX*1D0/
      DATA CX2,SX2,DX2/VECSIZE_MEMMAX*1D0,VECSIZE_MEMMAX*1D0
     $ ,VECSIZE_MEMMAX*1D0/
C     ----------
C     BEGIN CODE
C     ----------
...
C       Select a flavor combination (need to do here for right sign)
     ...
     $     ,IVEC))
      ...
      ENDDO
      CALL SMATRIX7_MULTI(P_MULTI, HEL_RAND, COL_RAND, CHANNEL,
...
C     
      ...
      SUBROUTINE SMATRIX7_MULTI(P_MULTI, HEL_RAND, COL_RAND, CHANNEL,
