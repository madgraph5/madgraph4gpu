...
#define ALWAYS_INLINE
          ...
          fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP8 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    ( *vertex ) = Ccoeff * COUP * ( -one ) * ( +cI * TMP8 + ( two * cI ) * TMP9 );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allV3[] )
  {
    ...
    const cxtype_sv TMP10 = ( F1[4] * ( F2[2] * ( P3[0] - P3[3] ) - F2[3] * ( P3[1] + cI * P3[2] ) ) + F1[5] * ( F2[2] * ( -P3[1] + cI * P3[2] ) + F2[3] * ( P3[0] + P3[3] ) ) );
    const cxtype_sv TMP7 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + cI * P3[2] ) ) + F1[3] * ( F2[4] * ( P3[1] - cI * P3[2] ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - cI * W3 ) );
    V3[2] = denom * ( -two * cI ) * ( OM3 * -half * P3[0] * ( TMP7 + two * TMP10 ) + ( +half * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) );
    V3[3] = denom * ( -two * cI ) * ( OM3 * -half * P3[1] * ( TMP7 + two * TMP10 ) + ( -half * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) );
    V3[4] = denom * ( two * cI ) * ( OM3 * half * P3[2] * ( TMP7 + two * TMP10 ) + ( half * cI * ( F1[2] * F2[5] ) - half * cI * ( F1[3] * F2[4] ) - cI * ( F1[4] * F2[3] ) + cI * ( F1[5] * F2[2] ) ) );
    V3[5] = denom * ( two * cI ) * ( OM3 * half * P3[3] * ( TMP7 + two * TMP10 ) + ( +half * ( F1[2] * F2[4] ) - half * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP8 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    ( *vertex ) = Ccoeff * COUP * ( -one ) * ( +cI * TMP8 + ( 4. * cI ) * TMP9 );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allV3[] )
  {
    ...
    const cxtype_sv TMP7 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + cI * P3[2] ) ) + F1[3] * ( F2[4] * ( P3[1] - cI * P3[2] ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv denom = Ccoeff * COUP / ( ( P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - cI * W3 ) );
    V3[2] = denom * ( -4. * cI ) * ( OM3 * -quarter * P3[0] * ( TMP7 + 4. * TMP10 ) + ( +quarter * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) );
    V3[3] = denom * ( -4. * cI ) * ( OM3 * -quarter * P3[1] * ( TMP7 + 4. * TMP10 ) + ( -quarter * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) );
    V3[4] = denom * ( 4. * cI ) * ( OM3 * quarter * P3[2] * ( TMP7 + 4. * TMP10 ) + ( +( quarter * cI ) * ( F1[2] * F2[5] ) + ( -quarter * cI ) * ( F1[3] * F2[4] ) - cI * ( F1[4] * F2[3] ) + cI * ( F1[5] * F2[2] ) ) );
    V3[5] = denom * ( 4. * cI ) * ( OM3 * quarter * P3[3] * ( TMP7 + 4. * TMP10 ) + ( +quarter * ( F1[2] * F2[4] ) - quarter * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
          ...
          fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP8 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    ( *vertex ) = Ccoeff * COUP * ( -cI * TMP8 + ( two * cI ) * TMP9 );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP8 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    ( *vertex ) = ( -one ) * ( Ccoeff2 * COUP2 * ( +cI * TMP8 + ( two * cI ) * TMP9 ) + cI * ( TMP8 * Ccoeff1 * COUP1 ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allV3[] )
  {
    ...
    V3[2] = denom * ( -two * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -half * P3[0] * ( TMP7 + two * TMP10 ) + ( +half * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) ) + half * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP7 ) ) );
    V3[3] = denom * ( -two * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -half * P3[1] * ( TMP7 + two * TMP10 ) + ( -half * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) ) - half * ( Ccoeff1 * COUP1 * ( F1[2] * F2[5] + F1[3] * F2[4] + P3[1] * OM3 * TMP7 ) ) );
    V3[4] = denom * cI * ( Ccoeff2 * COUP2 * ( OM3 * P3[2] * ( TMP7 + two * TMP10 ) + ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + ( -two * cI ) * ( F1[4] * F2[3] ) + ( two * cI ) * ( F1[5] * F2[2] ) ) ) + Ccoeff1 * COUP1 * ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + P3[2] * OM3 * TMP7 ) );
    V3[5] = denom * ( two * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * half * P3[3] * ( TMP7 + two * TMP10 ) + ( +half * ( F1[2] * F2[4] ) - half * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) ) + half * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + P3[3] * OM3 * TMP7 - F1[3] * F2[5] ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allvertexes[] )
  {
    ...
    const cxtype_sv TMP8 = ( F1[2] * ( F2[4] * ( V3[2] + V3[5] ) + F2[5] * ( V3[3] + cI * V3[4] ) ) + F1[3] * ( F2[4] * ( V3[3] - cI * V3[4] ) + F2[5] * ( V3[2] - V3[5] ) ) );
    const cxtype_sv TMP9 = ( F1[4] * ( F2[2] * ( V3[2] - V3[5] ) - F2[3] * ( V3[3] + cI * V3[4] ) ) + F1[5] * ( F2[2] * ( -V3[3] + cI * V3[4] ) + F2[3] * ( V3[2] + V3[5] ) ) );
    ( *vertex ) = ( -one ) * ( Ccoeff2 * COUP2 * ( +cI * TMP8 + ( 4. * cI ) * TMP9 ) + cI * ( TMP8 * Ccoeff1 * COUP1 ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
            ...
            fptype allV3[] )
  {
    ...
    const cxtype_sv TMP7 = ( F1[2] * ( F2[4] * ( P3[0] + P3[3] ) + F2[5] * ( P3[1] + cI * P3[2] ) ) + F1[3] * ( F2[4] * ( P3[1] - cI * P3[2] ) + F2[5] * ( P3[0] - P3[3] ) ) );
    const cxtype_sv denom = one / ( ( P3[0] * P3[0] ) - ( P3[1] * P3[1] ) - ( P3[2] * P3[2] ) - ( P3[3] * P3[3] ) - M3 * ( M3 - cI * W3 ) );
    V3[2] = denom * ( -4. * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -quarter * P3[0] * ( TMP7 + 4. * TMP10 ) + ( +quarter * ( F1[2] * F2[4] + F1[3] * F2[5] ) + F1[4] * F2[2] + F1[5] * F2[3] ) ) + quarter * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + F1[3] * F2[5] - P3[0] * OM3 * TMP7 ) ) );
    V3[3] = denom * ( -4. * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * -quarter * P3[1] * ( TMP7 + 4. * TMP10 ) + ( -quarter * ( F1[2] * F2[5] + F1[3] * F2[4] ) + F1[4] * F2[3] + F1[5] * F2[2] ) ) - quarter * ( Ccoeff1 * COUP1 * ( F1[2] * F2[5] + F1[3] * F2[4] + P3[1] * OM3 * TMP7 ) ) );
    V3[4] = denom * cI * ( Ccoeff2 * COUP2 * ( OM3 * P3[2] * ( TMP7 + 4. * TMP10 ) + ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + ( -4. * cI ) * ( F1[4] * F2[3] ) + ( 4. * cI ) * ( F1[5] * F2[2] ) ) ) + Ccoeff1 * COUP1 * ( +cI * ( F1[2] * F2[5] ) - cI * ( F1[3] * F2[4] ) + P3[2] * OM3 * TMP7 ) );
    V3[5] = denom * ( 4. * cI ) * ( Ccoeff2 * COUP2 * ( OM3 * quarter * P3[3] * ( TMP7 + 4. * TMP10 ) + ( +quarter * ( F1[2] * F2[4] ) - quarter * ( F1[3] * F2[5] ) - F1[4] * F2[2] + F1[5] * F2[3] ) ) + quarter * ( Ccoeff1 * COUP1 * ( F1[2] * F2[4] + P3[3] * OM3 * TMP7 - F1[3] * F2[5] ) ) );
    mgDebug( 1, __FUNCTION__ );
    return;
  }
