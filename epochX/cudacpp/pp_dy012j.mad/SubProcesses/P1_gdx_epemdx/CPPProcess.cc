...
// Process: g d~ > e+ e- d~ WEIGHTED<=5 @1
// Process: g d~ > mu+ mu- d~ WEIGHTED<=5 @1
// Process: g s~ > e+ e- s~ WEIGHTED<=5 @1
// Process: g s~ > mu+ mu- s~ WEIGHTED<=5 @1
// Process: g b~ > e+ e- b~ WEIGHTED<=5 @1
// Process: g b~ > mu+ mu- b~ WEIGHTED<=5 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gdx_epemdx()?)
