...
// Process: d d~ > e+ e- g WEIGHTED<=5 @1
// Process: d d~ > mu+ mu- g WEIGHTED<=5 @1
// Process: s s~ > e+ e- g WEIGHTED<=5 @1
// Process: s s~ > mu+ mu- g WEIGHTED<=5 @1
// Process: b b~ > e+ e- g WEIGHTED<=5 @1
// Process: b b~ > mu+ mu- g WEIGHTED<=5 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_ddx_epemg()?)
