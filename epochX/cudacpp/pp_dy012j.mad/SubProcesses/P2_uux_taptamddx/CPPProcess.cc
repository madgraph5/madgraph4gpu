...
// Process: u u~ > ta+ ta- d d~ WEIGHTED<=6 @2
// Process: u u~ > ta+ ta- s s~ WEIGHTED<=6 @2
// Process: u u~ > ta+ ta- b b~ WEIGHTED<=6 @2
// Process: c c~ > ta+ ta- d d~ WEIGHTED<=6 @2
// Process: c c~ > ta+ ta- s s~ WEIGHTED<=6 @2
// Process: c c~ > ta+ ta- b b~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[7], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[4] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_uux_taptamddx()?)
