...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: u u~ > ta+ ta- d d~ WEIGHTED<=6 @2
C     Process: u u~ > ta+ ta- s s~ WEIGHTED<=6 @2
C     Process: u u~ > ta+ ta- b b~ WEIGHTED<=6 @2
C     Process: c c~ > ta+ ta- d d~ WEIGHTED<=6 @2
C     Process: c c~ > ta+ ta- s s~ WEIGHTED<=6 @2
C     Process: c c~ > ta+ ta- b b~ WEIGHTED<=6 @2
C     
...
C     and update the couplings accordingly
      ...
      ENDIF
      IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! u u~ > ta+ ta- d d~
C     ENDIF
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! u u~ > ta+ ta- d d~
C     ENDIF
