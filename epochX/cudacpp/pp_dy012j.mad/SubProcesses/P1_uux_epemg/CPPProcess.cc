...
// Process: u u~ > e+ e- g WEIGHTED<=5 @1
// Process: u u~ > mu+ mu- g WEIGHTED<=5 @1
// Process: c c~ > e+ e- g WEIGHTED<=5 @1
// Process: c c~ > mu+ mu- g WEIGHTED<=5 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_uux_epemg()?)
