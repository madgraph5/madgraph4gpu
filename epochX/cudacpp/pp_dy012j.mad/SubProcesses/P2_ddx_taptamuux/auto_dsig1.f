...
C     
C     Process: d d~ > ta+ ta- u u~ WEIGHTED<=6 @2
C     Process: d d~ > ta+ ta- c c~ WEIGHTED<=6 @2
C     Process: s s~ > ta+ ta- u u~ WEIGHTED<=6 @2
C     Process: s s~ > ta+ ta- c c~ WEIGHTED<=6 @2
C     Process: b b~ > ta+ ta- u u~ WEIGHTED<=6 @2
C     Process: b b~ > ta+ ta- c c~ WEIGHTED<=6 @2
C     
