...
// Process: d s~ > e+ e- d s~ WEIGHTED<=6 @2
// Process: d s~ > mu+ mu- d s~ WEIGHTED<=6 @2
// Process: d b~ > e+ e- d b~ WEIGHTED<=6 @2
// Process: d b~ > mu+ mu- d b~ WEIGHTED<=6 @2
// Process: s d~ > e+ e- s d~ WEIGHTED<=6 @2
// Process: s d~ > mu+ mu- s d~ WEIGHTED<=6 @2
// Process: s b~ > e+ e- s b~ WEIGHTED<=6 @2
// Process: s b~ > mu+ mu- s b~ WEIGHTED<=6 @2
// Process: b d~ > e+ e- b d~ WEIGHTED<=6 @2
// Process: b d~ > mu+ mu- b d~ WEIGHTED<=6 @2
// Process: b s~ > e+ e- b s~ WEIGHTED<=6 @2
// Process: b s~ > mu+ mu- b s~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_dsx_epemdsx()?)
