...
C     Process: d b~ > e+ e- d b~ WEIGHTED<=6 @2
C     Process: d b~ > mu+ mu- d b~ WEIGHTED<=6 @2
C     Process: s d~ > e+ e- s d~ WEIGHTED<=6 @2
C     Process: s d~ > mu+ mu- s d~ WEIGHTED<=6 @2
C     Process: s b~ > e+ e- s b~ WEIGHTED<=6 @2
C     Process: s b~ > mu+ mu- s b~ WEIGHTED<=6 @2
C     Process: b d~ > e+ e- b d~ WEIGHTED<=6 @2
C     Process: b d~ > mu+ mu- b d~ WEIGHTED<=6 @2
C     Process: b s~ > e+ e- b s~ WEIGHTED<=6 @2
C     Process: b s~ > mu+ mu- b s~ WEIGHTED<=6 @2
C     
...
C     Continue only if IMODE is 0, 4 or 5
     ...
     $       -PP(3,I))))
      ...
      PD(IPROC)=B1*DX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! b d~ > mu+ mu- b d~
      PD(IPROC)=B1*DX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! b s~ > e+ e- b s~
      PD(IPROC)=B1*SX2
      PD(0)=PD(0)+DABS(PD(IPROC))
