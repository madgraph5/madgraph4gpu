...
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
C     
C     Process: g g > ta+ ta- d d~ WEIGHTED<=6 @2
C     Process: g g > ta+ ta- s s~ WEIGHTED<=6 @2
C     Process: g g > ta+ ta- b b~ WEIGHTED<=6 @2
C     
...
C     IF (PASSCUTS(P1)) THEN
     ...
     $ ,ALL_CM_RAP,ALL_WGT,IMODE,ALL_OUT,VECSIZE_USED)  ! g g > ta+ ta- d d~
C     ENDIF
