...
namespace mgOnGpu
{
  ...
  __device__ constexpr int channel2iconfig[16] = { // note: a trailing comma in the initializer list is allowed
  ...
  __device__ constexpr bool icolamp[16][2] = { // note: a trailing comma in the initializer list is allowed
    {  true,  true }, // ICONFIG=1   <-- CHANNEL_ID=1
    {  true,  true }, // ICONFIG=2   <-- CHANNEL_ID=2
    {  true,  true }, // ICONFIG=3   <-- CHANNEL_ID=3
    {  true,  true }, // ICONFIG=4   <-- CHANNEL_ID=4
    {  true, false }, // ICONFIG=5   <-- CHANNEL_ID=5
    {  true, false }, // ICONFIG=6   <-- CHANNEL_ID=6
    {  true, false }, // ICONFIG=7   <-- CHANNEL_ID=7
    {  true, false }, // ICONFIG=8   <-- CHANNEL_ID=8
    { false,  true }, // ICONFIG=9   <-- CHANNEL_ID=9
    { false,  true }, // ICONFIG=10  <-- CHANNEL_ID=10
    { false,  true }, // ICONFIG=11  <-- CHANNEL_ID=11
    { false,  true }, // ICONFIG=12  <-- CHANNEL_ID=12
    { false,  true }, // ICONFIG=13  <-- CHANNEL_ID=13
    { false,  true }, // ICONFIG=14  <-- CHANNEL_ID=14
    {  true, false }, // ICONFIG=15  <-- CHANNEL_ID=15
    {  true, false }, // ICONFIG=16  <-- CHANNEL_ID=16
  };
