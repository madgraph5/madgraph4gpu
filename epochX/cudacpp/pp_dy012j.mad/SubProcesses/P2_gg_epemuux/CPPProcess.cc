...
// Process: g g > e+ e- u u~ WEIGHTED<=6 @2
// Process: g g > e+ e- c c~ WEIGHTED<=6 @2
// Process: g g > mu+ mu- u u~ WEIGHTED<=6 @2
// Process: g g > mu+ mu- c c~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_gg_epemuux()?)
