...
// Process: u u~ > ta+ ta- WEIGHTED<=4
// Process: c c~ > ta+ ta- WEIGHTED<=4
...
#pragma nv_diagnostic pop
      ...
      FFV1P0_3<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[1], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[4] );
      ...
      FFV2_5_3<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[1], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, cIPD[0], cIPD[1], w_fp[4] );

      // Amplitude(s) for diagram number 2
      FFV2_4_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[2], w_fp[3], w_fp[4], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 3], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_uux_taptam()?)
