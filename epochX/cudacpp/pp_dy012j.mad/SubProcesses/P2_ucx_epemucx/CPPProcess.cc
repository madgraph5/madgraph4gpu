...
// Process: u c~ > e+ e- u c~ WEIGHTED<=6 @2
// Process: u c~ > mu+ mu- u c~ WEIGHTED<=6 @2
// Process: c u~ > e+ e- c u~ WEIGHTED<=6 @2
// Process: c u~ > mu+ mu- c u~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_ucx_epemucx()?)
