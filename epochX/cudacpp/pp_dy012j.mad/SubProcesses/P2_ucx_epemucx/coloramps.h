...
namespace mgOnGpu
{
  ...
  __device__ constexpr int channel2iconfig[8] = { // note: a trailing comma in the initializer list is allowed
  ...
  __device__ constexpr bool icolamp[8][2] = { // note: a trailing comma in the initializer list is allowed
    {  true, false }, // ICONFIG=1  <-- CHANNEL_ID=1
    {  true, false }, // ICONFIG=2  <-- CHANNEL_ID=2
    {  true, false }, // ICONFIG=3  <-- CHANNEL_ID=3
    {  true, false }, // ICONFIG=4  <-- CHANNEL_ID=4
