...
// Process: d d~ > e+ e- g g WEIGHTED<=6 @2
// Process: d d~ > mu+ mu- g g WEIGHTED<=6 @2
// Process: s s~ > e+ e- g g WEIGHTED<=6 @2
// Process: s s~ > mu+ mu- g g WEIGHTED<=6 @2
// Process: b b~ > e+ e- g g WEIGHTED<=6 @2
// Process: b b~ > mu+ mu- g g WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_ddx_epemgg()?)
