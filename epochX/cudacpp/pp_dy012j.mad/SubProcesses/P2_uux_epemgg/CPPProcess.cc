...
// Process: u u~ > e+ e- g g WEIGHTED<=6 @2
// Process: u u~ > mu+ mu- g g WEIGHTED<=6 @2
// Process: c c~ > e+ e- g g WEIGHTED<=6 @2
// Process: c c~ > mu+ mu- g g WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_uux_epemgg()?)
