...
// Process: d d~ > e+ e- WEIGHTED<=4
// Process: d d~ > mu+ mu- WEIGHTED<=4
// Process: s s~ > e+ e- WEIGHTED<=4
// Process: s s~ > mu+ mu- WEIGHTED<=4
// Process: b b~ > e+ e- WEIGHTED<=4
// Process: b b~ > mu+ mu- WEIGHTED<=4
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_ddx_epem()?)
