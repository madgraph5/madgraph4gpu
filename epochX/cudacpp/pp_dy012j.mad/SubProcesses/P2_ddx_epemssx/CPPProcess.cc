...
// Process: d d~ > e+ e- s s~ WEIGHTED<=6 @2
// Process: d d~ > e+ e- b b~ WEIGHTED<=6 @2
// Process: d d~ > mu+ mu- s s~ WEIGHTED<=6 @2
// Process: d d~ > mu+ mu- b b~ WEIGHTED<=6 @2
// Process: s s~ > e+ e- d d~ WEIGHTED<=6 @2
// Process: s s~ > e+ e- b b~ WEIGHTED<=6 @2
// Process: s s~ > mu+ mu- d d~ WEIGHTED<=6 @2
// Process: s s~ > mu+ mu- b b~ WEIGHTED<=6 @2
// Process: b b~ > e+ e- d d~ WEIGHTED<=6 @2
// Process: b b~ > e+ e- s s~ WEIGHTED<=6 @2
// Process: b b~ > mu+ mu- d d~ WEIGHTED<=6 @2
// Process: b b~ > mu+ mu- s s~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_ddx_epemssx()?)
