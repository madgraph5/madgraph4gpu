...
C     Process: d d~ > e+ e- b b~ WEIGHTED<=6 @2
C     Process: d d~ > mu+ mu- s s~ WEIGHTED<=6 @2
C     Process: d d~ > mu+ mu- b b~ WEIGHTED<=6 @2
C     Process: s s~ > e+ e- d d~ WEIGHTED<=6 @2
C     Process: s s~ > e+ e- b b~ WEIGHTED<=6 @2
C     Process: s s~ > mu+ mu- d d~ WEIGHTED<=6 @2
C     Process: s s~ > mu+ mu- b b~ WEIGHTED<=6 @2
C     Process: b b~ > e+ e- d d~ WEIGHTED<=6 @2
C     Process: b b~ > e+ e- s s~ WEIGHTED<=6 @2
C     Process: b b~ > mu+ mu- d d~ WEIGHTED<=6 @2
C     Process: b b~ > mu+ mu- s s~ WEIGHTED<=6 @2
C     
