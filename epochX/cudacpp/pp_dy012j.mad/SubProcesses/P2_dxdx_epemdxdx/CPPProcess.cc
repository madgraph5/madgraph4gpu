...
// Process: d~ d~ > e+ e- d~ d~ WEIGHTED<=6 @2
// Process: d~ d~ > mu+ mu- d~ d~ WEIGHTED<=6 @2
// Process: s~ s~ > e+ e- s~ s~ WEIGHTED<=6 @2
// Process: s~ s~ > mu+ mu- s~ s~ WEIGHTED<=6 @2
// Process: b~ b~ > e+ e- b~ b~ WEIGHTED<=6 @2
// Process: b~ b~ > mu+ mu- b~ b~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_dxdx_epemdxdx()?)
