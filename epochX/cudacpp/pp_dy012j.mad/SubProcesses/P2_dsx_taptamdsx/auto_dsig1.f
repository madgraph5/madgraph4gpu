...
C     
C     Process: d s~ > ta+ ta- d s~ WEIGHTED<=6 @2
C     Process: d b~ > ta+ ta- d b~ WEIGHTED<=6 @2
C     Process: s d~ > ta+ ta- s d~ WEIGHTED<=6 @2
C     Process: s b~ > ta+ ta- s b~ WEIGHTED<=6 @2
C     Process: b d~ > ta+ ta- b d~ WEIGHTED<=6 @2
C     Process: b s~ > ta+ ta- b s~ WEIGHTED<=6 @2
C     
