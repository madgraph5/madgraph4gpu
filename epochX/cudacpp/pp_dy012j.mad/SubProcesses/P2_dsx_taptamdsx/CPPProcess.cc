...
// Process: d s~ > ta+ ta- d s~ WEIGHTED<=6 @2
// Process: d b~ > ta+ ta- d b~ WEIGHTED<=6 @2
// Process: s d~ > ta+ ta- s d~ WEIGHTED<=6 @2
// Process: s b~ > ta+ ta- s b~ WEIGHTED<=6 @2
// Process: b d~ > ta+ ta- b d~ WEIGHTED<=6 @2
// Process: b s~ > ta+ ta- b s~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[1], COUPs[1], 1.0, 0., 0., w_fp[9] );
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[7], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[1] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[4], w_fp[9], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_dsx_taptamdsx()?)
