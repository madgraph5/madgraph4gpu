...
// Process: g d > ta+ ta- g d WEIGHTED<=6 @2
// Process: g s > ta+ ta- g s WEIGHTED<=6 @2
// Process: g b > ta+ ta- g b WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[8], w_fp[7], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[9], w_fp[5], w_fp[7], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[8], w_fp[6], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[9], w_fp[5], w_fp[6], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[4], COUPs[1], 1.0, 0., 0., w_fp[8] );
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[9], w_fp[4], COUPs[1], 1.0, 0., 0., w_fp[3] );
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[0], COUPs[1], 1.0, 0., 0., w_fp[3] );
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[4], COUPs[1], 1.0, 0., 0., w_fp[2] );

      // Amplitude(s) for diagram number 11
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[2], w_fp[5], w_fp[7], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[2], w_fp[5], w_fp[6], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[2], w_fp[7], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[2], w_fp[6], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_gd_taptamgd()?)
