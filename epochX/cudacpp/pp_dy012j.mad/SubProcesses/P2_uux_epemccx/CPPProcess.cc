...
// Process: u u~ > e+ e- c c~ WEIGHTED<=6 @2
// Process: u u~ > mu+ mu- c c~ WEIGHTED<=6 @2
// Process: c c~ > e+ e- u u~ WEIGHTED<=6 @2
// Process: c c~ > mu+ mu- u u~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_uux_epemccx()?)
