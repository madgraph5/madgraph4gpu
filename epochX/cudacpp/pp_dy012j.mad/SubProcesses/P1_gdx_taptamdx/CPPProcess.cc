...
// Process: g d~ > ta+ ta- d~ WEIGHTED<=5 @1
// Process: g s~ > ta+ ta- s~ WEIGHTED<=5 @1
// Process: g b~ > ta+ ta- b~ WEIGHTED<=5 @1
...
#pragma nv_diagnostic pop
      ...
      FFV1P0_3<W_ACCESS, CI_ACCESS>( w_fp[2], w_fp[3], COUPs[ndcoup + 0], 1.0, 0., 0., w_fp[6] );

      // Amplitude(s) for diagram number 1
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[5], w_fp[1], w_fp[6], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_4_3<W_ACCESS, CI_ACCESS>( w_fp[2], w_fp[3], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 3], 1.0, cIPD[0], cIPD[1], w_fp[7] );

      // Amplitude(s) for diagram number 2
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[5], w_fp[1], w_fp[7], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[4], w_fp[5], w_fp[6], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_3_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[4], w_fp[5], w_fp[7], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gdx_taptamdx()?)
      ...
      // [NB do keep 'static' for these constexpr arrays, see issue #283]
      static constexpr fptype2 cf[ncolor][ncolor] = { { 4 } }; // 2-D array[1][1]
