...
// Process: g u~ > e+ e- u~ WEIGHTED<=5 @1
// Process: g u~ > mu+ mu- u~ WEIGHTED<=5 @1
// Process: g c~ > e+ e- c~ WEIGHTED<=5 @1
// Process: g c~ > mu+ mu- c~ WEIGHTED<=5 @1
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gux_epemux()?)
