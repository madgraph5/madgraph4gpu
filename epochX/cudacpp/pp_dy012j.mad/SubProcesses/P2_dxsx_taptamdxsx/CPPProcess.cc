...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[4], w_fp[7], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[1] );
      ...
      FFV2_3_2<W_ACCESS, CI_ACCESS>( w_fp[4], w_fp[6], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[5] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_dxsx_taptamdxsx()?)
