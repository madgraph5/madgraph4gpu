...
// Process: u u~ > e+ e- d d~ WEIGHTED<=6 @2
// Process: u u~ > e+ e- s s~ WEIGHTED<=6 @2
// Process: u u~ > e+ e- b b~ WEIGHTED<=6 @2
// Process: u u~ > mu+ mu- d d~ WEIGHTED<=6 @2
// Process: u u~ > mu+ mu- s s~ WEIGHTED<=6 @2
// Process: u u~ > mu+ mu- b b~ WEIGHTED<=6 @2
// Process: c c~ > e+ e- d d~ WEIGHTED<=6 @2
// Process: c c~ > e+ e- s s~ WEIGHTED<=6 @2
// Process: c c~ > e+ e- b b~ WEIGHTED<=6 @2
// Process: c c~ > mu+ mu- d d~ WEIGHTED<=6 @2
// Process: c c~ > mu+ mu- s s~ WEIGHTED<=6 @2
// Process: c c~ > mu+ mu- b b~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_uux_epemddx()?)
