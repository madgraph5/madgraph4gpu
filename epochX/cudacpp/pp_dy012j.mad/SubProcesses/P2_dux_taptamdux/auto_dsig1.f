...
C     
C     Process: d u~ > ta+ ta- d u~ WEIGHTED<=6 @2
C     Process: d c~ > ta+ ta- d c~ WEIGHTED<=6 @2
C     Process: s u~ > ta+ ta- s u~ WEIGHTED<=6 @2
C     Process: s c~ > ta+ ta- s c~ WEIGHTED<=6 @2
C     Process: b u~ > ta+ ta- b u~ WEIGHTED<=6 @2
C     Process: b c~ > ta+ ta- b c~ WEIGHTED<=6 @2
C     
