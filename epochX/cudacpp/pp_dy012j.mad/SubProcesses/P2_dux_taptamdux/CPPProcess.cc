...
// Process: d u~ > ta+ ta- d u~ WEIGHTED<=6 @2
// Process: d c~ > ta+ ta- d c~ WEIGHTED<=6 @2
// Process: s u~ > ta+ ta- s u~ WEIGHTED<=6 @2
// Process: s c~ > ta+ ta- s c~ WEIGHTED<=6 @2
// Process: b u~ > ta+ ta- b u~ WEIGHTED<=6 @2
// Process: b c~ > ta+ ta- b c~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[5], w_fp[9], COUPs[1], 1.0, 0., 0., w_fp[4] );

      // Amplitude(s) for diagram number 5
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[4], w_fp[1], w_fp[7], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[0], w_fp[1], w_fp[9], COUPs[1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[4], w_fp[1], w_fp[6], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[5], w_fp[6], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[4] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_dux_taptamdux()?)
