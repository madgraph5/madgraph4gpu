...
// Process: u d~ > e+ e- u d~ WEIGHTED<=6 @2
// Process: u d~ > mu+ mu- u d~ WEIGHTED<=6 @2
// Process: u s~ > e+ e- u s~ WEIGHTED<=6 @2
// Process: u s~ > mu+ mu- u s~ WEIGHTED<=6 @2
// Process: u b~ > e+ e- u b~ WEIGHTED<=6 @2
// Process: u b~ > mu+ mu- u b~ WEIGHTED<=6 @2
// Process: c d~ > e+ e- c d~ WEIGHTED<=6 @2
// Process: c d~ > mu+ mu- c d~ WEIGHTED<=6 @2
// Process: c s~ > e+ e- c s~ WEIGHTED<=6 @2
// Process: c s~ > mu+ mu- c s~ WEIGHTED<=6 @2
// Process: c b~ > e+ e- c b~ WEIGHTED<=6 @2
// Process: c b~ > mu+ mu- c b~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_udx_epemudx()?)
