...
C     
C     Process: d d~ > ta+ ta- s s~ WEIGHTED<=6 @2
C     Process: d d~ > ta+ ta- b b~ WEIGHTED<=6 @2
C     Process: s s~ > ta+ ta- d d~ WEIGHTED<=6 @2
C     Process: s s~ > ta+ ta- b b~ WEIGHTED<=6 @2
C     Process: b b~ > ta+ ta- d d~ WEIGHTED<=6 @2
C     Process: b b~ > ta+ ta- s s~ WEIGHTED<=6 @2
C     
