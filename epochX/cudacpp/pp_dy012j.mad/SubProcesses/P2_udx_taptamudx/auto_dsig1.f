...
C     
C     Process: u d~ > ta+ ta- u d~ WEIGHTED<=6 @2
C     Process: u s~ > ta+ ta- u s~ WEIGHTED<=6 @2
C     Process: u b~ > ta+ ta- u b~ WEIGHTED<=6 @2
C     Process: c d~ > ta+ ta- c d~ WEIGHTED<=6 @2
C     Process: c s~ > ta+ ta- c s~ WEIGHTED<=6 @2
C     Process: c b~ > ta+ ta- c b~ WEIGHTED<=6 @2
C     
