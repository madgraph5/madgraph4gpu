...
// Process: u d~ > ta+ ta- u d~ WEIGHTED<=6 @2
// Process: u s~ > ta+ ta- u s~ WEIGHTED<=6 @2
// Process: u b~ > ta+ ta- u b~ WEIGHTED<=6 @2
// Process: c d~ > ta+ ta- c d~ WEIGHTED<=6 @2
// Process: c s~ > ta+ ta- c s~ WEIGHTED<=6 @2
// Process: c b~ > ta+ ta- c b~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[7], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[1] );
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[6], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[5] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_udx_taptamudx()?)
