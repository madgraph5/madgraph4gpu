...
#define MG_EPOCH_PROCESS_ID SIGMA_SM_NO_B_MASS_GDX_TAPTAMGDX

// For simplicity, define here the name of the process-dependent reference file for tests
#define MG_EPOCH_REFERENCE_FILE_NAME "../../test/ref/dump_CPUTest.Sigma_sm_no_b_mass_gdx_taptamgdx.txt"
