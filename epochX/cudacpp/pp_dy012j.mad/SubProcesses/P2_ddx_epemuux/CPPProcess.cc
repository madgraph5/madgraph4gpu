...
// Process: d d~ > e+ e- u u~ WEIGHTED<=6 @2
// Process: d d~ > e+ e- c c~ WEIGHTED<=6 @2
// Process: d d~ > mu+ mu- u u~ WEIGHTED<=6 @2
// Process: d d~ > mu+ mu- c c~ WEIGHTED<=6 @2
// Process: s s~ > e+ e- u u~ WEIGHTED<=6 @2
// Process: s s~ > e+ e- c c~ WEIGHTED<=6 @2
// Process: s s~ > mu+ mu- u u~ WEIGHTED<=6 @2
// Process: s s~ > mu+ mu- c c~ WEIGHTED<=6 @2
// Process: b b~ > e+ e- u u~ WEIGHTED<=6 @2
// Process: b b~ > e+ e- c c~ WEIGHTED<=6 @2
// Process: b b~ > mu+ mu- u u~ WEIGHTED<=6 @2
// Process: b b~ > mu+ mu- c c~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_ddx_epemuux()?)
