...
// Process: d u~ > e+ e- d u~ WEIGHTED<=6 @2
// Process: d u~ > mu+ mu- d u~ WEIGHTED<=6 @2
// Process: d c~ > e+ e- d c~ WEIGHTED<=6 @2
// Process: d c~ > mu+ mu- d c~ WEIGHTED<=6 @2
// Process: s u~ > e+ e- s u~ WEIGHTED<=6 @2
// Process: s u~ > mu+ mu- s u~ WEIGHTED<=6 @2
// Process: s c~ > e+ e- s c~ WEIGHTED<=6 @2
// Process: s c~ > mu+ mu- s c~ WEIGHTED<=6 @2
// Process: b u~ > e+ e- b u~ WEIGHTED<=6 @2
// Process: b u~ > mu+ mu- b u~ WEIGHTED<=6 @2
// Process: b c~ > e+ e- b c~ WEIGHTED<=6 @2
// Process: b c~ > mu+ mu- b c~ WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_dux_epemdux()?)
