...
C     Process: b u~ > e+ e- b u~ WEIGHTED<=6 @2
C     Process: b u~ > mu+ mu- b u~ WEIGHTED<=6 @2
C     Process: b c~ > e+ e- b c~ WEIGHTED<=6 @2
C     Process: b c~ > mu+ mu- b c~ WEIGHTED<=6 @2
C     
...
C     Continue only if IMODE is 0, 4 or 5
     ...
     $       -PP(3,I))))
      ...
      PD(IPROC)=B1*UX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! b u~ > mu+ mu- b u~
      PD(IPROC)=B1*UX2
      PD(0)=PD(0)+DABS(PD(IPROC))
      IPROC=IPROC+1  ! b c~ > e+ e- b c~
      PD(IPROC)=B1*CX2
      PD(0)=PD(0)+DABS(PD(IPROC))
