...
namespace mgOnGpu
{
  ...
  __device__ constexpr bool icolamp[16][2] = { // note: a trailing comma in the initializer list is allowed
    ...
    { false,  true }, // ICONFIG=2   <-- CHANNEL_ID=2
    { false,  true }, // ICONFIG=3   <-- CHANNEL_ID=3
    { false,  true }, // ICONFIG=4   <-- CHANNEL_ID=4
    ...
    {  true, false }, // ICONFIG=9   <-- CHANNEL_ID=9
    {  true, false }, // ICONFIG=10  <-- CHANNEL_ID=10
    {  true, false }, // ICONFIG=11  <-- CHANNEL_ID=11
    {  true, false }, // ICONFIG=12  <-- CHANNEL_ID=12
    { false,  true }, // ICONFIG=13  <-- CHANNEL_ID=13
    { false,  true }, // ICONFIG=14  <-- CHANNEL_ID=14
    { false,  true }, // ICONFIG=15  <-- CHANNEL_ID=15
    { false,  true }, // ICONFIG=16  <-- CHANNEL_ID=16
  };
