...
// Process: d d~ > ta+ ta- WEIGHTED<=4
// Process: s s~ > ta+ ta- WEIGHTED<=4
// Process: b b~ > ta+ ta- WEIGHTED<=4
...
#pragma nv_diagnostic pop
      ...
      FFV2_3_3<W_ACCESS, CI_ACCESS>( w_fp[0], w_fp[1], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, cIPD[0], cIPD[1], w_fp[4] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_ddx_taptam()?)
