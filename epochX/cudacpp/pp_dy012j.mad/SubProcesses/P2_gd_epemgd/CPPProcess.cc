...
// Process: g d > e+ e- g d WEIGHTED<=6 @2
// Process: g d > mu+ mu- g d WEIGHTED<=6 @2
// Process: g s > e+ e- g s WEIGHTED<=6 @2
// Process: g s > mu+ mu- g s WEIGHTED<=6 @2
// Process: g b > e+ e- g b WEIGHTED<=6 @2
// Process: g b > mu+ mu- g b WEIGHTED<=6 @2
...
#pragma nv_diagnostic pop
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_2_gd_epemgd()?)
