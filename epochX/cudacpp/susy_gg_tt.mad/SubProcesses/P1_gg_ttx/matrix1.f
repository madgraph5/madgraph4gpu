...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,3),W(1,5),-GC_51(IVEC),AMP(1))
      CALL FFV1_1(W(1,3),W(1,1),-GC_51(IVEC),MDL_MT, FK_MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,4),W(1,5),W(1,2),-GC_51(IVEC),AMP(2))
      CALL FFV1_2(W(1,4),W(1,1),-GC_51(IVEC),MDL_MT, FK_MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,5),W(1,3),W(1,2),-GC_51(IVEC),AMP(3))
