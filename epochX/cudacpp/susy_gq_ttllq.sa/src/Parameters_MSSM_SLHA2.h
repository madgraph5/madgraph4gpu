...
#endif
{
  ...
  public:
    ...
    cxsmpl<double> GC_1, GC_2, GC_3, GC_246, GC_248, GC_249, GC_250;
    ...
    //cxsmpl<double> GC_51, GC_6; // now computed event-by-event (running alphas #373)
...
#endif
{
  ...
  namespace Parameters_MSSM_SLHA2 // keep the same name rather than HardcodedParameters_MSSM_SLHA2 for simplicity
  {
    ...
    constexpr cxsmpl<double> GC_246 = -( mdl_cw * mdl_ee * mdl_complexi ) / ( 2. * ( -1. + mdl_sw ) * mdl_sw * ( 1. + mdl_sw ) );
    constexpr cxsmpl<double> GC_248 = -( mdl_cw * mdl_ee * mdl_complexi * mdl_sw ) / ( 3. * ( -1. + mdl_sw ) * ( 1. + mdl_sw ) );
    constexpr cxsmpl<double> GC_249 = ( 2. * mdl_cw * mdl_ee * mdl_complexi * mdl_sw ) / ( 3. * ( -1. + mdl_sw ) * ( 1. + mdl_sw ) );
    constexpr cxsmpl<double> GC_250 = -( ( mdl_cw * mdl_ee * mdl_complexi * mdl_sw ) / ( ( -1. + mdl_sw ) * ( 1. + mdl_sw ) ) );
