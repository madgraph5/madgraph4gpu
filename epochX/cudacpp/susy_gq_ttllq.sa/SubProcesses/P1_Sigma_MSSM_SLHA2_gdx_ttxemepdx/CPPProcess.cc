...
// Process: g d~ > t t~ e- e+ d~ WEIGHTED<=7 @1
// Process: g d~ > t t~ mu- mu+ d~ WEIGHTED<=7 @1
// Process: g s~ > t t~ e- e+ s~ WEIGHTED<=7 @1
// Process: g s~ > t t~ mu- mu+ s~ WEIGHTED<=7 @1
...
#endif
{
  ...
  __device__ const fptype cIPD[4] = { (fptype)Parameters_MSSM_SLHA2::mdl_MT, (fptype)Parameters_MSSM_SLHA2::mdl_MZ, (fptype)Parameters_MSSM_SLHA2::mdl_WZ, (fptype)Parameters_MSSM_SLHA2::mdl_WT };
  __device__ const fptype cIPC[14] = { (fptype)Parameters_MSSM_SLHA2::GC_3.real(), (fptype)Parameters_MSSM_SLHA2::GC_3.imag(), (fptype)Parameters_MSSM_SLHA2::GC_2.real(), (fptype)Parameters_MSSM_SLHA2::GC_2.imag(), (fptype)Parameters_MSSM_SLHA2::GC_246.real(), (fptype)Parameters_MSSM_SLHA2::GC_246.imag(), (fptype)Parameters_MSSM_SLHA2::GC_250.real(), (fptype)Parameters_MSSM_SLHA2::GC_250.imag(), (fptype)Parameters_MSSM_SLHA2::GC_249.real(), (fptype)Parameters_MSSM_SLHA2::GC_249.imag(), (fptype)Parameters_MSSM_SLHA2::GC_1.real(), (fptype)Parameters_MSSM_SLHA2::GC_1.imag(), (fptype)Parameters_MSSM_SLHA2::GC_248.real(), (fptype)Parameters_MSSM_SLHA2::GC_248.imag() };
#else
#ifdef MGONGPUCPP_GPUIMPL
  __device__ __constant__ fptype cIPD[4];
  __device__ __constant__ fptype cIPC[14];
#else
  static fptype cIPD[4];
  static fptype cIPC[14];
#endif
#endif
...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[0], COUPs[0], -1.0, 0., 0., w_fp[7] );
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[2], COUPs[0], -1.0, 0., 0., w_fp[8] );
      FFV1P0_3<W_ACCESS, CI_ACCESS>( w_fp[5], w_fp[4], COUPs[ndcoup + 0], 1.0, 0., 0., w_fp[9] );
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[7], w_fp[8], COUPs[0], -1.0, 0., 0., w_fp[10] );

      // Amplitude(s) for diagram number 1
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[1], w_fp[9], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[7], w_fp[9], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[11] );

      // Amplitude(s) for diagram number 2
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[11], w_fp[1], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_3<W_ACCESS, CI_ACCESS>( w_fp[5], w_fp[4], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 3], 1.0, cIPD[1], cIPD[2], w_fp[11] );

      // Amplitude(s) for diagram number 3
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[1], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[7], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, 0., 0., w_fp[10] );

      // Amplitude(s) for diagram number 4
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[1], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[7], w_fp[1], COUPs[0], -1.0, 0., 0., w_fp[10] );
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[2], w_fp[9], COUPs[ndcoup + 1], 1.0, cIPD[0], cIPD[3], w_fp[7] );

      // Amplitude(s) for diagram number 5
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[7], w_fp[10], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[3], w_fp[9], COUPs[ndcoup + 1], 1.0, cIPD[0], cIPD[3], w_fp[5] );

      // Amplitude(s) for diagram number 6
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[2], w_fp[10], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[2], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, cIPD[0], cIPD[3], w_fp[4] );

      // Amplitude(s) for diagram number 7
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[4], w_fp[10], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[3], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, cIPD[0], cIPD[3], w_fp[12] );

      // Amplitude(s) for diagram number 8
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[12], w_fp[2], w_fp[10], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[2], w_fp[0], COUPs[0], -1.0, cIPD[0], cIPD[3], w_fp[10] );
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[1], COUPs[0], -1.0, 0., 0., w_fp[13] );
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[10], w_fp[13], COUPs[0], -1.0, cIPD[0], cIPD[3], w_fp[14] );

      // Amplitude(s) for diagram number 9
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[3], w_fp[14], w_fp[9], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[10], w_fp[9], COUPs[ndcoup + 1], 1.0, cIPD[0], cIPD[3], w_fp[15] );

      // Amplitude(s) for diagram number 10
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[15], w_fp[13], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[3], w_fp[14], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[10], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, cIPD[0], cIPD[3], w_fp[14] );

      // Amplitude(s) for diagram number 12
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[14], w_fp[13], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[10], COUPs[0], -1.0, 0., 0., w_fp[14] );
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[9], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[10] );

      // Amplitude(s) for diagram number 13
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[1], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[9], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[15] );

      // Amplitude(s) for diagram number 14
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[15], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, 0., 0., w_fp[16] );

      // Amplitude(s) for diagram number 15
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[1], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, 0., 0., w_fp[17] );

      // Amplitude(s) for diagram number 16
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[17], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[0], COUPs[0], -1.0, cIPD[0], cIPD[3], w_fp[14] );
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[14], w_fp[13], COUPs[0], -1.0, cIPD[0], cIPD[3], w_fp[18] );

      // Amplitude(s) for diagram number 17
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[18], w_fp[2], w_fp[9], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[14], w_fp[9], COUPs[ndcoup + 1], 1.0, cIPD[0], cIPD[3], w_fp[19] );

      // Amplitude(s) for diagram number 18
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[19], w_fp[2], w_fp[13], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[18], w_fp[2], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[14], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, cIPD[0], cIPD[3], w_fp[18] );

      // Amplitude(s) for diagram number 20
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[18], w_fp[2], w_fp[13], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[14], w_fp[2], COUPs[0], -1.0, 0., 0., w_fp[18] );

      // Amplitude(s) for diagram number 21
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[1], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[15], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[1], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[17], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[0], COUPs[0], -1.0, 0., 0., w_fp[18] );
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[18], w_fp[8], COUPs[0], -1.0, 0., 0., w_fp[14] );

      // Amplitude(s) for diagram number 25
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[6], w_fp[14], w_fp[9], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[18], w_fp[9], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[19] );

      // Amplitude(s) for diagram number 26
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[19], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[6], w_fp[14], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[18], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, 0., 0., w_fp[14] );

      // Amplitude(s) for diagram number 28
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[14], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[18], COUPs[0], -1.0, 0., 0., w_fp[14] );

      // Amplitude(s) for diagram number 29
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[7], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[2], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[3], w_fp[4], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[12], w_fp[2], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      VVV1P0_1<W_ACCESS, CD_ACCESS>( w_fp[0], w_fp[13], COUPs[1], 1.0, 0., 0., w_fp[14] );
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[2], w_fp[13], COUPs[0], -1.0, cIPD[0], cIPD[3], w_fp[18] );

      // Amplitude(s) for diagram number 35
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[18], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[3], w_fp[13], COUPs[0], -1.0, cIPD[0], cIPD[3], w_fp[5] );

      // Amplitude(s) for diagram number 36
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[7], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[12], w_fp[18], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[5], w_fp[4], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] += 1. / 6. * amp_sv[0];
      ...
      VVV1P0_1<W_ACCESS, CD_ACCESS>( w_fp[0], w_fp[8], COUPs[1], 1.0, 0., 0., w_fp[5] );

      // Amplitude(s) for diagram number 41
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[1], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[15], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[8], COUPs[0], -1.0, 0., 0., w_fp[4] );

      // Amplitude(s) for diagram number 43
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[4], w_fp[15], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[8], COUPs[0], -1.0, 0., 0., w_fp[15] );

      // Amplitude(s) for diagram number 44
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[15], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[1], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[6], w_fp[17], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[4], w_fp[17], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[15], w_fp[0], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gdx_ttxemepdx()?)
  ...
  CPPProcess::initProc( const std::string& param_card_name )
  {
    ...
    const fptype tIPD[4] = { (fptype)m_pars->mdl_MT, (fptype)m_pars->mdl_MZ, (fptype)m_pars->mdl_WZ, (fptype)m_pars->mdl_WT };
    const cxtype tIPC[7] = { cxmake( m_pars->GC_3 ), cxmake( m_pars->GC_2 ), cxmake( m_pars->GC_246 ), cxmake( m_pars->GC_250 ), cxmake( m_pars->GC_249 ), cxmake( m_pars->GC_1 ), cxmake( m_pars->GC_248 ) };
#ifdef MGONGPUCPP_GPUIMPL
    gpuMemcpyToSymbol( cIPD, tIPD, 4 * sizeof( fptype ) );
    gpuMemcpyToSymbol( cIPC, tIPC, 7 * sizeof( cxtype ) );
#ifdef MGONGPUCPP_NBSMINDEPPARAM_GT_0
    ...
    memcpy( cIPC, tIPC, 7 * sizeof( cxtype ) );
#ifdef MGONGPUCPP_NBSMINDEPPARAM_GT_0
    if( Parameters_MSSM_SLHA2::nBsmIndepParam > 0 )
    ...
    //for ( int i=0; i<7; i++ ) std::cout << std::setprecision(17) << "tIPC[i] = " << tIPC[i] << std::endl;
