...
#endif
{
  ...
  constexpr int nIPC = 7; // SM independent couplings used in this CPPProcess.cc (FIXME? rename as sm_IndepCoupl?)
  ...
  __device__ const fptype cIPC[nIPC * 2] = { (fptype)Parameters_MSSM_SLHA2::GC_3.real(), (fptype)Parameters_MSSM_SLHA2::GC_3.imag(), (fptype)Parameters_MSSM_SLHA2::GC_2.real(), (fptype)Parameters_MSSM_SLHA2::GC_2.imag(), (fptype)Parameters_MSSM_SLHA2::GC_246.real(), (fptype)Parameters_MSSM_SLHA2::GC_246.imag(), (fptype)Parameters_MSSM_SLHA2::GC_250.real(), (fptype)Parameters_MSSM_SLHA2::GC_250.imag(), (fptype)Parameters_MSSM_SLHA2::GC_249.real(), (fptype)Parameters_MSSM_SLHA2::GC_249.imag(), (fptype)Parameters_MSSM_SLHA2::GC_1.real(), (fptype)Parameters_MSSM_SLHA2::GC_1.imag(), (fptype)Parameters_MSSM_SLHA2::GC_248.real(), (fptype)Parameters_MSSM_SLHA2::GC_248.imag() };
#else
#ifdef MGONGPUCPP_GPUIMPL
...
#pragma nv_diagnostic pop
  ...
  CPPProcess::initProc( const std::string& param_card_name )
  {
    ...
    const fptype tIPD[nIPD] = { (fptype)m_pars->mdl_MT, (fptype)m_pars->mdl_MZ, (fptype)m_pars->mdl_WZ, (fptype)m_pars->mdl_WT };
    const cxtype tIPC[nIPC] = { cxmake( m_pars->GC_3 ), cxmake( m_pars->GC_2 ), cxmake( m_pars->GC_246 ), cxmake( m_pars->GC_250 ), cxmake( m_pars->GC_249 ), cxmake( m_pars->GC_1 ), cxmake( m_pars->GC_248 ) };
#ifdef MGONGPUCPP_GPUIMPL
