...
#pragma nv_diagnostic pop
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[6], w_fp[9], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[6], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[9], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[10] );
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[9], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[15] );
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[16] );
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[17] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[14], w_fp[9], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] -= 1. / 6. * amp_sv[0];
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[14], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] -= 1. / 6. * amp_sv[0];
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gu_ttxemepu()?)
  ...
  CPPProcess::initProc( const std::string& param_card_name )
  {
    ...
    const cxtype tIPC[5] = { cxmake( m_pars->GC_3 ), cxmake( m_pars->GC_2 ), cxmake( m_pars->GC_246 ), cxmake( m_pars->GC_250 ), cxmake( m_pars->GC_249 ) };
#ifdef MGONGPUCPP_GPUIMPL
    gpuMemcpyToSymbol( cIPD, tIPD, 4 * sizeof( fptype ) );
    gpuMemcpyToSymbol( cIPC, tIPC, 5 * sizeof( cxtype ) );
#ifdef MGONGPUCPP_NBSMINDEPPARAM_GT_0
    ...
    memcpy( cIPC, tIPC, 5 * sizeof( cxtype ) );
#ifdef MGONGPUCPP_NBSMINDEPPARAM_GT_0
    if( Parameters_MSSM_SLHA2::nBsmIndepParam > 0 )
    ...
    //for ( int i=0; i<5; i++ ) std::cout << std::setprecision(17) << "tIPC[i] = " << tIPC[i] << std::endl;
