...
// Process: g u~ > t t~ e- e+ u~ WEIGHTED<=7 @1
// Process: g u~ > t t~ mu- mu+ u~ WEIGHTED<=7 @1
// Process: g c~ > t t~ e- e+ c~ WEIGHTED<=7 @1
// Process: g c~ > t t~ mu- mu+ c~ WEIGHTED<=7 @1
...
#pragma nv_diagnostic pop
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[1], w_fp[9], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[7], w_fp[9], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[11] );
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[1], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] += 1. / 6. * amp_sv[0];
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[7], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[10] );
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[9], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[10] );
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[9], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[15] );
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[16] );
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[17] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[6], w_fp[14], w_fp[9], COUPs[ndcoup + 1], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[18], w_fp[9], COUPs[ndcoup + 1], 1.0, 0., 0., w_fp[19] );
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[6], w_fp[14], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] -= 1. / 2. * amp_sv[0];
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[18], w_fp[11], COUPs[ndcoup + 2], 1.0, COUPs[ndcoup + 4], 1.0, 0., 0., w_fp[14] );
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gux_ttxemepux()?)
