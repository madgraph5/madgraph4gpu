...
#pragma nv_diagnostic pop
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[0], COUPs[0], -1.0, 0., 0., w_fp[7] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[6], w_fp[9], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[11], w_fp[6], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[10], w_fp[6], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[6], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[7], w_fp[6], COUPs[0], -1.0, 0., 0., w_fp[10] );
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[6], COUPs[0], -1.0, 0., 0., w_fp[13] );
      ...
      FFV1_2<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[9], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[10] );

      // Amplitude(s) for diagram number 13
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[6], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[9], COUPs[ndcoup + 5], 1.0, 0., 0., w_fp[15] );

      // Amplitude(s) for diagram number 14
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[15], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV2_5_2<W_ACCESS, CI_ACCESS>( w_fp[1], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, 0., 0., w_fp[16] );

      // Amplitude(s) for diagram number 15
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[6], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV2_5_1<W_ACCESS, CI_ACCESS>( w_fp[6], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, 0., 0., w_fp[17] );

      // Amplitude(s) for diagram number 16
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[17], w_fp[14], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[6], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] -= 1. / 6. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[15], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] -= 1. / 6. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[6], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] -= 1. / 6. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[17], w_fp[18], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[1] -= 1. / 6. * amp_sv[0];
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[0], COUPs[0], -1.0, 0., 0., w_fp[18] );
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[18], w_fp[8], COUPs[0], -1.0, 0., 0., w_fp[14] );

      // Amplitude(s) for diagram number 25
      FFV1_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[14], w_fp[9], COUPs[ndcoup + 5], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] -= 1. / 6. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[19], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] -= 1. / 6. * amp_sv[0];
      ...
      FFV2_5_0<W_ACCESS, A_ACCESS, CI_ACCESS>( w_fp[1], w_fp[14], w_fp[11], COUPs[ndcoup + 2], -1.0, COUPs[ndcoup + 6], 1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] -= 1. / 6. * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[14], w_fp[8], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[2] -= 1. / 6. * amp_sv[0];
      ...
      FFV1P0_3<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[18], COUPs[0], -1.0, 0., 0., w_fp[14] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[10], w_fp[6], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[15], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      FFV1_2<W_ACCESS, CD_ACCESS>( w_fp[1], w_fp[8], COUPs[0], -1.0, 0., 0., w_fp[4] );
      ...
      FFV1_1<W_ACCESS, CD_ACCESS>( w_fp[6], w_fp[8], COUPs[0], -1.0, 0., 0., w_fp[15] );
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[16], w_fp[6], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      FFV1_0<W_ACCESS, A_ACCESS, CD_ACCESS>( w_fp[1], w_fp[17], w_fp[5], COUPs[0], -1.0, &amp_fp[0] );
#ifdef MGONGPU_SUPPORTS_MULTICHANNEL
      // Here the code base generated with multichannel support updates numerators_sv and denominators_sv (#473)
#endif
      jamp_sv[0] += 1. / 2. * cxtype( 0, 1 ) * amp_sv[0];
      ...
      // *** COLOR MATRIX BELOW ***
      // (This method used to be called CPPProcess::matrix_1_gd_ttxemepd()?)
