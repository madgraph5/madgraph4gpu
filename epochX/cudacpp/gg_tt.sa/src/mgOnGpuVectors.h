...
cxmake( const fptype_v& r, const fptype& i )
{
  ...
  return cxtype_v( r, fptype_v{ 0., 0., 0., 0. } + i ); // IIII=0000+i=iiii
}
...
cxmake( const fptype& r, const fptype_v& i )
{
  ...
  return cxtype_v( fptype_v{ 0., 0., 0., 0. } + r, i ); // IIII=0000+r=rrrr
}
...
{
  return cxtype_v( a - b.real(), fptype_v{ 0., 0., 0., 0. } - b.imag() ); // IIII=0000-b.imag()
}
