      SUBROUTINE SMATRIX1(P, RHEL, RCOL, ICONFIG, IVEC, ANS, IHEL,
     $  ICOL)
C     
...
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ +TMP_JAMP(150)+TMP_JAMP(151)+TMP_JAMP(163)
      ...
      IF(SDE_STRAT.EQ.1)THEN
        AMP2(1)=AMP2(1)+AMP(4)*DCONJG(AMP(4))
        AMP2(2)=AMP2(2)+AMP(5)*DCONJG(AMP(5))
        AMP2(3)=AMP2(3)+AMP(6)*DCONJG(AMP(6))
        ...
        AMP2(9)=AMP2(9)+AMP(12)*DCONJG(AMP(12))
        AMP2(10)=AMP2(10)+AMP(13)*DCONJG(AMP(13))
        AMP2(11)=AMP2(11)+AMP(14)*DCONJG(AMP(14))
        AMP2(12)=AMP2(12)+AMP(15)*DCONJG(AMP(15))
        AMP2(13)=AMP2(13)+AMP(16)*DCONJG(AMP(16))
        AMP2(14)=AMP2(14)+AMP(17)*DCONJG(AMP(17))
        AMP2(15)=AMP2(15)+AMP(18)*DCONJG(AMP(18))
        AMP2(16)=AMP2(16)+AMP(19)*DCONJG(AMP(19))
        AMP2(17)=AMP2(17)+AMP(20)*DCONJG(AMP(20))
        AMP2(18)=AMP2(18)+AMP(21)*DCONJG(AMP(21))
        ...
        AMP2(31)=AMP2(31)+AMP(37)*DCONJG(AMP(37))
        AMP2(32)=AMP2(32)+AMP(38)*DCONJG(AMP(38))
        AMP2(33)=AMP2(33)+AMP(39)*DCONJG(AMP(39))
        AMP2(34)=AMP2(34)+AMP(40)*DCONJG(AMP(40))
        AMP2(35)=AMP2(35)+AMP(41)*DCONJG(AMP(41))
        AMP2(36)=AMP2(36)+AMP(42)*DCONJG(AMP(42))
        ...
        AMP2(46)=AMP2(46)+AMP(55)*DCONJG(AMP(55))
        AMP2(47)=AMP2(47)+AMP(56)*DCONJG(AMP(56))
        AMP2(48)=AMP2(48)+AMP(57)*DCONJG(AMP(57))
        AMP2(49)=AMP2(49)+AMP(58)*DCONJG(AMP(58))
        AMP2(50)=AMP2(50)+AMP(59)*DCONJG(AMP(59))
        AMP2(51)=AMP2(51)+AMP(60)*DCONJG(AMP(60))
        AMP2(52)=AMP2(52)+AMP(61)*DCONJG(AMP(61))
        AMP2(53)=AMP2(53)+AMP(62)*DCONJG(AMP(62))
        AMP2(54)=AMP2(54)+AMP(63)*DCONJG(AMP(63))
        AMP2(55)=AMP2(55)+AMP(67)*DCONJG(AMP(67))
        AMP2(56)=AMP2(56)+AMP(68)*DCONJG(AMP(68))
        AMP2(57)=AMP2(57)+AMP(69)*DCONJG(AMP(69))
        AMP2(58)=AMP2(58)+AMP(70)*DCONJG(AMP(70))
        AMP2(59)=AMP2(59)+AMP(71)*DCONJG(AMP(71))
        AMP2(60)=AMP2(60)+AMP(72)*DCONJG(AMP(72))
        AMP2(61)=AMP2(61)+AMP(73)*DCONJG(AMP(73))
        AMP2(62)=AMP2(62)+AMP(74)*DCONJG(AMP(74))
        AMP2(63)=AMP2(63)+AMP(75)*DCONJG(AMP(75))
        AMP2(64)=AMP2(64)+AMP(76)*DCONJG(AMP(76))
        AMP2(65)=AMP2(65)+AMP(77)*DCONJG(AMP(77))
        AMP2(66)=AMP2(66)+AMP(78)*DCONJG(AMP(78))
        AMP2(67)=AMP2(67)+AMP(79)*DCONJG(AMP(79))
        AMP2(68)=AMP2(68)+AMP(80)*DCONJG(AMP(80))
        AMP2(69)=AMP2(69)+AMP(81)*DCONJG(AMP(81))
        AMP2(70)=AMP2(70)+AMP(85)*DCONJG(AMP(85))
        AMP2(71)=AMP2(71)+AMP(86)*DCONJG(AMP(86))
        AMP2(72)=AMP2(72)+AMP(87)*DCONJG(AMP(87))
        AMP2(73)=AMP2(73)+AMP(88)*DCONJG(AMP(88))
        AMP2(74)=AMP2(74)+AMP(89)*DCONJG(AMP(89))
        AMP2(75)=AMP2(75)+AMP(90)*DCONJG(AMP(90))
        AMP2(76)=AMP2(76)+AMP(91)*DCONJG(AMP(91))
        AMP2(77)=AMP2(77)+AMP(92)*DCONJG(AMP(92))
        AMP2(78)=AMP2(78)+AMP(93)*DCONJG(AMP(93))
        AMP2(79)=AMP2(79)+AMP(94)*DCONJG(AMP(94))
        AMP2(80)=AMP2(80)+AMP(95)*DCONJG(AMP(95))
        AMP2(81)=AMP2(81)+AMP(96)*DCONJG(AMP(96))
        AMP2(82)=AMP2(82)+AMP(97)*DCONJG(AMP(97))
        AMP2(83)=AMP2(83)+AMP(98)*DCONJG(AMP(98))
        AMP2(84)=AMP2(84)+AMP(99)*DCONJG(AMP(99))
        AMP2(85)=AMP2(85)+AMP(100)*DCONJG(AMP(100))
        AMP2(86)=AMP2(86)+AMP(101)*DCONJG(AMP(101))
        AMP2(87)=AMP2(87)+AMP(102)*DCONJG(AMP(102))
        AMP2(88)=AMP2(88)+AMP(106)*DCONJG(AMP(106))
        AMP2(89)=AMP2(89)+AMP(107)*DCONJG(AMP(107))
        AMP2(90)=AMP2(90)+AMP(108)*DCONJG(AMP(108))
        AMP2(91)=AMP2(91)+AMP(109)*DCONJG(AMP(109))
        AMP2(92)=AMP2(92)+AMP(110)*DCONJG(AMP(110))
        AMP2(93)=AMP2(93)+AMP(111)*DCONJG(AMP(111))
        AMP2(94)=AMP2(94)+AMP(115)*DCONJG(AMP(115))
        AMP2(95)=AMP2(95)+AMP(116)*DCONJG(AMP(116))
        AMP2(96)=AMP2(96)+AMP(117)*DCONJG(AMP(117))
        AMP2(97)=AMP2(97)+AMP(118)*DCONJG(AMP(118))
        AMP2(98)=AMP2(98)+AMP(119)*DCONJG(AMP(119))
        AMP2(99)=AMP2(99)+AMP(120)*DCONJG(AMP(120))
        AMP2(100)=AMP2(100)+AMP(124)*DCONJG(AMP(124))
        AMP2(101)=AMP2(101)+AMP(125)*DCONJG(AMP(125))
        AMP2(102)=AMP2(102)+AMP(126)*DCONJG(AMP(126))
        AMP2(103)=AMP2(103)+AMP(127)*DCONJG(AMP(127))
        AMP2(104)=AMP2(104)+AMP(128)*DCONJG(AMP(128))
        AMP2(105)=AMP2(105)+AMP(129)*DCONJG(AMP(129))
      ENDIF
