...
#endif
{
  ...
  namespace Parameters_MSSM_SLHA2 // keep the same name rather than HardcodedParameters_MSSM_SLHA2 for simplicity
  {
    ...
    __device__ constexpr double mdl_bsmIndepParam[nBsmIndepParam] = { mdl_I51x36.real(), mdl_I51x36.imag(), mdl_I52x36.real(), mdl_I52x36.imag(), mdl_I52x33.real(), mdl_I52x33.imag(), mdl_I75x33.real(), mdl_I75x33.imag(), mdl_I51x33.real(), mdl_I51x33.imag(), mdl_I74x33.real(), mdl_I74x33.imag() }';
  }
...
#else
      const cxsmpl<double> mdl_I51x36 = cxsmpl<double>( bsmIndepParamPtr[0], bsmIndepParamPtr[1] );
      const cxsmpl<double> mdl_I52x36 = cxsmpl<double>( bsmIndepParamPtr[2], bsmIndepParamPtr[3] );
      const cxsmpl<double> mdl_I52x33 = cxsmpl<double>( bsmIndepParamPtr[4], bsmIndepParamPtr[5] );
      const cxsmpl<double> mdl_I75x33 = cxsmpl<double>( bsmIndepParamPtr[6], bsmIndepParamPtr[7] );
      const cxsmpl<double> mdl_I51x33 = cxsmpl<double>( bsmIndepParamPtr[8], bsmIndepParamPtr[9] );
      const cxsmpl<double> mdl_I74x33 = cxsmpl<double>( bsmIndepParamPtr[10], bsmIndepParamPtr[11] );
