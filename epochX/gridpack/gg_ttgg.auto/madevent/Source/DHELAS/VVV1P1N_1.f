...
C     
      ...
      V1(3)= COUP*(TMP6*(-CI*(P2(0))+CI*(P3(0)))+(V2(3)*(-CI*(TMP0)+CI
     $ *(TMP2))+V3(3)*(+CI*(TMP4)-CI*(TMP5))))
      V1(4)= COUP*(TMP6*(+CI*(P2(1))-CI*(P3(1)))+(V2(4)*(+CI*(TMP0)-CI
     $ *(TMP2))+V3(4)*(-CI*(TMP4)+CI*(TMP5))))
      V1(5)= COUP*(TMP6*(+CI*(P2(2))-CI*(P3(2)))+(V2(5)*(+CI*(TMP0)-CI
     $ *(TMP2))+V3(5)*(-CI*(TMP4)+CI*(TMP5))))
      V1(6)= COUP*(TMP6*(+CI*(P2(3))-CI*(P3(3)))+(V2(6)*(+CI*(TMP0)-CI
     $ *(TMP2))+V3(6)*(-CI*(TMP4)+CI*(TMP5))))
      END
