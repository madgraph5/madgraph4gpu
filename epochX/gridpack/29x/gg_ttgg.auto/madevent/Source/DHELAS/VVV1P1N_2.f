...
C     
      ...
      V2(3)= COUP*(TMP3*(+CI*(P1(0))-CI*(P3(0)))+(V1(3)*(-CI*(TMP0)+CI
     $ *(TMP2))+V3(3)*(-CI*(TMP7)+CI*(TMP8))))
      V2(4)= COUP*(TMP3*(-CI*(P1(1))+CI*(P3(1)))+(V1(4)*(+CI*(TMP0)-CI
     $ *(TMP2))+V3(4)*(+CI*(TMP7)-CI*(TMP8))))
      V2(5)= COUP*(TMP3*(-CI*(P1(2))+CI*(P3(2)))+(V1(5)*(+CI*(TMP0)-CI
     $ *(TMP2))+V3(5)*(+CI*(TMP7)-CI*(TMP8))))
      V2(6)= COUP*(TMP3*(-CI*(P1(3))+CI*(P3(3)))+(V1(6)*(+CI*(TMP0)-CI
     $ *(TMP2))+V3(6)*(+CI*(TMP7)-CI*(TMP8))))
      END
