...
// Provides macros for simply use of NVTX, if a compiler macro USE_NVTX is
// defined. Original author Peter Heywood <p.heywood@sheffield.ac.uk> With a few
// modifications by Andrea Valassi
