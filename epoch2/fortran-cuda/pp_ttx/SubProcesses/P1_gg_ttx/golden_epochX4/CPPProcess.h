...
public:
  ...
  // int getNIOParticles() const { return nexternal; } // nexternal was
  // nioparticles
...
public:
  ...
  // static const int nexternal = 4; // mgOnGpu::npar (nexternal was
  // nioparticles) static const int nprocesses = 1; // FIXME: assume
  // process.nprocesses == 1 static const int nwavefuncs = 6; // mgOnGpu::nwf
...
private:
  ...
  int m_numiterations; // number of iterations (each iteration has
                       // nblocks*nthreads events)
