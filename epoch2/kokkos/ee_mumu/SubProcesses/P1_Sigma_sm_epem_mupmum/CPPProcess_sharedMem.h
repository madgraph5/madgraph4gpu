...
// Kokkos::View<double *, Kokkos::LayoutStride, Kokkos::Device<Kokkos::CudaUVMSpace::execution_space, Kokkos::CudaUVMSpace::memory_space>, Kokkos::MemoryTraits<0U>>
// double
// int
// int
// Kokkos::View<Kokkos::complex<double> *, Kokkos::LayoutStride, Kokkos::Device<Kokkos::CudaUVMSpace::execution_space, Kokkos::CudaUVMSpace::memory_space>, Kokkos::MemoryTraits<0U>>
template<typename Stride, typename Device, typename MemSpace>
KOKKOS_FUNCTION void ixxxxx(Kokkos::View<double*,Stride,Device,MemSpace> pvec, 
                            double fmass, int nhel, int nsf, 
                            Kokkos::View<Kokkos::complex<double> *,Stride,Device,MemSpace> fi)
{
...
template<typename Stride, typename Device, typename MemSpace>
KOKKOS_FUNCTION void oxxxxx(Kokkos::View<double*,Stride,Device,MemSpace> pvec,
                            double fmass, int nhel, int nsf, 
                            Kokkos::View<Kokkos::complex<double> *,Stride,Device,MemSpace> fo) 
{
  Kokkos::complex<double> chi[2]; 
...
template <typename Stride, typename Device, typename MemSpace>
KOKKOS_FUNCTION void FFV1_0(Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> F1,
            Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> F2, 
            Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> V3, 
...
template <typename Layout, typename Device, typename MemSpace>
KOKKOS_FUNCTION void FFV1P0_3(Kokkos::View<Kokkos::complex<double>*,Layout,Device,MemSpace> F1,
              Kokkos::View<Kokkos::complex<double>*,Layout,Device,MemSpace> F2,
              const Kokkos::complex<double> COUP, 
              const double M3,
              const double W3, 
              Kokkos::View<Kokkos::complex<double>*,Layout,Device,MemSpace> V3)
{
  Kokkos::complex<double> cI = Kokkos::complex<double> (0., 1.); 
  double P3[4]; 
  Kokkos::complex<double> denom; 
...
template <typename Stride, typename Device, typename MemSpace>
KOKKOS_FUNCTION void FFV2_4_0(Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> F1,
              Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> F2, 
              Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> V3, 
...
template <typename Stride, typename Device, typename MemSpace>
KOKKOS_FUNCTION void FFV2_4_3(Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> F1,
              Kokkos::View<Kokkos::complex<double>*,Stride,Device,MemSpace> F2,
              const Kokkos::complex<double> COUP1, 
              const Kokkos::complex<double> COUP2, 
              const double M3, 
...
// Kokkos::View<double, Kokkos::Cuda::array_layout, Kokkos::Device<Kokkos::CudaUVMSpace::execution_space, Kokkos::CudaUVMSpace::memory_space>, Kokkos::MemoryManaged>
// Kokkos::View<Kokkos::complex<double> *, Kokkos::Cuda::array_layout, Kokkos::Device<Kokkos::CudaUVMSpace::execution_space, Kokkos::CudaUVMSpace::memory_space>, Kokkos::MemoryManaged>
// Kokkos::View<Kokkos::complex<double> **, Kokkos::Cuda::array_layout, Kokkos::Device<Kokkos::CudaUVMSpace::execution_space, Kokkos::CudaUVMSpace::memory_space>, Kokkos::MemoryManaged>



// Evaluate |M|^2 for each subprocess
template <typename Layout, typename Stride, typename Device, typename MemSpace, typename ExecSpace>
KOKKOS_FUNCTION void calculate_wavefunctions(
    Kokkos::View<int*,Stride,Device,MemSpace> cHel,
    Kokkos::View<double**,Layout,Device,MemSpace> local_mom,
    ...
    Kokkos::View<Kokkos::complex<double>*,Layout,Device,MemSpace> amp,
    Kokkos::View<Kokkos::complex<double>**,Layout,Device,MemSpace> w)
{
  // Kokkos::complex<double> amp[2]; 
  // Calculate wavefunctions for all processes
  // Kokkos::complex<double> w[5][6]; 
  oxxxxx(Kokkos::subview(local_mom,0,Kokkos::ALL), 0., cHel(0), -1, Kokkos::subview(w,0,Kokkos::ALL)); 
  ixxxxx(Kokkos::subview(local_mom,1,Kokkos::ALL), 0., cHel(1), +1, Kokkos::subview(w,1,Kokkos::ALL)); 
  ixxxxx(Kokkos::subview(local_mom,2,Kokkos::ALL), 0., cHel(2), -1, Kokkos::subview(w,2,Kokkos::ALL)); 
  oxxxxx(Kokkos::subview(local_mom,3,Kokkos::ALL), 0., cHel(3), +1, Kokkos::subview(w,3,Kokkos::ALL)); 
  FFV1P0_3(Kokkos::subview(w,1,Kokkos::ALL), Kokkos::subview(w,0,Kokkos::ALL), 
           cIPC(0), 0., 0., Kokkos::subview(w,4,Kokkos::ALL));
  // Amplitude(s) for diagram number 1
  FFV1_0(Kokkos::subview(w,2,Kokkos::ALL), Kokkos::subview(w,3,Kokkos::ALL), 
         Kokkos::subview(w,4,Kokkos::ALL), cIPC(0), &amp(0));
  FFV2_4_3(Kokkos::subview(w,1,Kokkos::ALL), Kokkos::subview(w,0,Kokkos::ALL), cIPC(1), cIPC(2), 
           cIPD(0), cIPD(1), Kokkos::subview(w,4,Kokkos::ALL));
  // Amplitude(s) for diagram number 2
  FFV2_4_0(Kokkos::subview(w,2,Kokkos::ALL), Kokkos::subview(w,3,Kokkos::ALL), 
           Kokkos::subview(w,4,Kokkos::ALL), cIPC(1),
           cIPC(2), &amp(1));
    ...
    const int& team_size) 
{
  ...
  KOKKOS_LAMBDA(member_type team_member){
    ...
    auto local_mom = Kokkos::subview(momenta,Kokkos::ALL,Kokkos::ALL,tid);
    auto local_me = Kokkos::subview(matrix_element,0,tid);
    auto local_amp = Kokkos::subview(amp,Kokkos::ALL,tid);
    auto local_w = Kokkos::subview(w,Kokkos::ALL,Kokkos::ALL,tid);
    for (int ihel = 0; ihel < ncomb; ++ihel)
    {
      ...
      calculate_wavefunctions(local_cHel, local_mom, cIPD, cIPC, local_me, local_amp, local_w);
    ...
    for (int i = 0; i < nprocesses; ++ i)
    {
      local_me() = local_me() / denominators[i]; 
    }
    // for (int i = 0; i < nprocesses; ++ i)
    // {
    //   output[i * nprocesses + tid] = local_me; 
