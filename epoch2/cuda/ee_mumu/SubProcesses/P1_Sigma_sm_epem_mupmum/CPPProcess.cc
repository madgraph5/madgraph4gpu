...
namespace MG5_sm
{
  ...
  __device__
  void imzxxx( const fptype* allmomenta,
               const int& nhel,
               const int& nsf,
               cxtype fi[6],
#ifndef __CUDACC__
  ...
  __device__
  void ixzxxx( const fptype* allmomenta,
               const int& nhel,
               const int& nsf,
               cxtype fi[6],
#ifndef __CUDACC__
  ...
  __device__
  void oxzxxx( const fptype* allmomenta,
               const int& nhel,
               const int& nsf,
               cxtype fo[6],
#ifndef __CUDACC__
  ...
  __device__ void FFV2_0( const cxtype F1[],
                          const cxtype F2[],
                          const cxtype V3[],
                          const cxtype COUP,
                          cxtype* vertex )
  ...
  __device__ void FFV2_3( const cxtype F1[],
                          const cxtype F2[],
                          const cxtype COUP,
                          const fptype M3,
                          const fptype W3,
