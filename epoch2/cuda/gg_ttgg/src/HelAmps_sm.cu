...
__device__ void VVV1_0(const fptype * allmomenta, const cxtype V1[], const
    unsigned short pid1, const cxtype V2[], const unsigned short pid2, const
...
#endif
  pIdp4Ievt(allmomenta, pid1, ievt, P1); 
  pIdp4Ievt(allmomenta, pid2, ievt, P2); 
  pIdp4Ievt(allmomenta, pid3, ievt, P3); 
  TMP4 = (P1[0] * V2[0] - P1[1] * V2[1] - P1[2] * V2[2] - P1[3] * V2[3]); 
  TMP8 = (V1[0] * P3[0] - V1[1] * P3[1] - V1[2] * P3[2] - V1[3] * P3[3]); 
  TMP5 = (V2[0] * P3[0] - V2[1] * P3[1] - V2[2] * P3[2] - V2[3] * P3[3]); 
  TMP2 = (V3[0] * P2[0] - V3[1] * P2[1] - V3[2] * P2[2] - V3[3] * P2[3]); 
  TMP7 = (V1[0] * P2[0] - V1[1] * P2[1] - V1[2] * P2[2] - V1[3] * P2[3]); 
  TMP1 = (V2[0] * V1[0] - V2[1] * V1[1] - V2[2] * V1[2] - V2[3] * V1[3]); 
  TMP3 = (V3[0] * V1[0] - V3[1] * V1[1] - V3[2] * V1[2] - V3[3] * V1[3]); 
  TMP6 = (V3[0] * V2[0] - V3[1] * V2[1] - V3[2] * V2[2] - V3[3] * V2[3]); 
  TMP0 = (V3[0] * P1[0] - V3[1] * P1[1] - V3[2] * P1[2] - V3[3] * P1[3]); 
  (*vertex) = COUP * (TMP1 * (-cI * (TMP0) + cI * (TMP2)) + (TMP3 * (+cI *
      (TMP4) - cI * (TMP5)) + TMP6 * (-cI * (TMP7) + cI * (TMP8))));
}


__device__ void VVV1P0_1(const fptype * allmomenta, const cxtype V2[], const
    unsigned short pid2, const cxtype V3[], const unsigned short pid3, const
    cxtype COUP, const fptype M1, const fptype W1,
#ifndef __CUDACC__
const int ievt, 
#endif
cxtype V1[])
{
  ...
  pIdp4Ievt(allmomenta, pid2, ievt, P2); 
  pIdp4Ievt(allmomenta, pid3, ievt, P3); 
  pIdp4Ievt(allmomenta, pid2 + pid3, ievt, P1); 
  P1[0] = -P1[0]; 
  P1[1] = -P1[1]; 
  P1[2] = -P1[2]; 
  P1[3] = -P1[3]; 
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[0] = denom * (TMP6 * (-cI * (P2[0]) + cI * (P3[0])) + (V2[0] * (-cI *
      (TMP0) + cI * (TMP2)) + V3[0] * (+cI * (TMP4) - cI * (TMP5))));
  V1[1] = denom * (TMP6 * (-cI * (P2[1]) + cI * (P3[1])) + (V2[1] * (-cI *
      (TMP0) + cI * (TMP2)) + V3[1] * (+cI * (TMP4) - cI * (TMP5))));
  V1[2] = denom * (TMP6 * (-cI * (P2[2]) + cI * (P3[2])) + (V2[2] * (-cI *
      (TMP0) + cI * (TMP2)) + V3[2] * (+cI * (TMP4) - cI * (TMP5))));
  V1[3] = denom * (TMP6 * (-cI * (P2[3]) + cI * (P3[3])) + (V2[3] * (-cI *
      (TMP0) + cI * (TMP2)) + V3[3] * (+cI * (TMP4) - cI * (TMP5))));
}


__device__ void VVVV3_0(const fptype * allmomenta, const cxtype V1[], const
    unsigned short pid1, const cxtype V2[], const unsigned short pid2, const
    cxtype V3[], const unsigned short pid3, const cxtype V4[], const unsigned
    short pid4, const cxtype COUP,
#ifndef __CUDACC__
const int ievt, 
#endif
cxtype * vertex)
{
  ...
  cxtype TMP9; 
  TMP6 = (V3[0] * V2[0] - V3[1] * V2[1] - V3[2] * V2[2] - V3[3] * V2[3]); 
  TMP9 = (V1[0] * V4[0] - V1[1] * V4[1] - V1[2] * V4[2] - V1[3] * V4[3]); 
  TMP10 = (V3[0] * V4[0] - V3[1] * V4[1] - V3[2] * V4[2] - V3[3] * V4[3]); 
  TMP1 = (V2[0] * V1[0] - V2[1] * V1[1] - V2[2] * V1[2] - V2[3] * V1[3]); 
  (*vertex) = COUP * (-cI * (TMP6 * TMP9) + cI * (TMP1 * TMP10)); 
}


__device__ void VVVV3P0_1(const fptype * allmomenta, const cxtype V2[], const
    unsigned short pid2, const cxtype V3[], const unsigned short pid3, const
    cxtype V4[], const unsigned short pid4, const cxtype COUP, const fptype M1,
    const fptype W1,
#ifndef __CUDACC__
const int ievt, 
#endif
cxtype V1[])
{
  ...
  const int ievt = blockDim.x * blockIdx.x + threadIdx.x; 
#endif
  pIdp4Ievt(allmomenta, pid2 + pid3 + pid4, ievt, P1); 
  P1[0] = -P1[0]; 
  P1[1] = -P1[1]; 
  P1[2] = -P1[2]; 
  P1[3] = -P1[3]; 
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[0] = denom * (-cI * (TMP6 * V4[0]) + cI * (V2[0] * TMP10)); 
  V1[1] = denom * (-cI * (TMP6 * V4[1]) + cI * (V2[1] * TMP10)); 
...
cxtype * vertex)
{
  cxtype cI = cxtype(0., 1.); 
  cxtype TMP11; 
  TMP11 = (F1[0] * (F2[2] * (V3[0] + V3[3]) + F2[3] * (V3[1] + cI * (V3[2]))) +
...
__device__ void FFV1_1(const fptype * allmomenta, const cxtype F2[], const
    unsigned short pid2, const cxtype V3[], const unsigned short pid3, const
    cxtype COUP, const fptype M1, const fptype W1,
#ifndef __CUDACC__
const int ievt, 
...
cxtype F1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  F1[0] = denom * cI * (F2[0] * (P1[0] * (-V3[0] + V3[3]) + (P1[1] * (V3[1] -
      cI * (V3[2])) + (P1[2] * (+cI * (V3[1]) + V3[2]) + P1[3] * (-V3[0] +
      V3[3])))) + (F2[1] * (P1[0] * (V3[1] + cI * (V3[2])) + (P1[1] * (-1.) *
      (V3[0] + V3[3]) + (P1[2] * (-1.) * (+cI * (V3[0] + V3[3])) + P1[3] *
      (V3[1] + cI * (V3[2]))))) + M1 * (F2[2] * (V3[0] + V3[3]) + F2[3] *
      (V3[1] + cI * (V3[2])))));
  F1[1] = denom * (-cI) * (F2[0] * (P1[0] * (-V3[1] + cI * (V3[2])) + (P1[1] *
      (V3[0] - V3[3]) + (P1[2] * (-cI * (V3[0]) + cI * (V3[3])) + P1[3] *
      (V3[1] - cI * (V3[2]))))) + (F2[1] * (P1[0] * (V3[0] + V3[3]) + (P1[1] *
      (-1.) * (V3[1] + cI * (V3[2])) + (P1[2] * (+cI * (V3[1]) - V3[2]) - P1[3]
      * (V3[0] + V3[3])))) + M1 * (F2[2] * (-V3[1] + cI * (V3[2])) + F2[3] *
      (-V3[0] + V3[3]))));
  F1[2] = denom * (-cI) * (F2[2] * (P1[0] * (V3[0] + V3[3]) + (P1[1] * (-V3[1]
      + cI * (V3[2])) + (P1[2] * (-1.) * (+cI * (V3[1]) + V3[2]) - P1[3] *
      (V3[0] + V3[3])))) + (F2[3] * (P1[0] * (V3[1] + cI * (V3[2])) + (P1[1] *
      (-V3[0] + V3[3]) + (P1[2] * (-cI * (V3[0]) + cI * (V3[3])) - P1[3] *
      (V3[1] + cI * (V3[2]))))) + M1 * (F2[0] * (-V3[0] + V3[3]) + F2[1] *
      (V3[1] + cI * (V3[2])))));
  F1[3] = denom * cI * (F2[2] * (P1[0] * (-V3[1] + cI * (V3[2])) + (P1[1] *
      (V3[0] + V3[3]) + (P1[2] * (-1.) * (+cI * (V3[0] + V3[3])) + P1[3] *
      (-V3[1] + cI * (V3[2]))))) + (F2[3] * (P1[0] * (-V3[0] + V3[3]) + (P1[1]
      * (V3[1] + cI * (V3[2])) + (P1[2] * (-cI * (V3[1]) + V3[2]) + P1[3] *
      (-V3[0] + V3[3])))) + M1 * (F2[0] * (-V3[1] + cI * (V3[2])) + F2[1] *
      (V3[0] + V3[3]))));
}


__device__ void FFV1_2(const fptype * allmomenta, const cxtype F1[], const
    unsigned short pid1, const cxtype V3[], const unsigned short pid3, const
    cxtype COUP, const fptype M2, const fptype W2,
#ifndef __CUDACC__
const int ievt, 
#endif
cxtype F2[])
{
  ...
  const int ievt = blockDim.x * blockIdx.x + threadIdx.x; 
#endif
  pIdp4Ievt(allmomenta, pid1 + pid3, ievt, P2); 
  P2[0] = -P2[0]; 
  P2[1] = -P2[1]; 
  P2[2] = -P2[2]; 
  P2[3] = -P2[3]; 
  denom = COUP/((P2[0] * P2[0]) - (P2[1] * P2[1]) - (P2[2] * P2[2]) - (P2[3] *
      P2[3]) - M2 * (M2 - cI * W2));
  F2[0] = denom * cI * (F1[0] * (P2[0] * (V3[0] + V3[3]) + (P2[1] * (-1.) *
      (V3[1] + cI * (V3[2])) + (P2[2] * (+cI * (V3[1]) - V3[2]) - P2[3] *
      (V3[0] + V3[3])))) + (F1[1] * (P2[0] * (V3[1] - cI * (V3[2])) + (P2[1] *
      (-V3[0] + V3[3]) + (P2[2] * (+cI * (V3[0]) - cI * (V3[3])) + P2[3] *
      (-V3[1] + cI * (V3[2]))))) + M2 * (F1[2] * (V3[0] - V3[3]) + F1[3] *
      (-V3[1] + cI * (V3[2])))));
  F2[1] = denom * (-cI) * (F1[0] * (P2[0] * (-1.) * (V3[1] + cI * (V3[2])) +
      (P2[1] * (V3[0] + V3[3]) + (P2[2] * (+cI * (V3[0] + V3[3])) - P2[3] *
      (V3[1] + cI * (V3[2]))))) + (F1[1] * (P2[0] * (-V3[0] + V3[3]) + (P2[1] *
      (V3[1] - cI * (V3[2])) + (P2[2] * (+cI * (V3[1]) + V3[2]) + P2[3] *
      (-V3[0] + V3[3])))) + M2 * (F1[2] * (V3[1] + cI * (V3[2])) - F1[3] *
      (V3[0] + V3[3]))));
  F2[2] = denom * (-cI) * (F1[2] * (P2[0] * (-V3[0] + V3[3]) + (P2[1] * (V3[1]
      + cI * (V3[2])) + (P2[2] * (-cI * (V3[1]) + V3[2]) + P2[3] * (-V3[0] +
      V3[3])))) + (F1[3] * (P2[0] * (V3[1] - cI * (V3[2])) + (P2[1] * (-1.) *
      (V3[0] + V3[3]) + (P2[2] * (+cI * (V3[0] + V3[3])) + P2[3] * (V3[1] - cI
      * (V3[2]))))) + M2 * (F1[0] * (-1.) * (V3[0] + V3[3]) + F1[1] * (-V3[1] +
      cI * (V3[2])))));
  F2[3] = denom * cI * (F1[2] * (P2[0] * (-1.) * (V3[1] + cI * (V3[2])) +
      (P2[1] * (V3[0] - V3[3]) + (P2[2] * (+cI * (V3[0]) - cI * (V3[3])) +
      P2[3] * (V3[1] + cI * (V3[2]))))) + (F1[3] * (P2[0] * (V3[0] + V3[3]) +
      (P2[1] * (-V3[1] + cI * (V3[2])) + (P2[2] * (-1.) * (+cI * (V3[1]) +
      V3[2]) - P2[3] * (V3[0] + V3[3])))) + M2 * (F1[0] * (V3[1] + cI *
      (V3[2])) + F1[1] * (V3[0] - V3[3]))));
}
...
__device__ void VVVV4_0(const fptype * allmomenta, const cxtype V1[], const
    unsigned short pid1, const cxtype V2[], const unsigned short pid2, const
    cxtype V3[], const unsigned short pid3, const cxtype V4[], const unsigned
    short pid4, const cxtype COUP,
#ifndef __CUDACC__
...
cxtype * vertex)
{
  ...
  TMP3 = (V3[0] * V1[0] - V3[1] * V1[1] - V3[2] * V1[2] - V3[3] * V1[3]); 
  TMP10 = (V3[0] * V4[0] - V3[1] * V4[1] - V3[2] * V4[2] - V3[3] * V4[3]); 
  TMP12 = (V2[0] * V4[0] - V2[1] * V4[1] - V2[2] * V4[2] - V2[3] * V4[3]); 
  TMP1 = (V2[0] * V1[0] - V2[1] * V1[1] - V2[2] * V1[2] - V2[3] * V1[3]); 
  (*vertex) = COUP * (-cI * (TMP3 * TMP12) + cI * (TMP1 * TMP10)); 
}


__device__ void VVVV4P0_1(const fptype * allmomenta, const cxtype V2[], const
    unsigned short pid2, const cxtype V3[], const unsigned short pid3, const
    cxtype V4[], const unsigned short pid4, const cxtype COUP, const fptype M1,
    const fptype W1,
#ifndef __CUDACC__
...
cxtype V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[0] = denom * (-cI * (V3[0] * TMP12) + cI * (V2[0] * TMP10)); 
  V1[1] = denom * (-cI * (V3[1] * TMP12) + cI * (V2[1] * TMP10)); 
  V1[2] = denom * (-cI * (V3[2] * TMP12) + cI * (V2[2] * TMP10)); 
  V1[3] = denom * (-cI * (V3[3] * TMP12) + cI * (V2[3] * TMP10)); 
}


__device__ void VVVV1_0(const fptype * allmomenta, const cxtype V1[], const
    unsigned short pid1, const cxtype V2[], const unsigned short pid2, const
    cxtype V3[], const unsigned short pid3, const cxtype V4[], const unsigned
    short pid4, const cxtype COUP,
#ifndef __CUDACC__
...
cxtype * vertex)
{
  ...
  TMP9 = (V1[0] * V4[0] - V1[1] * V4[1] - V1[2] * V4[2] - V1[3] * V4[3]); 
  TMP12 = (V2[0] * V4[0] - V2[1] * V4[1] - V2[2] * V4[2] - V2[3] * V4[3]); 
  (*vertex) = COUP * (-cI * (TMP6 * TMP9) + cI * (TMP3 * TMP12)); 
}


__device__ void VVVV1P0_1(const fptype * allmomenta, const cxtype V2[], const
    unsigned short pid2, const cxtype V3[], const unsigned short pid3, const
    cxtype V4[], const unsigned short pid4, const cxtype COUP, const fptype M1,
    const fptype W1,
#ifndef __CUDACC__
...
cxtype V1[])
{
  ...
  denom = COUP/((P1[0] * P1[0]) - (P1[1] * P1[1]) - (P1[2] * P1[2]) - (P1[3] *
      P1[3]) - M1 * (M1 - cI * W1));
  V1[0] = denom * (-cI * (TMP6 * V4[0]) + cI * (V3[0] * TMP12)); 
  V1[1] = denom * (-cI * (TMP6 * V4[1]) + cI * (V3[1] * TMP12)); 
  V1[2] = denom * (-cI * (TMP6 * V4[2]) + cI * (V3[2] * TMP12)); 
  V1[3] = denom * (-cI * (TMP6 * V4[3]) + cI * (V3[3] * TMP12)); 
}
